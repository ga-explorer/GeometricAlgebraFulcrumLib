...
namespace NumericalGeometryLib.GeometricAlgebra.Structures
{
        ...
        IReadOnlyCollection<double>
    {
        ...
        public double this[ulong index1, ulong index2]
        {
            ...
            {
                Debug.Assert(
                    index1 < GaSpaceDimension && 
                    index2 < GaSpaceDimension
                );
        ...
        public GaBivectorSparseList(ulong gaSpaceDimension)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private GaBivectorSparseList(ulong gaSpaceDimension, Dictionary<Pair<ulong>, double> numbersDictionary)
        {
            if (BitOperations.PopCount(gaSpaceDimension) != 1)
                throw new ArgumentException(nameof(gaSpaceDimension));
        ...
        public GaBivectorSparseList MapNumbers(Func<double, double> numberMapping)
        {
            ...
            return new GaBivectorSparseList(GaSpaceDimension, numbersDictionary);
        }
        ...
        {
            for (var i = 0UL; i < GaSpaceDimension - 1; i++)
            for (var j = i + 1; j < GaSpaceDimension; j++)
