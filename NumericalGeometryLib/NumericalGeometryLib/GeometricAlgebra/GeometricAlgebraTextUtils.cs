...
{
    public static class GeometricAlgebraTextUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string GetTermText(this GaTerm term)
        {
            return GetTermText(
                term.Id,
                term.Scalar
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string GetTermsText(this IEnumerable<GaTerm> terms)
        {
            return terms
                .Select(GetTermText)
                .ConcatenateText(", ");
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string GetMultivectorText(this GaMultivector multivector)
        {
            return GetTermsText(
                multivector.GetTermsOrderedByGrade()
            );
        }
