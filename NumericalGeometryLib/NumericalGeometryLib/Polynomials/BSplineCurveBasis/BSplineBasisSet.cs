...
namespace NumericalGeometryLib.Polynomials.BSplineCurveBasis
{
        ...
        IBSplineBasisSet
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private BSplineBasisSet([NotNull] BSplineKnotVector knotVector, int degree)
        {
        ...
        private double GetValue(int degree, int index, double parameterValue)
        {
            ...
            var a = a1.IsExactZero() || a2.IsExactZero() ? 0d : a1 / a2;
            var b = b1.IsExactZero() || b2.IsExactZero() ? 0d : b1 / b2;
