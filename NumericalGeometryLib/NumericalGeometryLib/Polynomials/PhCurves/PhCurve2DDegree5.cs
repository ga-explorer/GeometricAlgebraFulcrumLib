...
namespace NumericalGeometryLib.Polynomials.PhCurves
{
    public sealed class PhCurve2DDegree5
    {
        ...
        public Float64Tuple2D Point0 { get; }

        public Float64Tuple2D Point1 { get; }

        public Float64Tuple2D Tangent0 { get; }

        public Float64Tuple2D Tangent1 { get; }
        ...
        private PhCurve2DDegree5([NotNull] IFloat64Tuple2D point0, [NotNull] IFloat64Tuple2D tangent0, [NotNull] IFloat64Tuple2D point1, [NotNull] IFloat64Tuple2D tangent1)
        {
            ...
            ScaledRotor = Float64Tuple2D.E1.CreateEuclideanScaledPureRotor(tangent0);
        ...
        public Float64Tuple2D GetHodographPoint(double parameterValue)
        {
        ...
        public Float64Tuple2D GetCurvePoint(double parameterValue)
        {
