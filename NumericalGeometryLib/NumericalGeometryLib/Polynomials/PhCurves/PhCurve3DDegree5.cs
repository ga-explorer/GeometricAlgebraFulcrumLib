...
namespace NumericalGeometryLib.Polynomials.PhCurves
{
    public sealed class PhCurve3DDegree5
    {
        ...
        private PhCurve3DDegree5([NotNull] IFloat64Tuple3D point0, [NotNull] IFloat64Tuple3D tangent0, [NotNull] IFloat64Tuple3D point1, [NotNull] IFloat64Tuple3D tangent1, double theta1, double theta2)
        {
