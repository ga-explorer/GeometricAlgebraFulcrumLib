...
{
    public static class GeometricTupleUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double GetComponent(this ITuple2D tuple, int index)
        {
            return index switch
            {
                0 => tuple.X,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double GetComponent(this ITuple3D tuple, int index)
        {
            return index switch
            {
                0 => tuple.X,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double GetComponent(this ITuple3D tuple, Axis3D axis)
        {
            return axis switch
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double GetComponent(this ITuple4D tuple, int index)
        {
            return index switch
            {
                0 => tuple.X,
