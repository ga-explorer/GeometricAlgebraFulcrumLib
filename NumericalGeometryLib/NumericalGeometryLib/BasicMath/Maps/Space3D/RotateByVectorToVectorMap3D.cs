...
namespace NumericalGeometryLib.BasicMath.Maps.Space3D
{
        ...
        RotateMap3D
    {
        ...
        public static RotateByVectorToVectorMap3D Create(ITuple3D unitVector1, ITuple3D unitVector2)
        {
        ...
        private Tuple3D _unitVector1;
        public Tuple3D UnitVector1
        {
            get => _unitVector1;
            set
            {
        ...
        private Tuple3D _unitVector2;
        public Tuple3D UnitVector2
        {
            get => _unitVector2;
            set
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private RotateByVectorToVectorMap3D([NotNull] ITuple3D unitVector1, [NotNull] ITuple3D unitVector2)
        {
