    ...
    IReadOnlyList<HyperPlaneNormalReflection>
{
    ...
    {
        var reflectionSequence =
            new HyperPlaneNormalReflectionSequence(reflection.Dimensions);
    ...
    {
        if (reflectionNormal.Dimensions != Dimensions)
    ...
    {
        if (reflection.Dimensions != Dimensions)
            throw new ArgumentException();
    ...
    public HyperPlaneNormalReflectionSequence GetHyperPlaneReflectionSequenceInverse()
    {
        ...
        return new HyperPlaneNormalReflectionSequence(Dimensions, reflectionNormalList);
    }
    ...
    {
        return OrthogonalLinearMapSequence.CreateFromMatrix(GetMatrix());
    }
