...
namespace GraphicsComposerLib.WebGl.Xeogl.Materials
{
    ...
    public sealed class XeoglPhongMaterial : XeoglMaterial
    {
        ...
        public override void UpdateConstructorAttributes(JavaScriptAttributesDictionary composer)
        {
            ...
            JsCodeComponentUtils.SetValue(JsCodeComponentUtils.SetValue(JsCodeComponentUtils.SetValue(JsCodeComponentUtils.SetValue(JsCodeComponentUtils.SetValue(composer
                    .SetRgbaNumbersArrayValue("ambient", AmbientColor, Color.White)
                    .SetRgbaNumbersArrayValue("diffuse", DiffuseColor, Color.White)
                    .SetRgbaNumbersArrayValue("specular", SpecularColor, Color.White)
                    .SetRgbNumbersArrayValue("emissive", EmissiveColor, Color.Black), "diffuseFresnel", DiffuseFresnel, null), "specularFresnel", SpecularFresnel, null), "emissiveFresnel", EmissiveFresnel, null), "reflectivityFresnel", ReflectivityFresnel, null), "alphaFresnel", AlphaFresnel, null)
