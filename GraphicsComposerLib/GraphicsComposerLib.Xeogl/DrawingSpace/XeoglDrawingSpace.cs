...
namespace GraphicsComposerLib.Xeogl.DrawingSpace
{
    public sealed class XeoglDrawingSpace 
        : IReadOnlyList<XeoglDrawingSpaceLayer>, IXeoglScriptGenerator
    {
...
";
        ...
        {
            XeoglGeometry geometry;
            _geometryDictionary.TryGetValue(variableName, out geometry);
        ...
        {
            XeoglMaterial materials;
            _materialDictionary.TryGetValue(variableName, out materials);
