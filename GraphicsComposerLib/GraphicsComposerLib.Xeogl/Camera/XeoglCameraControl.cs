namespace GraphicsComposerLib.Xeogl.Camera
{
    ...
    public sealed class XeoglCameraControl : XeoglComponent
    {
        ...
        internal override void UpdateAttributesComposer(XeoglCodeComposer composer)
        {
            ...
            composer
                .SetAttributeValue("firstPerson", FirstPerson, false)
                .SetAttributeValue("walking", Walking, false)
                .SetAttributeValue("doublePickFlyTo", DoublePickFlyTo, true)
                .SetAttributeValue("active", Active, true)
                .SetAttributeValue("pivoting", Pivoting, false)
                .SetAttributeValue("panToPointer", PanToPointer, false)
                .SetAttributeValue("inertia", Inertia, 0.5);
        }
