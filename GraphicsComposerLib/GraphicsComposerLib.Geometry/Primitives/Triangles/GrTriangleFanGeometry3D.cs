...
namespace GraphicsComposerLib.Geometry.Primitives.Triangles
{
    ...
    {
        public static GrTriangleFanGeometry3D Create(IReadOnlyList<ITuple3D> pointsList)
        {
        ...
        public static GrTriangleFanGeometry3D Create(params ITuple3D[] pointsList)
        {
        ...
        public static GrTriangleFanGeometry3D Create(IEnumerable<ITuple3D> pointsList)
        {
        ...
        private GrTriangleFanGeometry3D(IReadOnlyList<ITuple3D> pointsList)
            : base(pointsList)
        {
        }
