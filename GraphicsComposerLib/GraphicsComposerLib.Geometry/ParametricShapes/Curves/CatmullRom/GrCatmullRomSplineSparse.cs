...
/// </summary>
public sealed class GrCatmullRomSplineSparse
{
    ...
    internal GrCatmullRomSplineSparse(IEnumerable<Float64Tuple> inputPointList, CatmullRomSplineType curveType, bool isClosed)
    {
        CurveType = curveType;
        IsClosed = isClosed;
