...
{
    //public sealed record GrParametricCurveTreeCornerIndex
    //{
    ...
    //    public GrParametricCurveTreeCornerIndex(int level, int segmentCount)
    //    {
    //        if (level < 0 || level > 31)
    ...
    //    public int GetGridIndex(int maxLevel)
    //    {
    //        if (maxLevel < Level)
