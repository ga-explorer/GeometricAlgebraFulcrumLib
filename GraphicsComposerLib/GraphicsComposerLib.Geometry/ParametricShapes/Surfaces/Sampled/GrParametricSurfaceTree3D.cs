...
namespace GraphicsComposerLib.Geometry.ParametricShapes.Surfaces.Sampled
{
        ...
        IGraphicsParametricSurface3D
    {
        ...
        public GrParametricSurfaceTree3D([NotNull] IGraphicsParametricSurface3D surface, [NotNull] IBoundingBox2D parameterValueRange)
        {
            Surface = surface;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GrParametricSurfaceTree3D([NotNull] IGraphicsParametricSurface3D surface)
        {
            Surface = surface;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal GrParametricSurfaceTreeLeaf3D AddLeafNode([NotNull] GrParametricSurfaceTreeLeaf3D leafNode)
        {
