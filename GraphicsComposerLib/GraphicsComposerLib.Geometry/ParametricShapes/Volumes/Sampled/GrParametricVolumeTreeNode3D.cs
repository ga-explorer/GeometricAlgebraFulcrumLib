...
namespace GraphicsComposerLib.Geometry.ParametricShapes.Volumes.Sampled
{
        ...
        IReadOnlyCollection<GrParametricVolumeTreeNode3D>
    {
        ...
        protected GrParametricVolumeTreeNode3D([NotNull] GrParametricVolumeTree3D parentTree)
        {
        ...
        protected GrParametricVolumeTreeNode3D([NotNull] GrParametricVolumeTreeBranch3D parentBranch, bool isChild1XX, bool isChildX1X, bool isChildXX1)
        {
