...
namespace GraphicsComposerLib.Geometry.ParametricShapes.Volumes.Sampled
{
    public sealed record GrParametricVolumeTreeSample3D
    {
        ...
        internal GrParametricVolumeTreeSample3D([NotNull] GrParametricVolumeTreeLeaf3D leafNode, double parameterValue1, double parameterValue2, double parameterValue3)
        {
            LeafNode = leafNode;
