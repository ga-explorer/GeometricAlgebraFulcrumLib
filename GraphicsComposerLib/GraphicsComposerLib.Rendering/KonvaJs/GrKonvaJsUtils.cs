...
public static class GrKonvaJsUtils
{
    ...
    public static GrKonvaJsVector3Value ToKonvaJsVector3Value(this IFloat64Vector3D value)
    {
    ...
    public static JToken GetKonvaJsJson(this IFloat64Vector2D value)
    {
        return new JArray(
            (float)value.X,
            (float)value.Y
    ...
    public static JToken GetKonvaJsJson(this ITriplet<double> value)
    {
        return new JArray(
            (float)value.Item1,
            (float)value.Item2,
    ...
    public static JToken GetKonvaJsJson(this IFloat64Vector3D value)
    {
        return new JArray(
            (float)value.X,
            (float)value.Y,
    ...
    public static JToken GetKonvaJsJson(this IFloat64Vector4D value)
    {
        return new JArray(
            (float)value.X,
            (float)value.Y,
    ...
    public static JToken GetKonvaJsJson(this Float64Quaternion value)
    {
        return new JArray(
            (float)-value.ScalarI,
            (float)-value.ScalarJ,
    ...
    public static string GetKonvaJsCode(this IPair<double> vector)
    {
        return $"{{ x: {(float)vector.Item1:G}, y: {(float)vector.Item2:G} }}";
    }

    public static string GetKonvaJsCode(this ITriplet<double> vector)
    {
        return $"new Konva.Vector3({(float)vector.Item1:G}, {(float)vector.Item2:G}, {(float)vector.Item3:G})";
    }

    public static string GetKonvaJsCode(this IQuad<double> vector)
    {
    ...
    public static string GetKonvaJsCode(this IEnumerable<IPair<double>> vectorList)
    {
        return vectorList.Select(
            vector => $"{vector.Item1.GetKonvaJsCode()}, {vector.Item2.GetKonvaJsCode()}"
        ).GetKonvaJsArrayCode();
    }

    //public static string GetKonvaJsCode(this IEnumerable<ITriplet<double>> vectorList)
    //{
    //    return vectorList.Select(
    //        vector => vector.GetKonvaJsCode()
    //    ).GetKonvaJsArrayCode();
    ...
    //public static string GetKonvaJsCode(this IEnumerable<IReadOnlyList<ITriplet<double>>> vectorList)
    //{
    //    return vectorList.Select(
    //        vector => vector.GetKonvaJsCode()
    //    ).GetKonvaJsArrayCode();
    ...
    public static string GetKonvaJsCode(this IPair<ITriplet<double>> vectorList)
    {
    ...
    public static string GetKonvaJsCode(this ITriplet<ITriplet<double>> vectorList)
    {
        var p1 = vectorList.Item1.GetKonvaJsCode();
        var p2 = vectorList.Item2.GetKonvaJsCode();
    ...
    public static string GetKonvaJsCode(this IQuad<ITriplet<double>> vectorList)
    {
        var p1 = vectorList.Item1.GetKonvaJsCode();
        var p2 = vectorList.Item2.GetKonvaJsCode();
        var p3 = vectorList.Item3.GetKonvaJsCode();
