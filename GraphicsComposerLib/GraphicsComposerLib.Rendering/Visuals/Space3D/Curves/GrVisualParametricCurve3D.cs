    ...
    GrVisualCurve3D
{
    ...
    public GrVisualParametricCurve3D(string name, IGraphicsC1ParametricCurve3D curve, IReadOnlyList<double> parameterValues, IReadOnlyList<double> frameParameterValues)
        : base(name)
    {
        Curve = curve;
