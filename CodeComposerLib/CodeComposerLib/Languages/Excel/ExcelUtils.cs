...
namespace CodeComposerLib.Languages.Excel
{
    public static class ExcelUtils
    {
        ...
        public static LanguageInfo Excel2007Info { get; private set; }


        static ExcelUtils()
        {
            ExcelUtils.Excel2007Info = new LanguageInfo("Excel 2007 Formulas", "2007", "Excel 2007");
        }
