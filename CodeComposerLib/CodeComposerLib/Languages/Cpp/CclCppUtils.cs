...
public static class CclCppUtils
{
    /// <summary>
    ...
    public static CclLanguageInfo Cpp11Info { get; private set; }


    static CclCppUtils()
    {
        Cpp11Info = new CclLanguageInfo("Cpp", "11", "C++ 11");
    }


    public static CclCppCodeGenerator Cpp11CodeComposer()
    {
        return new CclCppCodeGenerator();
    }

    public static CclCppSyntaxFactory Cpp11SyntaxFactory()
    {
        return new CclCppSyntaxFactory();
    }
