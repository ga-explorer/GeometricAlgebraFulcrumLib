...
namespace WebComposerLib.Svg.Values
{
    public class SvgValuePointsList : SvgComputedValue
    {
        ...
        public static SvgValuePointsList Create(IEnumerable<IPair<double>> points)
        {
            var pointsList = new SvgValuePointsList();
        ...
        public static SvgValuePointsList Create(SvgValueLengthUnit unit, IEnumerable<IPair<double>> points)
        {
            var pointsList = new SvgValuePointsList { Unit = unit };
        ...
        public SvgValuePointsList AddPoints(IEnumerable<IPair<double>> pointsList)
        {
        ...
        public SvgValuePointsList InsertPoints(int index, IEnumerable<IPair<double>> pointsList)
        {
