...
//    public LinFloat64UnilinearMapComposer SetColumnVector(int index2, Float64Tuple4D vector)
//    {
...
//    public LinFloat64UnilinearMapComposer SetColumnVectorNegative(int index2, Float64Tuple4D vector)
//    {
//        foreach (var (index1, scalar) in vector.IndexScalarPairs)
//            SetTerm(index1, index2, -scalar);
...
//    public LinFloat64UnilinearMapComposer SetColumnVector(int index2, Float64Tuple4D vector, double scalingFactor)
//    {
//        foreach (var (index1, scalar) in vector.IndexScalarPairs)
...
//    [MethodImpl(MethodImplOptions.AggressiveInlining)]
//    public LinFloat64UnilinearMapComposer SetDiagonalMap(Float64Tuple4D vector)
//    {
//        _indexPairScalarDictionary = new Dictionary<IndexPair, double>();
...
//    public LinFloat64UnilinearMapComposer AddColumnVector(int index2, Float64Tuple4D vector)
//    {
//        foreach (var (index1, scalar) in vector.IndexScalarPairs)
//            AddTerm(index1, index2, scalar);
...
//    public LinFloat64UnilinearMapComposer AddColumnVector(int index2, Float64Tuple4D vector, double scalingFactor)
//    {
//        foreach (var (index1, scalar) in vector.IndexScalarPairs)
//            AddTerm(
//                index1,
...
//    public LinFloat64UnilinearMapComposer AddColumnVectorNegative(int index2, Float64Tuple4D vector)
//    {
...
//    public LinFloat64UnilinearMapComposer AddDiagonalMap(Float64Tuple4D vector)
//    {
...
//    public LinFloat64UnilinearMapComposer SubtractColumnVector(int index2, Float64Tuple4D vector)
//    {
//        foreach (var (index1, scalar) in vector.IndexScalarPairs)
//            SubtractTerm(index1, index2, scalar);
...
//    public LinFloat64UnilinearMapComposer SubtractColumnVector(int index2, Float64Tuple4D vector, double scalingFactor)
//    {
//        foreach (var (index1, scalar) in vector.IndexScalarPairs)
//            SubtractTerm(
//                index1,
...
//    public LinFloat64UnilinearMapComposer SubtractColumnVectorNegative(int index2, Float64Tuple4D vector)
//    {
//        foreach (var (index1, scalar) in vector)
//            SubtractTerm(
//                index1, 
...
//    public LinFloat64UnilinearMapComposer SubtractDiagonalMap(Float64Tuple4D vector)
//    {
//        foreach (var (i, scalar) in vector)
//            SubtractTerm(i, i, scalar);
...
//    public Float64Tuple4D GetMappedBasisVector(int index)
//    {
...
//    public Float64Tuple4D GetMappedColumnVector(IReadOnlyList<double> vector)
//    {
//        var composer = new Float64Tuple4DComposer();
...
//    public Float64Tuple4D GetMappedColumnVector(Float64Tuple4D vector)
//    {
//        var composer = new Float64Tuple4DComposer();
