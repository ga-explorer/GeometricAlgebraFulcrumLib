    ...
    ILinearAlgebraElement<T>
{
    ...
    public static SquareMatrix3<T> CreateAxisToVectorRotationMatrix3D(LinBasisVector axis, ILinVector3D<T> unitVector)
    {
    ...
    public static SquareMatrix3<T> CreateVectorToAxisRotationMatrix3D(ILinVector3D<T> unitVector, LinBasisVector axis)
    {
