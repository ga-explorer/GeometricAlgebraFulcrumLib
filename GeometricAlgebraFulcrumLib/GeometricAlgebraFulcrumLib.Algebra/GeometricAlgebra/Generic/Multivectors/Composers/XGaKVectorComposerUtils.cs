...
public static class XGaKVectorComposerUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaKVector<T> KVectorTerm<T>(this XGaProcessor<T> processor, IndexSet basisBlade, string scalar)
    {
        return processor.KVectorTerm(basisBlade, processor.ScalarProcessor.ScalarFromText(scalar));
    }
