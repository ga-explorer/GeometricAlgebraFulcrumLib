...
public static class XGaSignedBasisBladeComposerUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaSignedBasisBlade CreateZeroBasisKVector(this XGaMetric metric, IndexSet indexSet)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaSignedBasisBlade CreatePositiveBasisKVector(this XGaMetric metric, IndexSet indexSet)
    {
        var basisBlade = metric.CreateBasisBlade(indexSet);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaSignedBasisBlade CreateNegativeBasisKVector(this XGaMetric metric, IndexSet indexSet)
    {
        var basisBlade = metric.CreateBasisBlade(indexSet);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaSignedBasisBlade CreateSignedBasisKVector(this XGaMetric metric, IndexSet indexSet, IntegerSign sign)
    {
        var basisBlade = metric.CreateBasisBlade(indexSet);
    ...
    public static XGaSignedBasisBlade CreateZeroBasisBlade(this XGaMetric metric, int grade)
    {
        return grade switch
        {
            ...
            _ => new XGaSignedBasisBlade(
                metric.CreateBasisBlade(grade.ToDenseIndexSet()), 
                IntegerSign.Zero
            )
        };
    }
