...
public sealed partial class XGaHigherKVector<T>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XGaHigherKVector<T> MapScalars(Func<IndexSet, T, T> scalarMapping)
    {
        if (IsZero) return this;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XGaFloat64HigherKVector MapScalars(XGaFloat64Processor processor, Func<IndexSet, T, double> scalarMapping)
    {
        if (IsZero) 
            return processor.HigherKVectorZero(Grade);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XGaHigherKVector<T1> MapScalars<T1>(XGaProcessor<T1> processor, Func<IndexSet, T, T1> scalarMapping)
    {
        if (IsZero) 
            return processor.HigherKVectorZero(Grade);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XGaHigherKVector<T> Times(Scalar<T> scalar)
    {
        return Times(scalar.ScalarValue);
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XGaHigherKVector<T> Times(IScalar<T> scalar)
    {
        return Times(scalar.ScalarValue);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XGaHigherKVector<T> Divide(Scalar<T> scalar)
    {
        return Divide(scalar.ScalarValue);
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XGaHigherKVector<T> Divide(IScalar<T> scalar)
    {
        return Divide(scalar.ScalarValue);
    }
