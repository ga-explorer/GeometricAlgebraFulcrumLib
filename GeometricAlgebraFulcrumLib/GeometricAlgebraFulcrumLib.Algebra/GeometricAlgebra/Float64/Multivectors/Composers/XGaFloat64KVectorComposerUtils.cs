...
public static class XGaFloat64KVectorComposerUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64HigherKVector ToXGaFloat64Trivector(this LinFloat64Trivector3D trivector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64HigherKVector ToXGaFloat64Trivector(this LinFloat64Trivector3D trivector, XGaFloat64Processor processor)
    {
        return processor
            .CreateComposer()
            .SetTrivectorTerm(0, 1, 2, trivector.Scalar123)
