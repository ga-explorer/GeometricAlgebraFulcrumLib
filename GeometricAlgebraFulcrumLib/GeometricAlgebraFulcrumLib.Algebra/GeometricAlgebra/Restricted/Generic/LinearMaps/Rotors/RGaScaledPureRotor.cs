    ...
    : RGaScaledRotorBase<T>
{
    ...
    {
        return new RGaScaledPureRotor<T>(processor, processor.ScalarProcessor.OneValue);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static RGaScaledPureRotor<T> Create(RGaProcessor<T> processor, IScalar<T> scalarPart)
    {
        return new RGaScaledPureRotor<T>(processor, scalarPart.ScalarValue);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static RGaScaledPureRotor<T> Create(IScalar<T> scalarPart, RGaBivector<T> bivectorPart)
    {
        return new RGaScaledPureRotor<T>(
            scalarPart + bivectorPart,
            scalarPart - bivectorPart
