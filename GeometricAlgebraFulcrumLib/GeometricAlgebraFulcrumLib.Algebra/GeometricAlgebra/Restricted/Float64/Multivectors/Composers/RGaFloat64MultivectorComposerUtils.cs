...
public static class RGaFloat64MultivectorComposerUtils
{
    ...
    {
        return metric.BivectorTerm(index1, index2, composer.ScalarValue);
    }
    ...
    {
        return metric.Multivector(id, composer.ScalarValue);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64GradedMultivector Multivector(this RGaFloat64Processor metric, IReadOnlyDictionary<ulong, double> termList)
    {
        return metric
            .CreateComposer()
            .SetTerms(termList)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64GradedMultivector Multivector(this RGaFloat64Processor metric, IReadOnlyDictionary<int, RGaFloat64KVector> gradeKVectorDictionary)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64GradedMultivector Multivector(this RGaFloat64Processor metric, IEnumerable<KeyValuePair<ulong, double>> termList)
    {
        return metric
            .CreateComposer()
            .AddTerms(termList)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64GradedMultivector Multivector(this RGaFloat64Processor metric, IEnumerable<RGaIdScalarRecord> termList)
    {
        return metric
            .CreateComposer()
            .AddTerms(termList)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64GradedMultivector Multivector(this RGaFloat64Processor metric, ulong id)
    {
        var grade = id.Grade();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64GradedMultivector Multivector(this RGaFloat64Processor metric, ulong id, double scalar)
    {
        var grade = id.Grade();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64GradedMultivector Multivector(this RGaFloat64Processor metric, KeyValuePair<ulong, double> basisScalarPair)
    {
        ...
        var gradeKVectorDictionary = new SingleItemDictionary<int, RGaFloat64KVector>(
            grade,
            metric.KVectorTerm(basisScalarPair)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64Multivector Multivector2D(this RGaFloat64Processor metric, double scalar, double vectorScalar0, double vectorScalar1, double bivectorScalar)
    {
        return metric
            .CreateComposer()
            .SetTerm(0, scalar)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64UniformMultivector UniformMultivector(this RGaFloat64Processor metric, IReadOnlyDictionary<ulong, double> basisScalarDictionary)
    {
        ...
        if (basisScalarDictionary.Count == 1 && basisScalarDictionary is not SingleItemDictionary<ulong, double>)
            return metric.UniformMultivector(basisScalarDictionary.First());
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64UniformMultivector UniformMultivector(this RGaFloat64Processor metric, ulong basisBlade)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64UniformMultivector UniformMultivector(this RGaFloat64Processor metric, ulong basisBlade, double scalar)
    {
        if (scalar.IsZero())
            return new RGaFloat64UniformMultivector(metric);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64UniformMultivector UniformMultivector(this RGaFloat64Processor metric, KeyValuePair<ulong, double> basisScalarPair)
    {
        return metric.UniformMultivector(
