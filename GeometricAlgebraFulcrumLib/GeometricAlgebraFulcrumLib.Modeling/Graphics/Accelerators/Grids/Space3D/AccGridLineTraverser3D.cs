...
public sealed class AccGridLineTraverser3D
{
    ...
    /// </summary>
    public LinFloat64Vector3D TDelta { get; }

    /// <summary>
    /// Initial values of line parameter in x and y directions 
    /// </summary>
    public LinFloat64Vector3D TFirst { get; }
    ...
    private AccGridLineTraverser3D(IAccGrid3D<IFiniteGeometricShape3D> grid, ILine3D line, Float64ScalarRange lineParamLimits)
    {
        ...
        if (t0 > t1)
        {
            ...
            TDelta = LinFloat64Vector3D.Zero;
        ...
        TDelta = LinFloat64Vector3D.Create((txMax - txMin) / grid.CellsCountX,
        ...
        TFirst = LinFloat64Vector3D.Create(txNext, tyNext, tzNext);
