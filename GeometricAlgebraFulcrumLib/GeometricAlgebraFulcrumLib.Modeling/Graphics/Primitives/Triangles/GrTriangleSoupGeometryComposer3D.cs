    ...
    IGraphicsTriangleGeometry3D
{
    ...
    private IGraphicsVertex3D CreateVertex(ILinFloat64Vector3D point)
    {
    ...
    private IGraphicsVertex3D AddVertex(ILinFloat64Vector3D point)
    {
    ...
    {
        var storedVertex = CreateVertex(LinFloat64Vector3D.Create(x, y, z));
    ...
    public GrTriangleSoupGeometryComposer3D AddTriangles(IEnumerable<ITriplet<ILinFloat64Vector3D>> trianglePointsList)
    {
    ...
    public GrTriangleSoupGeometryComposer3D AddTriangles(IReadOnlyList<ILinFloat64Vector3D> pointsList)
    {
