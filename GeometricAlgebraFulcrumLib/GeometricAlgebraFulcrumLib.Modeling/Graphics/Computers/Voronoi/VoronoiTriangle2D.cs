...
public sealed class VoronoiTriangle2D : IFloat64Triangle2D
{
    ...
    public LinFloat64Vector2D Point1 => PointsList[PointIndex1];

    public LinFloat64Vector2D Point2 => PointsList[PointIndex2];

    public LinFloat64Vector2D Point3 => PointsList[PointIndex3];
    ...
    public bool CircumcircleContainsVa(ILinFloat64Vector2D point)
    {
        ...
        var center = LinFloat64Vector2D.Create((Float64Scalar)centerX, (Float64Scalar)centerY);
