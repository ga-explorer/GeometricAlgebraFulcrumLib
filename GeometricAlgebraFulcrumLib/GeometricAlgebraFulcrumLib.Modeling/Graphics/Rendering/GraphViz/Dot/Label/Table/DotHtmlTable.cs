...
namespace GeometricAlgebraFulcrumLib.Modeling.Graphics.Rendering.GraphViz.Dot.Label.Table;
...
public sealed class DotHtmlTable : DotHtmlTag, IDotHtmlLabel, IList<DotHtmlRow>
{
    ...
    {
        get => AttrValues.GetAttribute("CELLBORDER");
    ...
    {
        get => AttrValues.GetAttribute("COLUMNS");
    ...
    public string Rows
    {
        get => AttrValues.GetAttribute("ROWS");
