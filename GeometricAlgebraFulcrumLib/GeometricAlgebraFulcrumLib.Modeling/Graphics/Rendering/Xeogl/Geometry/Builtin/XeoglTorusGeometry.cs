...
{
    public static XeoglTorusGeometry Create(ILinFloat64Vector3D center, double radius, double tubeRadius)
    {
    ...
    public static XeoglTorusGeometry Create(ILinFloat64Vector3D center, double radius, double tubeRadius, double arcAngle)
    {
        return new XeoglTorusGeometry(center)
        {
            Radius = radius,
    ...
    public static XeoglTorusGeometry Create(ILinFloat64Vector3D center, double radius, double tubeRadius, int radialSegments, int tubeSegments)
    {
        return new XeoglTorusGeometry(center)
        {
            Radius = radius,
    ...
    public static XeoglTorusGeometry Create(ILinFloat64Vector3D center, double radius, double tubeRadius, double arcAngle, int radialSegments, int tubeSegments)
    {
        return new XeoglTorusGeometry(center)
        {
            Radius = radius,
    ...
    public XeoglTorusGeometry(ILinFloat64Vector3D center)
    {
