...
public sealed class XeoglERotateScaleTranslateTransform : IXeoglNumericalTransform
{
    ...
    public static XeoglERotateScaleTranslateTransform CreateTranslate(ILinFloat64Vector3D t)
    {
        return new XeoglERotateScaleTranslateTransform()
        {
            TranslateX = t.X,
    ...
    public XeoglERotateScaleTranslateTransform SetRotate(ILinFloat64Vector3D rotateTuple)
    {
    ...
    public XeoglERotateScaleTranslateTransform SetScale(ILinFloat64Vector3D scaleTuple)
    {
        ScaleX = scaleTuple.X;
        ScaleY = scaleTuple.Y;
        ScaleZ = scaleTuple.Z;
    ...
    public XeoglERotateScaleTranslateTransform SetTranslate(ILinFloat64Vector3D translateTuple)
    {
