...
public sealed class GrPovRaySpotLightProperties :
    GrPovRayLightProperties
{
    ...
    public GrPovRaySpotLightProperties()
    {
    }

    public GrPovRaySpotLightProperties(GrPovRaySpotLightProperties properties)
    {
