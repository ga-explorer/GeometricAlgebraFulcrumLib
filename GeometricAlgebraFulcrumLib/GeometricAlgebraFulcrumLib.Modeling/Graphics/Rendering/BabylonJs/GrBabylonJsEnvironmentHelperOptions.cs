...
public sealed class GrBabylonJsEnvironmentHelperOptions :
    GrBabylonJsObjectOptions
{
    ...
    public GrBabylonJsEnvironmentHelperOptions()
    {
    }

    public GrBabylonJsEnvironmentHelperOptions(GrBabylonJsEnvironmentHelperOptions options)
    {
