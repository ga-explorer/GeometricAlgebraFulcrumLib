...
public sealed class GrBabylonJsArcRotateCameraProperties :
    GrBabylonJsTargetCameraProperties
{
    ...
    public GrBabylonJsArcRotateCameraProperties()
    {
    }

    public GrBabylonJsArcRotateCameraProperties(GrBabylonJsArcRotateCameraProperties properties)
    {
