...
public sealed class GrBabylonJsStandardMaterialProperties :
    GrBabylonJsMaterialProperties
{
    ...
    public GrBabylonJsStandardMaterialProperties()
    {
    }
            
    public GrBabylonJsStandardMaterialProperties(GrBabylonJsColor3Value color)
    {
        AmbientColor = color;
        DiffuseColor = color;
        SpecularColor = color;
    ...
    public GrBabylonJsStandardMaterialProperties(GrBabylonJsStandardMaterialProperties properties)
    {
