...
public static class GrBabylonJsKeyFrameDictionaryUtils
{
    ...
    private static bool TestNearLinear(this IReadOnlyList<KeyValuePair<int, LinFloat64Vector2D>> pointList, int index1, int index2, double yEpsilon)
    {
        var (x1, y1) = pointList[index1];
        var (x2, y2) = pointList[index2];
        var dx = x2 - x1;
    ...
    private static bool TestNearLinear(this IReadOnlyList<KeyValuePair<int, LinFloat64Vector3D>> pointList, int index1, int index2, double yEpsilon)
    {
        var (x1, y1) = pointList[index1];
        var (x2, y2) = pointList[index2];
        var dx = x2 - x1;
    ...
    private static bool TestNearLinear(this IReadOnlyList<KeyValuePair<int, LinFloat64Quaternion>> pointList, int index1, int index2, double yEpsilon)
    {
        var (x1, y1) = pointList[index1];
        var (x2, y2) = pointList[index2];
        var dx = x2 - x1;
    ...
    public static IEnumerable<int> OptimizeKeyFrameIndices(this GrBabylonJsKeyFrameDictionary<LinFloat64Vector2D> keyFrameDictionary, double valueEpsilon = 1e-4d)
    {
        if (keyFrameDictionary.Count < 2)
            throw new InvalidOperationException();
    ...
    public static IEnumerable<int> OptimizeKeyFrameIndices(this GrBabylonJsKeyFrameDictionary<LinFloat64Vector3D> keyFrameDictionary, double valueEpsilon = 1e-4d)
    {
        if (keyFrameDictionary.Count < 2)
            throw new InvalidOperationException();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<int> OptimizeQuaternionKeyFrameIndices(this GrBabylonJsKeyFrameDictionary<LinFloat64Quaternion> keyFrameDictionary, double valueEpsilon = 1e-4d)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GrBabylonJsKeyFrameDictionary<LinFloat64Vector2D> OptimizeKeyFrames(this GrBabylonJsKeyFrameDictionary<LinFloat64Vector2D> keyFrameDictionary, double valueEpsilon = 1e-4d)
    {
        return keyFrameDictionary
            .OptimizeKeyFrameIndices(valueEpsilon)
            .ReduceKeyFrames(keyFrameDictionary);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GrBabylonJsKeyFrameDictionary<LinFloat64Vector3D> OptimizeKeyFrames(this GrBabylonJsKeyFrameDictionary<LinFloat64Vector3D> keyFrameDictionary, double valueEpsilon = 1e-4d)
    {
        return keyFrameDictionary
            .OptimizeKeyFrameIndices(valueEpsilon)
            .ReduceKeyFrames(keyFrameDictionary);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GrBabylonJsKeyFrameDictionary<LinFloat64Quaternion> OptimizeQuaternionKeyFrames(this GrBabylonJsKeyFrameDictionary<LinFloat64Quaternion> keyFrameDictionary, double valueEpsilon = 1e-4d)
    {
        return keyFrameDictionary
    ...
    public static Pair<GrBabylonJsKeyFrameDictionary<double>> SeparateComponents(this IEnumerable<KeyValuePair<int, LinFloat64Vector2D>> keyFrameIndexVectorPairs, GrBabylonJsKeyFrameOptimizationKind optimizationKind = GrBabylonJsKeyFrameOptimizationKind.Separate, double valueEpsilon = 1e-4d)
    {
        var keyFrameXDictionary = new GrBabylonJsKeyFrameDictionary<double>();
        var keyFrameYDictionary = new GrBabylonJsKeyFrameDictionary<double>();
    ...
    public static Triplet<GrBabylonJsKeyFrameDictionary<double>> SeparateComponents(this IEnumerable<KeyValuePair<int, LinFloat64Vector3D>> keyFrameIndexVectorPairs, GrBabylonJsKeyFrameOptimizationKind optimizationKind = GrBabylonJsKeyFrameOptimizationKind.Separate, double valueEpsilon = 1e-4d)
    {
        var keyFrameXDictionary = new GrBabylonJsKeyFrameDictionary<double>();
        var keyFrameYDictionary = new GrBabylonJsKeyFrameDictionary<double>();
        var keyFrameZDictionary = new GrBabylonJsKeyFrameDictionary<double>();
    ...
    public static Quad<GrBabylonJsKeyFrameDictionary<double>> SeparateComponents(this IEnumerable<KeyValuePair<int, LinFloat64Quaternion>> keyFrameIndexVectorPairs, GrBabylonJsKeyFrameOptimizationKind optimizationKind = GrBabylonJsKeyFrameOptimizationKind.Separate, double valueEpsilon = 1e-4d)
    {
        var keyFrameXDictionary = new GrBabylonJsKeyFrameDictionary<double>();
        var keyFrameYDictionary = new GrBabylonJsKeyFrameDictionary<double>();
        var keyFrameZDictionary = new GrBabylonJsKeyFrameDictionary<double>();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsConstant(this GrBabylonJsKeyFrameDictionary<LinFloat64Vector2D> keyFrames)
    {
        return keyFrames.IsConstant(
            (v1, v2) => 
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsConstant(this GrBabylonJsKeyFrameDictionary<LinFloat64Vector3D> keyFrames)
    {
        return keyFrames.IsConstant(
            (v1, v2) => 
                v1.GetDistanceSquaredToPoint(v2).IsNearZero()
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsConstant(this GrBabylonJsKeyFrameDictionary<LinFloat64Quaternion> keyFrames)
    {
        return keyFrames.IsConstant(
            (v1, v2) => 
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsQuaternionConstant(this GrBabylonJsKeyFrameDictionary<LinFloat64Quaternion> keyFrames)
    {
        return keyFrames.IsConstant(
            (v1, v2) => 
