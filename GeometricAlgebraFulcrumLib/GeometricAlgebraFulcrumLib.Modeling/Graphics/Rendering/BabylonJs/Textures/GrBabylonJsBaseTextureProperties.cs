...
public abstract class GrBabylonJsBaseTextureProperties :
    GrBabylonJsObjectProperties
{
    ...
    protected GrBabylonJsBaseTextureProperties()
    {
    }

    protected GrBabylonJsBaseTextureProperties(GrBabylonJsBaseTextureProperties properties)
    {
