...
public sealed class GrBabylonJsMarpleTextureProperties :
    GrBabylonJsBaseTextureProperties
{
    ...
    public GrBabylonJsMarpleTextureProperties()
    {
    }

    public GrBabylonJsMarpleTextureProperties(GrBabylonJsMarpleTextureProperties properties)
    {
