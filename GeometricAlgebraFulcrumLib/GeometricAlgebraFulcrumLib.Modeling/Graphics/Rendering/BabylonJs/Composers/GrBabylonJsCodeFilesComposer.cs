...
public class GrBabylonJsCodeFilesComposer
{
...
var createDefaultEngine = function() { 
    return new BABYLON.Engine(canvas, true, { preserveDrawingBuffer: false, stencil: false,  disableWebGL2Support: false}); 
};
...
".Trim()
    ...
    private readonly Dictionary<string, GrBabylonJsSceneComposer> _sceneComposerList
        = new Dictionary<string, GrBabylonJsSceneComposer>();


    public bool OfflineJavaScriptLibraries { get; set; } = true;
    ...
    public GrBabylonJsSceneComposer this[string sceneName]
    {
    ...
    public GrBabylonJsSceneComposer ActiveSceneComposer { get; private set; }

    public GrBabylonJsSceneComposer FirstSceneComposer
        => _sceneComposerList.First().Value;

    public GrBabylonJsScene FirstScene
        => _sceneComposerList.First().Value.SceneObject;

    public GrBabylonJsSceneComposer LastSceneComposer
    ...
    public IEnumerable<GrBabylonJsSceneComposer> SceneComposers
    ...
    public GrBabylonJsCodeFilesComposer()
        : this(new GrBabylonJsSceneComposer())
    {
    }

    public GrBabylonJsCodeFilesComposer(string constName)
        : this(new GrBabylonJsSceneComposer(constName))
    {
    }

    public GrBabylonJsCodeFilesComposer(string constName, GrBabylonJsSnapshotSpecs snapshotSpecs)
        : this(new GrBabylonJsSceneComposer(constName, snapshotSpecs))
    {
    }

    public GrBabylonJsCodeFilesComposer(GrBabylonJsSceneComposer sceneComposer)
    {
    ...
    public GrBabylonJsSceneComposer GetSceneComposer(string constName)
    {
    ...
    public GrBabylonJsCodeFilesComposer SetActiveSceneComposer(string constName)
    {
    ...
    public GrBabylonJsCodeFilesComposer ClearSceneComposers()
    {
        _sceneComposerList.Clear();

        AddSceneComposer(
            new GrBabylonJsSceneComposer(),
            true
        );
    ...
    public GrBabylonJsSceneComposer AddSceneComposer(GrBabylonJsSceneComposer sceneComposer, bool setActive = true)
    {
        _sceneComposerList.Add(
    ...
    public GrBabylonJsSceneComposer AddSceneComposer(string constName, bool setActive = true)
    {
        var sceneComposer = new GrBabylonJsSceneComposer(constName);

        return AddSceneComposer(sceneComposer, setActive);
    }

    public GrBabylonJsSceneComposer AddSceneComposer(string constName, GrBabylonJsSnapshotSpecs snapshotSpecs, bool setActive = true)
    {
        var sceneComposer = new GrBabylonJsSceneComposer(constName, snapshotSpecs);
