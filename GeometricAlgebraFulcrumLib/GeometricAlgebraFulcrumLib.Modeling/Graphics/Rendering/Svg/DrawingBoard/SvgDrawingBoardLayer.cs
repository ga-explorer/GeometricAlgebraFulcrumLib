...
using GeometricAlgebraFulcrumLib.Utilities.Web.Svg.Elements.Shape;
using GeometricAlgebraFulcrumLib.Utilities.Web.Svg.Elements.Text;
...
public class SvgDrawingBoardLayer
{
    ...
    {
        get => CurrentStyle.PenPixelsWidth;
    ...
    {
        get => DefaultStyle.PenPixelsWidth;
    ...
    public SvgDrawingBoardLayer SetPen(int penPixelsWidth, System.Drawing.Color penColor, params int[] penDashPattern)
    {
    ...
    /// <returns></returns>
    public SvgDrawingBoardLayer DrawPolygon(IEnumerable<ILinFloat64Vector2D> pointsList)
    {
    ...
    /// <param name="pointsList"></param>
    /// <returns></returns>
    public SvgDrawingBoardLayer DrawPolygon(params ILinFloat64Vector2D[] pointsList)
    {
        var polygon = SvgElementPolygon
            .Create()
            .SetPoints(pointsList.Select(p => p.MapItems(s => s.ScalarValue)));
    ...
    /// <param name="pointsList"></param>
    /// <returns></returns>
    public SvgDrawingBoardLayer DrawPolyline(IEnumerable<ILinFloat64Vector2D> pointsList)
    {
    ...
    /// <param name="pointsList"></param>
    /// <returns></returns>
    public SvgDrawingBoardLayer DrawPolyline(params ILinFloat64Vector2D[] pointsList)
    {
    ...
    /// <param name="pixelsRadius"></param>
    /// <returns></returns>
    public SvgDrawingBoardLayer DrawCircleMarker(ILinFloat64Vector2D center, int pixelsRadius)
    {
        return DrawCircle(
            center.X,
            center.Y,
