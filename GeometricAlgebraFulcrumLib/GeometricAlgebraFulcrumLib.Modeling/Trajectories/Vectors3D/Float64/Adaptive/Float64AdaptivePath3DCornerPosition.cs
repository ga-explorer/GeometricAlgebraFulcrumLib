...
public sealed record Float64AdaptivePath3DCornerPosition :
    IComparable<Float64AdaptivePath3DCornerPosition>
{
    ...
    public Float64AdaptivePath3DCornerPosition(int level, int segmentCount)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(Float64AdaptivePath3DCornerPosition other)
    {
        if (other is null)
