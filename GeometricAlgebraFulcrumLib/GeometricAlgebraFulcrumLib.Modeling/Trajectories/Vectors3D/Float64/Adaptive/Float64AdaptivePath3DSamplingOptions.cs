...
public sealed class Float64AdaptivePath3DSamplingOptions
{
    ...
    public Float64AdaptivePath3DSamplingOptions(LinFloat64Angle maxAngleError, int minLevelCount, int maxLevelCount)
    {
