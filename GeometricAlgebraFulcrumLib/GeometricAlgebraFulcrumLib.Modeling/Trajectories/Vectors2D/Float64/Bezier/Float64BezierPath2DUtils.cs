...
public static class Float64BezierPath2DUtils
{
    ...
    public static LinFloat64Vector2D DeCasteljau(this double t, LinFloat64Vector2D p0)
    {
        return LinFloat64Vector2D.Create(p0);
    }

    public static LinFloat64Vector2D DeCasteljau(this double t, LinFloat64Vector2D p0, LinFloat64Vector2D p1)
    {
        var s = 1.0d - t;

        return LinFloat64Vector2D.Create(s * p0.X + t * p1.X,
            s * p0.Y + t * p1.Y);
    }

    public static LinFloat64Vector2D DeCasteljau(this double t, LinFloat64Vector2D p0, LinFloat64Vector2D p1, LinFloat64Vector2D p2)
    {
        ...
        return LinFloat64Vector2D.Create(s * x0 + t * x1,
            s * y0 + t * y1);
    }

    public static LinFloat64Vector2D DeCasteljau(this double t, LinFloat64Vector2D p0, LinFloat64Vector2D p1, LinFloat64Vector2D p2, LinFloat64Vector2D p3)
    {
        //Not using the Lerp function to increase performance by avoiding heap allocations and function calls
        var s = 1.0d - t;
    ...
    public static LinFloat64Vector2D DeCasteljau(this double t, params LinFloat64Vector2D[] pointsList)
    {
        var pointsCount = pointsList.Length;

        if (pointsCount == 1)
            return LinFloat64Vector2D.Create(pointsList[0]);
        ...
        return LinFloat64Vector2D.Create((Float64Scalar)(s * xList[0] + t * xList[1]),
