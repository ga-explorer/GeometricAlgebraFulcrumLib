    ...
    IReadOnlyList<Float64Path2D>
{
    ...
    public static Float64PlusPath2D Finite(Float64Path2D scalar1, Float64Path2D scalar2)
    {
        return Finite(new[] { scalar1, scalar2 });
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64PlusPath2D Finite(Float64Path2D scalar1, Float64Path2D scalar2, params Float64Path2D[] scalarList)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64PlusPath2D Finite(IEnumerable<Float64Path2D> scalarList)
    {
        ...
        return new Float64PlusPath2D(false, baseSignals);
    }

    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64PlusPath2D Periodic(Float64Path2D scalar1, Float64Path2D scalar2)
    {
        return Periodic(new[] { scalar1, scalar2 });
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64PlusPath2D Periodic(Float64Path2D scalar1, Float64Path2D scalar2, params Float64Path2D[] scalarList)
    {
        var scalars = new List<Float64Path2D>(scalarList.Length + 2)
        {
            scalar1,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64PlusPath2D Periodic(IEnumerable<Float64Path2D> scalarList)
    {
        var baseSignals = new List<Float64Path2D>();
        ...
        return new Float64PlusPath2D(true, baseSignals);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private Float64PlusPath2D(bool isPeriodic, IReadOnlyList<Float64Path2D> baseSignals)
        : base(
