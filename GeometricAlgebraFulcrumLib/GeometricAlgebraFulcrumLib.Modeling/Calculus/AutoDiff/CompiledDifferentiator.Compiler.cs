using InputEdge = GeometricAlgebraFulcrumLib.Modeling.Calculus.AutoDiff.Compiled.InputEdge;
using InputEdges = GeometricAlgebraFulcrumLib.Modeling.Calculus.AutoDiff.Compiled.InputEdges;

namespace GeometricAlgebraFulcrumLib.Modeling.Calculus.AutoDiff;

using TapeElement = Compiled.TapeElement;
