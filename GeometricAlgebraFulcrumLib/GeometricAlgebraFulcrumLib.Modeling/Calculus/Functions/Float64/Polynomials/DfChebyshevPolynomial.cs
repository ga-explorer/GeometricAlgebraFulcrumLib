    ...
    DfPolynomial
{
    ...
    public static LinFloat64Vector GetScalarCoefficients(int degree, Func<double, double> f)
    {
        if (degree < 0)
    ...
    public static LinFloat64Vector GetScalarCoefficients(int degree, Func<double, double> f, int sampleCount, double minVarValue, double maxVarValue)
    {
        if (degree < 0)
            throw new ArgumentOutOfRangeException(nameof(degree));
    ...
    public static LinFloat64Vector GetScalarCoefficients(int degree, Func<double, double> f, DfAffinePolynomial unitToVarMap)
    {
        if (degree < 0)
            throw new ArgumentOutOfRangeException(nameof(degree));
    ...
    public static double GetValue(LinFloat64Vector scalarList, double z)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DfChebyshevPolynomial Create(LinFloat64Vector scalarCoefficients)
    {
        return new DfChebyshevPolynomial(scalarCoefficients);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DfChebyshevPolynomial Create(LinFloat64Vector scalarCoefficients, double minVarValue, double maxVarValue)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DfChebyshevPolynomial Create(LinFloat64Vector scalarCoefficients, DfAffinePolynomial varToUnitMap, DfAffinePolynomial unitToVarMap)
    {
        return new DfChebyshevPolynomial(
            scalarCoefficients,
            varToUnitMap,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private DfChebyshevPolynomial(LinFloat64Vector scalarCoefficients, DfAffinePolynomial varToUnitMap, DfAffinePolynomial unitToVarMap)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private DfChebyshevPolynomial(LinFloat64Vector scalarCoefficients)
        : base(scalarCoefficients)
    {
        HasVarMap = false;
        VarToUnitMap = DfAffinePolynomial.Identity;
