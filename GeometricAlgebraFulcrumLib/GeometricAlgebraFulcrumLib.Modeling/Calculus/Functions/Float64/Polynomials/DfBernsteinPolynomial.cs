    ...
    DfPolynomial
{
    ...
    public static DfBernsteinPolynomial CreateZero(int spaceDegree)
    {
        return new DfBernsteinPolynomial(
            spaceDegree,
            LinFloat64Vector.Create()
        );
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DfBernsteinPolynomial Create(int spaceDegree, LinFloat64Vector scalarCoefficients)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private DfBernsteinPolynomial(int spaceDegree, LinFloat64Vector scalarCoefficients)
    ...
    public DfBernsteinPolynomial Add(double p2)
    {
        ...
        var scalarCoefficients =
            LinFloat64VectorComposer.Create(ScalarCoefficients);
