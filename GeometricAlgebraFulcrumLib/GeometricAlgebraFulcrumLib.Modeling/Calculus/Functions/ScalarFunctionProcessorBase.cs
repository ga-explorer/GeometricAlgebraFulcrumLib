...
namespace GeometricAlgebraFulcrumLib.Modeling.Calculus.Functions;
    ...
    IScalarFunctionProcessor<T>
{
    ...
    {
        return t => ScalarProcessor.Negative(f1(t)).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Add(Func<T, T> f1, T f2)
    {
        return t => ScalarProcessor.Add(f1(t), f2).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Add(T f1, Func<T, T> f2)
    {
        return t => ScalarProcessor.Add(f1, f2(t)).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Add(Func<T, T> f1, Func<T, T> f2)
    {
        return t => ScalarProcessor.Add(f1(t), f2(t)).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Subtract(Func<T, T> f1, T f2)
    {
        return t => ScalarProcessor.Subtract(f1(t), f2).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Subtract(T f1, Func<T, T> f2)
    {
        return t => ScalarProcessor.Subtract(f1, f2(t)).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Subtract(Func<T, T> f1, Func<T, T> f2)
    {
        return t => ScalarProcessor.Subtract(f1(t), f2(t)).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Times(Func<T, T> f1, T f2)
    {
        return t => ScalarProcessor.Times(f1(t), f2).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Times(T f1, Func<T, T> f2)
    {
        return t => ScalarProcessor.Times(f1, f2(t)).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Times(Func<T, T> f1, Func<T, T> f2)
    {
        return t => ScalarProcessor.Times(f1(t), f2(t)).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Divide(Func<T, T> f1, T f2)
    {
        return t => ScalarProcessor.Divide(f1(t), f2).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Divide(T f1, Func<T, T> f2)
    {
        return t => ScalarProcessor.Divide(f1, f2(t)).ScalarValue;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Func<T, T> Divide(Func<T, T> f1, Func<T, T> f2)
    {
        return t => ScalarProcessor.Divide(f1(t), f2(t)).ScalarValue;
    }
