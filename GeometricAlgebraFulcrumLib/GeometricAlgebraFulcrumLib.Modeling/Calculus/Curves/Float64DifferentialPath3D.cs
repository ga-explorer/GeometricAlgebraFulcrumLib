...
public class Float64DifferentialPath3D :
    Float64Path3D,
    ITriplet<DifferentialFunction>,
    IReadOnlyList<DifferentialFunction>
{
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64DifferentialPath3D Create(Float64ScalarRange timeRange, bool isPeriodic, Triplet<DifferentialFunction> components)
    {
        return new Float64DifferentialPath3D(timeRange, isPeriodic, components);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64DifferentialPath3D Create(Float64ScalarRange timeRange, bool isPeriodic, Triplet<DifferentialFunction> components, DifferentialFunction tangentNorm)
    {
        return new Float64DifferentialPath3D(timeRange, isPeriodic, components, tangentNorm);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64DifferentialPath3D Create(Float64ScalarRange timeRange, bool isPeriodic, DifferentialFunction component1, DifferentialFunction component2, DifferentialFunction component3)
    {
        return new Float64DifferentialPath3D(
            timeRange, 
            isPeriodic, 
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64DifferentialPath3D Create(Float64ScalarRange timeRange, bool isPeriodic, DifferentialFunction component1, DifferentialFunction component2, DifferentialFunction component3, DifferentialFunction tangentNorm)
    {
        return new Float64DifferentialPath3D(
            timeRange, 
            isPeriodic, 
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    protected Float64DifferentialPath3D(Float64ScalarRange timeRange, bool isPeriodic, ITriplet<DifferentialFunction> components)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    protected Float64DifferentialPath3D(Float64ScalarRange timeRange, bool isPeriodic, ITriplet<DifferentialFunction> components, DifferentialFunction tangentNorm)
        : base(timeRange, isPeriodic)
    {
        ComponentFunctions = components.ToTriplet();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public LinFloat64Vector3D GetDerivative3Value(double t)
    {
    ...
    public LinFloat64Vector3D GetArcLengthDerivative1Value(double t)
    {
        var vDt1 = GetDerivative1Value(t);
    ...
    public LinFloat64Vector3D GetArcLengthDerivative2Value(double t)
    {
        var vDt1 = GetDerivative1Value(t);
        var vDt2 = GetDerivative2Value(t);
    ...
    public LinFloat64Vector3D GetArcLengthDerivative3Value(double t)
    {
        var vDt1 = GetDerivative1Value(t);
        var vDt2 = GetDerivative2Value(t);
        var vDt3 = GetDerivative3Value(t);
    ...
    public Triplet<Float64Path3D> GetComponentCurves()
    {
        var curve1 = Float64ComputedPath3D.Create(
            TimeRange,
            IsPeriodic,
        ...
        var curve2 = Float64ComputedPath3D.Create(
            TimeRange,
            IsPeriodic,
            t => LinFloat64Vector3D.Create(
                0,
        ...
        var curve3 = Float64ComputedPath3D.Create(
            TimeRange,
            IsPeriodic,
            t => LinFloat64Vector3D.Create(
                0, 
        ...
        return new Triplet<Float64Path3D>(curve1, curve2, curve3);
    }
    ...
    {
        var origin = GetValue(parameterValue);

        var vDt1 = GetDerivative1Value(parameterValue);
        var vDt2 = GetDerivative2Value(parameterValue);
    ...
    public DifferentialCurveFrame3D GetFrenetFrame(double parameterValue, bool orthogonalFrame = false)
    {
        ...
        var vDt1 = GetDerivative1Value(parameterValue);
        var vDt2 = GetDerivative2Value(parameterValue);
        var vDt3 = GetDerivative3Value(parameterValue);
    ...
    {
        return Float64Path3DLocalFrame.CreateFromAffineFrame(
            parameterValue,
    ...
    public LinFloat64AffineFrame3D GetAffineFrame(double t)
    {
        ...
        Debug.Assert(e1.IsNearUnitVector());
        Debug.Assert(e2.IsNearUnitVector());
        Debug.Assert(e3.IsNearUnitVector());

        return LinFloat64AffineFrame3D.Create(origin, e1, e2, e3);
    }
    
    public double GetCurvature1(double t)
    {
        var vDt1 = GetDerivative1Value(t);
        var vDt2 = GetDerivative2Value(t);
        ...
        return (sDt1 * u2.VectorENorm()).ScalarValue.NaNInfinityToZero();
    }
    
    public double GetCurvature2(double t)
    {
        var vDt1 = GetDerivative1Value(t);
        var vDt2 = GetDerivative2Value(t);
        var vDt3 = GetDerivative3Value(t);
        ...
        var u3 = vDs3 - vDs3.ProjectOnUnitVector(e2) - vDs3.ProjectOnUnitVector(vDs1);
        
        return (sDt1 * u3.VectorENorm() / u2.VectorENorm()).NaNInfinityToZero();
    }
    ...
    {
        return GetFrequency(t) / Math.Tau;
    }
