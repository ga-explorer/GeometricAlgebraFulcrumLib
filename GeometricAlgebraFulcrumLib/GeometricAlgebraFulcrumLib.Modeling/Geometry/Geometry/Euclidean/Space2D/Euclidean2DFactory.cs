...
using GeometricAlgebraFulcrumLib.Modeling.Geometry.Geometry.Euclidean.Space2D.Objects;

namespace GeometricAlgebraFulcrumLib.Modeling.Geometry.Geometry.Euclidean.Space2D;
