...
using GeometricAlgebraFulcrumLib.Modeling.Geometry.Geometry.Euclidean.Space3D.Maps;
...
public static class Euclidean3DFactory
{
    ...
    {
        var zero = scalarProcessor.ZeroValue;
    ...
    {
        var zero = scalarProcessor.ZeroValue;
        var one = scalarProcessor.OneValue;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarXy<T>(this LinAngle<T> angle)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarXy<T>(this LinAngle<T> angle, T length)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarYx<T>(this LinAngle<T> angle)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarYx<T>(this LinAngle<T> angle, T length)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarYz<T>(this LinAngle<T> angle)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarYz<T>(this LinAngle<T> angle, T length)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarZy<T>(this LinAngle<T> angle)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarZy<T>(this LinAngle<T> angle, T length)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarZx<T>(this LinAngle<T> angle)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarZx<T>(this LinAngle<T> angle, T length)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarXz<T>(this LinAngle<T> angle)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorPolarXz<T>(this LinAngle<T> angle, T length)
    {
        var scalarProcessor = angle.ScalarProcessor;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorSphericalXyz<T>(this LinAngle<T> angleXy, LinAngle<T> angleZ)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DVector<T> CreateE3DVectorSphericalXyz<T>(this LinAngle<T> angleXy, LinAngle<T> angleZ, T length)
    {
        var angleZSin = angleZ.Sin();
    ...
    public static E3DPoint<T> CreateE3DPointZero<T>(this IScalarProcessor<T> scalarProcessor)
    {
        ...
        return new E3DPoint<T>(zero, zero, zero);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static E3DMapRotate<T> CreateE3DMapRotate<T>(this IScalarProcessor<T> scalarProcessor, LinAngle<T> angle, E3DPoint<T> origin, E3DVector<T> direction)
    {
