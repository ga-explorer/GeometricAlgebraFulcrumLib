...
public sealed class CGaFloat64OpnsDirectionBladeDecoder :
    CGaFloat64BladeDecoderBase
{
    internal CGaFloat64OpnsDirectionBladeDecoder(CGaFloat64Blade blade) 
        : base(blade)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public CGaFloat64Direction Element(LinFloat64Vector egaProbePoint)
    {
        return Element(
            Blade.GeometricSpace.Encode.VGa.Vector(egaProbePoint)
        );
