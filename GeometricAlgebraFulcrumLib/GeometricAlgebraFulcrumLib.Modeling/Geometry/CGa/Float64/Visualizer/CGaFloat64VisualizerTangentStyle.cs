...
public sealed record CGaFloat64VisualizerTangentStyle :
    CGaFloat64VisualizerElementStyle
{
    internal CGaFloat64VisualizerTangentStyle(CGaFloat64Visualizer visualizer, double thickness, bool drawPosition = true, double directionRadius = 1, double normalDirectionRadius = 1, double auxGeometryColorAlpha = 0.5)
