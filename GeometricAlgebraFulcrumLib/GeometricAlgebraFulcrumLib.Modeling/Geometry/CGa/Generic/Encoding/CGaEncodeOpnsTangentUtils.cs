...
public static class CGaEncodeOpnsTangentUtils
{
    /// <summary>
    ...
    public static CGaBlade<T> EncodeOpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> pointX, Scalar<T> pointY)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector2D<T> egaPoint)
    {
        return cgaGeometricSpace.EncodeOpnsTangentPoint(
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> pointX, Scalar<T> pointY, Scalar<T> pointZ)
    {
        return cgaGeometricSpace.EncodeOpnsTangentPoint(
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint)
    {
        return cgaGeometricSpace.EncodeOpnsTangentPoint(
            egaPoint.ToXGaVector(cgaGeometricSpace.EuclideanProcessor)
        );
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector<T> egaPoint)
    {
        return cgaGeometricSpace.EncodeOpnsTangentPoint(
            egaPoint.ToXGaVector(cgaGeometricSpace.EuclideanProcessor)
        );
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, Scalar<T> normalX, Scalar<T> normalY)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, LinVector2D<T> egaNormalVector)
    {
        return cgaGeometricSpace.EncodeOpnsTangentHyperPlane(
            distance,
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector2D<T> point, LinVector2D<T> vector)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentLineFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector2D<T> point1, LinVector2D<T> point2)
    {
        return cgaGeometricSpace.EncodeOpnsTangentLine(
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint, LinVector3D<T> egaVector)
    {
        return cgaGeometricSpace.EncodeOpnsTangentLine(
            egaPoint.ToXGaVector(cgaGeometricSpace.EuclideanProcessor),
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentLineFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint1, LinVector3D<T> egaPoint2)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint, XGaVector<T> egaDirection)
    {
        var direction =
            egaDirection
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentLineFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint1, XGaVector<T> egaPoint2)
    {
        var egaDirection =
            egaPoint2 - egaPoint1;
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, Scalar<T> normalX, Scalar<T> normalY, Scalar<T> normalZ)
    {
        return cgaGeometricSpace.EncodeOpnsTangentHyperPlane(
            distance,
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, LinVector3D<T> egaNormalVector)
    {
        return cgaGeometricSpace.EncodeOpnsTangentHyperPlane(
            distance,
            egaNormalVector.ToXGaVector(cgaGeometricSpace.EuclideanProcessor)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint, LinVector3D<T> egaVector1, LinVector3D<T> egaVector2)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint, LinVector3D<T> egaNormalVector)
    {
        var egaDirectionBivector =
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint, LinBivector3D<T> egaBivector)
    {
        return cgaGeometricSpace.EncodeOpnsTangentPlane(
            egaPoint.ToXGaVector(cgaGeometricSpace.EuclideanProcessor),
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPlaneFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint1, LinVector3D<T> egaPoint2, LinVector3D<T> egaPoint3)
    {
        return cgaGeometricSpace.EncodeOpnsTangentPlane(
            egaPoint1,
            egaPoint2 - egaPoint1,
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint, XGaBivector<T> egaDirection)
    {
        var direction =
            egaDirection
                .EncodeVGaBlade(cgaGeometricSpace)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentPlaneFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint1, XGaVector<T> egaPoint2, XGaVector<T> egaPoint3)
    {
        var egaDirection =
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentHyperPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, XGaVector<T> egaNormalVector)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangent<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint, XGaKVector<T> egaDirection)
    {
        var direction =
            egaDirection
                .EncodeVGaBlade(cgaGeometricSpace)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, params XGaVector<T>[] egaPointArray)
    {
        var egaPoint1 =
            egaPointArray[0];
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeOpnsTangentFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, IReadOnlyList<XGaVector<T>> egaPointList)
    {
        var egaPoint1 =
            egaPointList[0];
