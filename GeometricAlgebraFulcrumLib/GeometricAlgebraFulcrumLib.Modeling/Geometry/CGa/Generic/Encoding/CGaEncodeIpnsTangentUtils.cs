...
public static class CGaEncodeIpnsTangentUtils
{
    /// <summary>
    ...
    public static CGaBlade<T> EncodeIpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> pointX, Scalar<T> pointY)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector2D<T> egaPoint)
    {
        return cgaGeometricSpace.EncodeIpnsTangentPoint(
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> pointX, Scalar<T> pointY, Scalar<T> pointZ)
    {
        return cgaGeometricSpace.EncodeIpnsTangentPoint(
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint)
    {
        return cgaGeometricSpace.EncodeIpnsTangentPoint(
            egaPoint.ToXGaVector(cgaGeometricSpace.EuclideanProcessor)
        );
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector<T> egaPoint)
    {
        return cgaGeometricSpace.EncodeIpnsTangentPoint(
            egaPoint.ToXGaVector(cgaGeometricSpace.EuclideanProcessor)
        );
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPoint<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, Scalar<T> normalX, Scalar<T> normalY)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, LinVector2D<T> egaNormalVector)
    {
        return cgaGeometricSpace.EncodeIpnsTangentHyperPlane(
            distance,
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector2D<T> point, LinVector2D<T> vector)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentLineFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector2D<T> point1, LinVector2D<T> point2)
    {
        return cgaGeometricSpace.EncodeIpnsTangentLine(
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint, LinVector3D<T> egaVector)
    {
        return cgaGeometricSpace.EncodeIpnsTangentLine(
            egaPoint.ToXGaVector(cgaGeometricSpace.EuclideanProcessor),
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentLineFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint1, LinVector3D<T> egaPoint2)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentLine<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint, XGaVector<T> egaDirection)
    {
        var direction =
            egaDirection
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentLineFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint1, XGaVector<T> egaPoint2)
    {
        var egaDirection =
            egaPoint2 - egaPoint1;
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, Scalar<T> normalX, Scalar<T> normalY, Scalar<T> normalZ)
    {
        return cgaGeometricSpace.EncodeIpnsTangentHyperPlane(
            distance,
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, LinVector3D<T> egaNormalVector)
    {
        return cgaGeometricSpace.EncodeIpnsTangentHyperPlane(
            distance,
            egaNormalVector.ToXGaVector(cgaGeometricSpace.EuclideanProcessor)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint, LinVector3D<T> egaVector1, LinVector3D<T> egaVector2)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint, LinVector3D<T> egaNormalVector)
    {
        var egaDirectionBivector =
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint, LinBivector3D<T> egaBivector)
    {
        return cgaGeometricSpace.EncodeIpnsTangentPlane(
            egaPoint.ToXGaVector(cgaGeometricSpace.EuclideanProcessor),
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPlaneFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, LinVector3D<T> egaPoint1, LinVector3D<T> egaPoint2, LinVector3D<T> egaPoint3)
    {
        return cgaGeometricSpace.EncodeIpnsTangentPlane(
            egaPoint1,
            egaPoint2 - egaPoint1,
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint, XGaBivector<T> egaDirection)
    {
        var direction =
            egaDirection
                .EncodeVGaBlade(cgaGeometricSpace)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentPlaneFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint1, XGaVector<T> egaPoint2, XGaVector<T> egaPoint3)
    {
        var egaDirection =
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentHyperPlane<T>(this CGaGeometricSpace<T> cgaGeometricSpace, Scalar<T> distance, XGaVector<T> egaNormalVector)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangent<T>(this CGaGeometricSpace<T> cgaGeometricSpace, XGaVector<T> egaPoint, XGaKVector<T> egaDirection)
    {
        var direction =
            egaDirection
                .EncodeVGaBlade(cgaGeometricSpace)
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, params XGaVector<T>[] egaPointArray)
    {
        var egaPoint1 =
            egaPointArray[0];
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CGaBlade<T> EncodeIpnsTangentFromPoints<T>(this CGaGeometricSpace<T> cgaGeometricSpace, IReadOnlyList<XGaVector<T>> egaPointList)
    {
        var egaPoint1 =
            egaPointList[0];
