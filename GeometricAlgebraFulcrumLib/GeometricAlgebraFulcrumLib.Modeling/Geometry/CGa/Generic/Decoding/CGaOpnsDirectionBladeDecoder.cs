...
public sealed class CGaOpnsDirectionBladeDecoder<T> :
    CGaBladeDecoderBase<T>
{
    internal CGaOpnsDirectionBladeDecoder(CGaBlade<T> blade)
        : base(blade)
    {
    }
    ...
    {
        return Blade.GetVGaPartAsXGaKVector(true);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public CGaBlade<T> VGaDirectionAsBlade()
    {
        return Blade.GetVGaPart(true);
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public XGaKVector<T> VGaUnitDirectionAsXGaKVector()
    {
        return Blade.GetVGaPartAsXGaKVector(true).DivideByNorm();
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public CGaBlade<T> VGaUnitDirectionAsBlade()
    {
        return Blade.GetVGaPart(true).DivideByNorm();
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public CGaDirection<T> Element(LinVector<T> egaProbePoint)
    {
        return Element(
            Blade.GeometricSpace.EncodeVGa.Vector(egaProbePoint)
        );
