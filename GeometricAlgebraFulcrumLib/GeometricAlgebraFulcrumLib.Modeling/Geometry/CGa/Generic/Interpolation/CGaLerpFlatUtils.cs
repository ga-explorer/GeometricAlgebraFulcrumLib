...
public static class CGaLerpFlatUtils
{
    public static CGaFlat<T> LerpPoint2D<T>(this Scalar<T> t, CGaFlat<T> point1, CGaFlat<T> point2)
    {
        Debug.Assert(
            point1.IsPoint &&
            point2.IsPoint
        ...
        return point1.GeometricSpace5D.DefineFlatPoint(
            weight,
            position
        );
    }

    public static CGaFlat<T> LerpPoint3D<T>(this Scalar<T> t, CGaFlat<T> point1, CGaFlat<T> point2)
    {
        Debug.Assert(
            point1.IsPoint &&
            point2.IsPoint
    ...
    public static CGaFlat<T> LerpLine2D<T>(this Scalar<T> t, CGaFlat<T> line1, CGaFlat<T> line2)
    {
        Debug.Assert(
            line1.IsLine &&
            line2.IsLine
        ...
        return line1.GeometricSpace4D.DefineFlatLine(
            weight,
            position,
            directionVector
        );
    ...
    public static CGaFlat<T> LerpLine3D<T>(this Scalar<T> t, CGaFlat<T> line1, CGaFlat<T> line2)
    {
        Debug.Assert(
            line1.IsLine &&
            line2.IsLine
        ...
        return line1.GeometricSpace5D.DefineFlatLine(
            weight,
            position,
            directionVector
        );
    ...
    public static CGaFlat<T> LerpPlane3D<T>(this Scalar<T> t, CGaFlat<T> plane1, CGaFlat<T> plane2)
    {
        Debug.Assert(
            plane1.IsPlane &&
            plane2.IsPlane
        ...
        return plane1.GeometricSpace5D.DefineFlatPlane(
            weight,
            position,
            directionBivector
        );
