...
//            //Console.WriteLine($"Real Eigen Vector {i + 1}: {(Float64Tuple) realVector}");
//            //Console.WriteLine($"Imag Eigen Vector {i + 1}: {(Float64Tuple) imagVector}");
//            //Console.WriteLine();
//        }
...
//        return MapVector(
//            Float64Tuple.CreateBasis(Dimensions, basisIndex)
//        );
//    }
...
//            return Float64Tuple.CreateCopy(vector);
