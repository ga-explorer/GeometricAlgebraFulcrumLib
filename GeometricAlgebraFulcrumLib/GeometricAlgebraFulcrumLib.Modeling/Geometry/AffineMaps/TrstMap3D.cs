...
public sealed class TrstMap3D : ITransform3D
{
    ...
    public static TrstMap3D CreateFromXSectionToLineSectionMap(double section1StartX, double section1EndX, LinFloat64Vector3D section2Start, LinFloat64Vector3D section2End)
    {
    ...
    public LinFloat64Vector3D XSectionStart => LinFloat64Vector3D.Create(0, 0, 0);

    public LinFloat64Vector3D XSectionEnd => LinFloat64Vector3D.Create(XSectionLength, 0, 0);

    public LinFloat64Vector3D FinalSectionStart { get; set; }

    public LinFloat64Vector3D FinalSectionEnd { get; set; }


    public LinFloat64Vector3D MapPoint(LinFloat64Vector3D point)
    {
        ...
        return LinFloat64Vector3D.Create(x * _scaleFactor + _translate2X,
