...
public static class Float64AffineMapUtils
{
    ...
    public static LinFloat64Vector3D MapUnitVector(this IFloat64AffineMap3D linearMap, ILinFloat64Vector3D vector)
    {
        return linearMap.MapVector(vector).ToUnitLinVector3D();
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64Vector3D MapUnitNormal(this IFloat64AffineMap3D linearMap, ILinFloat64Vector3D normal)
    {
        return linearMap.MapNormal(normal).ToUnitLinVector3D();
    }

    public static LinearFrame3D MapFrame(this IFloat64AffineMap3D linearMap, LinearFrame3D frame)
    {
    ...
    public static Float64TrsAffineMap3D Lerp(this double t, Float64TrsAffineMap3D v1, Float64TrsAffineMap3D v2)
    {
        var s = 1.0d - t;

        var newValue = new Float64TrsAffineMap3D
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<Float64TrsAffineMap3D> Lerp(this IEnumerable<double> tList, Float64TrsAffineMap3D v1, Float64TrsAffineMap3D v2)
    {
