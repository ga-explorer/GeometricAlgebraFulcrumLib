...
/// </summary>
public class Float64RotateScaleTranslateAffineMap3D :
    IFloat64AffineMap3D
{
    public static Float64RotateScaleTranslateAffineMap3D CreateRotate(LinFloat64DirectedAngle angle, ILinFloat64Vector3D vector)
    {
        var map = new Float64RotateScaleTranslateAffineMap3D();

        return map.SetRotate(angle, vector);
    }

    public static Float64RotateScaleTranslateAffineMap3D CreateRotateScale(LinFloat64DirectedAngle angle, ILinFloat64Vector3D vector)
    {
        var map = new Float64RotateScaleTranslateAffineMap3D();
    ...
    public static Float64RotateScaleTranslateAffineMap3D CreateRotate(ILinFloat64Vector3D vector1, ILinFloat64Vector3D vector2)
    {
        var map = new Float64RotateScaleTranslateAffineMap3D();
    ...
    public static Float64RotateScaleTranslateAffineMap3D CreateRotateScale(ILinFloat64Vector3D vector1, ILinFloat64Vector3D vector2)
    {
        var map = new Float64RotateScaleTranslateAffineMap3D();
    ...
    public Float64RotateScaleTranslateAffineMap3D SetRotate(LinFloat64DirectedAngle angle, ILinFloat64Vector3D vector)
    {
        RotateAngle = angle;
    ...
    public Float64RotateScaleTranslateAffineMap3D SetRotate(ILinFloat64Vector3D vector1, ILinFloat64Vector3D vector2)
    {
    ...
    public Float64RotateScaleTranslateAffineMap3D SetRotateScale(LinFloat64DirectedAngle angle, ILinFloat64Vector3D vector)
    {
        RotateAngle = angle;
    ...
    public Float64RotateScaleTranslateAffineMap3D SetRotateScale(ILinFloat64Vector3D vector1, ILinFloat64Vector3D vector2)
    {
    ...
    public Float64RotateScaleTranslateAffineMap3D SetScale(double scaleFactor)
    {
    ...
    public Float64RotateScaleTranslateAffineMap3D SetScale(double scaleX, double scaleY, double scaleZ)
    {
    ...
    public Float64RotateScaleTranslateAffineMap3D SetScale(ILinFloat64Vector3D scaleVector)
    {
        Debug.Assert(
    ...
    public Float64RotateScaleTranslateAffineMap3D SetTranslate(double translateX, double translateY, double translateZ)
    {
    ...
    public Float64RotateScaleTranslateAffineMap3D SetTranslate(ILinFloat64Vector3D translateVector)
    {
    ...
    public Float64RotateScaleTranslateAffineMap3D SetTranslate(ILinFloat64Vector3D point1, ILinFloat64Vector3D point2)
    {
