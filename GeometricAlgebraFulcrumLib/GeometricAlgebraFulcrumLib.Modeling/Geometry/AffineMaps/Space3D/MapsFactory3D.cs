...
public static class MapsFactory3D
{
    ...
    public static TranslateMap3D CreateTranslateMap3D(this ILinFloat64Vector3D translationVector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RotateUniformScaleTranslateMap3D CreateRotateScaleTranslateMap3D(this IRotateMap3D rotateMap, double scalingFactor, ILinFloat64Vector3D translationVector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TranslateUniformScaleRotateMap3D CreateTranslateScaleRotateMap3D(this ILinFloat64Vector3D translationVector, double scalingFactor, IRotateMap3D rotateMap)
    {
