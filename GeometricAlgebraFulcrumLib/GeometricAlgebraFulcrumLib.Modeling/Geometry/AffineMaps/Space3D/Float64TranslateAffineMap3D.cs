...
public sealed class Float64TranslateAffineMap3D :
    IFloat64AffineMap3D
{
    ...
    public Float64TranslateAffineMap3D()
    {
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64TranslateAffineMap3D(ILinFloat64Vector3D translationVector)
    {
