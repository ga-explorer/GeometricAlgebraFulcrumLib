...
public sealed record Float64RouletteAffineMap2D :
    IFloat64AffineMap2D
{
    ...
    public Float64RouletteAffineMap2D(LinFloat64Vector2D fixedFrameOrigin, LinFloat64Vector2D movingFrameOrigin, LinFloat64DirectedAngle rotationAngle)
    {
