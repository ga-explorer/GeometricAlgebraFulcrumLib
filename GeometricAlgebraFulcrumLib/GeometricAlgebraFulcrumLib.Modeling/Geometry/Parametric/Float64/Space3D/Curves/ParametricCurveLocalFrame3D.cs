...
{
    public static ParametricCurveLocalFrame3D CreateFromAffineFrame(double parameterValue, LinFloat64AffineFrame3D affineFrame)
    {
    ...
    /// <returns></returns>
    public static ParametricCurveLocalFrame3D Create(double parameterValue, ILinFloat64Vector3D point, ILinFloat64Vector3D tangentVector)
    {
        var tangent =
    ...
    public static ParametricCurveLocalFrame3D Create(double parameterValue, ILinFloat64Vector3D point, ILinFloat64Vector3D tangent, IPair<ILinFloat64Vector3D> normalPair)
    {
        return new ParametricCurveLocalFrame3D(
            parameterValue,
            point.ToLinVector3D(),
    ...
    public static ParametricCurveLocalFrame3D Create(double parameterValue, ILinFloat64Vector3D point, ILinFloat64Vector3D tangent, ILinFloat64Vector3D normal1, ILinFloat64Vector3D normal2)
    {
        return new ParametricCurveLocalFrame3D(
            parameterValue,
            point.ToLinVector3D(),
    ...
    private ParametricCurveLocalFrame3D(double parameterValue, ILinFloat64Vector3D point, ILinFloat64Vector3D tangent, ILinFloat64Vector3D normal1, ILinFloat64Vector3D normal2)
    {
    ...
    internal ParametricCurveLocalFrame3D UpdateNormals(ILinFloat64Vector3D normal1, ILinFloat64Vector3D normal2)
    {
        Normal1.Set(normal1);
        Normal2.Set(normal2);
    ...
    public ParametricCurveLocalFrame3D SetFrenetNormals(ILinFloat64Vector3D secondDerivativeVector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ParametricCurveLocalFrame3D RotateNormalsBy(LinFloat64Angle angle)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ParametricCurveLocalFrame3D TranslateBy(ILinFloat64Vector3D translationVector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ParametricCurveLocalFrame3D TranslateRotateNormalsBy(ILinFloat64Vector3D translationVector, LinFloat64Angle angle)
    {
        Debug.Assert(translationVector.IsValid());
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ParametricCurveLocalFrame3D GetRotatedFrameUsingQuaternion(LinFloat64Quaternion quaternion)
    {
        return new ParametricCurveLocalFrame3D(
            ParameterValue,
            Point,
