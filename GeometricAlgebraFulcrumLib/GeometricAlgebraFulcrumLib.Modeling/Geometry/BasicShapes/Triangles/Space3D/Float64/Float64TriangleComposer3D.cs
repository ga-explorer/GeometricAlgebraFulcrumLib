...
public sealed class Float64TriangleComposer3D :
    IFloat64Triangle3D
{
    public static Float64TriangleComposer3D CreateFromPoints(ILinFloat64Vector3D point1, ILinFloat64Vector3D point2, ILinFloat64Vector3D point3)
    {
        return new Float64TriangleComposer3D(
    ...
    public Float64TriangleComposer3D()
    {
    }

    internal Float64TriangleComposer3D(double p1X, double p1Y, double p1Z, double p2X, double p2Y, double p2Z, double p3X, double p3Y, double p3Z)
    {
        Point1X = p1X;
        Point1Y = p1Y;
        Point1Z = p1Z;
    ...
    public Float64TriangleComposer3D SetPoint1(double x, double y, double z)
    {
        Point1X = x;
        Point1Y = y;
        Point1Z = z;
    ...
    public Float64TriangleComposer3D SetPoint2(double x, double y, double z)
    {
        Point2X = x;
        Point2Y = y;
        Point2Z = z;
    ...
    public Float64TriangleComposer3D SetPoint3(double x, double y, double z)
    {
        Point3X = x;
        Point3Y = y;
        Point3Z = z;
