...
public sealed class MutableLine2D : ILine2D
{
    ...
    public static MutableLine2D Create(ILinFloat64Vector2D origin, ILinFloat64Vector2D direction)
    {
        return new MutableLine2D(
            origin.X,
            origin.Y,
    ...
    public MutableLine2D SetOrigin(ILinFloat64Vector2D origin)
    {
        OriginX = origin.X;
        OriginY = origin.Y;
    ...
    public MutableLine2D SetDirection(ILinFloat64Vector2D direction)
    {
    ...
    public MutableLine2D SetLine(ILinFloat64Vector2D origin, ILinFloat64Vector2D direction)
    {
        OriginX = origin.X;
        OriginY = origin.Y;
