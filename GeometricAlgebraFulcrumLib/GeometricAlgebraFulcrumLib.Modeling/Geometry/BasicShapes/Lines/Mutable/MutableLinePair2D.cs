...
public sealed class MutableLinePair2D : ILinePair2D
{
    ...
    public MutableLinePair2D Create(ILinFloat64Vector2D origin1, ILinFloat64Vector2D direction1, ILinFloat64Vector2D origin2, ILinFloat64Vector2D direction2)
    {
        return new MutableLinePair2D(
            origin1.X,
            origin1.Y,
    ...
    public MutableLinePair2D SetOrigin1(ILinFloat64Vector2D origin)
    {
        Origin1X = origin.X;
        Origin1Y = origin.Y;
    ...
    public MutableLinePair2D SetDirection1(ILinFloat64Vector2D direction)
    {
    ...
    public MutableLinePair2D SetOrigin2(ILinFloat64Vector2D origin)
    {
        Origin2X = origin.X;
        Origin2Y = origin.Y;
    ...
    public MutableLinePair2D SetDirection2(ILinFloat64Vector2D direction)
    {
