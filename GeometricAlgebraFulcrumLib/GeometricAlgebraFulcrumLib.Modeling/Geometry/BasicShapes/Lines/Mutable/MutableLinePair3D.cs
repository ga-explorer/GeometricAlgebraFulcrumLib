...
public sealed class MutableLinePair3D : ILinePair3D
{
    ...
    public static MutableLinePair3D Create(ILinFloat64Vector3D origin1, ILinFloat64Vector3D direction1, ILinFloat64Vector3D origin2, ILinFloat64Vector3D direction2)
    {
        return new MutableLinePair3D(
            origin1.X,
            origin1.Y,
    ...
    public MutableLinePair3D SetOrigin1(ILinFloat64Vector3D origin)
    {
        Origin1X = origin.X;
        Origin1Y = origin.Y;
        Origin1Z = origin.Z;
    ...
    public MutableLinePair3D SetDirection1(ILinFloat64Vector3D direction)
    {
    ...
    public MutableLinePair3D SetOrigin2(ILinFloat64Vector3D origin)
    {
        Origin2X = origin.X;
        Origin2Y = origin.Y;
        Origin2Z = origin.Z;
    ...
    public MutableLinePair3D SetDirection2(ILinFloat64Vector3D direction)
    {
