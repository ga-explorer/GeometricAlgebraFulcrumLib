...
namespace GeometricAlgebraFulcrumLib.Modeling.Geometry.BasicShapes.Lines.Mutable;
...
{
    public static MutableBeam2D Create(ILinFloat64Vector2D origin, ILinFloat64Vector2D direction1, ILinFloat64Vector2D direction2)
    {
    ...
    public MutableBeam2D SetOrigin(ILinFloat64Vector2D origin)
    {
        OriginX = origin.X;
        OriginY = origin.Y;
    ...
    public MutableBeam2D SetDirection1(ILinFloat64Vector2D direction)
    {
    ...
    public MutableBeam2D SetDirection2(ILinFloat64Vector2D direction)
    {
    ...
    public MutableBeam2D SetBeam(ILinFloat64Vector2D origin, ILinFloat64Vector2D direction1, ILinFloat64Vector2D direction2)
    {
        OriginX = origin.X;
        OriginY = origin.Y;
