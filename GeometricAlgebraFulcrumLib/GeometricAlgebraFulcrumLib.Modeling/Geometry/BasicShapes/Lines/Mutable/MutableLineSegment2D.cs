...
public sealed class MutableLineSegment2D : ILineSegment2D
{
    ...
    public static MutableLineSegment2D Create(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2)
    {
        return new MutableLineSegment2D(
            point1.X,
            point1.Y,
    ...
    public MutableLineSegment2D SetPoint1(ILinFloat64Vector2D point)
    {
        Point1X = point.X;
        Point1Y = point.Y;
    ...
    public MutableLineSegment2D SetPoint2(ILinFloat64Vector2D point)
    {
        Point2X = point.X;
        Point2Y = point.Y;
    ...
    public MutableLineSegment2D SetLineSegment(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2)
    {
        Point1X = point1.X;
        Point1Y = point1.Y;
