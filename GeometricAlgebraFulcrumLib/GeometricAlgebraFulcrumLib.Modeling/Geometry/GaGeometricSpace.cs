...
public abstract class GaGeometricSpace<T>
{
    public GaGeometricSpaceBasisSpecs<T> BasisSpecs { get; }
    ...
    protected GaGeometricSpace(GaGeometricSpaceBasisSpecs<T> basisSpecs)
    {
