...
public sealed record Float64BoundingBox3D :
    IFloat64BoundingBox3D
{
    public static Float64BoundingBox3D CreateInfinite()
    {
        return new Float64BoundingBox3D(
    ...
    public static Float64BoundingBox3D CreateInfiniteX(double y1, double z1, double y2, double z2)
    {
        if (y1 > y2)
        {
            (y1, y2) = (y2, y1);
    ...
    public static Float64BoundingBox3D CreateInfiniteY(double x1, double z1, double x2, double z2)
    {
        if (x1 > x2)
        {
            (x1, x2) = (x2, x1);
    ...
    public static Float64BoundingBox3D CreateInfiniteZ(double x1, double y1, double x2, double y2)
    {
        if (x1 > x2)
        {
            (x1, x2) = (x2, x1);
    ...
    public static Float64BoundingBox3D CreateInfiniteXy(double z1, double z2)
    {
        if (z1 > z2)
        {
            (z1, z2) = (z2, z1);
    ...
    public static Float64BoundingBox3D CreateInfiniteYz(double x1, double x2)
    {
        if (x1 > x2)
        {
            (x1, x2) = (x2, x1);
    ...
    public static Float64BoundingBox3D CreateInfiniteXz(double y1, double y2)
    {
        if (y1 > y2)
        {
            (y1, y2) = (y2, y1);
    ...
    public static Float64BoundingBox3D CreateAround(double centerX, double centerY, double centerZ, double deltaX, double deltaY, double deltaZ)
    {
    ...
    public static Float64BoundingBox3D CreateAround(ILinFloat64Vector3D center, double deltaX, double deltaY, double deltaZ)
    {
    ...
    public static Float64BoundingBox3D CreateFromPoint(ILinFloat64Vector3D point)
    {
        return new Float64BoundingBox3D(
            point.X,
            point.Y,
    ...
    public static Float64BoundingBox3D CreateFromPoints(double point1X, double point1Y, double point1Z, double point2X, double point2Y, double point2Z)
    {
    ...
    public static Float64BoundingBox3D CreateFromPoints(ILinFloat64Vector3D point1, ILinFloat64Vector3D point2)
    {
        double minX, minY, minZ, maxX, maxY, maxZ;
    ...
    public static Float64BoundingBox3D CreateFromPoints(ILinFloat64Vector3D point1, ILinFloat64Vector3D point2, ILinFloat64Vector3D point3)
    {
        var minX = point1.X;
        var minY = point1.Y;
        var minZ = point1.Z;
    ...
    public static Float64BoundingBox3D CreateFromPoints(params ILinFloat64Vector3D[] pointsList)
    {
    ...
    public static Float64BoundingBox3D CreateFromPoints(IEnumerable<ILinFloat64Vector3D> pointsList)
    {
    ...
    public static Float64BoundingBox3D CreateFromPoints(IEnumerable<ILinFloat64Vector3D> pointsList, double scalingFactor)
    {
        double minX = 0, minY = 0, minZ = 0;
        double maxX = 0, maxY = 0, maxZ = 0;
    ...
    public static Float64BoundingBox3D Create(ILinFloat64Vector3D point)
    {
        return new Float64BoundingBox3D(
            point.X,
            point.Y,
    ...
    public static Float64BoundingBox3D Create(double point1X, double point1Y, double point1Z, double point2X, double point2Y, double point2Z)
    {
        double minX, minY, minZ, maxX, maxY, maxZ;
    ...
    public static Float64BoundingBox3D Create(IFloat64BoundingBox3D boundingBox)
    {
        return new Float64BoundingBox3D(boundingBox);
    }

    public static Float64BoundingBox3D Create(IFloat64BoundingBox3D b1, IFloat64BoundingBox3D b2)
    {
        return new Float64BoundingBox3D(
    ...
    public static Float64BoundingBox3D Create(params IFloat64BoundingBox3D[] boundingBoxesList)
    {
    ...
    public static Float64BoundingBox3D Create(IEnumerable<IFloat64BoundingBox3D> boundingBoxesList)
    {
        var result = new Float64BoundingBoxComposer3D();
    ...
    public static Float64BoundingBox3D CreateFromIntersection(IFloat64BoundingBox3D b1, IFloat64BoundingBox3D b2)
    {
        return new Float64BoundingBox3D(
    ...
    public static Float64BoundingBox3D Create(IFloat64FiniteGeometricShape3D geometricObject)
    {
        return geometricObject.GetBoundingBox();
    }

    public static Float64BoundingBox3D Create(params IFloat64FiniteGeometricShape3D[] geometricObjectsList)
    {
        var result = new Float64BoundingBoxComposer3D();
    ...
    public static Float64BoundingBox3D Create<T>(IEnumerable<T> geometricObjectsList)
    ...
    public Float64BoundingBox3D(double minX, double minY, double minZ, double maxX, double maxY, double maxZ)
    {
        MinX = minX;
        MinY = minY;
        MinZ = minZ;
    ...
    public Float64BoundingBox3D(IFloat64BoundingBox3D boundingBox)
    {
