    ...
    E3DPlane<T>
{
    ...
    public E3DPlaneSegment(E3DPoint<T> point1, E3DPoint<T> point2, E3DPoint<T> point3)
    {
        Point1 = point1;
        Point2 = point2;
        Point3 = point3;
    ...
    {
        var t1 = ScalarProcessor.One - ScalarProcessor.Add(t2, t3);

        return t1.ScalarValue * Point1 + t2 * Point2 + t3 * Point3;
    }
