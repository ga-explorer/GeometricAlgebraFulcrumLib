...
public sealed record E2DLineLineIntersectionRecord<T>
{
    ...
    {
        return (Line1Point1Distance / ScalarProcessor.Subtract(Line1Point1Distance, Line1Point2Distance)).ScalarValue;
    }
    ...
    {
        return (Line1Point2Distance / ScalarProcessor.Subtract(Line1Point2Distance, Line1Point1Distance)).ScalarValue;
    }
    ...
    {
        return (Line2Point1Distance / ScalarProcessor.Subtract(Line2Point1Distance, Line2Point2Distance)).ScalarValue;
    }
    ...
    {
        return (Line2Point2Distance / ScalarProcessor.Subtract(Line2Point2Distance, Line2Point1Distance)).ScalarValue;
    }
    ...
    public bool HasLineSegmentIntersection()
    {
        ...
        var s2 = ScalarProcessor.Subtract(ScalarProcessor.OneValue, t2).ScalarValue;
    ...
    public bool HasSegmentLineIntersection()
    {
        ...
        var s1 = ScalarProcessor.Subtract(ScalarProcessor.OneValue, t1).ScalarValue;
