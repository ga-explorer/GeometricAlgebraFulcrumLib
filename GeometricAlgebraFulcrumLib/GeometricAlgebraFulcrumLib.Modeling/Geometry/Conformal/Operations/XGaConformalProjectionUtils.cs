...
public static class XGaConformalProjectionUtils
{
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaConformalElement<T> ProjectOn<T>(this XGaConformalElement<T> element1, XGaConformalElement<T> element2)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaConformalBlade<T> ProjectPositionOnFlat<T>(this XGaConformalElement<T> element, XGaConformalFlat<T> flat)
    {
        return element
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinVector2D<T> ProjectPositionOnFlat2D<T>(this XGaConformalElement<T> element, XGaConformalFlat<T> flat)
    {
        return element
            .PositionToOpnsFlatPoint()
            .ProjectOpnsOn(flat.EncodeOpnsBlade())
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinVector3D<T> ProjectPositionOnFlat3D<T>(this XGaConformalElement<T> element, XGaConformalFlat<T> flat)
    {
        return element
            .PositionToOpnsFlatPoint()
            .ProjectOpnsOn(flat.EncodeOpnsBlade())
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static XGaConformalBlade<T> ProjectOn<T>(this XGaConformalBlade<T> blade, XGaKVector<T> subspace)
    {
        var projectedBlade =
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaConformalBlade<T> ProjectEGaOn<T>(this XGaConformalBlade<T> blade, XGaConformalBlade<T> subspace)
    {
        Debug.Assert(
            blade.IsEGaBlade() &&
            subspace.IsEGaBlade()
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaConformalBlade<T> ProjectPGaOn<T>(this XGaConformalBlade<T> blade, XGaConformalBlade<T> subspace)
    {
        Debug.Assert(
            blade.IsPGaBlade() &&
            subspace.IsPGaBlade()
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaConformalBlade<T> ProjectOpnsOn<T>(this XGaConformalBlade<T> blade, XGaConformalBlade<T> subspace)
    {
        return blade.ProjectOn(subspace.InternalKVector);
    }
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaConformalBlade<T> ProjectIpnsOn<T>(this XGaConformalBlade<T> blade, XGaConformalBlade<T> subspace)
    {
        return blade.ProjectOn(subspace.InternalKVector);
    }
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaConformalBlade<T> ProjectEGaPointOnIpns<T>(this XGaConformalBlade<T> blade, XGaConformalBlade<T> subspace)
    {
        Debug.Assert(
            blade.IsEGaBlade()
        );
