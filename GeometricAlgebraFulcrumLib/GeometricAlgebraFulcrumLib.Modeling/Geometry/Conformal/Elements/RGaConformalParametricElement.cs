...
//    public static XGaConformalParametricElement<T> Create(XGaConformalSpace<T> conformalSpace, ScalarRange<T> parameterRange, Func<Scalar<T>, XGaConformalElement<T>> getElementFunc)
//    {
...
//    [MethodImpl(MethodImplOptions.AggressiveInlining)]
//    private XGaConformalParametricElement(XGaConformalSpace<T> conformalSpace, ScalarRange<T> parameterRange, Func<Scalar<T>, XGaConformalElement<T>> getBladeFunc)
//    {
