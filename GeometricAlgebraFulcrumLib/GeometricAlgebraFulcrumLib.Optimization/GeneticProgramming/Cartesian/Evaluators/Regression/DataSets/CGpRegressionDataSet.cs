...
public abstract class CGpRegressionDataSet :
    IReadOnlyList<CGpRegressionDataSetSample>
{
    ...
    public CGpRegressionDataSetSample this[int index]
        => GetSample(index);


    protected CGpRegressionDataSet(int inputSize, int outputSize)
    {
        if (inputSize < 1)
    ...
    public abstract CGpRegressionDataSetSample GetSample(int sampleIndex);
    ...
    public virtual IEnumerator<CGpRegressionDataSetSample> GetEnumerator()
    {
