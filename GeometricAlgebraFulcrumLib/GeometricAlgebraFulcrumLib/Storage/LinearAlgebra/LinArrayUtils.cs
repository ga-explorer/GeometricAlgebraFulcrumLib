...
//        //public static VectorStorage<T> ColumnToVectorStorage<T>(this T[,] scalarsArray, int colIndex, IScalarProcessor<T> scalarProcessor)
//        //{
//        //    var rowsCount = scalarsArray.GetLength(0);
...
//        //public static VectorStorage<T> RowToVectorStorage<T>(this T[,] scalarsArray, int rowIndex, IScalarProcessor<T> scalarProcessor)
//        //{
//        //    var colsCount = scalarsArray.GetLength(1);
...
//        //public static Dictionary<ulong, VectorStorage<T>> ColumnsToVectorStoragesDictionary<T>(this T[,] scalarsArray, IScalarProcessor<T> scalarProcessor)
//        //{
//        //    var rowsCount = scalarsArray.GetLength(0);
//        //    var colsCount = scalarsArray.GetLength(1);
...
//        //public static VectorStorage<T>[] ColumnsToVectorStoragesArray<T>(this T[,] scalarsArray, IScalarProcessor<T> scalarProcessor)
//        //{
//        //    var rowsCount = scalarsArray.GetLength(0);
//        //    var colsCount = scalarsArray.GetLength(1);
...
//        //public static GaVector<T>[] ColumnsToVectorsArray<T>(this T[,] scalarsArray, IScalarProcessor<T> scalarProcessor)
//        //{
//        //    var rowsCount = scalarsArray.GetLength(0);
//        //    var colsCount = scalarsArray.GetLength(1);
...
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        public static T GetScalar<T>(this IScalarProcessor<T> scalarProcessor, T[] matrix, int index)
//        {
//            return index >= 0 &&
//                   index < matrix.Length
