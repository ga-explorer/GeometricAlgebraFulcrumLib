    ...
    IXGaProcessorContainer<IMetaExpressionAtomic>
{
    ...
    public IMetaExpressionAtomic ArcCos(IMetaExpressionAtomic scalar)
    {
        if (ContextOptions.PropagateConstants)
        {
            ...
            {
                var number = 
                    s1.NumberHeadSpecs.NumberFloat64Value.ArcCos();
    ...
    public IMetaExpressionAtomic ArcSin(IMetaExpressionAtomic scalar)
    {
        if (ContextOptions.PropagateConstants)
        {
            ...
            {
                var number = 
                    s1.NumberHeadSpecs.NumberFloat64Value.ArcSin();
    ...
    public IMetaExpressionAtomic ArcTan(IMetaExpressionAtomic scalar)
    {
        if (ContextOptions.PropagateConstants)
        {
            ...
            {
                var number = 
                    s1.NumberHeadSpecs.NumberFloat64Value.ArcTan();
    ...
    public IMetaExpressionAtomic ArcTan2(IMetaExpressionAtomic scalarX, IMetaExpressionAtomic scalarY)
    {
        if (ContextOptions.PropagateConstants)
        {
            if (scalarX is MetaExpressionNumber sX && scalarY is MetaExpressionNumber sY)
            {
                var number = 
                    Math.Atan2(
                        sY.NumberHeadSpecs.NumberFloat64Value, 
                        sX.NumberHeadSpecs.NumberFloat64Value
                    );
