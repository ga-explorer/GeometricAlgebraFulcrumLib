...
{
    public abstract class LaTeXComposerBase<T>
        : ITextComposer<T>
    {
        ...
        protected LaTeXComposerBase([NotNull] IScalarAlgebraProcessor<T> scalarProcessor)
        {
        ...
        public abstract string GetAngleText(PlanarAngle angle);
