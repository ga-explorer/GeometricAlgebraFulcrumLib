...
{
    public sealed class LaMatrixSparseEvenStorageComposer<T> :
        LaMatrixEvenStorageComposerBase<T>
    {
        ...
        internal LaMatrixSparseEvenStorageComposer([NotNull] IScalarProcessor<T> scalarProcessor)
        ...
        public override ILaMatrixEvenStorage<T> CreateEvenGrid()
        {
            ...
            var array = ScalarProcessor.GetArrayZero2D((int) denseCount1, (int) denseCount2);
