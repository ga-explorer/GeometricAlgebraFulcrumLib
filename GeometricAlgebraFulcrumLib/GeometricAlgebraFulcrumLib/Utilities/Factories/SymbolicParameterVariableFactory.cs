...
namespace GeometricAlgebraFulcrumLib.Utilities.Factories
{
        ...
        SymbolicAtomicExpressionFactoryBase
    {
        ...
        public GaScalarStorage<ISymbolicExpressionAtomic> CreateScalarTerm(string scalarName)
        {
            var namedScalar = 
        ...
        public IGaVectorStorage<ISymbolicExpressionAtomic> CreateVector(params string[] scalarNames)
        {
            return Context.CreateGaVectorStorage(scalarNames
        ...
        public GaVectorStorage<ISymbolicExpressionAtomic> CreateVectorTerm(ulong index, string scalarName)
        {
            var namedScalar = 
                Context.GetOrDefineParameterVariable(scalarName);

            return Context.CreateGaVectorStorage(index, namedScalar);
        }
        
        public IGaVectorStorage<ISymbolicExpressionAtomic> CreateDenseVector(uint vSpaceDimension, Func<ulong, string> namingFunction)
        {
            var parametersList =
                vSpaceDimension
                    .GetRange()
            ...
            return Context.CreateGaVectorStorage(parametersList);
        }

        public IGaKVectorStorage<ISymbolicExpressionAtomic> CreateDenseKVector(uint vSpaceDimensions, uint grade, Func<ulong, string> namingFunction)
        {
        ...
        public IGaMultivectorSparseStorage<ISymbolicExpressionAtomic> CreateDenseMultivector(uint vSpaceDimensions, Func<ulong, string> namingFunction)
        {
            var parametersList =
            ...
            return GaMultivectorSparseStorage<ISymbolicExpressionAtomic>.Create(parametersList);
        }
