...
namespace GeometricAlgebraFulcrumLib.Utilities.Factories
{
    public static class GaBasisTermFactory
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBasisTerm<T> CreateBasisVectorTerm<T>(this IndexScalarRecord<T> indexScalarRecord)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBasisTerm<T> CreateBasisBivectorTerm<T>(this IndexScalarRecord<T> indexScalarRecord)
        {
            var (index, scalar) = indexScalarRecord;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBasisTerm<T> CreateBasisTerm<T>(this T scalar, GradeIndexRecord gradeIndexRecord)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBasisTerm<T> CreateBasisTerm<T>(this uint grade, IndexScalarRecord<T> indexScalarRecord)
        {
            var (index, scalar) = indexScalarRecord;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBasisTerm<T> CreateBasisTerm<T>(this IndexScalarRecord<T> idScalarRecord)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBasisTerm<T> CreateBasisTerm<T>(this IndexScalarRecord<T> indexScalarRecord, uint grade)
        {
            var (index, scalar) = indexScalarRecord;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBasisTerm<T> CreateBasisTerm<T>(this GradeIndexScalarRecord<T> gradeIndexValueRecord)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<GaBasisTerm<T>> GetBasisVectorTerms<T>(this IEnumerable<IndexScalarRecord<T>> indexScalarRecords)
        {
            return indexScalarRecords.Select(record => CreateBasisVectorTerm(record));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<GaBasisTerm<T>> GetBasisBivectorTerms<T>(this IEnumerable<IndexScalarRecord<T>> indexScalarRecords)
        {
            return indexScalarRecords.Select(record => CreateBasisBivectorTerm(record));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<GaBasisTerm<T>> GetBasisTerms<T>(this uint grade, IEnumerable<IndexScalarRecord<T>> indexScalarList)
        {
            return indexScalarList.Select(record => CreateBasisTerm(grade, record));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<GaBasisTerm<T>> GetBasisTerms<T>(this IEnumerable<IndexScalarRecord<T>> indexScalarRecords, uint grade)
        {
            return indexScalarRecords.Select(record => CreateBasisTerm(record, grade));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<GaBasisTerm<T>> GetBasisTerms<T>(this IEnumerable<IndexScalarRecord<T>> idScalarList)
        {
            return idScalarList.Select(CreateBasisTerm);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<GaBasisTerm<T>> GetBasisTerms<T>(this IEnumerable<GradeIndexScalarRecord<T>> gradeIndexScalarList)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<GradeIndexRecord> GetGradeIndexRecords<T>(this IEnumerable<GaBasisTerm<T>> termsList)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<GradeIndexScalarRecord<T>> GetGradeIndexScalarRecords<T>(this IEnumerable<GaBasisTerm<T>> termsList)
        {
