...
{
    public static class GaFuLLookupTables
    {
        ...
        private static void ComputeIsNegativeEgpLookupTables()
        {
            ...
            for (var id1 = 0; id1 < MaxGaSpaceDimension; id1++)
            {
                ...
                Parallel.For(
                    0, 
                    MaxGaSpaceDimension, 
                    id2 => { bitArray[(int) id2] = BasisBladeProductUtils.ComputeIsNegativeEGp(n, (ulong)id2); }
                );
        ...
        private static void ComputeIsNegativeVectorEgpLookupTables()
        {
            ...
            for (var index1 = 0; index1 < MaxVSpaceDimension; index1++)
            {
                ...
                Parallel.For(
                    0,
                    MaxGaSpaceDimension,
                    id2 => { bitArray[(int) id2] = BasisBladeProductUtils.ComputeIsNegativeEGp(id1, (ulong)id2); }
                );
        ...
        private static void ComputeGeoLookupTables()
        {
        ...
        private static void ComputeVectorKVectorOpIndexLookupTables()
        {
            ...
            var maxVSpaceDim =
                GeometricAlgebraSpaceUtils.MaxVSpaceDimension < maxDim
