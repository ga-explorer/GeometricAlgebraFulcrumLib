...
namespace GeometricAlgebraFulcrumLib.Utilities.Extensions
{
    public static class GaMultivectorUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> ScalarPart<T>(this GaMultivector<T> mv1)
        {
            if (!mv1.MultivectorStorage.TryGetTermScalar(0, out var scalar))
                scalar = mv1.Processor.ScalarZero;

            return new Scalar<T>(mv1.Processor, scalar);
        }
        ...
        public static GaMultivector<T> OddKVectorsPart<T>(this GaMultivector<T> mv1)
        {
            ...
            return new GaMultivector<T>(
                mv1.Processor,
                composer.CreateGaMultivectorGradedStorage()
            );
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> Sp<T>(this GaMultivector<T> mv1)
        {
            var processor = mv1.Processor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> Sp<T>(this GaMultivector<T> mv1, GaMultivector<T> mv2)
        {
            var processor = mv1.Processor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> Norm<T>(this GaMultivector<T> mv1)
        {
            var processor = mv1.Processor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> NormSquared<T>(this GaMultivector<T> mv1)
        {
            var processor = mv1.Processor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> ESp<T>(this GaMultivector<T> mv1)
        {
            var processor = mv1.Processor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> ESp<T>(this GaMultivector<T> mv1, GaMultivector<T> mv2)
        {
            var processor = mv1.Processor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> ENorm<T>(this GaMultivector<T> mv1)
        {
            var processor = mv1.Processor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Scalar<T> ENormSquared<T>(this GaMultivector<T> mv1)
        {
            var processor = mv1.Processor;
