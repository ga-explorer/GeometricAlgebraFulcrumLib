...
namespace GeometricAlgebraFulcrumLib.Utilities.Extensions
{
    public static class MultivectorStorageIteratorsUtils
    {
        ...
        /// <param name="mv2"></param>
        /// <returns></returns>
        public static IEnumerable<IndexScalarRecord<T>> GetGbtGpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv1, mv2);
        ...
        /// <param name="mv2"></param>
        /// <returns></returns>
        public static IEnumerable<IndexScalarRecord<T>> GetGbtLcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv1, mv2);
        ...
        /// <param name="mv2"></param>
        /// <returns></returns>
        public static IEnumerable<IndexScalarRecord<T>> GetGbtRcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv1, mv2);
        ...
        /// <param name="mv2"></param>
        /// <returns></returns>
        public static IEnumerable<IndexScalarRecord<T>> GetGbtSpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv1, mv2);
        ...
        /// <param name="mv2"></param>
        /// <returns></returns>
        public static IEnumerable<IndexScalarRecord<T>> GetGbtFdpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv1, mv2);
        ...
        /// <param name="mv2"></param>
        /// <returns></returns>
        public static IEnumerable<IndexScalarRecord<T>> GetGbtHipIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv1, mv2);
        ...
        /// <param name="mv2"></param>
        /// <returns></returns>
        public static IEnumerable<IndexScalarRecord<T>> GetGbtAcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv1, mv2);
        ...
        /// <param name="mv2"></param>
        /// <returns></returns>
        public static IEnumerable<IndexScalarRecord<T>> GetGbtCpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv1, mv2);
        ...
        public static IEnumerable<IndexScalarRecord<T>> GetGbtNorm2IdScalarPairs<T>(this Multivector<T> mv, GeometricAlgebraSignature metric)
        {
            var stack = GeoGbtProductsStack2<T>.Create(mv, mv.Reverse());
        ...
        public static T Norm2<T>(this Multivector<T> mv, GeometricAlgebraSignature metric)
        {
            return mv.GeometricProcessor.Add(
                mv.GetGbtNorm2IdScalarPairs(metric).Select(t => t.Scalar)
            );
        }

        public static T Norm<T>(this Multivector<T> mv, GeometricAlgebraSignature metric)
        {
            var scalarProcessor = mv.GeometricProcessor;
        ...
        public static IEnumerable<BasisTerm<T>> GetGptInverseIdScalarPairs<T>(this Multivector<T> mv, GeometricAlgebraSignature metric)
        {
            var mvReverse = mv.Reverse();
        ...
        ///// <param name="mv2"></param>
        ///// <returns></returns>
        //public static IEnumerable<GeoTerm<T>> GetGbtGpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv1 =
        ...
        ///// <param name="mv2"></param>
        ///// <returns></returns>
        //public static IEnumerable<GeoTerm<T>> GetGbtLcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv1 =
        //        metric.ForwardOutermorphism.MapMultivector(mv1);
        ...
        ///// <param name="mv2"></param>
        ///// <returns></returns>
        //public static IEnumerable<GeoTerm<T>> GetGbtRcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv1 =
        //        metric.ForwardOutermorphism.MapMultivector(mv1);
        ...
        ///// <param name="mv2"></param>
        ///// <returns></returns>
        //public static IEnumerable<GeoTerm<T>> GetGbtSpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv1 =
        //        metric.ForwardOutermorphism.MapMultivector(mv1);
        ...
        ///// <param name="mv2"></param>
        ///// <returns></returns>
        //public static IEnumerable<GeoTerm<T>> GetGbtFdpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv1 =
        //        metric.ForwardOutermorphism.MapMultivector(mv1);
        ...
        ///// <param name="mv2"></param>
        ///// <returns></returns>
        //public static IEnumerable<GeoTerm<T>> GetGbtHipIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv1 =
        //        metric.ForwardOutermorphism.MapMultivector(mv1);
        ...
        ///// <param name="mv2"></param>
        ///// <returns></returns>
        //public static IEnumerable<GeoTerm<T>> GetGbtAcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv1 =
        //        metric.ForwardOutermorphism.MapMultivector(mv1);
        ...
        ///// <param name="mv2"></param>
        ///// <returns></returns>
        //public static IEnumerable<GeoTerm<T>> GetGbtCpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv1 =
        //        metric.ForwardOutermorphism.MapMultivector(mv1);
        ...
        //public static IEnumerable<GeoTerm<T>> GetGbtNorm2IdScalarPairs<T>(this Multivector<T> mv, GeoOmChangeOfBasis<T> metric)
        //{
        //    var orthoMv =
        ...
        //public static T Norm2<T>(this Multivector<T> mv, GeoOmChangeOfBasis<T> metric)
        //{
        //    return mv.GetGbtNorm2Terms(metric).Select(t => t.Scalar).Sum();
        //}

        //public static T Norm<T>(this Multivector<T> mv, GeoOmChangeOfBasis<T> metric)
        //{
        //    return Math.Sqrt(
        ...
        //public static IEnumerable<GeoTerm<T>> GetGbtInverseIdScalarPairs<T>(this Multivector<T> mv, GeoOmChangeOfBasis<T> metric)
        //{
        ...
        //public static IEnumerable<GeoTerm<T>> GetGbtGpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, IGeoNumMetric metric)
        //{
        //    if (metric is GeoOmChangeOfBasis<T> nonOrthogonalMetric)
        //        return mv1.GetGbtGpTerms(mv2, nonOrthogonalMetric);

        //    var orthogonalMetric = (GeoBasesSignature)metric;
        //    return mv1.GetGbtGpTerms(mv2, orthogonalMetric);
        //}

        //public static T GetGbtNorm2(this Multivector<T> mv, IGeoNumMetric metric)
        //{
        //    if (metric is GeoOmChangeOfBasis<T> nonOrthogonalMetric)
        ...
        //public static IEnumerable<GeoTerm<T>> GetLoopGpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoBasesSignature metric)
        //{
        //    foreach (var term1 in mv1.GetNotZeroTerms())
        //    {
        //        foreach (var term2 in mv2.GetNotZeroTerms())
        ...
        //public static IEnumerable<GeoTerm<T>> GetLoopLcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoBasesSignature metric)
        //{
        //    foreach (var term1 in mv1.GetNotZeroTerms())
        //    {
        //        foreach (var term2 in mv2.GetNotZeroTerms())
        ...
        //public static IEnumerable<GeoTerm<T>> GetLoopRcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoBasesSignature metric)
        //{
        //    foreach (var term1 in mv1.GetNotZeroTerms())
        //    {
        //        foreach (var term2 in mv2.GetNotZeroTerms())
        ...
        //public static IEnumerable<GeoTerm<T>> GetLoopSpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoBasesSignature metric)
        //{
        //    foreach (var term1 in mv1.GetNotZeroTerms())
        //    {
        //        foreach (var term2 in mv2.GetNotZeroTerms())
        ...
        //public static IEnumerable<GeoTerm<T>> GetLoopFdpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoBasesSignature metric)
        //{
        //    foreach (var term1 in mv1.GetNotZeroTerms())
        //    {
        //        foreach (var term2 in mv2.GetNotZeroTerms())
        ...
        //public static IEnumerable<GeoTerm<T>> GetLoopHipIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoBasesSignature metric)
        //{
        //    foreach (var term1 in mv1.GetNotZeroTerms())
        //    {
        //        foreach (var term2 in mv2.GetNotZeroTerms())
        ...
        //public static IEnumerable<GeoTerm<T>> GetLoopAcpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoBasesSignature metric)
        //{
        //    foreach (var term1 in mv1.GetNotZeroTerms())
        //    {
        //        foreach (var term2 in mv2.GetNotZeroTerms())
        ...
        //public static IEnumerable<GeoTerm<T>> GetLoopCpIdScalarPairs<T>(this Multivector<T> mv1, Multivector<T> mv2, GeoBasesSignature metric)
        //{
        //    foreach (var term1 in mv1.GetNotZeroTerms())
        //    {
        //        foreach (var term2 in mv2.GetNotZeroTerms())
        ...
        //public static GeoNumSarMultivector Gp<T>(this GeoNumSarMultivector mv1, GeoNumSarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumSarMultivector Sp<T>(this GeoNumSarMultivector mv1, GeoNumSarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumSarMultivector Lcp<T>(this GeoNumSarMultivector mv1, GeoNumSarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumSarMultivector Rcp<T>(this GeoNumSarMultivector mv1, GeoNumSarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumSarMultivector Fdp<T>(this GeoNumSarMultivector mv1, GeoNumSarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumSarMultivector Hip<T>(this GeoNumSarMultivector mv1, GeoNumSarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumSarMultivector Acp<T>(this GeoNumSarMultivector mv1, GeoNumSarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumSarMultivector Cp<T>(this GeoNumSarMultivector mv1, GeoNumSarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumSarMultivector Inverse<T>(this GeoNumSarMultivector mv, GeoBasesSignature metric)
        //{
        ...
        //public static GeoNumDgrMultivector Gp<T>(this GeoNumDgrMultivector mv1, GeoNumDgrMultivector mv2, GeoBasesSignature metric)
        //{
        ...
        //public static GeoNumDgrMultivector Sp<T>(this GeoNumDgrMultivector mv1, GeoNumDgrMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.VSpaceDimension != mv2.VSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDgrMultivector Lcp<T>(this GeoNumDgrMultivector mv1, GeoNumDgrMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.VSpaceDimension != mv2.VSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDgrMultivector Rcp<T>(this GeoNumDgrMultivector mv1, GeoNumDgrMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.VSpaceDimension != mv2.VSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDgrMultivector Fdp<T>(this GeoNumDgrMultivector mv1, GeoNumDgrMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.VSpaceDimension != mv2.VSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDgrMultivector Hip<T>(this GeoNumDgrMultivector mv1, GeoNumDgrMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.VSpaceDimension != mv2.VSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDgrMultivector Acp<T>(this GeoNumDgrMultivector mv1, GeoNumDgrMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.VSpaceDimension != mv2.VSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDgrMultivector Cp<T>(this GeoNumDgrMultivector mv1, GeoNumDgrMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.VSpaceDimension != mv2.VSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDgrMultivector Inverse<T>(this GeoNumDgrMultivector mv, GeoBasesSignature metric)
        //{
        ...
        //public static GeoNumDarMultivector Gp<T>(this GeoNumDarMultivector mv1, GeoNumDarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDarMultivector Sp<T>(this GeoNumDarMultivector mv1, GeoNumDarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDarMultivector Lcp<T>(this GeoNumDarMultivector mv1, GeoNumDarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDarMultivector Rcp<T>(this GeoNumDarMultivector mv1, GeoNumDarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDarMultivector Fdp<T>(this GeoNumDarMultivector mv1, GeoNumDarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDarMultivector Hip<T>(this GeoNumDarMultivector mv1, GeoNumDarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDarMultivector Acp<T>(this GeoNumDarMultivector mv1, GeoNumDarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDarMultivector Cp<T>(this GeoNumDarMultivector mv1, GeoNumDarMultivector mv2, GeoBasesSignature metric)
        //{
        //    if (mv1.GaSpaceDimension != mv2.GaSpaceDimension)
        //        throw new GeoNumericsException("Multivector size mismatch");
        ...
        //public static GeoNumDarMultivector Inverse<T>(this GeoNumDarMultivector mv, GeoBasesSignature metric)
        //{
