...
namespace GeometricAlgebraFulcrumLib.Utilities.Extensions
{
    public static class LinVectorUtils
    {
        ...
        public static T GetNorm<T>(this LinVector<T> v1)
        {
            var processor = v1.LinearProcessor;

            return processor.Sqrt(processor.TimesInner(v1.VectorStorage));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T GetNormSquared<T>(this LinVector<T> v1)
        {
            var processor = v1.LinearProcessor;

            return processor.TimesInner(v1.VectorStorage);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T InnerProduct<T>(this LinVector<T> v1, LinVector<T> v2)
        {
            var processor = v1.LinearProcessor;

            return processor.TimesInner(v1.VectorStorage, v2.VectorStorage);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T GetCosAngle<T>(this LinVector<T> v1, LinVector<T> v2)
        {
            var processor = v1.LinearProcessor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T GetAngle<T>(this LinVector<T> v1, LinVector<T> v2)
        {
            var processor = v1.LinearProcessor;
