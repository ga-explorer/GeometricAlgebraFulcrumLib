...
namespace GeometricAlgebraFulcrumLib.Utilities.Extensions
{
    public static class BasisBladeProductUtils
    {
        ...
        {
            if (id >= (ulong) GaFuLLookupTables.IsNegativeEgpLookupTables.Length) 
                return ComputeIsNegativeEGp(id);

            var lookupTable = 
                GaFuLLookupTables.IsNegativeEgpLookupTables[id];
        ...
        {
            if (id1 >= (ulong) GaFuLLookupTables.IsNegativeEgpLookupTables.Length) 
                return ComputeIsNegativeEGp(id1, id2);

            var lookupTable = 
                GaFuLLookupTables.IsNegativeEgpLookupTables[id1];
        ...
        {
            if (index1 < (ulong)GaFuLLookupTables.IsNegativeVectorEgpLookupTables.Length)
            {
                var lookupTable = GaFuLLookupTables.IsNegativeEgpLookupTables[index1];
