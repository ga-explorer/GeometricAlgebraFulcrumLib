...
using GeometricAlgebraFulcrumLib.Algebra.SignalProcessing.Functions;
...
namespace GeometricAlgebraFulcrumLib.Utilities.Extensions
{
    public static class SignalProcessingUtils
    {
        ...
        {
            return WienerFilter(scalarSignal, scalarSignal.SamplingRate, order);
        }
        ...
        public static void PlotSignal(this ScalarSignalFloat64 scalarSignal1, ScalarSignalFloat64 scalarSignal2, double tMin, double tMax, string plotFileName)
        {
            ...
            OxyPlot.SkiaSharp.PngExporter.Export(pm, $"{plotFileName}.png", samplingSpecs.SampleCount * 2, 750, 200);
        }
        ...
        public static void PlotSignal(this GaVector<ScalarSignalFloat64> vectorSignal1, GaVector<ScalarSignalFloat64> vectorSignal2, double tMin, double tMax, string plotFileName)
        {
            ...
            for (var i = 0; i < vSpaceDimension; i++)
            {
                ...
                //OxyPlot.SkiaSharp.PdfExporter.Export(pm, filePath + ".pdf", 1024, 768);
                OxyPlot.SkiaSharp.PngExporter.Export(pm, $"{plotFileName}{i}.png", samplingSpecs.SampleCount * 2, 750, 200);
            }
        }
        ...
        public static void PlotVectorSignalComponents(this GaVector<ScalarSignalFloat64> vectorSignal, string title, string filePath)
        {
            ...
            //OxyPlot.SkiaSharp.PdfExporter.Export(pm, filePath + ".pdf", 1024, 768);
            OxyPlot.SkiaSharp.PngExporter.Export(pm, filePath + ".png", sampleCount * 2, 750, 200);
        }

        public static void PlotScalarSignal(this Scalar<ScalarSignalFloat64> scalarSignal, string title, string filePath)
        {
            PlotScalarSignal(scalarSignal.ScalarValue, title, filePath);
        }
        ...
        public static void PlotScalarSignal(this ScalarSignalFloat64 scalarSignal, string title, string filePath)
        {
            ...
            //OxyPlot.SkiaSharp.PdfExporter.Export(pm, filePath + ".pdf", 1024, 768);
            OxyPlot.SkiaSharp.PngExporter.Export(pm, filePath + ".png", scalarSignal.Count * 2, 750, 200);
        }
        ...
        {
            return ((Func<double, double>) scalarFunction.GetFirstDerivative).Plot(scalarSignal, xMin, xMax);
        }
        ...
        {
            return ((Func<double, double>) scalarFunction.GetSecondDerivative).Plot(scalarSignal, xMin, xMax);
        }
        ...
        {
            return ((Func<double, double>) scalarFunction.GetFirstDerivative).Plot(scalarSignal, xMin, xMax, yMin, yMax);
        }
        ...
        {
            return ((Func<double, double>) scalarFunction.GetSecondDerivative).Plot(scalarSignal, xMin, xMax, yMin, yMax);
        }
    }
}
