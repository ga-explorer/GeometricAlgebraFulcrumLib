...
namespace GeometricAlgebraFulcrumLib.Utilities.Extensions
{
    public static class GaGeometryUtils
    {
        ...
        public static T GetAngle<T>(this IScalarProcessor<T> scalarProcessor, IGaVectorStorage<T> v1, IGaVectorStorage<T> v2)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsEuclideanRotor<T>(this IScalarProcessor<T> scalarProcessor, IGaMultivectorStorage<T> storage)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsSimpleEuclideanRotor<T>(this IScalarProcessor<T> scalarProcessor, IGaMultivectorStorage<T> storage)
        {
        ...
        public static GaPureRotor<T> ComplexEigenPairToEuclideanSimpleRotor<T>(this IGaProcessor<T> processor, T realValue, T imagValue, ILaVectorEvenStorage<T> realVector, ILaVectorEvenStorage<T> imagVector)
        {
