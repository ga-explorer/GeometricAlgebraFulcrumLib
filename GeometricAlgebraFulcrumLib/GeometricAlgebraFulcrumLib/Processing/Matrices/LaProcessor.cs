...
namespace GeometricAlgebraFulcrumLib.Processing.Matrices
{
        ...
        ILaProcessor<T>
    {
        ...
        internal LaProcessor([NotNull] IScalarProcessor<T> scalarProcessor) 
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T GetScalarFromInteger(int value)
        {
            return ScalarProcessor.GetScalarFromInteger(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T GetScalarFromFloat64(double value)
        {
