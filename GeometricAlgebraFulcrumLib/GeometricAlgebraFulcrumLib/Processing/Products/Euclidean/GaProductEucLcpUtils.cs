...
namespace GeometricAlgebraFulcrumLib.Processing.Products.Euclidean
{
    public static class GaProductEucLcpUtils
    {
        ...
        public static IGasScalar<T> ELcp<T>(this IGasScalar<T> mv1, IGasScalar<T> mv2)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGasScalar<T> ELcp<T>(this IGasVectorTerm<T> mv1, IGasVectorTerm<T> mv2)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static IGasKVectorTerm<T> ELcpAsKVectorTerm<T>(this IGasKVectorTerm<T> mv1, IGasKVectorTerm<T> mv2)
        {
            ...
            var signature = 
                GaBasisUtils.ELcpSignature(mv1.Id, mv2.Id);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGasKVectorTerm<T> ELcp<T>(this IGasKVectorTerm<T> mv1, IGasKVectorTerm<T> mv2)
        {
            return mv1 switch
            {
                ...
                _ => 
                    ELcpAsKVectorTerm(mv1, mv2)
            };
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGasScalar<T> VectorsELcp<T>(this IGaScalarProcessor<T> scalarProcessor, IReadOnlyList<T> vector1, IReadOnlyList<T> vector2)
        {
        ...
        private static IGasScalar<T> ELcpAsScalar<T>(this IGasVector<T> mv1, IGasVector<T> mv2)
        {
            var scalarProcessor = mv1.ScalarProcessor;
        ...
        public static IGasScalar<T> ELcp<T>(this IGasVector<T> mv1, IGasVector<T> mv2)
        {
            return mv1 is IGasVectorTerm<T> vt1 && mv2 is IGasVectorTerm<T> vt2
                ? ELcp(vt1, vt2)
                : ELcpAsScalar(mv1, mv2);
        }

        private static IGasKVector<T> ELcpAsKVector<T>(this IGasKVector<T> mv1, IGasKVector<T> mv2)
        {
            var scalarProcessor = 
                mv1.ScalarProcessor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGasKVector<T> ELcp<T>(this IGasKVector<T> mv1, IGasKVector<T> mv2)
        {
            if (mv2.Grade < mv1.Grade)
                return mv1.ScalarProcessor.CreateZeroScalar();
            ...
            return mv1 switch
            {
                ...
                IGasKVectorTerm<T> kvt1 when mv2 is IGasKVectorTerm<T> kvt2 => 
                    ELcpAsKVectorTerm(kvt1, kvt2),

                IGasVector<T> v1 when mv2 is IGasVector<T> v2 => 
                    ELcpAsScalar(v1, v2),

                _ => 
                    ELcpAsKVector(mv1, mv2)
            };
        }

        private static IGasGradedMultivector<T> ELcpAsGaMultivectorGraded<T>(this IGasGradedMultivector<T> mv1, IGasGradedMultivector<T> mv2)
        {
            var scalarProcessor = 
                mv1.ScalarProcessor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGasGradedMultivector<T> ELcp<T>(this IGasGradedMultivector<T> mv1, IGasGradedMultivector<T> mv2)
        {
            return mv1 switch
            {
                IGasScalar<T> s1 when mv2 is IGasScalar<T> s2 => 
                ...
                IGasKVector<T> kv1 when mv2 is IGasKVector<T> kv2 => 
                    ELcpAsKVector(kv1, kv2),

                _ => 
                    ELcpAsGaMultivectorGraded(mv1, mv2)
            };
        }

        private static IGasTermsMultivector<T> ELcpAsTermsMultivector<T>(this IGasMultivector<T> mv1, IGasMultivector<T> mv2)
        {
            var scalarProcessor = 
                mv1.ScalarProcessor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGasTermsMultivector<T> ELcp<T>(this IGasTermsMultivector<T> mv1, IGasTermsMultivector<T> mv2)
        {
            return mv1 switch
            {
                IGasScalar<T> s1 when mv2 is IGasScalar<T> s2 => 
                ...
                _ => 
                    ELcpAsTermsMultivector(mv1, mv2)
            };
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGasMultivector<T> ELcp<T>(this IGasMultivector<T> mv1, IGasMultivector<T> mv2)
        {
            return mv1 switch
            {
                IGasScalar<T> s1 when mv2 is IGasScalar<T> s2 => 
                ...
                IGasGradedMultivector<T> gmv1 when mv2 is IGasGradedMultivector<T> gmv2 => 
                    ELcpAsGaMultivectorGraded(gmv1, gmv2),
