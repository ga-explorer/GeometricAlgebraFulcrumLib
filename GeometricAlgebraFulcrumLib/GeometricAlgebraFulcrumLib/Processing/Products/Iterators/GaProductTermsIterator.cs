...
namespace GeometricAlgebraFulcrumLib.Processing.Products.Iterators
{
    ...
    {
        public static GaProductTermsIterator<T> Create()
        {
            return new(null, null);
        }

        public static GaProductTermsIterator<T> Create(GaMultivector<T> mv1, GaMultivector<T> mv2)
        {
            return new(mv1.Storage, mv2.Storage);
        }

        public static GaProductTermsIterator<T> Create(IGasMultivector<T> mv1, IGasMultivector<T> mv2)
        {
            return new(mv1, mv2);
        }
        ...
        public IGasMultivector<T> Storage1 { get; set; }

        public IGasMultivector<T> Storage2 { get; set; }


        private GaProductTermsIterator(IGasMultivector<T> storage1, IGasMultivector<T> storage2) 
        {
            Storage1 = storage1;
            Storage2 = storage2;
        }
