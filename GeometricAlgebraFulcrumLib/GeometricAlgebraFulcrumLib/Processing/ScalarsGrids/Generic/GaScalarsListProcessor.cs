...
{
    public class GaScalarsListProcessor<T> :
        IGaScalarsListProcessor<T>
    {
        ...
        internal GaScalarsListProcessor([NotNull] IGaScalarProcessor<T> scalarProcessor)
        {
        ...
        public T GetZeroScalar()
        {
            return ScalarProcessor.GetZeroScalar();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T GetOneScalar()
        {
            return ScalarProcessor.GetOneScalar();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T GetMinusOneScalar()
        {
            return ScalarProcessor.GetMinusOneScalar();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T GetPiScalar()
        {
            return ScalarProcessor.GetPiScalar();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T[] GetZeroScalarArray1D(int count)
        {
            return ScalarProcessor.GetZeroScalarArray1D(count);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T[,] GetZeroScalarArray2D(int count)
        {
            return ScalarProcessor.GetZeroScalarArray2D(count);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T[,] GetZeroScalarArray2D(int count1, int count2)
        {
            return ScalarProcessor.GetZeroScalarArray2D(count1, count2);
        }
