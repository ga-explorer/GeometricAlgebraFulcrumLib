...
{
    public sealed class AngouriMathScalarProcessor
        : ISymbolicScalarProcessor<Entity>
    {
        public static AngouriMathScalarProcessor DefaultProcessor { get; }
            = new AngouriMathScalarProcessor();
        ...
        private AngouriMathScalarProcessor()
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Entity Log(Entity scalar)
        {
            return PostProcessScalar(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Entity GetScalarFromInteger(int value)
        {
            return MathS.Numbers.Create(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Entity GetScalarFromFloat64(double value)
        {
            return MathS.Numbers.Create(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Entity GetScalarFromRandom(System.Random randomGenerator, double minValue, double maxValue)
        {
