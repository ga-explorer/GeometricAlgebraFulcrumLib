...
namespace GeometricAlgebraFulcrumLib.Processing.Scalars
{
    ...
    /// </summary>
    public class SymbolicExpressionScalarProcessor :
        IScalarProcessor<ISymbolicExpression>
    {
        ...
        internal SymbolicExpressionScalarProcessor([NotNull] SymbolicContext context)
        {
            Context = context;
        }
        ...
        public ISymbolicExpression GetScalarFromInteger(int value)
        {
        ...
        public ISymbolicExpression GetScalarFromFloat64(double value)
        {
            return SymbolicNumber.Create(
                Context, 
                value
        ...
        public ISymbolicExpression GetScalarFromRandom(System.Random randomGenerator, double minValue, double maxValue)
        {
            ...
            return GetScalarFromFloat64(value);
        }
