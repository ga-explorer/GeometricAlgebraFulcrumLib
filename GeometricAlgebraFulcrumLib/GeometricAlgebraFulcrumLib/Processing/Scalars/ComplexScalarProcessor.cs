...
{
    public sealed class ComplexScalarProcessor
        : IScalarProcessor<Complex>
    {
        public static ComplexScalarProcessor DefaultProcessor { get; }
            = new ComplexScalarProcessor();
        ...
        private ComplexScalarProcessor()
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Complex GetScalarFromInteger(int value)
        {
            return new Complex(value, 0);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Complex GetScalarFromFloat64(double value)
        {
