...
public sealed class GaHomogeneousGeometry3D<T>
{
    ...
    public GaHomogeneousGeometry3D([NotNull] IScalarAlgebraProcessor<T> scalarProcessor)
    {
        ScalarProcessor = scalarProcessor;
        GeometricProcessor = ScalarProcessor.CreateGeometricAlgebraEuclideanProcessor(3);
    }


    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E2DPoint<T> GetE2DPoint(GaVector<T> vector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaVector<T> GetDirectionMultivector(float x, float y)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaVector<T> GetDirectionMultivector(double x, double y)
    {
        return GeometricProcessor.CreateVector(
            ScalarProcessor.GetScalarFromNumber(x), 
            ScalarProcessor.GetScalarFromNumber(y)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaVector<T> GetDirectionMultivector(T x, T y)
    {
        return GeometricProcessor.CreateVector(x, y);
    }
        
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaVector<T> GetDirectionMultivector(E2DVector<T> vector)
    {
        return GeometricProcessor.CreateVector(
            vector.X, 
            vector.Y
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaVector<T> GetPointMultivector(float x, float y)
    {
        return GeometricProcessor.CreateVector(
            ScalarProcessor.GetScalarFromNumber(x), 
            ScalarProcessor.GetScalarFromNumber(y),
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaVector<T> GetPointMultivector(double x, double y)
    {
        return GeometricProcessor.CreateVector(
            ScalarProcessor.GetScalarFromNumber(x), 
            ScalarProcessor.GetScalarFromNumber(y),
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaVector<T> GetPointMultivector(T x, T y)
    {
        return GeometricProcessor.CreateVector(
            x, 
            y, 
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaVector<T> GetPointMultivector(E2DPoint<T> point)
    {
        return GeometricProcessor.CreateVector(
            point.X, 
            point.Y, 
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaBivector<T> GetLineMultivector(E2DPoint<T> point1, E2DPoint<T> point2)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaBivector<T> GetLineMultivector(E2DPoint<T> origin, E2DVector<T> direction)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GaBivector<T> GetLineMultivector(E2DLine<T> line)
    {
