    ...
    E2DLine<T>
{
    ...
    internal E2DLineTangent([NotNull] E2DPoint<T> origin, [NotNull] E2DVector<T> direction)
    {
        Point1 = origin;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E2DLineTangent<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
