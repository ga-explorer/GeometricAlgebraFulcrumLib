    ...
    E2DLine<T>
{
    ...
    internal E2DLineSegment([NotNull] E2DPoint<T> point1, [NotNull] E2DPoint<T> point2)
    {
        Point1 = point1;
        Point2 = point2;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E2DLineSegment<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
