...
public sealed record E2DVector<T>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal E2DVector([NotNull] IScalarAlgebraProcessor<T> scalarProcessor, [NotNull] T x, [NotNull] T y, bool assumeUnit = false)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E2DVector<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
