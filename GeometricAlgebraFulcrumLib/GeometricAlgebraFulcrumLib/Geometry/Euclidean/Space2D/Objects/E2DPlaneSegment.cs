    ...
    E2DPlane<T>
{
    ...
    internal E2DPlaneSegment([NotNull] E2DPoint<T> point1, [NotNull] E2DPoint<T> point2, [NotNull] E2DPoint<T> point3)
    {
        Point1 = point1;
        Point2 = point2;
        Point3 = point3;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E2DPlaneSegment<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
