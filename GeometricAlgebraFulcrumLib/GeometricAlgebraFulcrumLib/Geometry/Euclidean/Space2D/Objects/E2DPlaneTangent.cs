    ...
    E2DPlane<T>
{
    ...
    internal E2DPlaneTangent([NotNull] E2DPoint<T> origin, [NotNull] E2DVector<T> direction12, [NotNull] E2DVector<T> direction13)
    {
        Point1 = origin;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E2DPlaneTangent<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
