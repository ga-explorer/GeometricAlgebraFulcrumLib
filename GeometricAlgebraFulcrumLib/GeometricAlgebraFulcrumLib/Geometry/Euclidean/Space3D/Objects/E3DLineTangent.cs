    ...
    E3DLine<T>
{
    ...
    internal E3DLineTangent([NotNull] E3DPoint<T> origin, [NotNull] E3DVector<T> direction)
    {
        Point1 = origin;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E3DLineTangent<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
