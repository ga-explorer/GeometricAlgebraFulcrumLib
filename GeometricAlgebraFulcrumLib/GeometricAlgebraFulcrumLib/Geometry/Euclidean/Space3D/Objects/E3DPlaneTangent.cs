    ...
    E3DPlane<T>
{
    ...
    internal E3DPlaneTangent([NotNull] E3DPoint<T> origin, [NotNull] E3DVector<T> direction12, [NotNull] E3DVector<T> direction13)
    {
        Point1 = origin;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E3DPlaneTangent<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
