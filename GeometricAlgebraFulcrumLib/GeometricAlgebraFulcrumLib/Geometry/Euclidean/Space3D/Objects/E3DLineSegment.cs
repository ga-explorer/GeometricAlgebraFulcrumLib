    ...
    E3DLine<T>
{
    ...
    internal E3DLineSegment([NotNull] E3DPoint<T> point1, [NotNull] E3DPoint<T> point2)
    {
        Point1 = point1;
        Point2 = point2;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E3DLineSegment<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
