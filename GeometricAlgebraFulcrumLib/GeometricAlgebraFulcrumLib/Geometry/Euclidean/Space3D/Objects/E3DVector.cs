...
public sealed record E3DVector<T>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal E3DVector([NotNull] IScalarAlgebraProcessor<T> scalarProcessor, [NotNull] T x, [NotNull] T y, [NotNull] T z, bool assumeUnit = false)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E3DVector<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
