    ...
    E3DPlane<T>
{
    ...
    internal E3DPlaneSegment([NotNull] E3DPoint<T> point1, [NotNull] E3DPoint<T> point2, [NotNull] E3DPoint<T> point3)
    {
        Point1 = point1;
        Point2 = point2;
        Point3 = point3;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public E3DPlaneSegment<T2> MapScalars<T2>(Func<T, T2> scalarMapping, IScalarAlgebraProcessor<T2> scalarProcessor)
    {
