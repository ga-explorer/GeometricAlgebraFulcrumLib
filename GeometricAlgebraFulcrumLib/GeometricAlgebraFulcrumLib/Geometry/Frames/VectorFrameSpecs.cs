...
{
    public sealed class VectorFrameSpecs
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorFrameSpecs CreateUndefinedSpecs()
        {
            return new VectorFrameSpecs()
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorFrameSpecs CreateLinearlyIndependentSpecs()
        {
            return new VectorFrameSpecs()
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorFrameSpecs CreateUnitBasisSpecs()
        {
            return new VectorFrameSpecs()
            {
                LinearlyIndependent = true,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorFrameSpecs CreateScaledBasisSpecs()
        {
            return new VectorFrameSpecs()
            {
                LinearlyIndependent = true,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorFrameSpecs CreateSimplexSpecs()
        {
            return new VectorFrameSpecs()
            {
                LinearlyIndependent = true,
