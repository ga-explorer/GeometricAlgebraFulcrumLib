...
public abstract class ScalarAlgebraProcessorContainer<T> :
    IScalarAlgebraProcessor<T>
{
    ...
    protected ScalarAlgebraProcessorContainer(IScalarAlgebraProcessor<T> scalarProcessor)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T GetScalarFromRandom(Random randomGenerator, double minValue, double maxValue)
    {
