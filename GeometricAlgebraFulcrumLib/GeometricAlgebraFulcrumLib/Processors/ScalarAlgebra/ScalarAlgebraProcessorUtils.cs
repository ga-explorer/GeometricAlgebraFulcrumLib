...
namespace GeometricAlgebraFulcrumLib.Processors.ScalarAlgebra
{
    public static class ScalarAlgebraProcessorUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Subtract<T>(this IScalarAlgebraProcessor<T> scalarProcessor, T scalar1, double scalar2)
        {
            return scalarProcessor.Subtract(
                scalar1,
                scalarProcessor.GetScalarFromNumber(scalar2)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T Subtract<T>(this IScalarAlgebraProcessor<T> scalarProcessor, double scalar1, T scalar2)
        {
            return scalarProcessor.Subtract(
                scalarProcessor.GetScalarFromNumber(scalar1),
                scalar2
