...
{
    public sealed class ScalarAlgebraFloat64NdArrayProcessor :
        IScalarAlgebraNumericProcessor<ndarray>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ndarray GetScalarFromRandom(Random randomGenerator, double minValue, double maxValue)
        {
            var scalar = 
