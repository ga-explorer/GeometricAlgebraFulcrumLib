...
{
    public sealed class GeometricAlgebraSignatureLookup :
        IGeometricAlgebraSignatureLookup
    {
        ...
        public IGeometricAlgebraSignatureComputed BaseSignature { get; }
        ...
        internal GeometricAlgebraSignatureLookup([NotNull] IGeometricAlgebraSignatureComputed baseSignature)
        {
        ...
        private void Initialize(IGeometricAlgebraSignature baseSignature)
        {
            for (var id1 = 0UL; id1 < GaSpaceDimension; id1++)
            {
                for (var id2 = 0UL; id2 < GaSpaceDimension; id2++)
                {
                    ...
                    signature |= 
                        (BasisBladeProductUtils.IsNonZeroESp(id1, id2) ? gpSignature : 1) << 4;
                    
                    signature |= 
                        (BasisBladeProductUtils.IsNonZeroELcp(id1, id2) ? gpSignature : 1) << 6;
                    
                    signature |= 
                        (BasisBladeProductUtils.IsNonZeroERcp(id1, id2) ? gpSignature : 1) << 8;
                    
                    signature |= 
                        (BasisBladeProductUtils.IsNonZeroEFdp(id1, id2) ? gpSignature : 1) << 10;
                    
                    signature |= 
                        (BasisBladeProductUtils.IsNonZeroEHip(id1, id2) ? gpSignature : 1) << 12;
                    
                    signature |= 
                        (BasisBladeProductUtils.IsNonZeroEAcp(id1, id2) ? gpSignature : 1) << 14;
                    
                    signature |= 
                        (BasisBladeProductUtils.IsNonZeroECp(id1, id2) ? gpSignature : 1) << 16;
