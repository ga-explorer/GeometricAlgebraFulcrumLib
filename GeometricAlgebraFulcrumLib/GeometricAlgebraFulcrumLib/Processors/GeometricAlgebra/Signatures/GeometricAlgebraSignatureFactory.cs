...
namespace GeometricAlgebraFulcrumLib.Processors.GeometricAlgebra.Signatures
{
    public static class GeometricAlgebraSignatureFactory
    {
        ...
        public static IGeometricAlgebraSignature CreateEuclidean(uint vSpaceDimension, bool lookup = false)
        {
        ...
        public static IGeometricAlgebraSignature CreateConformal(uint vSpaceDimension, bool lookup = false)
        {
            ...
            return ComputedSignaturesDictionary.TryGetValue(signatureId, out var computedSignature) 
                ? (GeometricAlgebraSignatureConformal) computedSignature 
                : (GeometricAlgebraSignatureConformal) CreateComputedSignature(vSpaceDimension - 1, 1);
        }

        public static IGeometricAlgebraSignature CreateProjective(uint vSpaceDimension, bool lookup = false)
        {
            ...
            return ComputedSignaturesDictionary.TryGetValue(signatureId, out var computedSignature) 
                ? (GeometricAlgebraSignatureProjective) computedSignature 
                : (GeometricAlgebraSignatureProjective) CreateComputedSignature(vSpaceDimension - 1, 0, 1);
        }

        public static IGeometricAlgebraSignature Create(uint positiveCount, uint negativeCount, bool lookup = false)
        {
        ...
        public static IGeometricAlgebraSignature Create(uint positiveCount, uint negativeCount, uint zeroCount, bool lookup = false)
        {
