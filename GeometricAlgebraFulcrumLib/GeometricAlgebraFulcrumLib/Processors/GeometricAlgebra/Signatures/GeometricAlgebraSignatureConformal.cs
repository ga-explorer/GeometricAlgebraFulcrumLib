...
{
    public sealed record GeometricAlgebraSignatureConformal :
        IGeometricAlgebraSignatureComputed
    {
        ...
        public ulong NegativeBasisVectorId 
            => (VSpaceDimension - 1).BasisVectorIndexToId();


        internal GeometricAlgebraSignatureConformal(uint vSpaceDimension)
        {
