...
namespace GeometricAlgebraFulcrumLib.Algebra.SymbolicAlgebra.Numbers
{
        ...
        ISymbolicNumber
    {
        ...
        public static SymbolicNumber Create(SymbolicContext context, uint number)
        {
            return new SymbolicNumber(
                SymbolicHeadSpecsNumberUInt32.Create(context, number)
            );
        }
        ...
        {
            return new SymbolicNumber(
                SymbolicHeadSpecsNumberInt64.Create(context, number)
            );
        }

        public static SymbolicNumber Create(SymbolicContext context, ulong number)
        {
            return new SymbolicNumber(
                SymbolicHeadSpecsNumberUInt64.Create(context, number)
            );
        }
