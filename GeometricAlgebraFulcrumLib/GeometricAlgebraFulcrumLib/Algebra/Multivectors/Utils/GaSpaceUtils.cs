...
namespace GeometricAlgebraFulcrumLib.Algebra.Multivectors.Utils
{
    public static class GaSpaceUtils
    {
        ...
        {
            return vSpaceDimension >= 2 && vSpaceDimension < GaSpaceUtils.MaxVSpaceDimension;
        }
        ...
        {
            return
                gaSpaceDimension == (GaSpaceUtils.MaxVSpaceBasisBladeId & gaSpaceDimension) &&
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaRecordGradeKey BasisBladeGradeIndex(this IGaSpace space, ulong basisBladeId)
        {
            ...
            else
            {
                ...
                return new GaRecordGradeKey((uint) grade, index);
            }
        }
