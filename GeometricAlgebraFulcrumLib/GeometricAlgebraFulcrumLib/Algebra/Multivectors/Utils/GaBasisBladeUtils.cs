...
{
    public static class GaBasisBladeUtils
    {
        private static ulong LookupBasisBladeId(uint grade, ulong basisBladeIndex)
        {
            ...
            var table = 
                GaLookupTables.GradeIndexToIdTable[(int) grade];
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong BasisBladeMaxVectorIndex(this GaBasisBlade basisBlade)
        {
        ...
        public static void BasisBladeIdToGradeIndex(this ulong basisBladeId, out uint grade, out ulong basisBladeIndex)
        {
            if (basisBladeId < (ulong) GaLookupTables.IdToIndexTable.Length)
            {
                ...
                basisBladeIndex = GaLookupTables.IdToIndexTable[basisBladeId];
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaRecordGradeKey BasisBladeIdToGradeIndex(this ulong basisBladeId)
        {
            if (basisBladeId < (ulong) GaLookupTables.IdToIndexTable.Length)
            {
                var grade = GaLookupTables.IdToGradeTable[basisBladeId];
                var basisBladeIndex = GaLookupTables.IdToIndexTable[basisBladeId];

                return new GaRecordGradeKey(grade, basisBladeIndex);
            }
            else
            {
                basisBladeId.CombinadicPatternToIndex(out var grade, out var basisBladeIndex);

                return new GaRecordGradeKey((uint) grade, basisBladeIndex);
            }
        }
        ...
        public static bool IsValidBasisBladeIndex(this ulong basisBladeIndex, uint grade)
        {
            ...
            var kvDim = GaSpaceUtils.MaxVSpaceDimension.KVectorSpaceDimension(grade);
        ...
        {
            return grade <= GaSpaceUtils.MaxVSpaceDimension;
        }
        ...
        {
            return basisBladeId < (ulong)GaLookupTables.IsNegativeCliffConjTable.Length
                ? GaLookupTables.IsNegativeCliffConjTable.Get((int)basisBladeId)
        ...
        {
            return basisBladeId < (ulong)GaLookupTables.IsNegativeGradeInvTable.Length
                ? GaLookupTables.IsNegativeGradeInvTable.Get((int)basisBladeId)
        ...
        {
            return basisBladeId < (ulong) GaLookupTables.IsNegativeReverseTable.Length
                ? GaLookupTables.IsNegativeReverseTable.Get((int) basisBladeId)
