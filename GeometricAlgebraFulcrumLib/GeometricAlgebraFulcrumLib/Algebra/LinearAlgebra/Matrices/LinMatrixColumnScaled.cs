...
namespace GeometricAlgebraFulcrumLib.Algebra.LinearAlgebra.Matrices
{
        ...
        LinMatrixColumnBase<TMatrix, TScalar>
    {
        ...
        internal LinMatrixColumnScaled([NotNull] ILinearAlgebraProcessor<TMatrix, TScalar> matrixProcessor, [NotNull] TMatrix matrix, int columnIndex, [NotNull] TScalar scalingFactor)
