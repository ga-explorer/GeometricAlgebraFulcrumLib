...
namespace GeometricAlgebraFulcrumLib.Algebra.LinearAlgebra.Matrices
{
    public static class LinMatrixUtils
    {
        ...
        {
            return sourceVector.GeometricProcessor.CreateVectorToVectorRotationMatrix(
        ...
        {
            return unitVector.GeometricProcessor.CreateBasisToVectorRotationMatrix(
                basisVectorIndex,
        ...
        {
            return unitVector.GeometricProcessor.CreateVectorToBasisRotationMatrix(
                unitVector.VectorStorage,
                basisVectorIndex,
                matrixSize
            );
