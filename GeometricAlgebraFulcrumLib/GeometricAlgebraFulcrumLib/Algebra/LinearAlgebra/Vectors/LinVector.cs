...
//        internal LinVector(IScalarProcessor<T> linearProcessor, ILinVectorStorage<T> vectorStorage)
//        {
//            LinearProcessor = (ILinearAlgebraProcessor<T>) linearProcessor;
//            VectorStorage = vectorStorage;
//        }
        
//        internal LinVector(ILinearAlgebraProcessor<T> linearProcessor, ILinVectorStorage<T> vectorStorage)
//        {
