 ...
 */
    ...
    public class SgFilter
    {
        ...
        private readonly List<ISgDataFilter> _dataFilters = new ArrayList<ISgDataFilter>();

        private int _nl;

        private int _nr;

        private readonly List<ISgPreprocessor> _preprocessors = new ArrayList<ISgPreprocessor>();
