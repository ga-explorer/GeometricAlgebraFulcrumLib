...
namespace GeometricAlgebraFulcrumLib.Algebra.SignalProcessing
{
        ...
        IReadOnlyList<SignalSpectrum<T>.SignalSpectrumSample>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected SignalSpectrum([NotNull] SignalSamplingSpecs samplingSpecs)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected SignalSpectrum([NotNull] SignalSamplingSpecs samplingSpecs, [NotNull] Dictionary<int, SignalSpectrumSample> indexSampleDictionary)
        {
            Debug.Assert(
