...
namespace GeometricAlgebraFulcrumLib.Algebra.GeometricAlgebra.Outermorphisms
{
    public static class OutermorphismFactory
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaDiagonalLinearMapOutermorphism<T> CreateDiagonalAutomorphism<T>(this IGeometricAlgebraProcessor<T> geometricProcessor, IReadOnlyList<T> basisVectorsSignatures)
        {
            return new GaDiagonalLinearMapOutermorphism<T>(
                geometricProcessor,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaDiagonalLinearMapOutermorphism<T> CreateDiagonalAutomorphism<T>(this IReadOnlyList<T> basisVectorsSignatures, IGeometricAlgebraProcessor<T> geometricProcessor)
        {
            return new GaDiagonalLinearMapOutermorphism<T>(
                geometricProcessor,
                basisVectorsSignatures
        ...
        public static IGaOutermorphism<T> CreateComputedOutermorphism<T>(this IGeometricAlgebraProcessor<T> geometricProcessor, int basisVectorsCount, Func<int, VectorStorage<T>> basisVectorMapFunc)
        {
        ...
        public static IGaOutermorphism<T> CreateComputedOutermorphism<T>(this IGeometricAlgebraProcessor<T> geometricProcessor, int basisVectorsCount, Func<VectorStorage<T>, VectorStorage<T>> basisVectorMapFunc)
        {
            var mappedBasisVectors =
                Enumerable
                    .Range(0, basisVectorsCount)
