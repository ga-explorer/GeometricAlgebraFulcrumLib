...
namespace GeometricAlgebraFulcrumLib.Algebra.GeometricAlgebra.Outermorphisms
{
    public static class OutermorphismUtils
    {
        ...
        public static GaVector<T> OmMap<T>(this IGaOutermorphism<T> outermorphism, Axis axis)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorStorage<T> OmMap<T>(this IGaOutermorphism<T> map, VectorStorage<T> mv)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BivectorStorage<T> OmMap<T>(this IGaOutermorphism<T> map, BivectorStorage<T> mv)
        {
            var processor = map.GeometricProcessor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static KVectorStorage<T> OmMap<T>(this IGaOutermorphism<T> map, KVectorStorage<T> mv)
        {
            var processor = map.GeometricProcessor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IMultivectorGradedStorage<T> OmMap<T>(this IGaOutermorphism<T> map, IMultivectorGradedStorage<T> mv)
        {
            var processor = map.GeometricProcessor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IMultivectorStorage<T> OmMap<T>(this IGaOutermorphism<T> map, IMultivectorStorage<T> mv)
        {
            var processor = map.GeometricProcessor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorFrame<T> OmMap<T>(this IGaOutermorphism<T> outermorphism, VectorFrame<T> frame)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaKVector<T> OmMapPseudoScalar<T>(this IGaOutermorphism<T> outermorphism, uint vSpaceDimension)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaVector<T> OmMapBasisVector<T>(this IReadOnlyList<IGaOutermorphism<T>> omList, ulong index)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBivector<T> OmMapBasisBivector<T>(this IReadOnlyList<IGaOutermorphism<T>> omList, ulong index)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBivector<T> OmMapBasisBivector<T>(this IReadOnlyList<IGaOutermorphism<T>> omList, ulong index1, ulong index2)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaKVector<T> OmMapBasisBlade<T>(this IReadOnlyList<IGaOutermorphism<T>> omList, uint grade, ulong index)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaKVector<T> OmMapBasisBlade<T>(this IReadOnlyList<IGaOutermorphism<T>> omList, ulong id)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaKVector<T> OmMapPseudoScalar<T>(this IReadOnlyList<IGaOutermorphism<T>> omList, uint vSpaceDimension)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaVector<T> OmMap<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, GaVector<T> vector)
        {
            return omSeq
                .Aggregate(
                    vector,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaBivector<T> OmMap<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, GaBivector<T> vector)
        {
            return omSeq
                .Aggregate(
                    vector,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaKVector<T> OmMap<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, GaKVector<T> vector)
        {
            return omSeq
                .Aggregate(
                    vector,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GaMultivector<T> OmMap<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, GaMultivector<T> vector)
        {
            return omSeq
                .Aggregate(
                    vector,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorFrame<T> OmMap<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, VectorFrame<T> frame)
        {
            return VectorFrame<T>.Create(
                frame.GeometricProcessor,
                frame.FrameSpecs,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T[,] GetFinalMappingArray<T>(this IGeometricAlgebraProcessor<T> geometricProcessor, IEnumerable<IGaOutermorphism<T>> omSeq, int rowsCount)
        {
            return omSeq.OmMap(
        ...
        public static IEnumerable<GaVector<T>> OmMapVectorSequence<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, GaVector<T> vector)
        {
            var v = vector;
        ...
        public static IEnumerable<GaBivector<T>> OmMapBivectorSequence<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, GaBivector<T> vector)
        {
            var v = vector;
        ...
        public static IEnumerable<GaKVector<T>> OmMapKVectorSequence<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, GaKVector<T> vector)
        {
            var v = vector;
        ...
        public static IEnumerable<GaMultivector<T>> OmMapMultivectorSequence<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, GaMultivector<T> vector)
        {
            var v = vector;
        ...
        public static IEnumerable<VectorFrame<T>> OmMapFreeFrameSequence<T>(this IEnumerable<IGaOutermorphism<T>> omSeq, VectorFrame<T> frame)
        {
            var f = frame;
        ...
        //TODO: Remove this
        public static ILinMatrixStorage<T> GetVectorOmMappingMatrix<T>(this IGaOutermorphism<T> linearMap, int rowsCount, int colsCount)
        {
        ...
        public static T GetEuclideanDeterminant<T>(this IGeometricAlgebraProcessor<T> geometricProcessor, IGaOutermorphism<T> om)
        {
        ...
        public static Scalar<T> GetDeterminant<T>(this IGaOutermorphism<T> om)
        {
        ...
        public static Scalar<T> GetDeterminant<T>(this IGeometricAlgebraProcessor<T> geometricProcessor, IGaOutermorphism<T> om)
        {
            return om
                .OmMapBasisBlade(geometricProcessor.MaxBasisBladeId)
                .Sp(geometricProcessor.PseudoScalarInverse);
        ...
        public static Scalar<T> GetDeterminant<T>(this IGaOutermorphism<T> om, IGeometricAlgebraProcessor<T> geometricProcessor)
        {
            return om
                .OmMapBasisBlade(geometricProcessor.MaxBasisBladeId)
                .Sp(geometricProcessor.PseudoScalarInverse);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGaOutermorphism<T> CreateComputedOutermorphism<T>(this VectorFrame<T> frame)
        {
