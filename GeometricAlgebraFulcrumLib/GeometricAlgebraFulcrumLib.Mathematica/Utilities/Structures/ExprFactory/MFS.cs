...
public sealed class Mfs
{
    ...
    public static Mfs CubeRoot { get; } = new Mfs("CubeRoot");
    public static Mfs Sin { get; } = new Mfs("Sin");
    public static Mfs Cos { get; } = new Mfs("Cos");
    public static Mfs Tan { get; } = new Mfs("Tan");
    public static Mfs Csc { get; } = new Mfs("Csc");
    public static Mfs Sec { get; } = new Mfs("Sec");
    public static Mfs Cot { get; } = new Mfs("Cot");
