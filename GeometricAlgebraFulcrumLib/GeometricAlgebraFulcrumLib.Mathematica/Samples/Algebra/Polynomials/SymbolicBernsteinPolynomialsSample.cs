...
public static class SymbolicBernsteinPolynomialsSample
{
    ...
    public static void Example1()
    {
        ...
        for (var degree = 1; degree <= 7; degree++)
        {
            ...
            var valueSum2 = ScalarProcessor.Zero;
            for (var index = 0; index <= degree; index++)
            {
                ...
                valueSum2 += ScalarProcessor.Times(bi, value);
            ...
            valueSum1 = valueSum1.FullSimplifyScalar();
            valueSum2 = valueSum2.FullSimplifyScalar();
