...
{
    public sealed class ScalarAlgebraMathematicaProcessor
        : IScalarAlgebraSymbolicProcessor<Expr>
    {
        public static ScalarAlgebraMathematicaProcessor DefaultProcessor { get; }
            = new ScalarAlgebraMathematicaProcessor();
