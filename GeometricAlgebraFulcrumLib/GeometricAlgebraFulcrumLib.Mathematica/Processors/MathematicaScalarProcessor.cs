...
{
    public sealed class MathematicaScalarProcessor
        : ISymbolicScalarProcessor<Expr>
    {
        public static MathematicaScalarProcessor DefaultProcessor { get; }
            = new MathematicaScalarProcessor();
        ...
        private MathematicaScalarProcessor()
        {
        }
