...
{
    public sealed class LinearAlgebraMathematicaProcessor
        : ILinearAlgebraSymbolicProcessor<Expr>
    {
        public static LinearAlgebraMathematicaProcessor DefaultProcessor { get; }
            = new LinearAlgebraMathematicaProcessor();
        ...
        private LinearAlgebraMathematicaProcessor()
        {
        }
