using System.Text;
using GeometricAlgebraFulcrumLib.Core.Utilities.Text.Linear.LineHeader;

namespace GeometricAlgebraFulcrumLib.Core.Utilities.Text.Linear;
...
public class LinearTextComposer
{
    ...
    {
        get => _indentation.DefaultIndentation;
        set => _indentation.DefaultIndentation = value;
    }
