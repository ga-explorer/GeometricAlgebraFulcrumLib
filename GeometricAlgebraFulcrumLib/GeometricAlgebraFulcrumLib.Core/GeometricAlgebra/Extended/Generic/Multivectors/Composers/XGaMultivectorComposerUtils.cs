...
namespace GeometricAlgebraFulcrumLib.Core.GeometricAlgebra.Extended.Generic.Multivectors.Composers;
...
public static class XGaMultivectorComposerUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaGradedMultivector<T> Multivector<T>(this XGaProcessor<T> processor, IReadOnlyDictionary<int, XGaKVector<T>> gradeKVectorDictionary)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaMultivector<T> Multivector2D<T>(this XGaProcessor<T> processor, T scalar, T vectorScalar0, T vectorScalar1, T bivectorScalar)
    {
        return processor
            .CreateComposer()
            .SetTerm(0, scalar)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaMultivector<T> Multivector2D<T>(this XGaProcessor<T> processor, IScalar<T> scalar, IScalar<T> vectorScalar0, IScalar<T> vectorScalar1, IScalar<T> bivectorScalar)
    {
        return processor
            .CreateComposer()
            .SetTerm(0, scalar)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaUniformMultivector<T> UniformMultivectorZero<T>(this XGaProcessor<T> processor)
    {
