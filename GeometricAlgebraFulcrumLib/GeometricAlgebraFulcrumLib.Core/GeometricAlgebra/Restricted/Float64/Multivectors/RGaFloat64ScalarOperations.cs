...
public sealed partial class RGaFloat64Scalar
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64Scalar operator /(RGaFloat64Scalar s1, Float64Scalar s2)
    {
        return new RGaFloat64Scalar(
            s1.Processor,
            s1.ScalarValue / s2.ScalarValue
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaFloat64Scalar operator /(RGaFloat64Scalar s1, IFloat64Scalar s2)
    {
        return new RGaFloat64Scalar(
            s1.Processor,
            s1.ScalarValue / s2.ScalarValue
