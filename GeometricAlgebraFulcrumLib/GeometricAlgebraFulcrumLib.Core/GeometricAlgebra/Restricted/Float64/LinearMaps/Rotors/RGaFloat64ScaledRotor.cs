    ...
    : RGaFloat64ScaledRotorBase
{
    ...
    public static RGaFloat64ScaledRotor CreateEuclideanScaledPureRotor(RGaFloat64Vector sourceVector, RGaFloat64Vector targetVector)
    {
        ...
        var cosAngle = sourceVector.ESp(targetVector).Divide(norm1 * norm2);
    ...
    /// <returns></returns>
    public static RGaFloat64ScaledRotor CreateEuclideanScaledPureRotor(LinFloat64PolarAngle rotationAngle, RGaFloat64KVector rotationBlade)
    {
    ...
    /// <param name="rotationAngle"></param>
    /// <returns></returns>
    public static RGaFloat64ScaledRotor CreateScaledGivensRotor(RGaFloat64Processor metric, int i, int j, LinFloat64PolarAngle rotationAngle)
    {
