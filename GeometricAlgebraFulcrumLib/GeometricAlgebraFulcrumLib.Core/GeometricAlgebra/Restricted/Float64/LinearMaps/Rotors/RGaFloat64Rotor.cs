    ...
    : RGaFloat64RotorBase
{
    ...
    /// <returns></returns>
    public static RGaFloat64Rotor CreateEuclideanPureRotor(LinFloat64PolarAngle rotationAngle, RGaFloat64KVector rotationBlade)
    {
    ...
    /// <param name="rotationAngle"></param>
    /// <returns></returns>
    public static RGaFloat64Rotor CreateGivensRotor(int i, int j, LinFloat64PolarAngle rotationAngle)
    {
