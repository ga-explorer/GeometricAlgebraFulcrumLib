...
namespace GeometricAlgebraFulcrumLib.Core.GeometricAlgebra.Restricted.Generic.Multivectors.Composers;
...
public static class RGaMultivectorComposerUtils
{
    ...
    public static ScalarComposer<T> AddEGpTerm<T>(this ScalarComposer<T> composer, RGaProcessor<T> processor, ulong id, T scalar1, T scalar2)
    {
        ...
        return composer.AddScalar(scalar);
    }
    ...
    {
        return processor.BivectorTerm(index1, index2, composer.Scalar);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaGradedMultivector<T> Multivector<T>(this RGaProcessor<T> processor, IReadOnlyDictionary<ulong, T> termList)
    {
        return processor
            .CreateComposer()
            .SetTerms(termList)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaGradedMultivector<T> Multivector<T>(this RGaProcessor<T> processor, IReadOnlyDictionary<int, RGaKVector<T>> gradeKVectorDictionary)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaGradedMultivector<T> Multivector<T>(this RGaProcessor<T> processor, IEnumerable<KeyValuePair<ulong, T>> termList)
    {
        return processor
            .CreateComposer()
            .AddTerms(termList)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaGradedMultivector<T> Multivector<T>(this RGaProcessor<T> processor, ulong id)
    {
        var grade = id.Grade();

        var gradeKVectorDictionary = new SingleItemDictionary<int, RGaKVector<T>>(
            grade,
            processor.KVectorTerm(id, processor.ScalarProcessor.OneValue)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaGradedMultivector<T> Multivector<T>(this RGaProcessor<T> processor, ulong id, T scalar)
    {
        var grade = id.Grade();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaGradedMultivector<T> Multivector<T>(this RGaProcessor<T> processor, ulong id, IScalar<T> scalar)
    {
        return Multivector(processor, id, scalar.ScalarValue);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaGradedMultivector<T> Multivector<T>(this RGaProcessor<T> processor, KeyValuePair<ulong, T> basisScalarPair)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaMultivector<T> Multivector2D<T>(this RGaProcessor<T> processor, T scalar, T vectorScalar0, T vectorScalar1, T bivectorScalar)
    {
        ...
        return processor.Multivector(idScalarDictionary);
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaMultivector<T> Multivector2D<T>(this RGaProcessor<T> processor, IScalar<T> scalar, IScalar<T> vectorScalar0, IScalar<T> vectorScalar1, IScalar<T> bivectorScalar)
    {
        var idScalarDictionary = new Dictionary<ulong, T>()
        {
            [0] = scalar.ScalarValue,
            [1] = vectorScalar0.ScalarValue,
            [2] = vectorScalar1.ScalarValue,
            [3] = bivectorScalar.ScalarValue
        };
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaUniformMultivector<T> UniformMultivector<T>(this RGaProcessor<T> processor, IReadOnlyDictionary<ulong, T> basisScalarDictionary)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaUniformMultivector<T> UniformMultivector<T>(this RGaProcessor<T> processor, ulong basisBlade)
    {
        return new RGaUniformMultivector<T>(
            processor,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaUniformMultivector<T> UniformMultivector<T>(this RGaProcessor<T> processor, ulong basisBlade, T scalar)
    {
        if (processor.ScalarProcessor.IsZero(scalar))
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaUniformMultivector<T> UniformMultivector<T>(this RGaProcessor<T> processor, KeyValuePair<ulong, T> basisScalarPair)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaUniformMultivector<T> UniformMultivector<T>(this RGaProcessor<T> processor, ulong basisBlade, Scalar<T> scalar)
    {
