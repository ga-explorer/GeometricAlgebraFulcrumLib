...
public static class RGaVectorUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64Vector3D GetTuple3D(this RGaVector<double> vector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64Vector GetTuple(this RGaVector<double> vector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinAngle<T> GetEuclideanAngle<T>(this RGaVector<T> vector1, RGaVector<T> vector2, bool assumeUnitVectors = false)
    {
