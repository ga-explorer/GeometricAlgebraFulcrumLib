...
public static class RGaKVectorUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaKVector<T> Op<T>(this IEnumerable<RGaVector<T>> mvList, RGaProcessor<T> processor)
    {
        var blade = (RGaKVector<T>) processor.ScalarOne;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaKVector<T> Op<T>(this RGaProcessor<T> processor, IEnumerable<RGaVector<T>> mvList)
    {
        var blade = (RGaKVector<T>) processor.ScalarOne;
    ...
    public static RGaKVector<T> SpanToBlade<T>(this IEnumerable<RGaVector<T>> mvList, RGaProcessor<T> processor)
    {
        var blade = (RGaKVector<T>) processor.ScalarOne;
