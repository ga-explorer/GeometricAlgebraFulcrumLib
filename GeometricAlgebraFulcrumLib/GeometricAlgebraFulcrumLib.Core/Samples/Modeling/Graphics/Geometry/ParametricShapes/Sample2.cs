...
using GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.Parametric.Space3D.Surfaces;
...
namespace GeometricAlgebraFulcrumLib.Core.Samples.Modeling.Graphics.Geometry.ParametricShapes;
