...
public sealed class MutableComplexTuple3D : ILinComplexVector3D, IEnumerable<Complex>
{
    ...
    public MutableComplexTuple3D(ILinFloat64Vector3D tuple)
    {
        RealX = tuple.X;
        RealY = tuple.Y;
        RealZ = tuple.Z;
    ...
    public MutableComplexTuple3D(ILinComplexVector3D tuple)
    {
        RealX = tuple.X.Real;
        RealY = tuple.Y.Real;
        RealZ = tuple.Z.Real;
    ...
    public MutableComplexTuple3D SetTuple(ILinFloat64Vector3D tuple)
    {
        RealX = tuple.X;
        RealY = tuple.Y;
        RealZ = tuple.Z;
    ...
    public MutableComplexTuple3D SetRealTuple(ILinFloat64Vector3D tuple)
    {
        RealX = tuple.X;
        RealY = tuple.Y;
        RealZ = tuple.Z;
    ...
    public MutableComplexTuple3D SetImaginaryTuple(ILinFloat64Vector3D tuple)
    {
        ImagX = tuple.X;
        ImagY = tuple.Y;
        ImagZ = tuple.Z;
    ...
    public MutableComplexTuple3D SetTuple(ILinComplexVector3D tuple)
    {
        RealX = tuple.X.Real;
        RealY = tuple.Y.Real;
        RealZ = tuple.Z.Real;
