...
public static class Float64RangeUtils
{
    ...
    public static BoundingBox2D GetBoundingBox(this IEnumerable<ILinFloat64Vector2D> pointsList)
    {
        return BoundingBox2D.CreateFromPoints(pointsList);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BoundingBox2D GetBoundingBox(this IEnumerable<ILinFloat64Vector2D> pointsList, double scalingFactor)
    {
        return BoundingBox2D.CreateFromPoints(pointsList, scalingFactor);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BoundingSphere2D GetBoundingSphere(this IEnumerable<ILinFloat64Vector2D> pointsList)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BoundingBox3D GetBoundingBox(this IEnumerable<ILinFloat64Vector3D> pointsList)
    {
        return BoundingBox3D.CreateFromPoints(pointsList);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BoundingBox3D GetBoundingBox(this IEnumerable<ILinFloat64Vector3D> pointsList, double scalingFactor)
    {
    ...
    public static LinFloat64Vector2D GetCorner(this IBoundingBox2D boundingBox, bool maxCorner)
    {
        return maxCorner
    ...
    public static LinFloat64Vector2D GetMinCorner(this IBoundingBox2D boundingBox)
    {
        return LinFloat64Vector2D.Create((Float64Scalar)boundingBox.MinX, (Float64Scalar)boundingBox.MinY);
    }

    public static LinFloat64Vector2D GetMaxCorner(this IBoundingBox2D boundingBox)
    {
        return LinFloat64Vector2D.Create((Float64Scalar)boundingBox.MaxX, (Float64Scalar)boundingBox.MaxY);
    }

    public static LinFloat64Vector2D GetMidPoint(this IBoundingBox2D boundingBox)
    {
    ...
    public static LinFloat64Vector2D GetSideLengths(this IBoundingBox2D boundingBox)
    {
    ...
    public static LinFloat64Vector2D GetDiagonalVector(this IBoundingBox2D boundingBox)
    {
        return LinFloat64Vector2D.Create((Float64Scalar)(boundingBox.MaxX - boundingBox.MinX),
            (Float64Scalar)(boundingBox.MaxY - boundingBox.MinY));
    }
    ...
    /// <returns></returns>
    public static LinFloat64Vector2D GetCorner(this IBoundingBox2D boundingBox, int cornerIndex)
    {
    ...
    public static LinFloat64Vector2D GetSideDirection(this MutableBoundingBox2D boundingBox, int cornerIndex1, int cornerIndex2)
    {
    ...
    public static LinFloat64Vector2D GetPointOffset(this IBoundingBox2D boundingBox, ILinFloat64Vector2D point)
    {
    ...
    public static bool Contains(this IBoundingBox2D boundingBox, ILinFloat64Vector2D point, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                point.X >= boundingBox.MinX - epsilon &&
                point.X <= boundingBox.MaxX + epsilon &&
                point.Y >= boundingBox.MinY - epsilon &&
                point.Y <= boundingBox.MaxY + epsilon;
    ...
    public static bool Contains(this IBoundingBox2D boundingBox, double pointX, double pointY, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                pointX >= boundingBox.MinX - epsilon &&
                pointX <= boundingBox.MaxX + epsilon &&
                pointY >= boundingBox.MinY - epsilon &&
                pointY <= boundingBox.MaxY + epsilon;
    ...
    public static bool Contains(this IBoundingBox2D boundingBox, IBoundingBox2D box, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                box.MinX >= boundingBox.MinX - epsilon &&
                box.MaxX <= boundingBox.MaxX + epsilon &&
                box.MinY >= boundingBox.MinY - epsilon &&
                box.MaxY <= boundingBox.MaxY + epsilon;
    ...
    public static bool ContainsUpperExclusive(this IBoundingBox2D boundingBox, ILinFloat64Vector2D point, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                point.X >= boundingBox.MinX - epsilon &&
    ...
    public static bool Overlaps(this IBoundingBox2D boundingBox, IBoundingBox2D box, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                box.MaxX >= boundingBox.MinX - epsilon &&
                box.MinX <= boundingBox.MaxX + epsilon &&
                box.MaxY >= boundingBox.MinY - epsilon &&
                box.MinY <= boundingBox.MaxY + epsilon;
    ...
    public static LinFloat64Vector3D GetCorner(this IBoundingBox3D boundingBox, bool maxCorner)
    {
        return maxCorner
    ...
    public static LinFloat64Vector2D GetPointAt(this IBoundingBox2D boundingBox, double tx, double ty)
    {
    ...
    public static LinFloat64Vector2D GetPointAt(this IBoundingBox2D boundingBox, ILinFloat64Vector2D tVector)
    {
    ...
    public static LinFloat64Vector3D GetMinCorner(this IBoundingBox3D boundingBox)
    {
    ...
    public static LinFloat64Vector3D GetMaxCorner(this IBoundingBox3D boundingBox)
    {
    ...
    public static LinFloat64Vector3D GetMidPoint(this IBoundingBox3D boundingBox)
    {
    ...
    public static LinFloat64Vector3D GetSideLengths(this IBoundingBox3D boundingBox)
    {
    ...
    public static LinFloat64Vector3D GetSideHalfLengths(this IBoundingBox3D boundingBox)
    {
    ...
    public static LinFloat64Vector3D GetDiagonalVector(this IBoundingBox3D boundingBox)
    {
        return LinFloat64Vector3D.Create(boundingBox.MaxX - boundingBox.MinX,
            boundingBox.MaxY - boundingBox.MinY,
            boundingBox.MaxZ - boundingBox.MinZ);
    ...
    /// <param name="cornerIndex"></param>
    /// <returns></returns>
    public static LinFloat64Vector3D GetCorner(this IBoundingBox3D boundingBox, int cornerIndex)
    {
    ...
    public static LinFloat64Vector3D GetSideDirection(this IBoundingBox3D boundingBox, int cornerIndex1, int cornerIndex2)
    {
        var point1 = boundingBox.GetCorner(cornerIndex1);
        var point2 = boundingBox.GetCorner(cornerIndex2);
    ...
    public static LinFloat64Vector3D GetPointOffset(this IBoundingBox3D boundingBox, ILinFloat64Vector3D point)
    {
        var oX = point.X - boundingBox.MinX;
        var oY = point.Y - boundingBox.MinY;
    ...
    public static bool Contains(this IBoundingBox3D boundingBox, ILinFloat64Vector3D point, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                point.X >= boundingBox.MinX - epsilon &&
                ...
                point.Y >= boundingBox.MinY - epsilon &&
                point.Y <= boundingBox.MaxY + epsilon &&
                point.Z >= boundingBox.MinZ - epsilon &&
                point.Z <= boundingBox.MaxZ + epsilon;
    ...
    public static bool Contains(this IBoundingBox3D boundingBox, double pointX, double pointY, double pointZ, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                pointX >= boundingBox.MinX - epsilon &&
                ...
                pointY >= boundingBox.MinY - epsilon &&
                pointY <= boundingBox.MaxY + epsilon &&
                pointZ >= boundingBox.MinZ - epsilon &&
                pointZ <= boundingBox.MaxZ + epsilon;
    ...
    public static bool Contains(this IBoundingBox3D boundingBox, IBoundingBox3D box, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                box.MinX >= boundingBox.MinX - epsilon &&
                ...
                box.MinY >= boundingBox.MinY - epsilon &&
                box.MaxY <= boundingBox.MaxY + epsilon &&
                box.MinZ >= boundingBox.MinZ - epsilon &&
                box.MaxZ <= boundingBox.MaxZ + epsilon;
    ...
    public static bool ContainsUpperExclusive(this IBoundingBox3D boundingBox, ILinFloat64Vector3D point, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                point.X >= boundingBox.MinX - epsilon &&
                ...
                point.Y >= boundingBox.MinY - epsilon &&
                point.Y < boundingBox.MaxY + epsilon &&
                point.Y >= boundingBox.MinZ - epsilon &&
                point.Y < boundingBox.MaxZ + epsilon;
    ...
    public static bool Overlaps(this IBoundingBox3D boundingBox, IBoundingBox3D box, bool useMargins = false, double epsilon = 1e-12)
    {
        if (useMargins)
            return
                box.MaxX >= boundingBox.MinX - epsilon &&
                ...
                box.MaxY >= boundingBox.MinY - epsilon &&
                box.MinY <= boundingBox.MaxY + epsilon &&
                box.MaxZ >= boundingBox.MinZ - epsilon &&
                box.MinZ <= boundingBox.MaxZ + epsilon;
    ...
    public static LinFloat64Vector3D GetPointAt(this IBoundingBox3D boundingBox, double tx, double ty, double tz)
    {
    ...
    public static LinFloat64Vector3D GetPointAt(this IBoundingBox3D boundingBox, ILinFloat64Vector3D tVector)
    {
