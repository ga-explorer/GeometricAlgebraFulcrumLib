...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.Borders.Space3D.Mutable;
...
public sealed class MutableBoundingBox3D : IBoundingBox3D
{
    ...
    public static MutableBoundingBox3D CreateAround(ILinFloat64Vector3D center, double deltaX, double deltaY, double deltaZ)
    {
    ...
    public static MutableBoundingBox3D CreateFromPoint(ILinFloat64Vector3D point)
    {
    ...
    public static MutableBoundingBox3D CreateFromPoints(ILinFloat64Vector3D point1, ILinFloat64Vector3D point2)
    {
        double minX, minY, minZ, maxX, maxY, maxZ;
    ...
    public static MutableBoundingBox3D CreateFromPoints(ILinFloat64Vector3D point1, ILinFloat64Vector3D point2, ILinFloat64Vector3D point3)
    {
        var minX = point1.X;
        var minY = point1.Y;
        var minZ = point1.Z;
    ...
    public static MutableBoundingBox3D CreateFromPoints(params ILinFloat64Vector3D[] pointsList)
    {
    ...
    public static MutableBoundingBox3D CreateFromPoints(IEnumerable<ILinFloat64Vector3D> pointsList)
    {
    ...
    public MutableBoundingBox3D SetTo(ILinFloat64Vector3D point)
    {
        MinX = point.X;
        MinY = point.Y;
        MinZ = point.Z;
    ...
    public MutableBoundingBox3D MoveMidPointTo(ILinFloat64Vector3D newMidPoint)
    {
    ...
    public MutableBoundingBox3D MoveBy(ILinFloat64Vector3D delta)
    {
        MinX += delta.X;
        MinY += delta.Y;
        MinZ += delta.Z;
    ...
    public MutableBoundingBox3D UpdateSizeBy(ILinFloat64Vector3D delta)
    {
        MinX = MinX - delta.X;
        MinY = MinY - delta.Y;
        MinZ = MinZ - delta.Z;
    ...
    public MutableBoundingBox3D UpdateSizeByFactor(ILinFloat64Vector3D updateFactor)
    {
        var midX = 0.5d * (MaxX + MinX);
        var midY = 0.5d * (MaxY + MinY);
        var midZ = 0.5d * (MaxZ + MinZ);
    ...
    public MutableBoundingBox3D ExpandToInclude(ILinFloat64Vector3D point)
    {
        if (MinX > point.X) MinX = point.X;
        if (MinY > point.Y) MinY = point.Y;
        if (MinZ > point.Z) MinZ = point.Z;
    ...
    public MutableBoundingBox3D ExpandToInclude(params ILinFloat64Vector3D[] pointsList)
    {
        foreach (var point in pointsList)
        {
            if (MinX > point.X) MinX = point.X;
    ...
    public MutableBoundingBox3D ExpandToInclude(IEnumerable<ILinFloat64Vector3D> pointsList)
    {
        foreach (var point in pointsList)
        {
            if (MinX > point.X) MinX = point.X;
