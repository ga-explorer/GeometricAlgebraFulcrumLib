...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.Borders.Space2D.Mutable;
...
public sealed class MutableBoundingBox2D : IBoundingBox2D
{
    ...
    public static MutableBoundingBox2D CreateFromPoint(ILinFloat64Vector2D point)
    {
    ...
    public static MutableBoundingBox2D CreateFromPoints(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2)
    {
        double minX, minY, maxX, maxY;
    ...
    public static MutableBoundingBox2D CreateFromPoints(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2, ILinFloat64Vector2D point3)
    {
        var minX = point1.X;
        var minY = point1.Y;
    ...
    public static MutableBoundingBox2D CreateFromPoints(params ILinFloat64Vector2D[] pointsList)
    {
    ...
    public static MutableBoundingBox2D CreateFromPoints(IEnumerable<ILinFloat64Vector2D> pointsList)
    {
    ...
    public static MutableBoundingBox2D CreateAround(ILinFloat64Vector2D center, double deltaX, double deltaY)
    {
    ...
    public MutableBoundingBox2D SetTo(ILinFloat64Vector2D point)
    {
        MinX = point.X;
        MinY = point.Y;
    ...
    public MutableBoundingBox2D MoveMidPointTo(ILinFloat64Vector2D newMidPoint)
    {
    ...
    public MutableBoundingBox2D MoveBy(ILinFloat64Vector2D delta)
    {
        MinX += delta.X;
        MinY += delta.Y;
    ...
    public MutableBoundingBox2D UpdateSizeBy(ILinFloat64Vector2D delta)
    {
        MinX = MinX - delta.X;
        MinY = MinY - delta.Y;
    ...
    public MutableBoundingBox2D UpdateSizeByFactor(ILinFloat64Vector2D updateFactor)
    {
        var midX = 0.5d * (MaxX + MinX);
        var midY = 0.5d * (MaxY + MinY);
    ...
    public MutableBoundingBox2D ExpandToInclude(ILinFloat64Vector2D point)
    {
        if (MinX > point.X) MinX = point.X;
        if (MinY > point.Y) MinY = point.Y;
    ...
    public MutableBoundingBox2D ExpandToInclude(params ILinFloat64Vector2D[] pointsList)
    {
        foreach (var point in pointsList)
        {
            if (MinX > point.X) MinX = point.X;
    ...
    public MutableBoundingBox2D ExpandToInclude(IEnumerable<ILinFloat64Vector2D> pointsList)
    {
        foreach (var point in pointsList)
        {
            if (MinX > point.X) MinX = point.X;
