...
public sealed class MutableBoundingSphere2D : IBorderCurve2D
{
    ...
    public static MutableBoundingSphere2D Create(ILinFloat64Vector2D center, double radius)
    {
        return new MutableBoundingSphere2D(center.X, center.Y, radius);
    }

    public static MutableBoundingSphere2D CreateFromPoints(IEnumerable<ILinFloat64Vector2D> pointsList, bool tightBound = true)
    {
    ...
    internal MutableBoundingSphere2D(ILinFloat64Vector2D center, double radius)
    {
        CenterX = center.X;
        CenterY = center.Y;
        Radius = radius;
    ...
    public MutableBoundingSphere2D SetCenter(ILinFloat64Vector2D center)
    {
        CenterX = center.X;
        CenterY = center.Y;
    ...
    public MutableBoundingSphere2D SetTo(ILinFloat64Vector2D center, double radius)
    {
        CenterX = center.X;
        CenterY = center.Y;
        Radius = radius;
    ...
    public MutableBoundingSphere2D MoveCenterBy(ILinFloat64Vector2D delta)
    {
        CenterX += delta.X;
        CenterY += delta.Y;
