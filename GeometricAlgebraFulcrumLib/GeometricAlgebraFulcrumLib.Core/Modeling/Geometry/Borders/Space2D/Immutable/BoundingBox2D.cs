...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.Borders.Space2D.Immutable;
    ...
    IBoundingBox2D
{
    ...
    public static BoundingBox2D CreateAround(ILinFloat64Vector2D center, double deltaX, double deltaY)
    {
    ...
    public static BoundingBox2D Create(ILinFloat64Vector2D point)
    {
        return new BoundingBox2D(
            point.X,
            point.Y,
    ...
    public static BoundingBox2D Create(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2)
    {
        double minX, minY, maxX, maxY;
    ...
    public static BoundingBox2D CreateFromPoints(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2, ILinFloat64Vector2D point3)
    {
        var minX = point1.X;
        var minY = point1.Y;
    ...
    public static BoundingBox2D CreateFromPoints(params ILinFloat64Vector2D[] pointsList)
    {
    ...
    public static BoundingBox2D CreateFromPoints(IEnumerable<ILinFloat64Vector2D> pointsList)
    {
    ...
    public static BoundingBox2D CreateFromPoints(IEnumerable<ILinFloat64Vector2D> pointsList, double updateFactor)
    {
        double minX = 0, minY = 0, maxX = 0, maxY = 0;
    ...
    public BoundingBox2D(IBoundingBox2D boundingBox)
    {
