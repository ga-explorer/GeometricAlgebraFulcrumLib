    ...
    DfPolynomialBasis
{
    ...
    public DfMonomialPolynomial GetPolynomialDerivative1()
    {
        ...
        var scalarCoefficients = LinFloat64VectorComposer.Create(Degree - 1, Degree);
    ...
    public DfMonomialPolynomial GetPolynomialDerivativeN(int order)
    {
        ...
        var scalarCoefficients = LinFloat64VectorComposer.Create(degree, scalar);
    ...
    {
        var scalarCoefficients = LinFloat64VectorComposer.Create(Degree, 1d);
    ...
    public DfBernsteinPolynomial ToBernsteinPolynomial(int spaceDegree)
    {
        ...
        return DfBernsteinPolynomial.Create(spaceDegree, scalarCoefficients.GetVector());
    }
