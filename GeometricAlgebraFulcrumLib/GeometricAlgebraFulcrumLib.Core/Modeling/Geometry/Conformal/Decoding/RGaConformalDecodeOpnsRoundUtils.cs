...
public static class RGaConformalDecodeOpnsRoundUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalRound DecodeOpnsRound(this RGaConformalBlade opnsRound, LinFloat64Vector egaProbePoint)
    {
        return opnsRound.DecodeOpnsRound(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64Vector2D DecodeOpnsCircleEGaCenter2D(this RGaConformalBlade opnsRound)
    {
        return opnsRound.CGaDual().DecodeIpnsCircleEGaCenter2D();
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64Vector3D DecodeOpnsCircleEGaCenter3D(this RGaConformalBlade opnsRound)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tuple<double, LinFloat64Vector2D> DecodeOpnsCircleWeightEGaCenter2D(this RGaConformalBlade opnsRound)
    {
        return opnsRound.CGaDual().DecodeIpnsCircleWeightEGaCenter2D();
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tuple<double, LinFloat64Vector3D> DecodeOpnsSphereWeightEGaCenter3D(this RGaConformalBlade opnsRound)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double DecodeOpnsRoundWeight2D(this RGaConformalBlade opnsRound, LinFloat64Vector2D egaProbePoint)
    {
        return opnsRound.DecodeOpnsRoundWeight(
            opnsRound.ConformalSpace.EncodeEGaVector(egaProbePoint)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double DecodeOpnsRoundWeight3D(this RGaConformalBlade opnsRound, LinFloat64Vector3D egaProbePoint)
    {
        return opnsRound.DecodeOpnsRoundWeight(
            opnsRound.ConformalSpace.EncodeEGaVector(egaProbePoint)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double DecodeOpnsRoundWeight(this RGaConformalBlade opnsRound, LinFloat64Vector egaProbePoint)
    {
        return opnsRound.DecodeOpnsRoundWeight(
            opnsRound.ConformalSpace.EncodeEGaVector(egaProbePoint)
        );
