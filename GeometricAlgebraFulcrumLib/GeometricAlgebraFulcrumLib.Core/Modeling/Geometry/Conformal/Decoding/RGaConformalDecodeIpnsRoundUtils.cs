...
public static class RGaConformalDecodeIpnsRoundUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64Vector2D DecodeIpnsCircleEGaCenter2D(this RGaConformalBlade ipnsRound)
    {
        Debug.Assert(ipnsRound.ConformalSpace.Is4D);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64Vector3D DecodeIpnsCircleEGaCenter3D(this RGaConformalBlade ipnsRound)
    {
        Debug.Assert(ipnsRound.ConformalSpace.Is5D);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tuple<double, LinFloat64Vector2D> DecodeIpnsCircleWeightEGaCenter2D(this RGaConformalBlade ipnsRound)
    {
        Debug.Assert(ipnsRound.ConformalSpace.Is4D);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tuple<double, LinFloat64Vector3D> DecodeIpnsSphereWeightEGaCenter3D(this RGaConformalBlade ipnsRound)
    {
        Debug.Assert(ipnsRound.ConformalSpace.Is5D);
    ...
    public static Pair<LinFloat64Vector2D> DecodeIpnsPointPairEGaPointsAsVector2D(this RGaConformalBlade ipnsRound)
    {
        var pointPair =
            ipnsRound.DecodeIpnsRound();
    ...
    public static Pair<LinFloat64Vector3D> DecodeIpnsPointPairEGaPointsAsVector3D(this RGaConformalBlade ipnsRound)
    {
        var pointPair =
            ipnsRound.DecodeIpnsRound();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double DecodeIpnsRoundWeight2D(this RGaConformalBlade ipnsRound, LinFloat64Vector2D egaProbePoint)
    {
        return ipnsRound.DecodeIpnsRoundWeight(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double DecodeIpnsRoundWeight3D(this RGaConformalBlade ipnsRound, LinFloat64Vector3D egaProbePoint)
    {
        return ipnsRound.DecodeIpnsRoundWeight(
            ipnsRound.ConformalSpace.EncodeEGaVector(egaProbePoint)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double DecodeIpnsRoundWeight(this RGaConformalBlade ipnsRound, LinFloat64Vector egaProbePoint)
    {
        return ipnsRound.DecodeIpnsRoundWeight(
            ipnsRound.ConformalSpace.EncodeEGaVector(egaProbePoint)
        );
