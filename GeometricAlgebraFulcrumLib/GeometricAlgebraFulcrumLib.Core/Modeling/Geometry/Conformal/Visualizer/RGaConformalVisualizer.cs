    ...
    GeometryVisualizer
{
    ...
    public RGaConformalVisualizer DrawDirectionPoint2D(Color color, LinFloat64Vector2D position)
    {
    ...
    public RGaConformalVisualizer DrawDirectionPoint2D(Color color, IFloat64ParametricCurve2D position)
    {
        MainSceneComposer.AddPoint(
    ...
    public RGaConformalVisualizer DrawDirectionPoint3D(Color color, LinFloat64Vector3D position)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateStatic(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawDirectionLine2D(Color color, LinFloat64Vector2D position, LinFloat64Vector2D direction)
    {
    ...
    public RGaConformalVisualizer DrawDirectionLine2D(Color color, IFloat64ParametricCurve2D position, IFloat64ParametricCurve2D direction)
    {
        var animatedPosition =
            AnimationSpecs.CreateXyAnimatedVector3D(position);
    ...
    public RGaConformalVisualizer DrawDirectionLine3D(Color color, LinFloat64Vector3D position, LinFloat64Vector3D direction)
    {
        if (DirectionStyle.DrawPosition)
        {
            MainSceneComposer.AddPoint(
    ...
    public RGaConformalVisualizer DrawDirectionPlane2D(Color color, LinFloat64Vector2D position, LinFloat64Bivector2D direction)
    {
        if (DirectionStyle.DrawPosition)
        {
            MainSceneComposer.AddPoint(
    ...
    public RGaConformalVisualizer DrawDirectionPlane2D(Color color, IFloat64ParametricCurve2D position, IParametricBivector2D direction)
    {
        var animatedPosition =
            AnimationSpecs.CreateXyAnimatedVector3D(position);
    ...
    public RGaConformalVisualizer DrawDirectionPlane3D(Color color, LinFloat64Vector3D position, LinFloat64Bivector3D direction)
    {
        var normal = 
    ...
    public RGaConformalVisualizer DrawTangentPoint2D(Color color, LinFloat64Vector2D position)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateStatic(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawTangentPoint2D(Color color, IFloat64ParametricCurve2D position)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateAnimated(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawTangentPoint3D(Color color, LinFloat64Vector3D position)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateStatic(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawTangentLine2D(Color color, LinFloat64Vector2D position, LinFloat64Vector2D direction)
    {
    ...
    public RGaConformalVisualizer DrawTangentLine2D(Color color, IFloat64ParametricCurve2D position, IFloat64ParametricCurve2D direction)
    {
        var animatedPosition =
            AnimationSpecs.CreateXyAnimatedVector3D(position);
    ...
    public RGaConformalVisualizer DrawTangentLine3D(Color color, LinFloat64Vector3D position, LinFloat64Vector3D direction)
    {
        if (TangentStyle.DrawPosition)
        {
            MainSceneComposer.AddPoint(
    ...
    public RGaConformalVisualizer DrawTangentPlane2D(Color color, LinFloat64Vector2D position, LinFloat64Bivector2D direction)
    {
        if (TangentStyle.DrawPosition)
        {
            MainSceneComposer.AddPoint(
    ...
    public RGaConformalVisualizer DrawTangentPlane2D(Color color, IFloat64ParametricCurve2D position, IParametricBivector2D direction)
    {
        var animatedPosition =
            AnimationSpecs.CreateXyAnimatedVector3D(position);
    ...
    public RGaConformalVisualizer DrawTangentPlane3D(Color color, LinFloat64Vector3D position, LinFloat64Bivector3D direction)
    {
        var normal = 
            direction.DirectionToUnitNormal3D(LinFloat64Vector3D.UnitSymmetric);
    ...
    public RGaConformalVisualizer DrawFlatPoint2D(Color color, LinFloat64Vector2D position)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateStatic(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawFlatPoint2D(Color color, IFloat64ParametricCurve2D position)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateAnimated(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawFlatPoint3D(Color color, LinFloat64Vector3D position)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateStatic(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawFlatLine2D(Color color, LinFloat64Vector2D position, LinFloat64Vector2D direction)
    {
    ...
    public RGaConformalVisualizer DrawFlatLine2D(Color color, IFloat64ParametricCurve2D position, IFloat64ParametricCurve2D direction)
    {
        var animatedPosition =
            AnimationSpecs.CreateXyAnimatedVector3D(position);
    ...
    public RGaConformalVisualizer DrawFlatLine3D(Color color, LinFloat64Vector3D position, LinFloat64Vector3D direction)
    {
        MainSceneComposer.AddLineSegment(
            GrVisualLineSegment3D.CreateStatic(
                GetNewSceneObjectName("lineSegment"),
    ...
    public RGaConformalVisualizer DrawFlatPlane2D(Color color, LinFloat64Vector2D position, LinFloat64Bivector2D direction)
    {
        var normal = 
            direction.ToXyBivector3D().DirectionToUnitNormal3D(LinFloat64Vector3D.UnitSymmetric);
    ...
    public RGaConformalVisualizer DrawFlatPlane2D(Color color, IFloat64ParametricCurve2D position, IParametricBivector2D direction)
    {
        var animatedPosition =
            AnimationSpecs.CreateXyAnimatedVector3D(position);
    ...
    public RGaConformalVisualizer DrawFlatPlane3D(Color color, LinFloat64Vector3D position, LinFloat64Bivector3D direction)
    {
        var normal = 
            direction.DirectionToUnitNormal3D(LinFloat64Vector3D.UnitSymmetric);
    ...
    public RGaConformalVisualizer DrawRoundPoint2D(Color color, LinFloat64Vector2D center)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateStatic(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawRoundPoint2D(Color color, IFloat64ParametricCurve2D center)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateAnimated(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawRoundPoint3D(Color color, LinFloat64Vector3D center)
    {
        MainSceneComposer.AddPoint(
            GrVisualPoint3D.CreateStatic(
                GetNewSceneObjectName("point"),
    ...
    public RGaConformalVisualizer DrawRoundPointPair2D(Color color, LinFloat64Vector2D center, LinFloat64Vector2D direction, double radius)
    {
    ...
    public RGaConformalVisualizer DrawRoundPointPair2D(Color color, IFloat64ParametricCurve2D center, IFloat64ParametricCurve2D direction, IFloat64ParametricScalar radius)
    {
        var animatedCenter =
    ...
    public RGaConformalVisualizer DrawRoundPointPair3D(Color color, LinFloat64Vector3D center, LinFloat64Vector3D direction, double radius)
    {
    ...
    public RGaConformalVisualizer DrawRoundPointPair3D(Color color, IParametricCurve3D center, IParametricCurve3D direction, IFloat64ParametricScalar radius)
    {
        var animatedCenter =
            AnimationSpecs.CreateAnimatedVector3D(center);
    ...
    public RGaConformalVisualizer DrawRoundCircle2D(Color color, LinFloat64Vector2D center, LinFloat64Bivector2D direction, double radius)
    {
        var normal = 
            direction.ToXyBivector3D().DirectionToUnitNormal3D(LinFloat64Vector3D.UnitSymmetric);
    ...
    public RGaConformalVisualizer DrawRoundCircle2D(Color color, IFloat64ParametricCurve2D center, IParametricBivector2D direction, IFloat64ParametricScalar radius)
    {
        var animatedCenter = 
            AnimationSpecs.CreateAnimatedVector3D(center.ToXyParametricCurve3D());
    ...
    public RGaConformalVisualizer DrawRoundCircle3D(Color color, LinFloat64Vector3D center, LinFloat64Bivector3D direction, double radius)
    {
        var normal = 
            direction.DirectionToUnitNormal3D(LinFloat64Vector3D.UnitSymmetric);
    ...
    public RGaConformalVisualizer DrawRoundCircle3D(Color color, IParametricCurve3D center, IParametricBivector3D direction, IFloat64ParametricScalar radius)
    {
        var animatedCenter = 
            AnimationSpecs.CreateAnimatedVector3D(center);
    ...
    public RGaConformalVisualizer DrawRoundSphere3D(Color color, LinFloat64Vector3D center, LinFloat64Trivector3D direction, double radius)
    {
        MainSceneComposer.AddSphereSurface(
            GrVisualSphereSurface3D.CreateStatic(
                GetNewSceneObjectName("sphere"),
    ...
    public RGaConformalVisualizer DrawRoundSphere3D(Color color, IParametricCurve3D center, IParametricTrivector3D direction, IFloat64ParametricScalar radius)
    {
        var animatedCenter = 
            AnimationSpecs.CreateAnimatedVector3D(center);
