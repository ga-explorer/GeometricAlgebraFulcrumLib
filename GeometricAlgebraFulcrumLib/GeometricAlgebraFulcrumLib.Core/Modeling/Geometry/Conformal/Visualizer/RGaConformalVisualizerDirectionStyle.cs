...
public sealed record RGaConformalVisualizerDirectionStyle :
    RGaConformalVisualizerElementStyle
{
    internal RGaConformalVisualizerDirectionStyle(RGaConformalVisualizer visualizer, double thickness, bool drawPosition = true, double directionRadius = 1, double normalDirectionRadius = 1, double auxGeometryColorAlpha = 0.5)
