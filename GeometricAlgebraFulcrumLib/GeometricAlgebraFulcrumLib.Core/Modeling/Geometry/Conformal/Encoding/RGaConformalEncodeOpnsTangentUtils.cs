...
public static class RGaConformalEncodeOpnsTangentUtils
{
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentPoint(this RGaConformalSpace conformalSpace, LinFloat64Vector2D egaPoint)
    {
        return conformalSpace.EncodeOpnsTangentPoint(
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentPoint(this RGaConformalSpace conformalSpace, LinFloat64Vector3D egaPoint)
    {
        return conformalSpace.EncodeOpnsTangentPoint(
            egaPoint.ToRGaFloat64Vector()
        );
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentPoint(this RGaConformalSpace conformalSpace, LinFloat64Vector egaPoint)
    {
        return conformalSpace.EncodeOpnsTangentPoint(
            egaPoint.ToRGaFloat64Vector()
        );
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentLine(this RGaConformalSpace conformalSpace, double distance, LinFloat64Vector2D egaNormalVector)
    {
        return conformalSpace.EncodeOpnsTangentHyperPlane(
            distance, 
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentLine(this RGaConformalSpace conformalSpace, LinFloat64Vector2D point, LinFloat64Vector2D vector)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentLineFromPoints(this RGaConformalSpace conformalSpace, LinFloat64Vector2D point1, LinFloat64Vector2D point2)
    {
        return conformalSpace.EncodeOpnsTangentLine(
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentLine(this RGaConformalSpace conformalSpace, LinFloat64Vector3D egaPoint, LinFloat64Vector3D egaVector)
    {
        return conformalSpace.EncodeOpnsTangentLine(
            egaPoint.ToRGaFloat64Vector(),
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentLineFromPoints(this RGaConformalSpace conformalSpace, LinFloat64Vector3D egaPoint1, LinFloat64Vector3D egaPoint2)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentPlane(this RGaConformalSpace conformalSpace, double distance, LinFloat64Vector3D egaNormalVector)
    {
        return conformalSpace.EncodeOpnsTangentHyperPlane(
            distance, 
            egaNormalVector.ToRGaFloat64Vector()
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentPlane(this RGaConformalSpace conformalSpace, LinFloat64Vector3D egaPoint, LinFloat64Vector3D egaVector1, LinFloat64Vector3D egaVector2)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentPlane(this RGaConformalSpace conformalSpace, LinFloat64Vector3D egaPoint, LinFloat64Vector3D egaNormalVector)
    {
        var egaDirectionBivector = 
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentPlane(this RGaConformalSpace conformalSpace, LinFloat64Vector3D egaPoint, LinFloat64Bivector3D egaBivector)
    {
        return conformalSpace.EncodeOpnsTangentPlane(
            egaPoint.ToRGaFloat64Vector(),
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsTangentPlaneFromPoints(this RGaConformalSpace conformalSpace, LinFloat64Vector3D egaPoint1, LinFloat64Vector3D egaPoint2, LinFloat64Vector3D egaPoint3)
    {
        return conformalSpace.EncodeOpnsTangentPlane(
            egaPoint1,
            egaPoint2 - egaPoint1,
