    ...
    RGaConformalElement
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool SurfaceContainsEGaPoint2D(LinFloat64Vector2D egaPoint)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool SurfaceContainsEGaPoint3D(LinFloat64Vector3D egaPoint)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool SurfaceNearContainsEGaPoint2D(LinFloat64Vector2D egaPoint, double epsilon = 1e-12)
    {
        var v = egaPoint - PositionToVector2D();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool SurfaceNearContainsEGaPoint3D(LinFloat64Vector3D egaPoint, double epsilon = 1e-12)
    {
        var v = egaPoint - PositionToVector3D();
