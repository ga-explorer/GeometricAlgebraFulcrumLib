    ...
    IAlgebraicElement
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalFlat ToFlat(LinFloat64Vector2D egaPosition)
    {
        return ToFlat(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalFlat ToFlat(LinFloat64Vector3D egaPosition)
    {
        return ToFlat(
            ConformalSpace.EncodeEGaVector(egaPosition)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalFlat ToFlat(LinFloat64Vector egaPosition)
    {
        return ToFlat(
            ConformalSpace.EncodeEGaVector(egaPosition)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalTangent ToTangent(LinFloat64Vector2D egaPosition)
    {
        return ToTangent(
            ConformalSpace.EncodeEGaVector(egaPosition)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalTangent ToTangent(LinFloat64Vector3D egaPosition)
    {
        return ToTangent(
            ConformalSpace.EncodeEGaVector(egaPosition)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalTangent ToTangent(LinFloat64Vector egaPosition)
    {
        return ToTangent(
            ConformalSpace.EncodeEGaVector(egaPosition)
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalRound ToRound(LinFloat64Vector2D egaPosition, double radiusSquared)
    {
        return ToRound(
            ConformalSpace.EncodeEGaVector(egaPosition),
            radiusSquared
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalRound ToRound(LinFloat64Vector3D egaPosition, double radiusSquared)
    {
        return ToRound(
            ConformalSpace.EncodeEGaVector(egaPosition),
            radiusSquared
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalRound ToRound(LinFloat64Vector egaPosition, double radiusSquared)
    {
        return ToRound(
            ConformalSpace.EncodeEGaVector(egaPosition),
            radiusSquared
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalRound ToRealRound(LinFloat64Vector2D egaPosition, double radius)
    {
        return ToRound(
            ConformalSpace.EncodeEGaVector(egaPosition),
            radius * radius
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalRound ToRealRound(LinFloat64Vector3D egaPosition, double radius)
    {
        return ToRound(
            ConformalSpace.EncodeEGaVector(egaPosition),
            radius * radius
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalRound ToRealRound(LinFloat64Vector egaPosition, double radius)
    {
        return ToRound(
            egaPosition,
            radius * radius
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalRound ToImaginaryRound(LinFloat64Vector3D egaPosition, double radius)
    {
        return ToRound(
            ConformalSpace.EncodeEGaVector(egaPosition),
            -radius * radius
