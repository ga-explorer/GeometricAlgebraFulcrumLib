...
public sealed record AdaptiveCurveTreeCornerPosition2D :
    IComparable<AdaptiveCurveTreeCornerPosition2D>
{
    ...
    public AdaptiveCurveTreeCornerPosition2D(int level, int segmentCount)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(AdaptiveCurveTreeCornerPosition2D? other)
    {
        if (other is null)
