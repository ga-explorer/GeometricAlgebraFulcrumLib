    ...
    IArcLengthCurve3D
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public HarmonicCurve3D SetHarmonic(int harmonicFactor, LinFloat64Vector3D magnitudeVector)
    {
        return SetHarmonic(
            harmonicFactor,
            magnitudeVector,
    ...
    public HarmonicCurve3D SetHarmonic(int harmonicFactor, LinFloat64Vector3D magnitudeVector, LinFloat64Vector3D parameterShiftVector)
    {
