...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.BasicShapes.Triangles.Mutable;

public sealed class MutableTriangle2D : ITriangle2D
{
    public static MutableTriangle2D Create(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2, ILinFloat64Vector2D point3)
    {
    ...
    public MutableTriangle2D SetPoint1(ILinFloat64Vector2D point)
    {
        Point1X = point.X;
        Point1Y = point.Y;
    ...
    public MutableTriangle2D SetPoint2(ILinFloat64Vector2D point)
    {
        Point2X = point.X;
        Point2Y = point.Y;
    ...
    public MutableTriangle2D SetPoint3(ILinFloat64Vector2D point)
    {
        Point3X = point.X;
        Point3Y = point.Y;
    ...
    public MutableTriangle2D SetTriangle(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2, ILinFloat64Vector2D point3)
    {
        Point1X = point1.X;
        Point1Y = point1.Y;
