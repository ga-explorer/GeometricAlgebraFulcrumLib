...
using GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.BasicShapes.Planes.Immutable;
...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.BasicShapes.Triangles;

public static class TrianglesUtils
{
    #region Triangles in 2D
    public static LinFloat64Vector2D GetPoint1(this ITriangle2D triangle)
    {
        return LinFloat64Vector2D.Create((Float64Scalar)triangle.Point1X, (Float64Scalar)triangle.Point1Y);
    }

    public static LinFloat64Vector2D GetPoint2(this ITriangle2D triangle)
    {
        return LinFloat64Vector2D.Create((Float64Scalar)triangle.Point2X, (Float64Scalar)triangle.Point2Y);
    }

    public static LinFloat64Vector2D GetPoint3(this ITriangle2D triangle)
    {
        return LinFloat64Vector2D.Create((Float64Scalar)triangle.Point3X, (Float64Scalar)triangle.Point3Y);
    }

    public static LinFloat64Vector2D[] GetEndPoints(this ITriangle2D lineSegment)
    {
        return new[]
        {
    ...
    public static IEnumerable<LinFloat64Vector2D> GetEndPoints(this IEnumerable<ITriangle2D> trianglesList)
    {
    ...
    public static LinFloat64Vector2D GetDirection12(this ITriangle2D triangle)
    {
    ...
    public static LinFloat64Vector2D GetDirection21(this ITriangle2D triangle)
    {
    ...
    public static LinFloat64Vector2D GetDirection23(this ITriangle2D triangle)
    {
    ...
    public static LinFloat64Vector2D GetDirection32(this ITriangle2D triangle)
    {
    ...
    public static LinFloat64Vector2D GetDirection31(this ITriangle2D triangle)
    {
    ...
    public static LinFloat64Vector2D GetDirection13(this ITriangle2D triangle)
    {
    ...
    public static LinFloat64Vector2D GetInnerPointAt(this ITriangle2D triangle, double d1, double d2, double d3)
    {
        var dInv = 1 / (d1 + d2 + d3);
        var w1 = d1 * dInv;
        var w2 = d2 * dInv;
    ...
    public static LinFloat64Vector2D GetInnerPointAt(this ITriangle2D triangle, ILinFloat64Vector3D dTuple)
    {
    ...
    public static IEnumerable<LinFloat64Vector2D> GetInnerPointsAt(this ITriangle2D triangle, IEnumerable<ILinFloat64Vector3D> parametersList)
    {
    ...
    public static LinFloat64Vector2D GetPointAt(this ITriangle2D triangle, double w1, double w2)
    {
        var w3 = 1.0d - (w1 + w2);
    ...
    public static IEnumerable<LinFloat64Vector2D> GetPointsAt(this ITriangle2D triangle, IEnumerable<LinFloat64Vector2D> parametersList)
    {
        return parametersList.Select(
    ...
    public static Triangle2D GetTriangleAt(this ITriangle2D triangle, LinFloat64Vector2D w1, LinFloat64Vector2D w2, LinFloat64Vector2D w3)
    {
    ...
    public static LinFloat64Vector3D GetPoint1(this ITriangle3D triangle)
    {
        return LinFloat64Vector3D.Create(triangle.Point1X, triangle.Point1Y, triangle.Point1Z);
    }

    public static LinFloat64Vector3D GetPoint2(this ITriangle3D triangle)
    {
        return LinFloat64Vector3D.Create(triangle.Point2X, triangle.Point2Y, triangle.Point2Z);
    }

    public static LinFloat64Vector3D GetPoint3(this ITriangle3D triangle)
    {
        return LinFloat64Vector3D.Create(triangle.Point3X, triangle.Point3Y, triangle.Point3Z);
    }

    public static LinFloat64Vector3D[] GetEndPoints(this ITriangle3D lineSegment)
    {
        return new[]
        {
    ...
    public static IEnumerable<LinFloat64Vector3D> GetEndPoints(this IEnumerable<ITriangle3D> trianglesList)
    {
        return trianglesList.SelectMany(t => t.GetEndPoints());
    }

    public static LinFloat64Vector3D GetDirection12(this ITriangle3D triangle)
    {
    ...
    public static LinFloat64Vector3D GetDirection21(this ITriangle3D triangle)
    {
    ...
    public static LinFloat64Vector3D GetDirection23(this ITriangle3D triangle)
    {
    ...
    public static LinFloat64Vector3D GetDirection32(this ITriangle3D triangle)
    {
    ...
    public static LinFloat64Vector3D GetDirection31(this ITriangle3D triangle)
    {
    ...
    public static LinFloat64Vector3D GetDirection13(this ITriangle3D triangle)
    {
    ...
    public static LinFloat64Vector3D GetNormal(this ITriangle3D triangle)
    {
        return triangle
            .GetDirection12()
            .VectorCross(
    ...
    public static LinFloat64Vector3D GetUnitNormal(this ITriangle3D triangle)
    {
        return triangle
            .GetDirection12()
            .VectorUnitCross(
    ...
    public static LinFloat64Vector3D GetPointAt(this ITriangle3D triangle, double d1, double d2, double d3)
    {
        var d = 1 / (d1 + d2 + d3);
        var w1 = d1 * d;
        var w2 = d2 * d;
    ...
    public static LinFloat64Vector3D GetPointAt(this ITriangle3D triangle, double w1, double w2)
    {
        var w3 = 1.0d - (w1 + w2);
    ...
    public static IEnumerable<LinFloat64Vector3D> GetPointsAt(this ITriangle3D triangle, IEnumerable<LinFloat64Vector3D> parametersList)
    {
        return parametersList.Select(p => triangle.GetPointAt(p.X, p.Y));
    }

    public static Triangle3D GetTriangleAt(this ITriangle3D triangle, LinFloat64Vector3D w1, LinFloat64Vector3D w2, LinFloat64Vector3D w3)
    {
        var point1 = triangle.GetPointAt(w1.X, w1.Y);
        var point2 = triangle.GetPointAt(w2.X, w2.Y);
        var point3 = triangle.GetPointAt(w3.X, w3.Y);
