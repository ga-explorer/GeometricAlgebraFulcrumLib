...
public sealed class PlanarBeam3Dp
{
    ...
    public LineSegment3D GetLineSegment(LinFloat64Vector2D t1, LinFloat64Vector2D t2)
    {
    ...
    public Line3D GetRay(LinFloat64Vector2D t1, LinFloat64Vector2D t2)
    {
        var point1 = GetPoint(t1.X, t1.Y);
        var point2 = GetPoint(t2.X, t2.Y);
    ...
    public Triangle3D GetTriangle(LinFloat64Vector2D t1, LinFloat64Vector2D t2, LinFloat64Vector2D t3)
    {
        var point1 = GetPoint(t1.X, t1.Y);
        var point2 = GetPoint(t2.X, t2.Y);
