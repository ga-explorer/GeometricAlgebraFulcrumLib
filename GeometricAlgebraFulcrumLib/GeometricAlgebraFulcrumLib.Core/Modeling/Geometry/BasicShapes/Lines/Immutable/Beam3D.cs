using GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.BasicShapes.Polyhedra.Immutable;
using GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.BasicShapes.Triangles.Immutable;
using GeometricAlgebraFulcrumLib.Core.Algebra.LinearAlgebra.Float64.Vectors.Space3D;

namespace GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.BasicShapes.Lines.Immutable;
...
public sealed class Beam3D
{
    ...
    public LineSegment3D GetLineSegmentAt(LinFloat64Vector3D t1, LinFloat64Vector3D t2)
    {
    ...
    public Line3D GetRayAt(LinFloat64Vector3D t1, LinFloat64Vector3D t2)
    {
        var point1 = GetPointAt(t1.X, t1.Y, t1.Z);
        var point2 = GetPointAt(t2.X, t2.Y, t2.Z);
    ...
    public Triangle3D GetTriangleAt(LinFloat64Vector3D t1, LinFloat64Vector3D t2, LinFloat64Vector3D t3)
    {
        var point1 = GetPointAt(t1.X, t1.Y, t1.Z);
        var point2 = GetPointAt(t2.X, t2.Y, t2.Z);
