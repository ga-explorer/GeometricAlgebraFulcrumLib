...
public sealed class LineSegment2D : ILineSegment2D
{
    ...
    public static LineSegment2D Create(ILinFloat64Vector2D point1, ILinFloat64Vector2D point2)
    {
        return new LineSegment2D(
            point1.X,
            point1.Y,
    ...
    public LineSegment2D(double p1X, double p1Y, double p2X, double p2Y)
    {
        Point1X = p1X;
        Point1Y = p1Y;
