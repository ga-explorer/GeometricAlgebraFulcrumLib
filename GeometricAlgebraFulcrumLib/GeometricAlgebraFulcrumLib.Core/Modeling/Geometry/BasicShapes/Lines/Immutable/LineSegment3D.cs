...
public sealed class LineSegment3D : 
    ILineSegment3D
{
    public static LineSegment3D Create(ILinFloat64Vector3D point1, ILinFloat64Vector3D point2)
    {
    ...
    public static LineSegment3D CreateFromPointAndVector(ILinFloat64Vector3D point1, ILinFloat64Vector3D direction)
    {
        return new LineSegment3D(
            point1.X,
            point1.Y,
    ...
    public static LineSegment3D CreateFromPointAndScaledVector(ILinFloat64Vector3D point1, ILinFloat64Vector3D direction, double scaleFactor)
    {
        return new LineSegment3D(
            point1.X,
            point1.Y,
