...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.BasicShapes.Planes.Immutable;
...
public sealed class Plane3D : IPlane3D
{
    ...
    public Plane3D(ILinFloat64Vector3D origin, ILinFloat64Vector3D direction1, ILinFloat64Vector3D direction2)
    {
        OriginX = origin.X;
        OriginY = origin.Y;
        OriginZ = origin.Z;
