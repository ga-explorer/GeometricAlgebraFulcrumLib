...
using GeometricAlgebraFulcrumLib.Core.Modeling.Geometry.BasicShapes.Planes;
...
public static class DistanceUtils
{
    ...
    public static double GetSignedDistanceToLineVa(this ILinFloat64Vector2D point, ILine2D line)
    {
    ...
    public static double GetSignedDistanceToLineVa(this ILinFloat64Vector2D point, ILineSegment2D lineSegment)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_line
    ...
    public static double GetDistanceToLineVa(this ILinFloat64Vector2D point, ILine2D line)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_line
    ...
    public static double GetDistanceToLineVa(this ILinFloat64Vector2D point, ILineSegment2D lineSegment)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_line
    ...
    public static double GetSignedDistanceToPlaneVa(this ILinFloat64Vector3D point, IPlane3D plane)
    {
    ...
    public static double GetSignedDistanceToPlaneVa(this ILinFloat64Vector3D point, ITriangle3D triangle)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_plane
    ...
    public static double GetDistanceToPlaneVa(this ILinFloat64Vector3D point, IPlane3D plane)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_plane
    ...
    public static double GetDistanceToPlaneVa(this ILinFloat64Vector3D point, ITriangle3D triangle)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_plane
    ...
    public static double GetSignedDistanceFromPointVa(this IPlane3D plane, ILinFloat64Vector3D point)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_plane
    ...
    public static double GetDistanceFromPointVa(this IPlane3D plane, ILinFloat64Vector3D point)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_plane
    ...
    public static double GetSignedDistanceFromPointVa(this ILine2D line, ILinFloat64Vector2D point)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_line
    ...
    public static double GetDistanceFromPointVa(this ILine2D line, ILinFloat64Vector2D point)
    {
        //https://en.wikipedia.org/wiki/Distance_from_a_point_to_a_line
