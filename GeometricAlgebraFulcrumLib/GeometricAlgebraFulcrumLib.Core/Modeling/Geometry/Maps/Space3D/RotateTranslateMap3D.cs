...
public class RotateTranslateMap3D :
    IAffineMap3D
{
    public static RotateTranslateMap3D CreateRotate(LinFloat64DirectedAngle angle, ILinFloat64Vector3D vector)
    {
    ...
    public static RotateTranslateMap3D CreateRotate(ILinFloat64Vector3D vector1, ILinFloat64Vector3D vector2)
    {
        var map = new RotateTranslateMap3D();
    ...
    public LinFloat64Quaternion RotateQuaternion
    {
        get
        {
            ...
            return LinFloat64Quaternion.Create(
                RotateVectorX * sinHalfAngle,
                RotateVectorY * sinHalfAngle,
                RotateVectorZ * sinHalfAngle,
                cosHalfAngle
            );
        }
    }
    ...
    public RotateTranslateMap3D SetRotate(LinFloat64DirectedAngle angle, ILinFloat64Vector3D vector)
    {
        RotateAngle = angle;
    ...
    public RotateTranslateMap3D SetRotate(ILinFloat64Vector3D vector1, ILinFloat64Vector3D vector2)
    {
    ...
    public RotateTranslateMap3D SetTranslate(ILinFloat64Vector3D translateVector)
    {
    ...
    public RotateTranslateMap3D SetTranslate(ILinFloat64Vector3D point1, ILinFloat64Vector3D point2)
    {
