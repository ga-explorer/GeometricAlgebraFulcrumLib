...
public sealed class RGaGeometrySpaceBasisSpecs
{
    ...
    public static RGaGeometrySpaceBasisSpecs CreateEGa(int vSpaceDimensions)
    {
        ...
        return new RGaGeometrySpaceBasisSpecs(
            RGaFloat64EuclideanProcessor.Instance, 
            laTeXVectorSubscripts
        );
    }

    public static RGaGeometrySpaceBasisSpecs CreateCGa(int vSpaceDimensions)
    {
    ...
    public static RGaGeometrySpaceBasisSpecs CreateCGaOrthogonal(int vSpaceDimensions)
    {
        if (vSpaceDimensions < 4)
            throw new ArgumentOutOfRangeException(nameof(vSpaceDimensions));
    ...
    private RGaGeometrySpaceBasisSpecs(RGaFloat64Processor processor, IReadOnlyList<string> laTeXVectorSubscripts)
    {
        Processor = processor;
    ...
    private RGaGeometrySpaceBasisSpecs(RGaFloat64Processor processor, IReadOnlyList<string> laTeXVectorSubscripts, IRGaFloat64Outermorphism basisMap, IRGaFloat64Outermorphism basisMapInverse)
    {
        Processor = processor;
        LaTeXVectorSubscripts = laTeXVectorSubscripts;
        BasisMap = basisMap;
