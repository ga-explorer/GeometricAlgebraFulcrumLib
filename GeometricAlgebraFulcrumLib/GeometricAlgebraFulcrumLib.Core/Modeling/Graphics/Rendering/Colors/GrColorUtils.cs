...
public static class GrColorUtils
{
    ...
    public static LinFloat64Vector3D RgbToVector3D(this Color color)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64Vector4D RgbaToVector4D(this Color color)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Color ToRgbColor(this ITriplet<Float64Scalar> colorVector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Color ToRgbaColor(this IQuad<Float64Scalar> colorVector)
    {
