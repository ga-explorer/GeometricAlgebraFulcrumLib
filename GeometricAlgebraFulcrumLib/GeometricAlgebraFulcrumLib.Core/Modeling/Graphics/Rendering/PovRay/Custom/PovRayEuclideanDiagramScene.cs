using GeometricAlgebraFulcrumLib.Core.Modeling.Graphics.Rendering.PovRay.SDL;
...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Graphics.Rendering.PovRay.Custom;
