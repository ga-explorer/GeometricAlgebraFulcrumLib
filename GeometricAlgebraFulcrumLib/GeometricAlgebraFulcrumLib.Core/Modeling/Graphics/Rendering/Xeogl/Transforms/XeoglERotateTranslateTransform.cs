...
public sealed class XeoglERotateTranslateTransform : IXeoglNumericalTransform
{
    ...
    public static XeoglERotateTranslateTransform CreateTranslate(ILinFloat64Vector3D t)
    {
        return new XeoglERotateTranslateTransform()
        {
            TranslateX = t.X,
    ...
    public XeoglERotateTranslateTransform SetRotate(ILinFloat64Vector3D rotateTuple)
    {
    ...
    public XeoglERotateTranslateTransform SetTranslate(ILinFloat64Vector3D translateTuple)
    {
