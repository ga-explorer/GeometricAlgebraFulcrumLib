...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Graphics.Computers.Projections;
...
public class GcPlaneProjector3D
{
    ...
    /// <returns></returns>
    public LinFloat64Vector3D ComputeProjection(ILinFloat64Vector3D vector)
    {
    ...
    /// <param name="vector"></param>
    /// <returns></returns>
    public Tuple<LinFloat64Vector3D, LinFloat64Vector3D> ComputeComponents(ILinFloat64Vector3D vector)
    {
        //Begin GMac Macro Code Generation, 2018-10-20T20:49:38.2694768+02:00
        //Macro: cemsim.hga4d.ProjectVectorOnPlaneDirections3D
        //Input Variables: 9 used, 0 not used, 9 total.
        ...
        return Tuple.Create(
            ...
            LinFloat64Vector3D.Create(vector.X - x, 
                vector.Y - y, 
                vector.Z - z)
        );
    }
    ...
    /// <param name="vector"></param>
    /// <returns></returns>
    public LinFloat64Vector3D ComputeRejection(ILinFloat64Vector3D vector)
    {
        //Begin GMac Macro Code Generation, 2018-10-20T20:49:38.2694768+02:00
        //Macro: cemsim.hga4d.ProjectVectorOnPlaneDirections3D
        //Input Variables: 9 used, 0 not used, 9 total.
        ...
        return LinFloat64Vector3D.Create(vector.X - x,
            vector.Y - y,
            vector.Z - z);
    }
}