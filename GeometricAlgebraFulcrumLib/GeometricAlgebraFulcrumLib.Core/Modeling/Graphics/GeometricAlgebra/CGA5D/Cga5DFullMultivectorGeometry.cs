    ...
    : Cga5DMultivectorGeometry
{
    ...
    private LinFloat64Vector3D GetOpnsNormal(ILinFloat64Vector3D point)
    {
    ...
    private LinFloat64Vector3D GetIpnsNormal(ILinFloat64Vector3D point)
    {
    ...
    public override LinFloat64Vector3D ComputeSdfNormal(ILinFloat64Vector3D point)
    {
