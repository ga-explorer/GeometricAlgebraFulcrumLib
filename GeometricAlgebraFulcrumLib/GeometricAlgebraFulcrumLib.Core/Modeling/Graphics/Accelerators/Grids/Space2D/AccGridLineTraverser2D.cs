...
public sealed class AccGridLineTraverser2D
{
    ...
    /// </summary>
    public LinFloat64Vector2D TDelta { get; }

    /// <summary>
    /// Initial values of line parameter in x and y directions 
    /// </summary>
    public LinFloat64Vector2D TFirst { get; }
    ...
    private AccGridLineTraverser2D(IAccGrid2D<IFiniteGeometricShape2D> grid, ILine2D line, Float64ScalarRange lineParamLimits)
    {
        ...
        if (t0 > t1)
        {
            ...
            TDelta = LinFloat64Vector2D.Zero;
        ...
        TDelta = LinFloat64Vector2D.Create((Float64Scalar)((txMax - txMin) / grid.CellsCountX),
        ...
        TFirst = LinFloat64Vector2D.Create((Float64Scalar)txNext, (Float64Scalar)tyNext);
