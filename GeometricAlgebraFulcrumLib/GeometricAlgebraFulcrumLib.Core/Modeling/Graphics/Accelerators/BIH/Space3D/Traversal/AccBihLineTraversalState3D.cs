...
namespace GeometricAlgebraFulcrumLib.Core.Modeling.Graphics.Accelerators.BIH.Space3D.Traversal;
...
public struct AccBihLineTraversalState3D
{
    ...
    internal AccBihLineTraversalState3D(IAccBihNode3D bihNode, Float64ScalarRange lineParameterRange)
    {
        Debug.Assert(!ReferenceEquals(bihNode, null));
