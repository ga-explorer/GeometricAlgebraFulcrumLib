...
using GeometricAlgebraFulcrumLib.Core.Modeling.Graphics.Meshes.PointsMesh.Space2D;
...
public static class PointsMeshUtils
{
    ...
    public static ILinFloat64Vector3D GetPoint(this IPointsMesh3D baseMesh, int meshPointIndex)
    {
        meshPointIndex = meshPointIndex.Mod(baseMesh.Count);
    ...
    public static ILinFloat64Vector3D GetPoint(this IPointsMesh3D baseMesh, int pointIndex1, int pointIndex2)
    {
        return baseMesh[pointIndex1, pointIndex2];
    }
    ...
    public static IEnumerable<ILinFloat64Vector3D> GetPoints(this IPointsMesh3D mesh)
    {
        return mesh;
    }
    ...
    public static ArrayPointsMesh3D ToArrayPointsMesh(this IPointsMesh3D mesh)
    {
        ...
        var pointArray = new ILinFloat64Vector3D[mesh.Count1, mesh.Count2];
    ...
    public static IEnumerable<IQuad<ILinFloat64Vector3D>> GetPointQuads(this IPointsMesh3D baseMesh)
    {
