    ...
    IEnumerable<Complex>
{
    ...
    public MutableComplexTuple2D(ILinFloat64Vector2D tuple)
    {
        RealX = tuple.X;
        RealY = tuple.Y;
    ...
    public MutableComplexTuple2D(ILinComplexVector2D tuple)
    {
        RealX = tuple.X.Real;
        RealY = tuple.Y.Real;
    ...
    public MutableComplexTuple2D SetTuple(ILinFloat64Vector2D tuple)
    {
        RealX = tuple.X;
        RealY = tuple.Y;
    ...
    public MutableComplexTuple2D SetTuple(ILinComplexVector2D tuple)
    {
        RealX = tuple.X.Real;
        RealY = tuple.Y.Real;
