    ...
    IAffineMap3D
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SquareMatrix4 SetDiagonal(IQuad<Float64Scalar> vector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SquareMatrix4 SetRow(int rowIndex, IQuad<Float64Scalar> vector)
    {
        if (rowIndex == 0)
        {
            Scalar00 = vector.Item1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public SquareMatrix4 SetColumn(int colIndex, IQuad<Float64Scalar> vector)
    {
        if (colIndex == 0)
        {
            Scalar00 = vector.Item1;
