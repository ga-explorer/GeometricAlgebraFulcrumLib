...
using BasisBladeUtils = GeometricAlgebraFulcrumLib.Core.Algebra.GeometricAlgebra.Basis.BasisBladeUtils;
...
public sealed partial class XGaFloat64HigherKVector
{
    ...
    {
        return IsZero || BasisBladeUtils.ReverseIsPositiveOfGrade(Grade)
            ? this
            : Negative();
    }
