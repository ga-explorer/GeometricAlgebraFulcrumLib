...
public class ProListInterpolatedRows2D<TValue> : 
    IPeriodicReadOnlyList2D<TValue>
{
    ...
    public ProListInterpolatedRows2D(int count2, [NotNull] IPeriodicReadOnlyList<TValue> sourceList1, [NotNull] IPeriodicReadOnlyList<TValue> sourceList2, [NotNull] Func<double, TValue, TValue, TValue> interpolationFunc)
    {
