...
namespace GeometricAlgebraFulcrumLib.Matlab.GeometricAlgebra.Float64.Multivectors
{
    public abstract partial class XGaFloat64Multivector
    {
        ...
        public virtual XGaFloat64Multivector ELcp(XGaFloat64Vector kv2)
        {
            return this switch
            {
                XGaFloat64Scalar mv1 => mv1.ELcp(kv2),
                XGaFloat64Vector mv1 => mv1.ELcp(kv2),
                XGaFloat64Bivector mv1 => mv1.ELcp(kv2),
                XGaFloat64HigherKVector mv1 => mv1.ELcp(kv2),
                XGaFloat64GradedMultivector mv1 => mv1.ELcp(kv2),
                XGaFloat64UniformMultivector mv1 => mv1.ELcp(kv2),
                _ => throw new InvalidOperationException()
            };
        }

        
        public virtual XGaFloat64Multivector ELcp(XGaFloat64Bivector kv2)
        {
            return this switch
            {
                XGaFloat64Scalar mv1 => mv1.ELcp(kv2),
        ...
        public virtual XGaFloat64Multivector ELcp(XGaFloat64HigherKVector kv2)
        {
            return this switch
            {
                XGaFloat64Scalar mv1 => mv1.ELcp(kv2),
        ...
        public virtual XGaFloat64Multivector ELcp(XGaFloat64GradedMultivector mv2)
        {
            return this switch
            {
                XGaFloat64Scalar mv1 => mv1.ELcp(mv2),
                XGaFloat64Vector mv1 => mv1.ELcp(mv2),
                XGaFloat64Bivector mv1 => mv1.ELcp(mv2),
                XGaFloat64HigherKVector mv1 => mv1.ELcp(mv2),
                XGaFloat64GradedMultivector mv1 => mv1.ELcp(mv2),
                XGaFloat64UniformMultivector mv1 => mv1.ELcp(mv2),
                _ => throw new InvalidOperationException()
            };
        }
        ...
        public XGaFloat64Multivector ELcp(XGaFloat64KVector kv2)
        {
            return kv2 switch
            {
        ...
        public virtual XGaFloat64Multivector Lcp(XGaFloat64Vector kv2)
        {
            return this switch
            {
                XGaFloat64Scalar mv1 => mv1.Lcp(kv2),
                XGaFloat64Vector mv1 => mv1.Lcp(kv2),
                XGaFloat64Bivector mv1 => mv1.Lcp(kv2),
                XGaFloat64HigherKVector mv1 => mv1.Lcp(kv2),
                XGaFloat64GradedMultivector mv1 => mv1.Lcp(kv2),
                XGaFloat64UniformMultivector mv1 => mv1.Lcp(kv2),
                _ => throw new InvalidOperationException()
            };
        }

        
        public virtual XGaFloat64Multivector Lcp(XGaFloat64Bivector kv2)
        {
            return this switch
            {
                XGaFloat64Scalar mv1 => mv1.Lcp(kv2),
        ...
        public virtual XGaFloat64Multivector Lcp(XGaFloat64HigherKVector kv2)
        {
            return this switch
            {
                XGaFloat64Scalar mv1 => mv1.Lcp(kv2),
        ...
        public virtual XGaFloat64Multivector Lcp(XGaFloat64GradedMultivector mv2)
        {
            return this switch
            {
                XGaFloat64Scalar mv1 => mv1.Lcp(mv2),
                XGaFloat64Vector mv1 => mv1.Lcp(mv2),
                XGaFloat64Bivector mv1 => mv1.Lcp(mv2),
                XGaFloat64HigherKVector mv1 => mv1.Lcp(mv2),
                XGaFloat64GradedMultivector mv1 => mv1.Lcp(mv2),
                XGaFloat64UniformMultivector mv1 => mv1.Lcp(mv2),
                _ => throw new InvalidOperationException()
            };
        }
    ...
    public abstract partial class XGaFloat64KVector
    {
        ...
        public new XGaFloat64KVector ELcp(XGaFloat64Vector kv2)
        {
        ...
        public new XGaFloat64KVector ELcp(XGaFloat64Bivector kv2)
        {
            if (IsZero || kv2.IsZero)
                return Processor.ScalarZero;
        ...
        public new XGaFloat64KVector ELcp(XGaFloat64HigherKVector kv2)
        {
            if (IsZero || kv2.IsZero)
                return Processor.ScalarZero;
        ...
        public new XGaFloat64KVector ELcp(XGaFloat64KVector kv2)
        {
        ...
        public new XGaFloat64KVector Lcp(XGaFloat64Vector kv2)
        {
            if (IsZero || kv2.IsZero)
                return Processor.ScalarZero;
        ...
        public new XGaFloat64KVector Lcp(XGaFloat64Bivector kv2)
        {
            if (IsZero || kv2.IsZero)
                return Processor.ScalarZero;
        ...
        public new XGaFloat64KVector Lcp(XGaFloat64HigherKVector kv2)
        {
            if (IsZero || kv2.IsZero)
                return Processor.ScalarZero;
        ...
        public new XGaFloat64KVector Lcp(XGaFloat64KVector kv2)
        {
            if (IsZero || kv2.IsZero)
                return Processor.ScalarZero;
    ...
    public sealed partial class XGaFloat64Scalar
    {
        ...
        public new XGaFloat64Vector ELcp(XGaFloat64Vector kv2)
        {
            return kv2.Times(ScalarValue);
        }

        
        public new XGaFloat64Bivector ELcp(XGaFloat64Bivector kv2)
        {
            return kv2.Times(ScalarValue);
        }

        
        public new XGaFloat64HigherKVector ELcp(XGaFloat64HigherKVector kv2)
        {
            return kv2.Times(ScalarValue);
        }
        ...
        public new XGaFloat64Vector Lcp(XGaFloat64Vector kv2)
        {
            return kv2.Times(ScalarValue);
        }

        
        public new XGaFloat64Bivector Lcp(XGaFloat64Bivector kv2)
        {
            return kv2.Times(ScalarValue);
        }

        
        public new XGaFloat64HigherKVector Lcp(XGaFloat64HigherKVector kv2)
        {
            return kv2.Times(ScalarValue);
        }
    ...
    public sealed partial class XGaFloat64Vector
    {
        ...
        public new XGaFloat64Scalar ELcp(XGaFloat64Vector kv2)
        {
        ...
        public new XGaFloat64Vector ELcp(XGaFloat64Bivector kv2)
        {
            return IsZero || kv2.IsZero
        ...
        public new XGaFloat64Scalar Lcp(XGaFloat64Vector kv2)
        {
            return IsZero || kv2.IsZero
                ? Processor.ScalarZero
                : Float64ScalarComposer
        ...
        public new XGaFloat64Vector Lcp(XGaFloat64Bivector kv2)
        {
            return IsZero || kv2.IsZero
                ? Processor.VectorZero
                : Processor
    ...
    public sealed partial class XGaFloat64Bivector
    {
        ...
        public new XGaFloat64Scalar ELcp(XGaFloat64Vector _)
        {
            return Processor.ScalarZero;
        }

        
        public new XGaFloat64Scalar ELcp(XGaFloat64Bivector kv2)
        {
            return IsZero || kv2.IsZero
                ? Processor.ScalarZero
                : Float64ScalarComposer
        ...
        public new XGaFloat64Scalar Lcp(XGaFloat64Vector _)
        {
            return Processor.ScalarZero;
        }

        
        public new XGaFloat64Scalar Lcp(XGaFloat64Bivector kv2)
        {
            return IsZero || kv2.IsZero
                ? Processor.ScalarZero
                : Float64ScalarComposer
    ...
    public sealed partial class XGaFloat64HigherKVector
    {
        ...
        public new XGaFloat64Scalar ELcp(XGaFloat64Bivector _)
        {
            return Processor.ScalarZero;
        }
        ...
        public new XGaFloat64Scalar Lcp(XGaFloat64Bivector _)
        {
            return Processor.ScalarZero;
        }
