    ...
    IXGaFloat64Element
{
    ...
    public XGaFloat64Multivector GetPart(Func<IndexSet, bool> filterFunc)
    {
        return this switch
        {
    ...
    public XGaFloat64Multivector GetPart(Func<double, bool> filterFunc)
    {
        return this switch
        {
            XGaFloat64Scalar s => s.GetPart(filterFunc),
    ...
    public XGaFloat64Multivector GetPart(Func<IndexSet, double, bool> filterFunc)
    {
        return this switch
        {
            XGaFloat64Scalar s => s.GetPart(filterFunc),
    ...
    public Tuple<IndexSet, double> GetMinScalarMagnitudeIdScalar()
    {
        ...
        var (minValueId, minValue) = IdScalarPairs.First().ToTuple();
