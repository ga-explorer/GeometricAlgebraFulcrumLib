    ...
    LinFloat64Angle
{
    ...
    public static LinFloat64PolarAngle CreateFromUnitVectors(IPair<double> v1, IPair<double> v2)
    {
        return CreateFromCos(v1.VectorESp(v2));
    }

    
    public static LinFloat64PolarAngle CreateFromUnitVectors(ITriplet<double> v1, ITriplet<double> v2)
    {
        return CreateFromCos(v1.VectorESp(v2));
    }

    
    public static LinFloat64PolarAngle CreateFromUnitVectors(IQuad<double> v1, IQuad<double> v2)
    {
        return CreateFromCos(v1.VectorESp(v2));
    }
    ...
    public new LinFloat64PolarAngle NegativeAngle()
    {
        return new LinFloat64PolarAngle(CosValue, -SinValue);
    }
    
    
    public new LinFloat64PolarAngle OppositeAngle()
    {
        return new LinFloat64PolarAngle(-CosValue, -SinValue);
    }

    
    public new LinFloat64PolarAngle AngleAdd(double angle2)
    {
    ...
    public new LinFloat64PolarAngle AngleSubtract(double angle2)
    {
        var a2Cos = Math.Cos(angle2);
        var a2Sin = Math.Sin(angle2);
    ...
    public new LinFloat64PolarAngle AngleTimes(double scalingFactor)
    {
        return CreateFromRadians(RadiansValue * scalingFactor);
    }
    
    
    public new LinFloat64PolarAngle AngleDivide(double scalingFactor)
    {
        return CreateFromRadians(RadiansValue / scalingFactor);
    }
