    ...
    ILinFloat64Multivector2D
{
    public static LinFloat64Bivector2D Zero { get; }
        = new LinFloat64Bivector2D(0d);

    public static LinFloat64Bivector2D E12 { get; }
        = new LinFloat64Bivector2D(1d);
    ...
    private LinFloat64Bivector2D(double scalar12)
    {
        Scalar12 = scalar12;
    ...
    public LinFloat64Scalar2D DirectionToNormal2D()
    {
        ...
        return LinFloat64Scalar2D.Create(1d / Scalar12);
    }
    ...
    public LinFloat64Scalar2D DirectionToNormal2D(double scalingFactor)
    {
        ...
        return LinFloat64Scalar2D.Create(scalingFactor / Scalar12);
    }
    ...
    {
        return LinFloat64Bivector3D.Create(Xy, 0, 0);
    }
