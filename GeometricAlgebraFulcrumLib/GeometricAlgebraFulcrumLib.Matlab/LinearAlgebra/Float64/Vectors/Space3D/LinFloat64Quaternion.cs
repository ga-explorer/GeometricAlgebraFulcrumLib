    ...
    ILinFloat64Multivector3D
{
    ...
    public static LinFloat64Quaternion Create(double scalar, double iScalar, double jScalar, double kScalar)
    {
        return new LinFloat64Quaternion(scalar, iScalar, jScalar, kScalar);
    }

    
    public static LinFloat64Quaternion Create(double scalar, LinFloat64Bivector3D bivectorPart)
    {
        return new LinFloat64Quaternion(scalar, bivectorPart);
    }

    
    public static LinFloat64Quaternion Create(double scalar)
    {
    ...
    {
        return new LinFloat64Quaternion(0d, bivectorPart);
    }
    ...
    public static LinFloat64Quaternion CreateFromAxisAngle(ITriplet<double> axis, LinFloat64Angle angle)
    {
        var (halfAngleCos, halfAngleSin) = angle.HalfPolarAngle();
    ...
    private LinFloat64Quaternion(double scalar, double iScalar, double jScalar, double kScalar)
    {
        ScalarI = iScalar;
        ScalarJ = jScalar;
        ScalarK = kScalar;
    ...
    private LinFloat64Quaternion(double scalar, LinFloat64Bivector3D bivectorPart)
    {
    ...
    public double NormSquaredInverse()
    {
    ...
    public double ESp(LinFloat64Quaternion q2)
    {
