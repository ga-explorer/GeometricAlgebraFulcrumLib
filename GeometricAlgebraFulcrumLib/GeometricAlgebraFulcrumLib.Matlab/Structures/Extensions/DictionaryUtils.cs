...
public static class DictionaryExtensions
{
    ...
    public static IEnumerable<Tuple<TKey, TValue1, TValue2>> FullOuterJoin<TKey, TValue1, TValue2>(this IReadOnlyDictionary<TKey, TValue1> dictionary1, IReadOnlyDictionary<TKey, TValue2> dictionary2)
    {
        ...
        {
            if (dictionary2.TryGetValue(keyValuePair1.Key, out var value2))
                yield return new Tuple<TKey, TValue1, TValue2>(keyValuePair1.Key, keyValuePair1.Value, value2);
            else
                yield return new Tuple<TKey, TValue1, TValue2>(keyValuePair1.Key, keyValuePair1.Value, default);
        }

        foreach (var keyValuePair2 in dictionary2)
        {
            if (!dictionary1.ContainsKey(keyValuePair2.Key))
                yield return new Tuple<TKey, TValue1, TValue2>(keyValuePair2.Key, default, keyValuePair2.Value);
        }
    }
