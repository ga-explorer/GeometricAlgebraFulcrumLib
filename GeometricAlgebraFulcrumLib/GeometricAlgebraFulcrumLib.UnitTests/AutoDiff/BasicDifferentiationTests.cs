...
//            Assert.AreEqual(NumVec(0, 1, 0), grad);
//        }
...
//            Assert.AreEqual(NumVec(-4, 3), grad);
//        }
...
//            Assert.AreEqual(NumVec(9, -6), grad);
//        }
...
//            // df(x, y) = (4x, -6y)
//            Assert.AreEqual(NumVec(8, -18), grad);
//        }
...
//            // df(x, y) = [x-5, x+2]
//            Assert.AreEqual(NumVec(0, 0), gradOpt);
//            Assert.AreEqual(NumVec(-2, 3), gradGen);
//        }
...
//            Assert.AreEqual(NumVec(-0.92, 0.88), grad1);

//            // df(-6,4) = [-11, -26]
//            var grad2 = func.Differentiate(Vec(x, y), NumVec(-6, 4));
//            Assert.AreEqual(NumVec(-11, -26), grad2);
//        }
...
//            Assert.AreEqual(NumVec(6, -3, 0), result.Item1);
...
//            Assert.AreEqual(NumVec(161.5, 107, -62), result.Item1);
...
//            Assert.AreEqual(NumVec(Math.Exp(1)), grad1);
//            Assert.AreEqual(NumVec(Math.Exp(-2)), grad2);
//        }
...
//            Assert.AreEqual(NumVec(12, 8 * Math.Log(2)), grad);
//        }
...
//            Assert.AreEqual(expectedGrad[0], grad[0], 10);
//        }
...
//            Assert.AreEqual(Vec(2.0), y1);
//            Assert.AreEqual(Vec(4.0), y2);
//            Assert.AreEqual(Vec(6.0), y3);
//        }
...
//            Assert.AreEqual(Vec(2.0, 0.0), y1);
//            Assert.AreEqual(Vec(0.0, 4.0), y2);
//            Assert.AreEqual(Vec(4.0, 4.0), y3);
//        }
...
//            Assert.AreEqual(Vec(2.0, -1.0), y1);
//            Assert.AreEqual(Vec(-1.0, 0.0), y2);
//            Assert.AreEqual(Vec(0.0, -1.0), y3);
//        }
...
//            Assert.AreEqual(Vec(2.0, 0.0), y1);
//            Assert.AreEqual(Vec(0.0, -2.0), y2);
//            Assert.AreEqual(Vec(4.0, -2.0), y3);
//        }
...
//            Assert.AreEqual(NumVec(1, 2, 3), diffResult.Item1);
//        }
...
//            Assert.AreEqual(diff.Item1, Vec(2.0, 6.0));
...
//            Assert.AreEqual(grad, input); // the gradient at (x, y) is (x, y)
