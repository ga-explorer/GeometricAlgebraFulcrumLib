...
{
    internal static class GaLanguageTypeExtensions
    {
        /// <summary>
        ...
        public static bool IsInteger(this ILanguageType langType)
        {
            ...
            return typePrimitive.ObjectName == GaLanguageTypeNames.Integer;
        }
        ...
        public static bool IsScalar(this ILanguageType langType)
        {
            ...
            return typePrimitive.ObjectName == GaLanguageTypeNames.Scalar;
        }
        ...
        public static bool IsNumber(this ILanguageType langType)
        {
            ...
            return typePrimitive.ObjectName == GaLanguageTypeNames.Integer || typePrimitive.ObjectName == GaLanguageTypeNames.Scalar;
        }
        ...
        public static bool IsBoolean(this ILanguageType langType)
        {
            ...
            return typePrimitive.ObjectName == GaLanguageTypeNames.Bool;
        }
