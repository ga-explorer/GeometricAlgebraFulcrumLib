...
//        }
        ...
        private bool GeneratePreComputationsCode(GaFuLSymbolicContextCodeComposer contextCodeComposer)
        {
            //Generate comments
            GaFuLSymbolicContextCodeComposer.DefaultGenerateCommentsBeforeComputations(contextCodeComposer);
        ...
        private void GeneratePostComputationsCode(GaFuLSymbolicContextCodeComposer contextCodeComposer)
        {
            //Generate comments
            GaFuLSymbolicContextCodeComposer.DefaultGenerateCommentsAfterComputations(contextCodeComposer);
        }
