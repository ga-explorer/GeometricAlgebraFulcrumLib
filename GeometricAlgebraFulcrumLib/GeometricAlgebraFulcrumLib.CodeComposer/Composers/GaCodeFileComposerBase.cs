...
{
    public abstract class GaCodeFileComposerBase :
        CclCodeFileComposerBase, IGaCodeComposer
    {
        ...
        protected GaCodeFileComposerBase(string filePath, GaLanguageServer targetLanguage)
            : base(filePath)
        {
