...
{
    public abstract class GaSingleSymbolicContextCodeComposerBase : 
        GaCodeLibraryComposerBase
    {
        ...
        protected GaSingleSymbolicContextCodeComposerBase([NotNull] SymbolicContext context, GaLanguageServer languageServer)
            : base(languageServer)
        {
            Context = context;
        }
        ...
        protected GaSymbolicContextCodeComposer InitSymbolicContextCodeComposer()
        {
