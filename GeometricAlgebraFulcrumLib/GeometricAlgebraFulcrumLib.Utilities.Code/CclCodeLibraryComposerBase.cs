...
/// </summary>
public abstract class CclCodeLibraryComposerBase : 
    ICclCodeComposer
{
    /// <summary>
    ...
    /// </summary>
    public CclLanguageCodeGeneratorBase CodeComposer => Language.CodeGenerator;

    /// <summary>
    /// The language syntax elements factory for this code library composer
    /// </summary>
    public CclLanguageSyntaxFactory SyntaxFactory => Language.SyntaxFactory;
    ...
    protected CclCodeLibraryComposerBase()
    {
