...
public static class CclMatlabUtils
{
    /// <summary>
    ...
    public static CclLanguageInfo Matlab4Info { get; }


    static CclMatlabUtils()
    {
        Matlab4Info = new CclLanguageInfo("Matlab", "7.0", "MATLAB 7.0");
    }


    public static CclMatlabCodeGenerator Matlab4CodeComposer()
    {
        return new CclMatlabCodeGenerator();
    }

    public static CclMatlabSyntaxFactory Matlab4SyntaxFactory()
    {
        return new CclMatlabSyntaxFactory();
    }
