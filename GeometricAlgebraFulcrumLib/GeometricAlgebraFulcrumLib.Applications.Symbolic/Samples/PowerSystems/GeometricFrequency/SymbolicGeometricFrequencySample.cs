...
public static class SymbolicGeometricFrequencySample
{
    ...
    public static void Example1()
    {
        ...
        var v1 = "19".ToExpr() * GeometricProcessor.Vector(
            (w * t).Sin(),
            (w * t - theta).Sin(),
            (w * t + theta).Sin()
        );

        var v2 = "3".ToExpr() * GeometricProcessor.Vector(
            (2 * (w * t)).Sin(),
            (2 * (w * t - theta)).Sin(),
            (2 * (w * t + theta)).Sin()
        );

        var v3 = "5".ToExpr() * GeometricProcessor.Vector(
            (7 * (w * t)).Sin(),
            (7 * (w * t - theta)).Sin(),
            (7 * (w * t + theta)).Sin()
        );

        var v4 = "9".ToExpr() * GeometricProcessor.Vector(
            (5 * (w * t)).Sin(),
            (5 * (w * t - theta)).Sin(),
            (5 * (w * t + theta)).Sin()
        );
        ...
        var sDt2 = sDt1.DifferentiateScalar(t.ScalarValue).TrigReduceScalar();
    ...
    public static void Example2()
    {
        ...
        var twoPi = "2 * Pi".ScalarFromText(ScalarProcessor);

        var n = VSpaceDimensions;
        var v1 = "200".ToExpr() * GeometricProcessor.Vector(
            (w * t - 0 * twoPi / n).Sin(),
            (w * t - 1 * twoPi / n).Sin(),
            (w * t - 2 * twoPi / n).Sin(),
            (w * t - 3 * twoPi / n).Sin(),
        ...
        var v2 = "21".ToExpr() * GeometricProcessor.Vector(
            (2 * (w * t - 0 * twoPi / n)).Sin(),
            (2 * (w * t - 1 * twoPi / n)).Sin(),
            (2 * (w * t - 2 * twoPi / n)).Sin(),
            (2 * (w * t - 3 * twoPi / n)).Sin(),
        ...
        var v3 = "-55".ToExpr() * GeometricProcessor.Vector(
            (3 * (w * t - 0 * twoPi / n)).Sin(),
            (3 * (w * t - 1 * twoPi / n)).Sin(),
            (3 * (w * t - 2 * twoPi / n)).Sin(),
            (3 * (w * t - 3 * twoPi / n)).Sin(),
        ...
        var v4 = "-30".ToExpr() * GeometricProcessor.Vector(
            (4 * (w * t - 0 * twoPi / n)).Sin(),
            (4 * (w * t - 1 * twoPi / n)).Sin(),
            (4 * (w * t - 2 * twoPi / n)).Sin(),
            (4 * (w * t - 3 * twoPi / n)).Sin(),
        ...
        var v5 = "35".ToExpr() * GeometricProcessor.Vector(
            (5 * (w * t - 0 * twoPi / n)).Sin(),
            (5 * (w * t - 1 * twoPi / n)).Sin(),
            (5 * (w * t - 2 * twoPi / n)).Sin(),
            (5 * (w * t - 3 * twoPi / n)).Sin(),
    ...
    public static void Example3()
    {
        ...
        var v1 = "Sqrt[2]".ToExpr() * GeometricProcessor.Vector(
            210 * (w * t).Sin(),
            200 * (w * t - theta).Sin(),
            195 * (w * t + theta).Sin()
        );

        var v2 = "Sqrt[2]".ToExpr() * GeometricProcessor.Vector(
            22 * (2 * (w * t)).Sin(),
            20 * (2 * (w * t - theta)).Sin(),
            18 * (2 * (w * t + theta)).Sin()
        );

        var v3 = "Sqrt[2]".ToExpr() * GeometricProcessor.Vector(
            -30 * (7 * (w * t)).Sin(),
            -35 * (7 * (w * t - theta)).Sin(),
            -24 * (7 * (w * t + theta)).Sin()
        );
    ...
    public static void Example7()
    {
        ...
        var a = "a".ScalarFromText(ScalarProcessor);
        var b = "b".ScalarFromText(ScalarProcessor);
    ...
    public static void Example8()
    {
        ...
        var a = "a".ScalarFromText(ScalarProcessor);
        var b = "b".ScalarFromText(ScalarProcessor);
        var c = "c".ScalarFromText(ScalarProcessor);
    ...
    public static void Example9()
    {
        ...
        var a1 = "a1".ScalarFromText(ScalarProcessor);
        var a2 = "a2".ScalarFromText(ScalarProcessor);
        var a3 = "a3".ScalarFromText(ScalarProcessor);

        var b1 = "b1".ScalarFromText(ScalarProcessor);
        var b2 = "b2".ScalarFromText(ScalarProcessor);
        var b3 = "b3".ScalarFromText(ScalarProcessor);
