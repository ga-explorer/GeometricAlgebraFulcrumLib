...
public static class SymbolicAngularVelocitySample
{
    ...
    public static void Example1()
    {
        ...
        var wt = w * t;
        var theta = $"2 * Pi / {VSpaceDimensions}".ScalarFromText(ScalarProcessor);
        var vMax = "V".ScalarFromText(ScalarProcessor);
        ...
        var v2 =
            v2Scalars.Select(s => s.ScalarValue).Vector(GeometricProcessor);
