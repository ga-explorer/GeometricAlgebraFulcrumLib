using GeometricAlgebraFulcrumLib.Algebra.GeometricAlgebra.Extended.Generic.LinearMaps;
...
namespace GeometricAlgebraFulcrumLib.Applications.Symbolic.Samples.EuclideanGeometry;
