...
using GeometricAlgebraFulcrumLib.Applications.Symbolic.GeneticProgramming.Cartesian.Reproduction;
using GeometricAlgebraFulcrumLib.Applications.Symbolic.GeneticProgramming.Cartesian.Selection;
...
public class CGpParameters
{
    ...
    public CGpCostFunction CostFunction { get; set; }
