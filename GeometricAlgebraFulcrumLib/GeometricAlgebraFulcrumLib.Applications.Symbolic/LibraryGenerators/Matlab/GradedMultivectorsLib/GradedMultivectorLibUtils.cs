...
internal static class GradedMultivectorLibUtils
{
    ...
    public static string GetBasisBladeCode(XGaBasisBlade basisBlade, Func<int, string> codeFunc)
    {
        var id = (int) basisBlade.Id;
    ...
    public static string GetRhsCode(this XGaFloat64UnilinearCombinationTerm term, Func<int, string> argNameFunc)
    {
    ...
    public static string GetRhsCode(this IEnumerable<XGaFloat64UnilinearCombinationTerm> termList, Func<int, string> argNameFunc)
    {
        var termCodeList = 
            termList
    ...
    public static string GetRhsCode(this XGaFloat64BilinearCombinationTerm term, Func<int, string> arg1NameFunc, Func<int, string> arg2NameFunc)
    {
        Debug.Assert(!term.IsInputScalarZero);
    ...
    public static string GetRhsCode(this IEnumerable<XGaFloat64BilinearCombinationTerm> termList, Func<int, string> arg1NameFunc, Func<int, string> arg2NameFunc)
    {
        var termCodeList =
            termList
    ...
    public static string GetRhsCode(this XGaFloat64TrilinearCombinationTerm term, Func<int, string> arg1NameFunc, Func<int, string> arg2NameFunc, Func<int, string> arg3NameFunc)
    {
        Debug.Assert(!term.IsInputScalarZero);
    ...
    public static string GetRhsCode(this IEnumerable<XGaFloat64TrilinearCombinationTerm> termList, Func<int, string> arg1NameFunc, Func<int, string> arg2NameFunc, Func<int, string> arg3NameFunc)
    {
        var termCodeList =
            termList
