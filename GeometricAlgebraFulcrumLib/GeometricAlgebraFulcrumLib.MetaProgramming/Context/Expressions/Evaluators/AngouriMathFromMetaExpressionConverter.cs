...
{
    public static AngouriMathFromMetaExpressionConverter Instance { get; }
        = new AngouriMathFromMetaExpressionConverter();
    ...
    private AngouriMathFromMetaExpressionConverter()
    {
        //Context = context;
    }
