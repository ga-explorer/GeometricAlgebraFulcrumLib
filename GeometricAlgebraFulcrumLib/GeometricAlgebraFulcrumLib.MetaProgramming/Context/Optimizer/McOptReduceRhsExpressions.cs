    ...
    MetaContextProcessorBase
{
    ...
    /// <summary>
    /// Reduce a complex expression into a simpler one by refactoring all sub-expressions into
    ...
    private void AddOutputVariable(IMetaExpressionVariableComputed outputVar)
    {
        ...
        {
            outputVar.SetRhsExpression(rhsExpression);
    ...
    {
        Debug.Assert(Context.IsValidComputationOrder());
