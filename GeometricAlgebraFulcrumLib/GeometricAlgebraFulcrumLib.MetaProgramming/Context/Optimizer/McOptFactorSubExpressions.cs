    ...
    MetaContextProcessorBase
{
    ...
    private void AddVariable(IMetaExpressionVariableComputed computedVariable, string rhsExpressionText)
    {
    ...
    private void AddVariable(IMetaExpressionVariableComputed computedVariable)
    {
        computedVariable.SetComputationOrder(_computedVariablesList.Count);
    ...
    private void AddRhsExpression(IMetaExpressionVariableComputed computedVariable)
    {
        ...
        if (computedVariable.IsIntermediateVariable)
        {
            ...
            AddVariable(computedVariable, rhsExpressionText);
        ...
        if (!rhsExpression.IsAtomic && !_subExpressionsTextDictionary.ContainsKey(rhsExpressionText))
        {
            ...
            AddVariable(subExpressionVariable, rhsExpressionText);
        }
    ...
    private void AddSubExpressions(IMetaExpressionVariableComputed computedVar)
    {
        ...
        foreach (var subExpression in subExpressionsList)
        {
            ...
            else
            {
                ...
                AddVariable(subExpressionVariable, subExpressionText);
            }
        }
    ...
    /// <returns></returns>
    private static bool IsRelevantComputedVariable(IMetaExpressionVariableComputed computedVariable)
    {
