...
internal static class GaFuLLanguageTypeExtensions
{
    /// <summary>
    ...
    public static bool IsInteger(this ILanguageType langType)
    {
        ...
        return typePrimitive.ObjectName == GaFuLLanguageTypeNames.Integer;
    }
    ...
    public static bool IsScalar(this ILanguageType langType)
    {
        ...
        return typePrimitive.ObjectName == GaFuLLanguageTypeNames.Scalar;
    }
    ...
    public static bool IsNumber(this ILanguageType langType)
    {
        ...
        return typePrimitive.ObjectName == GaFuLLanguageTypeNames.Integer || typePrimitive.ObjectName == GaFuLLanguageTypeNames.Scalar;
    }
    ...
    public static bool IsBoolean(this ILanguageType langType)
    {
        ...
        return typePrimitive.ObjectName == GaFuLLanguageTypeNames.Bool;
    }
    ...
    public static bool CanAssignValue(this ILanguageType lhsType, ILanguageType rhsType)
    {
        return
            ...
            lhsType.IsInteger() && rhsType.IsInteger() ||
            lhsType.IsScalar() && rhsType.IsNumber();
    }
}