...
public sealed class SingleMetaContextMatlabCodeComposer :
    GaFuLSingleMetaContextCodeComposerBase
{
    public SingleMetaContextMatlabCodeComposer(MetaContext context)
        : base(context, GaFuLLanguageServerBase.MatlabFloat64())
    {
    }
    ...
    {
        return new SingleMetaContextMatlabCodeComposer(Context);
    }
}