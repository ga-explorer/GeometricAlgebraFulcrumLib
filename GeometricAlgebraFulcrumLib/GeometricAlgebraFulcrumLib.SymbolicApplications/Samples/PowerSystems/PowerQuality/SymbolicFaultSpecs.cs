...
namespace GeometricAlgebraFulcrumLib.SymbolicApplications.Samples.PowerSystems.PowerQuality
{
    public class SymbolicFaultSpecs
    {
        ...
        private void DefineSignal(Expr va, Expr vb, Expr vc)
        {
            ...
            var e2 =
                GeometricProcessor.CreateVector(0, 1);

            var e3 =
                GeometricProcessor.CreateVector(0, 0, 1);
