...
public class ComputedPowerSignal3D
{
    ...
    public IScalarD3Function ScalarFunc1 { get; }

    public IScalarD3Function ScalarFunc2 { get; }

    public IScalarD3Function ScalarFunc3 { get; }

    public string LaTeXCode { get; init; }
    ...
    public ComputedPowerSignal3D(ScalarSignalFloat64 timeValues, IScalarD3Function scalarFunc1, IScalarD3Function scalarFunc2, IScalarD3Function scalarFunc3)
    {
        TimeValues = timeValues;

        ScalarFunc1 = scalarFunc1;
        ScalarFunc2 = scalarFunc2;
        ScalarFunc3 = scalarFunc3;
    }


    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Triplet<Tuple3D> GetPhaseVectors(double t)
    {
        var x = new Tuple3D(ScalarFunc1.GetValue(t), 0, 0);
        var y = new Tuple3D(0, ScalarFunc2.GetValue(t), 0);
        var z = new Tuple3D(0, 0, ScalarFunc3.GetValue(t));

        return new Triplet<Tuple3D>(x, y, z);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Tuple3D GetPoint(double t)
    {
        var xDt = ScalarFunc1.GetValue(t);
        var yDt = ScalarFunc2.GetValue(t);
        var zDt = ScalarFunc3.GetValue(t);

        return new Tuple3D(xDt, yDt, zDt);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Tuple3D GetDerivative1(double t)
    {
        var xDt = ScalarFunc1.GetFirstDerivative(t);
        var yDt = ScalarFunc2.GetFirstDerivative(t);
        var zDt = ScalarFunc3.GetFirstDerivative(t);

        return new Tuple3D(xDt, yDt, zDt);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Tuple3D GetDerivative2(double t)
    {
        var xDt = ScalarFunc1.GetSecondDerivative(t);
        var yDt = ScalarFunc2.GetSecondDerivative(t);
        var zDt = ScalarFunc3.GetSecondDerivative(t);

        return new Tuple3D(xDt, yDt, zDt);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Tuple3D GetDerivative3(double t)
    {
        var xDt = ScalarFunc1.GetThirdDerivative(t);
        var yDt = ScalarFunc2.GetThirdDerivative(t);
        var zDt = ScalarFunc3.GetThirdDerivative(t);
    ...
    public Pair<double> GetCurvatures(double t)
    {
        ...
        var kappa1 = sDt1 * u2.GetLength();
        var kappa2 = sDt1 * u3.GetLength() / u2.GetLength();
    ...
    public Image GetSignalPlotImage(int index, int plotSampleCount)
    {
        ...
        model.Series.Add(
            new FunctionSeries(ScalarFunc1.GetValue, tMin, t, dt)
            {
        ...
        model.Series.Add(
            new FunctionSeries(ScalarFunc2.GetValue, tMin, t, dt)
            {
        ...
        model.Series.Add(
            new FunctionSeries(ScalarFunc3.GetValue, tMin, t, dt)
            {
    ...
    public ComputedPowerSignal3D InitializeComponents()
    {
        SampledCurve =
            GetSampledCurve();
