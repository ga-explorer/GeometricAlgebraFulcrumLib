...
public class SymmetricalComponentsSignalVisualizer3D :
    GrBabylonJsSnapshotComposer3D
{
    ...
    public SymmetricalComponentsSignalVisualizer3D(IReadOnlyList<double> cameraAlphaValues, IReadOnlyList<double> cameraBetaValues, SymmetricalComponentsSignal3D powerSignal)
