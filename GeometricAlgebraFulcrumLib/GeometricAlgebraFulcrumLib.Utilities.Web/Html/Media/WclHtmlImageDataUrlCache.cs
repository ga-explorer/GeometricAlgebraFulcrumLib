...
//        => _cacheDictionary.Values.Select(v => v.GetImageUrl());
...
//    public void GeneratePngDataUrlStrings(string workingFolder, bool saveImages = false)
//    {
//        var keyArray = 
//            _cacheDictionary
...
//        foreach (var key in keyArray)
//        {
//            katexComposer.AddLaTeXCode(key, GetLaTeXCode(key) ?? string.Empty);
//        }

//        katexComposer.RenderKaTeX();

//        foreach (var (key, item) in katexComposer)
//        {
//            var image = item.PngImage;

//            if (saveImages)
//                image.SaveAsPng(
//                    workingFolder.GetPngFilePath(key),
//                    new PngEncoder()
//                    {
...
//    {
//        return _cacheDictionary[key].GetImageUrl();
//    }
//}