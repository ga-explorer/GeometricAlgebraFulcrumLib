...
{
    public class ScalarProcessorFloat64
        : INumericScalarProcessor<double>
    {
        public static ScalarProcessorFloat64 DefaultProcessor { get; }
            = new ScalarProcessorFloat64();
        ...
        protected ScalarProcessorFloat64()
        {
        }
