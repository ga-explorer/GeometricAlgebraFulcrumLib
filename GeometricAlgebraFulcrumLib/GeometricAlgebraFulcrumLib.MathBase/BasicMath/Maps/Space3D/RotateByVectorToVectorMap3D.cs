...
namespace GeometricAlgebraFulcrumLib.MathBase.BasicMath.Maps.Space3D
{
        ...
        RotateMap3D
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private RotateByVectorToVectorMap3D(IFloat64Tuple3D unitVector1, IFloat64Tuple3D unitVector2)
        {
        ...
        {
            var angle = Float64PlanarAngle.CreateFromUnitVectors(_unitVector1, _unitVector2);
