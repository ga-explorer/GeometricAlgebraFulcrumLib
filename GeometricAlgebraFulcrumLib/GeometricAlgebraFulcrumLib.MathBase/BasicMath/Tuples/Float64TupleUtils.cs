...
namespace GeometricAlgebraFulcrumLib.MathBase.BasicMath.Tuples
{
    public static class Float64TupleUtils
    {
        ...
        public static LinFloat64VectorToVectorRotation GetVectorToVectorRotation(this System.Random random, int dimensions)
        {
            ...
            return LinFloat64VectorToVectorRotation.Create(u, v);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Tuple<bool, double, LinSignedBasisVector> TryToAxis(this Float64Tuple vector)
        {
            return TryVectorToAxis(vector.ScalarArray);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Tuple<bool, double, LinSignedBasisVector> TryToNearAxis(this Float64Tuple vector, double epsilon = 1e-12)
        {
