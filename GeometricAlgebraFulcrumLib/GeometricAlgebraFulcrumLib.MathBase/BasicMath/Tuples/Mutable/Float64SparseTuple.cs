...
namespace GeometricAlgebraFulcrumLib.MathBase.BasicMath.Tuples.Mutable
{
        ...
        IReadOnlyList<double>
    {
        ...
        public int FirstIndex
            => _itemDictionary.Count == 0 
                ? -1 
                : _itemDictionary.Keys.First();

        public int LastIndex
            => _itemDictionary.Count == 0 
                ? -1 
                : _itemDictionary.Keys.Last();
        
        public double FirstItem
            => _itemDictionary.Count == 0 
                ? 0d 
                : _itemDictionary.Values.First();
        
        public double LastItem
            => _itemDictionary.Count == 0 
                ? 0d 
                : _itemDictionary.Values.Last();

        public KeyValuePair<int, double> FirstIndexItem
            => _itemDictionary.Count == 0 
                ? new KeyValuePair<int, double>(-1, 0d) 
                : _itemDictionary.First();
        
        public KeyValuePair<int, double> LastIndexItem
            => _itemDictionary.Count == 0 
                ? new KeyValuePair<int, double>(-1, 0d) 
                : _itemDictionary.Last();

        public int Count
            => _itemDictionary.Count == 0 
                ? 0 : 1 + _itemDictionary.Keys.Last();
        ...
        {
            get => _itemDictionary.TryGetValue(index, out var item) ? item : 0d;
            set
            {
        ...
        public Float64SparseTuple(double item0)
        {
            ...
            if (item0.IsNotZero()) _itemDictionary.Add(0, item0);
        }
        ...
        public Float64SparseTuple(double item0, double item1)
        {
            ...
            if (item0.IsNotZero()) _itemDictionary.Add(0, item0);
            if (item1.IsNotZero()) _itemDictionary.Add(1, item1);
        }
        ...
        public Float64SparseTuple(double item0, double item1, double item2)
        {
            ...
            if (item0.IsNotZero()) _itemDictionary.Add(0, item0);
            if (item1.IsNotZero()) _itemDictionary.Add(1, item1);
            if (item2.IsNotZero()) _itemDictionary.Add(2, item2);
        }
        ...
        public Float64SparseTuple(double item0, double item1, double item2, double item3)
        {
            ...
            if (item1.IsNotZero()) _itemDictionary.Add(1, item1);
            if (item2.IsNotZero()) _itemDictionary.Add(2, item2);
            if (item3.IsNotZero()) _itemDictionary.Add(3, item3);
        }
        ...
        public Float64SparseTuple(IPair<double> tuple)
        {
            ...
            if (tuple.Item1.IsNotZero()) _itemDictionary.Add(0, tuple.Item1);
            if (tuple.Item2.IsNotZero()) _itemDictionary.Add(1, tuple.Item2);
        }
        ...
        public Float64SparseTuple(ITriplet<double> tuple)
        {
            ...
            if (tuple.Item1.IsNotZero()) _itemDictionary.Add(0, tuple.Item1);
            if (tuple.Item2.IsNotZero()) _itemDictionary.Add(1, tuple.Item2);
            if (tuple.Item3.IsNotZero()) _itemDictionary.Add(2, tuple.Item3);
        }
        ...
        public Float64SparseTuple(IQuad<double> tuple)
        {
            ...
            if (tuple.Item2.IsNotZero()) _itemDictionary.Add(1, tuple.Item2);
            if (tuple.Item3.IsNotZero()) _itemDictionary.Add(2, tuple.Item3);
            if (tuple.Item4.IsNotZero()) _itemDictionary.Add(3, tuple.Item4);
        }
        ...
        public Float64SparseTuple(IQuint<double> tuple)
        {
            ...
            if (tuple.Item3.IsNotZero()) _itemDictionary.Add(2, tuple.Item3);
            if (tuple.Item4.IsNotZero()) _itemDictionary.Add(3, tuple.Item4);
            if (tuple.Item5.IsNotZero()) _itemDictionary.Add(4, tuple.Item5);
        }
        ...
        public Float64SparseTuple(IHexad<double> tuple)
        {
            ...
            if (tuple.Item4.IsNotZero()) _itemDictionary.Add(3, tuple.Item4);
            if (tuple.Item5.IsNotZero()) _itemDictionary.Add(4, tuple.Item5);
            if (tuple.Item6.IsNotZero()) _itemDictionary.Add(5, tuple.Item6);
        }
        ...
        public Float64SparseTuple(Color color)
        {
            ...
            if (tuple.R != 0) _itemDictionary.Add(0, tuple.R / 255d);
            if (tuple.R != 1) _itemDictionary.Add(1, tuple.G / 255d);
            if (tuple.R != 2) _itemDictionary.Add(2, tuple.B / 255d);
            if (tuple.R != 3) _itemDictionary.Add(3, tuple.A / 255d);
        }
        ...
        public Float64SparseTuple ClearByIndex(Func<int, bool> keyPredicate)
        {
            var keyList =
                _itemDictionary
                    .Keys
        ...
        public Float64SparseTuple ClearByValue(Func<double, bool> valuePredicate)
        {
            var keyList =
                _itemDictionary
                    .Where(p => valuePredicate(p.Value))
                    .Select(p => p.Key)
                    .ToImmutableArray();
        ...
        public Float64SparseTuple ClearByIndexValue(Func<int, double, bool> keyValuePredicate)
        {
            var keyList =
                _itemDictionary
                    .Where(p => keyValuePredicate(p.Key, p.Value))
                    .Select(p => p.Key)
                    .ToImmutableArray();
        ...
        public Float64SparseTuple InPlaceScale(double scalar)
        {
            ...
            foreach (var index in _itemDictionary.Keys.ToImmutableArray())
