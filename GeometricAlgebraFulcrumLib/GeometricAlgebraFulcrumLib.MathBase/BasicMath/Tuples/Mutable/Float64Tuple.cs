        ...
        IReadOnlyList<double>
    {
        ...
        public bool IsVectorBasis(int basisIndex)
        {
            for (var i = 0; i < basisIndex; i++)
                if (!ScalarArray[i].IsZero())
                    return false;

            if (!ScalarArray[basisIndex].IsOne())
                return false;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double GetComponent(LinSignedBasisVector axis)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double VectorDot(LinSignedBasisVector axis)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64PlanarAngle GetAngle(Float64Tuple vector)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Tuple RotateToUnitVector(Float64Tuple unitVector, Float64PlanarAngle angle)
        {
            var u = ScalarArray;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Tuple RotateFromUnitVector(Float64Tuple unitVector, Float64PlanarAngle angle)
        {
