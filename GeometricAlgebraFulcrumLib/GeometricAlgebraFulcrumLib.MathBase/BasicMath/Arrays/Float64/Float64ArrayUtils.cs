...
namespace GeometricAlgebraFulcrumLib.MathBase.BasicMath.Arrays.Float64
{
    public static class Float64ArrayUtils
    {
        ...
        {
            return v1.MapScalars(a => a.ArcCos().Radians);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double[] ArcSin(this IReadOnlyList<double> v1)
        {
            return v1.MapScalars(a => a.ArcSin().Radians);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double[] ArcTan(this IReadOnlyList<double> v1)
        {
            return v1.MapScalars(a => a.ArcTan().Radians);
        }
