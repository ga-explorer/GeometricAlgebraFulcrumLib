...
public static class LinFloat64UnilinearMap4DUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<Float64Vector4D> GetMappedBasisVectors(this ILinFloat64UnilinearMap4D map)
    {
    ...
    //[MethodImpl(MethodImplOptions.AggressiveInlining)]
    //public static IEnumerable<KeyValuePair<int, Float64Tuple4D>> GetColumns(this LinFloat64UnilinearMap map)
    //{
    //    return map.GetMappedBasisVectors();
    //}

    //[MethodImpl(MethodImplOptions.AggressiveInlining)]
    //public static Float64Tuple4D GetColumn(this LinFloat64UnilinearMap map, int colIndex)
    //{
    //    return map.MapBasisVector(colIndex);
    //}

    //[MethodImpl(MethodImplOptions.AggressiveInlining)]
    //public static Float64Tuple4D GetScaledColumn(this LinFloat64UnilinearMap map, int colIndex, double scalingFactor)
    //{
    //    return map.MapBasisVector(colIndex).Times(scalingFactor);
    //}

    //[MethodImpl(MethodImplOptions.AggressiveInlining)]
    //public static Float64Tuple4D GetMappedColumn(this LinFloat64UnilinearMap map, int colIndex, Func<double, double> scalarMapping)
    //{
    //    return map.MapBasisVector(colIndex).MapScalars(scalarMapping);
    //}

    //[MethodImpl(MethodImplOptions.AggressiveInlining)]
    //public static Float64Tuple4D GetMappedColumn(this LinFloat64UnilinearMap map, int colIndex, Func<int, double, double> indexScalarMapping)
    //{
    //    return map.MapBasisVector(colIndex).MapScalars(indexScalarMapping);
    //}


    //public static Float64Tuple4D CombineColumns(this LinFloat64UnilinearMap map, IReadOnlyList<double> scalarList, Func<double, Float64Tuple4D, Float64Tuple4D> scalingFunc, Func<Float64Tuple4D, Float64Tuple4D, Float64Tuple4D> reducingFunc)
    //{
    ...
    //public static Float64Tuple4D CombineColumns(this LinFloat64UnilinearMap map, Float64Tuple4D scalingVector, Func<double, Float64Tuple4D, Float64Tuple4D> scalingFunc, Func<Float64Tuple4D, Float64Tuple4D, Float64Tuple4D> reducingFunc)
    //{
        
    //    var vector = Float64Tuple4D.ZeroVector;
    ...
    //[MethodImpl(MethodImplOptions.AggressiveInlining)]
    //public static LinFloat64UnilinearMap CombineColumns(this LinFloat64UnilinearMap map1, LinFloat64UnilinearMap map2, Func<double, Float64Tuple4D, Float64Tuple4D> scalingFunc, Func<Float64Tuple4D, Float64Tuple4D, Float64Tuple4D> reducingFunc)
    //{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector4D MapVector(this double[,] matrix, Float64Quaternion vector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector4D MapVector(this double[,] matrix, IEnumerable<double> vector)
    {
        var composer = new Float64Vector4DComposer();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector4D MapVector(this double[,] matrix, IReadOnlyDictionary<int, double> vector)
    {
        var composer = new Float64Vector4DComposer();
    ...
    //public static Float64Tuple4D MapVector(this LinFloat64UnilinearMap map, IReadOnlyList<double> vector)
    //{
    ...
    //public static Float64Tuple4D MapVector(this LinFloat64UnilinearMap map, IReadOnlyDictionary<int, double> vector)
    //{
    //    var composer = new Float64Tuple4DComposer();
