...
//        var u = LinFloat64Vector.Create(imagVector).InPlaceNormalize();
//        var v = LinFloat64Vector.Create(realVector).InPlaceNormalize();
...
//            //Console.WriteLine($"Real Eigen Vector {i + 1}: {(LinFloat64Vector) realVector}");
//            //Console.WriteLine($"Imag Eigen Vector {i + 1}: {(LinFloat64Vector) imagVector}");
//            //Console.WriteLine();
//        }
...
//    [MethodImpl(MethodImplOptions.AggressiveInlining)]
//    public override LinFloat64Vector MapVectorBasis(int basisIndex)
//    {
//        Debug.Assert(basisIndex >= 0 && basisIndex < Dimensions);

//        return MapVector(
//            LinFloat64Vector.CreateBasis(Dimensions, basisIndex)
//        );
//    }
...
//            return LinFloat64Vector.CreateCopy(vector);
