...
public static class LinFloat64UnilinearMapComposerUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ILinFloat64SimpleVectorToVectorRotation CreateSimpleVectorToVectorRotation(this IReadOnlyDictionary<int, double> sourceVector, LinFloat64Vector targetVector)
        {
