...
namespace GeometricAlgebraFulcrumLib.MathBase.LinearAlgebra.Float64.LinearMaps.SpaceND.Composers
{
        ...
        IReadOnlyList<LinFloat64PlanarRotation>
    {
        ...
        public static LinFloat64PlanarRotationSequence CreateRandom(System.Random random, int dimensions, int count)
        {
        ...
        public static LinFloat64PlanarRotationSequence CreateRandomOrthogonal(System.Random random, int dimensions, int count)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LinFloat64PlanarRotationSequence AppendMap(Float64Vector sourceVector, Float64Vector targetVector)
        {
            _mapList.Add(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LinFloat64PlanarRotationSequence AppendMap(Float64Vector sourceVector, Float64Vector targetVector, Float64PlanarAngle angle)
        {
            _mapList.Add(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LinFloat64PlanarRotationSequence PrependMap(Float64Vector sourceVector, Float64Vector targetVector)
        {
            _mapList.Insert(
                0,
                LinFloat64VectorToVectorRotation.CreateFromRotatedVector(sourceVector, targetVector)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LinFloat64PlanarRotationSequence InsertMap(int index, Float64Vector sourceVector, Float64Vector targetVector)
        {
            _mapList.Insert(
                index,
                LinFloat64VectorToVectorRotation.CreateFromRotatedVector(sourceVector, targetVector)
        ...
        public override Float64Vector MapBasisVector(int basisIndex)
        {
            ...
            var composer = Float64VectorComposer
                .Create()
