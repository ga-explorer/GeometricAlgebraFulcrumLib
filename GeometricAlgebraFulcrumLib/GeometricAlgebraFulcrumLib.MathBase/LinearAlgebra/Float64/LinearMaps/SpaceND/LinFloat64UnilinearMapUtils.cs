...
public static class LinFloat64UnilinearMapUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<KeyValuePair<int, Float64Vector>> GetColumns(this LinFloat64UnilinearMap map)
    {
        return map.GetMappedBasisVectors();
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector GetColumn(this LinFloat64UnilinearMap map, int colIndex)
    {
        return map.MapBasisVector(colIndex);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector GetScaledColumn(this LinFloat64UnilinearMap map, int colIndex, double scalingFactor)
    {
        return map.MapBasisVector(colIndex).Times(scalingFactor);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector GetMappedColumn(this LinFloat64UnilinearMap map, int colIndex, Func<double, double> scalarMapping)
    {
        return map.MapBasisVector(colIndex).MapScalars(scalarMapping);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector GetMappedColumn(this LinFloat64UnilinearMap map, int colIndex, Func<int, double, double> indexScalarMapping)
    {
        return map.MapBasisVector(colIndex).MapScalars(indexScalarMapping);
    }


    public static Float64Vector CombineColumns(this LinFloat64UnilinearMap map, IReadOnlyList<double> scalarList, Func<double, Float64Vector, Float64Vector> scalingFunc, Func<Float64Vector, Float64Vector, Float64Vector> reducingFunc)
    {
        var vector = Float64Vector.ZeroVector;
    ...
    public static Float64Vector CombineColumns(this LinFloat64UnilinearMap map, Float64Vector scalingVector, Func<double, Float64Vector, Float64Vector> scalingFunc, Func<Float64Vector, Float64Vector, Float64Vector> reducingFunc)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LinFloat64UnilinearMap CombineColumns(this LinFloat64UnilinearMap map1, LinFloat64UnilinearMap map2, Func<double, Float64Vector, Float64Vector> scalingFunc, Func<Float64Vector, Float64Vector, Float64Vector> reducingFunc)
    {
        var vectorsDictionary = new Dictionary<int, Float64Vector>();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector MapVector(this double[,] matrix, Float64Vector vector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector MapVector(this double[,] matrix, IEnumerable<double> vector)
    {
        var composer = Float64VectorComposer.Create();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector MapVector(this double[,] matrix, IReadOnlyDictionary<int, double> vector)
    {
        var composer = Float64VectorComposer.Create();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector MapVectorUsing(this IReadOnlyList<double> vector, LinFloat64UnilinearMap map)
    {
        return map.MapVector(vector);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector MapVectorUsing(this IReadOnlyDictionary<int, double> vector, LinFloat64UnilinearMap map)
    {
        return map.MapVector(vector);
    }

    public static Float64Vector MapVector(this LinFloat64UnilinearMap map, IReadOnlyList<double> vector)
    {
        var composer = Float64VectorComposer.Create();
    ...
    public static Float64Vector MapVector(this LinFloat64UnilinearMap map, IReadOnlyDictionary<int, double> vector)
    {
        var composer = Float64VectorComposer.Create();
