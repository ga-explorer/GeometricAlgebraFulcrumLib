...
namespace GeometricAlgebraFulcrumLib.MathBase.LinearAlgebra.Float64
{
        ...
        ILinElement
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal LinFloat64VectorComposer()
        {
        }
        ...
        public LinFloat64VectorComposer SetVector(LinFloat64Vector multivector)
        {
        ...
        public LinFloat64VectorComposer SetVectorNegative(LinFloat64Vector multivector)
        {
            foreach (var (basis, scalar) in multivector.IndexScalarPairs)
                SetTerm(basis, -scalar);
        ...
        public LinFloat64VectorComposer SetVector(LinFloat64Vector multivector, double scalingFactor)
        {
            foreach (var (basis, scalar) in multivector.IndexScalarPairs)
