    ...
    IFloat64Tuple4D
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector4DComposer Create(double x, double y, double z, double w)
    {
        return new Float64Vector4DComposer(x, y, z, w);
    }
        
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector4DComposer Create(IQuad<double> vector)
    {
        return new Float64Vector4DComposer(
            vector.Item1, 
            vector.Item2, 
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal Float64Vector4DComposer()
    {
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal Float64Vector4DComposer(double x, double y, double z, double w)
    {
        X = x;
        Y = y;
        Z = z;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer Clear()
    {
        X = 0;
        Y = 0;
        Z = 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer ClearTerm(int index)
    {
        if (index == 0)
            X = 0;
        else if (index == 1)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer RemoveTerm(int basisBlade)
    {
        this[basisBlade] = 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer SetTerm(int basisBlade, double scalar)
    {
    ...
    public Float64Vector4DComposer SetVector(IQuad<double> vector)
    {
        X = vector.Item1;
        Y = vector.Item2;
        Z = vector.Item3;
    ...
    public Float64Vector4DComposer SetVectorNegative(IQuad<double> vector)
    {
        X = -vector.Item1;
        Y = -vector.Item2;
        Z = -vector.Item3;
    ...
    public Float64Vector4DComposer SetVector(IQuad<double> vector, double scalingFactor)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer AddTerm(int basisBlade, double scalar)
    {
        this[basisBlade] += scalar;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer AddVector(IQuad<double> vector)
    {
        X += vector.Item1;
        Y += vector.Item2;
        Z += vector.Item3;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer AddVector(IQuad<double> vector, double scalingFactor)
    {
        X += scalingFactor * vector.Item1;
        Y += scalingFactor * vector.Item2;
        Z += scalingFactor * vector.Item3;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer SubtractTerm(int basisBlade, double scalar)
    {
        this[basisBlade] -= scalar;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer SubtractVector(IQuad<double> vector)
    {
        X -= vector.Item1;
        Y -= vector.Item2;
        Z -= vector.Item3;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer SubtractVector(IQuad<double> vector, double scalingFactor)
    {
        X -= scalingFactor * vector.Item1;
        Y -= scalingFactor * vector.Item2;
        Z -= scalingFactor * vector.Item3;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer SetTerm(LinSignedBasisVector basisBlade)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer AddTerm(int basisBlade, double scalar1, double scalar2)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer SubtractTerm(int basisBlade, double scalar1, double scalar2)
    {
        this[basisBlade] -= scalar1 * scalar2;
    ...
    public Float64Vector4DComposer MapScalars(Func<double, double> mappingFunction)
    {
        X = mappingFunction(X);
        Y = mappingFunction(Y);
        Z = mappingFunction(Z);
    ...
    public Float64Vector4DComposer MapScalars(Func<int, double, double> mappingFunction)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer Negative()
    {
        X = -X;
        Y = -Y;
        Z = -Z;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer Times(double scalarFactor)
    {
        X = scalarFactor * X;
        Y = scalarFactor * Y;
        Z = scalarFactor * Z;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector4DComposer Divide(double scalarFactor)
    {
