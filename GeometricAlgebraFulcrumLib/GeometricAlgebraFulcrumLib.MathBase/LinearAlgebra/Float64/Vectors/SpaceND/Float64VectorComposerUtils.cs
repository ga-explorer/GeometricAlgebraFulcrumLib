...
.CreateValidLinVectorDictionary(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Vector VectorToLinVector(this IReadOnlyDictionary<IIndexSet, double> mv)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Vector VectorToLinVector(this IReadOnlyDictionary<ulong, double> mv)
        {
            var indexScalarDictionary = mv.ToDictionary(
