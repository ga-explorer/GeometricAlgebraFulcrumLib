...
namespace GeometricAlgebraFulcrumLib.MathBase.PolynomialAlgebra.PhCurves
{
    ...
    public sealed class PhCurve2DDegree5Canonical
    {
        ...
        public Float64Vector2D VectorU { get; }

        public Float64Vector2D Vector00 { get; }

        public Float64Vector2D Vector01 { get; }

        public Float64Vector2D Vector02 { get; }

        public Float64Vector2D Vector11 { get; }

        public Float64Vector2D Vector12 { get; }

        public Float64Vector2D Vector22 { get; }
