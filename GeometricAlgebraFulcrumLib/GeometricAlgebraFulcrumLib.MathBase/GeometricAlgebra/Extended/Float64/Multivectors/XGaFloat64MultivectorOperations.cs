...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Extended.Float64.Multivectors
{
    public abstract partial class XGaFloat64Multivector
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual XGaFloat64Scalar ENormSquared()
        {
            if (IsZero)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual XGaFloat64Scalar NormSquared()
        {
            if (IsZero)
                return Processor.CreateZeroScalar();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual XGaFloat64Scalar ENorm()
        {
            return ENormSquared().Sqrt();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual XGaFloat64Scalar Norm()
        {
            return NormSquared().SqrtOfAbs();
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual XGaFloat64Scalar ESpSquared()
        {
            if (IsZero)
                return Processor.CreateZeroScalar();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual XGaFloat64Scalar SpSquared()
        {
            if (IsZero)
                return Processor.CreateZeroScalar();
