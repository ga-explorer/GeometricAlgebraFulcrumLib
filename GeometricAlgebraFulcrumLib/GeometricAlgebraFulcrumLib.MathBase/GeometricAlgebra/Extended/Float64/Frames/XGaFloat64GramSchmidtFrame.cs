...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Extended.Float64.Frames
{
    ...
    {
        public static XGaFloat64GramSchmidtFrame Create(Float64Tuple3D v1, Float64Tuple3D v2, Float64Tuple3D v3)
        {
            var array = new[,]
            {
                { v1.X, v2.X, v3.X },
            ...
            {
                XGaFloat64Processor.Euclidean.CreateVector(e1),
                XGaFloat64Processor.Euclidean.CreateVector(e2),
                XGaFloat64Processor.Euclidean.CreateVector(e3)
            };

            return new XGaFloat64GramSchmidtFrame(directionNorms, unitDirections);
        }

        public static XGaFloat64GramSchmidtFrame Create(params Float64Tuple[] vArray)
        {
            var n = Math.Max(
                vArray.Length,
            ...
            for (var c = 0; c < n; c++)
            {
                ...
                unitDirections[c] = XGaFloat64Processor.Euclidean.CreateVector(unitDirection);
            }

            return new XGaFloat64GramSchmidtFrame(directionNorms, unitDirections);
        }

        public static XGaFloat64GramSchmidtFrame Create(params Float64SparseTuple[] vArray)
        {
            var n = Math.Max(
                vArray.Length,
                vArray.Max(v => v.Count)
