...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Extended.Float64.LinearMaps.Rotors
{
        ...
        : XGaFloat64ScaledRotorBase
    {
        ...
        /// <returns></returns>
        public static XGaFloat64ScaledRotor CreateEuclideanScaledPureRotor(double rotationAngle, XGaFloat64KVector rotationBlade)
        {
        ...
        /// <param name="rotationAngle"></param>
        /// <returns></returns>
        public static XGaFloat64ScaledRotor CreateScaledGivensRotor(XGaFloat64Processor metric, int i, int j, double rotationAngle)
        {
