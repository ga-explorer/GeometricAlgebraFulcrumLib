...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Extended.Basis
{
        ...
        IXGaSignedBasisBlade
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal XGaSignedBasisBlade(XGaBasisBlade basisBlade, IntegerSign sign)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal XGaSignedBasisBlade(XGaMetric metric, IIndexSet basisBladeId, IntegerSign sign)
        {
