...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Extended.Generic.Multivectors
{
    public static class XGaMultivectorUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Tuple2D GetVectorPartAsTuple2D(this XGaMultivector<double> mv)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Tuple3D GetVectorPartAsTuple3D(this XGaMultivector<double> mv)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Tuple4D GetVectorPartAsTuple4D(this XGaMultivector<double> mv)
        {
