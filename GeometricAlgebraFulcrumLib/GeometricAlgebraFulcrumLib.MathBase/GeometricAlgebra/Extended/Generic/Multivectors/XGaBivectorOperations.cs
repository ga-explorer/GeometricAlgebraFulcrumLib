...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Extended.Generic.Multivectors
{
    public sealed partial class XGaBivector<T>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaBivector<T> MapScalars(Func<IIndexSet, T, T> scalarMapping)
        {
            if (IsZero) return this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaFloat64Bivector MapScalars(XGaFloat64Processor processor, Func<IIndexSet, T, double> scalarMapping)
        {
            if (IsZero) 
                return processor.CreateZeroBivector();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaBivector<T1> MapScalars<T1>(XGaProcessor<T1> processor, Func<IIndexSet, T, T1> scalarMapping)
        {
            if (IsZero) 
                return processor.CreateZeroBivector();
