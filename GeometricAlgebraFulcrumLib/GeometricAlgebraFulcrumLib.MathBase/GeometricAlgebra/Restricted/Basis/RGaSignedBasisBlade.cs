...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Restricted.Basis
{
        ...
        IRGaSignedBasisBlade
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal RGaSignedBasisBlade(RGaBasisBlade basisBlade, IntegerSign sign)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal RGaSignedBasisBlade(RGaMetric metric, ulong basisBladeId, IntegerSign sign)
        {
