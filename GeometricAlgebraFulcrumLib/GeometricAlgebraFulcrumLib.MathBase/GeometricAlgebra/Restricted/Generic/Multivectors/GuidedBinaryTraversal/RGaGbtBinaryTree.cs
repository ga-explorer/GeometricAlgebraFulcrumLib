...
public sealed class RGaGbtBinaryTree<T>
{
    ...
    private RGaGbtBinaryTree(int treeDepth, List<Pair<int>> internalNodesList, IReadOnlyList<ulong> leafNodeIDsList, T[] leafNodeScalarsArray)
    {
        TreeDepth = treeDepth;
    ...
    internal RGaGbtBinaryTree(int treeDepth, IReadOnlyList<ulong> leafNodeIDsList)
    {
        if (treeDepth < 1)
    ...
    internal RGaGbtBinaryTree(int treeDepth, IReadOnlyDictionary<ulong, T> leafNodes)
    {
        if (treeDepth < 1)
            throw new ArgumentOutOfRangeException(nameof(treeDepth));
    ...
    internal RGaGbtBinaryTree(int treeDepth, IReadOnlyList<ulong> leafNodeIDsList, IReadOnlyCollection<T> leafNodeScalarsList)
    {
        if (treeDepth < 1)
            throw new ArgumentOutOfRangeException(nameof(treeDepth));
    ...
    internal RGaGbtBinaryTree(int treeDepth, RGaGbtBinaryTree<T> binaryTree)
    {
    ...
    internal RGaGbtBinaryTree(RGaGbtBinaryTree<T> binaryTree)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaGbtBinaryTree<T> ClearScalars()
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaGbtBinaryTree<T> SetLeafNodeScalarByIndex(int index, T value)
    {
        _leafNodeScalarsArray[index] = value;
    ...
    public RGaGbtBinaryTree<T> UpdateScalarsById(Func<ulong, T> mappingFunc)
    {
    ...
    public RGaGbtBinaryTree<T> UpdateScalarsByIdScalar(Func<ulong, T, T> mappingFunc)
    {
        for (var i = 0; i < _leafNodeScalarsArray.Length; i++)
        {
            var id = _leafNodeIDsList[i];
    ...
    public RGaGbtBinaryTree<T> UpdateScalarsByIndex(Func<int, T> mappingFunc)
    {
        for (var i = 0; i < _leafNodeScalarsArray.Length; i++)
    ...
    public RGaGbtBinaryTree<T> UpdateScalarsByIndexScalar(Func<int, T, T> mappingFunc)
    {
        for (var i = 0; i < _leafNodeScalarsArray.Length; i++)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaGbtBinaryTree<T> UpdateScalars(Func<T, T> mappingFunc)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaGbtBinaryTree<T> GetCopy()
    {
        return GetTreeCopy();
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaGbtBinaryTree<T> GetPermutation(Func<ulong, ulong> indexMapping)
    {
        return new RGaGbtBinaryTree<T>(
            TreeDepth,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaGbtBinaryTree<T2> MapScalars<T2>(Func<T, T2> valueMapping)
    {
        return new RGaGbtBinaryTree<T2>(
            TreeDepth,
            _internalNodesList,
            _leafNodeIDsList,
    ...
    public RGaGbtBinaryTree<T2> MapScalars<T2>(Func<ulong, T, T2> indexScalarMapping)
    {
    ...
    public RGaGbtBinaryTree<T> FilterByIndex(Func<ulong, bool> indexFilter)
    {
    ...
    public RGaGbtBinaryTree<T> FilterByIndexScalar(Func<ulong, T, bool> indexScalarFilter)
    {
        var leafNodeIDsList = new List<ulong>();
        var leafNodeScalarsList = new List<T>();
    ...
    public RGaGbtBinaryTree<T> FilterByScalar(Func<T, bool> valueFilter)
    {
        var leafNodeIDsList = new List<ulong>();
        var leafNodeScalarsList = new List<T>();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaGbtBinaryTree<T> GetTreeCopy()
    {
        return new RGaGbtBinaryTree<T>(
            TreeDepth,
            _internalNodesList,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaGbtBinaryTree<T> GetTreeCopy(T[] leafNodeScalarsArray)
    {
