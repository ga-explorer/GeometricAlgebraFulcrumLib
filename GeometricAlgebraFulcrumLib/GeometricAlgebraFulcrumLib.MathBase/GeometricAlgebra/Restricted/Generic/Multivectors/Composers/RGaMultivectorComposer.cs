...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Restricted.Generic.Multivectors.Composers
{
        ...
        IRGaElement<T>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RGaScalar<T> ENormSquared()
        {
            var scalarList =
                _idScalarDictionary
                    .Values
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RGaScalar<T> ENorm()
        {
            return ENormSquared().Sqrt();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RGaScalar<T> NormSquared()
        {
            var scalarList =
                _idScalarDictionary
                    .Select(p =>
        ...
        public RGaKVector<T> GetKVector(int grade)
        {
            ...
            return Processor.CreateKVector(grade, _idScalarDictionary);
        }
