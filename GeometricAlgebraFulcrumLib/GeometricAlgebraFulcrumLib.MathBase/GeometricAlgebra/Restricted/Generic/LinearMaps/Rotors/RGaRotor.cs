...
namespace GeometricAlgebraFulcrumLib.MathBase.GeometricAlgebra.Restricted.Generic.LinearMaps.Rotors
{
        ...
        : RGaRotorBase<T>
    {
        ...
        /// <returns></returns>
        public static RGaRotor<T> CreateEuclideanPureRotor(T rotationAngle, RGaKVector<T> rotationBlade)
        {
        ...
        /// <param name="rotationAngle"></param>
        /// <returns></returns>
        public static RGaRotor<T> CreateGivensRotor(RGaProcessor<T> processor, int i, int j, T rotationAngle)
        {
