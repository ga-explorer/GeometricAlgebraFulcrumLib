...
using GeometricAlgebraFulcrumLib.MathBase.BasicShapes.Lines.Mutable;
...
namespace GeometricAlgebraFulcrumLib.MathBase.BasicShapes.Lines
{
    public static class LinesUtils
    {
        ...
        {
            return EuclideanFloat64TupleUtils.ToUnitVector(line.DirectionX, line.DirectionY);
        }
        ...
        {
            return EuclideanFloat64TupleUtils.ToUnitVector(
                line.DirectionX,
                line.DirectionY,
                line.DirectionZ
            );
