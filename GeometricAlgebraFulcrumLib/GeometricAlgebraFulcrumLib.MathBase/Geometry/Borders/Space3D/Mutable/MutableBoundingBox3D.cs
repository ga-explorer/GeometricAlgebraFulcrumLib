...
namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.Borders.Space3D.Mutable
{
    /// <summary>
    ...
    public sealed class MutableBoundingBox3D : IBoundingBox3D
    {
        ...
        {
            var oldSide001 = Float64Vector3D.Create(MaxX - MinX, 0, 0);
            var oldSide010 = Float64Vector3D.Create(0, MaxY - MinY, 0);
            var oldSide100 = Float64Vector3D.Create(0, 0, MaxZ - MinZ);
