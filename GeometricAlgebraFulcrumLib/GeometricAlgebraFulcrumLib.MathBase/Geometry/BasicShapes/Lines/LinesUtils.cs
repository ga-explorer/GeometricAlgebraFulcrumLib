...
using GeometricAlgebraFulcrumLib.MathBase.Geometry.BasicShapes.Lines.Mutable;
...
namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.BasicShapes.Lines
{
    public static class LinesUtils
    {
        ...
        #region Lines in 3D
        public static Float64Vector3D GetOrigin(this ILine3D line)
        {
            return Float64Vector3D.Create(line.OriginX,
                line.OriginY,
                line.OriginZ);
        }

        public static Float64Vector3D GetDirection(this ILine3D line)
        {
            return Float64Vector3D.Create(line.DirectionX,
                line.DirectionY,
                line.DirectionZ);
        }

        public static Float64Vector3D GetDirectionInv(this ILine3D line)
        {
            return Float64Vector3D.Create(1 / line.DirectionX,
                1 / line.DirectionY,
                1 / line.DirectionZ);
        }
        ...
        public static Tuple<double, Float64Vector3D> ToLengthAndUnitDirection(this ILine3D line)
        {
            var length = Math.Sqrt(
                line.DirectionX * line.DirectionX +
                line.DirectionY * line.DirectionY +
            ...
            return Tuple.Create(
                length,
                Float64Vector3D.Create(line.DirectionX * lengthInv,
                    line.DirectionY * lengthInv,
        ...
        public static Float64Vector3D GetPointAt(this ILine3D line, double t)
        {
            return Float64Vector3D.Create(line.OriginX + t * line.DirectionX,
                line.OriginY + t * line.DirectionY,
                line.OriginZ + t * line.DirectionZ);
        }

        public static IEnumerable<Float64Vector3D> GetPointsAt(this ILine3D line, IEnumerable<double> tList)
        {
            return tList.Select(line.GetPointAt);
        }

        public static Float64Vector2D GetPointAtDistance(this ILine2D line, double distance)
        {
        ...
        public static IEnumerable<Float64Vector3D> GetPointsAtDistances(this ILine3D line, IEnumerable<double> distancesList)
        {
        ...
        public static Float64Vector2D GetPointAt(this ILineSegment2D lineSegment, double t)
        {
        ...
        public static Triangle2D ToTriangle(this ILineSegment2D lineSegment, Float64Vector2D point3)
        {
            return new Triangle2D(
                lineSegment.Point1X,
                lineSegment.Point1Y,
        ...
        public static Float64Vector3D GetPoint1(this ILineSegment3D lineSegment)
        {
            return Float64Vector3D.Create(lineSegment.Point1X,
                lineSegment.Point1Y,
                lineSegment.Point1Z);
        }

        public static Float64Vector3D GetPoint2(this ILineSegment3D lineSegment)
        {
            return Float64Vector3D.Create(lineSegment.Point2X,
                lineSegment.Point2Y,
                lineSegment.Point2Z);
        }

        public static Float64Vector3D[] GetEndPoints(this ILineSegment3D lineSegment)
        {
            return new[]
            {
                Float64Vector3D.Create(lineSegment.Point1X,
                    lineSegment.Point1Y,
                    lineSegment.Point1Z),
                Float64Vector3D.Create(lineSegment.Point2X,
                    lineSegment.Point2Y,
                    lineSegment.Point2Z)
            };
        }

        public static IEnumerable<Float64Vector3D> GetEndpoints(this IEnumerable<ILineSegment3D> lineSegmentsList)
        {
            return lineSegmentsList
                .SelectMany(s => s.GetEndPoints());
        }

        public static Float64Vector3D GetPointAt(this ILineSegment3D lineSegment, double t)
        {
            Debug.Assert(!double.IsNaN(t));

            var s = 1.0d - t;

            return Float64Vector3D.Create(s * lineSegment.Point1X + t * lineSegment.Point2X,
                s * lineSegment.Point1Y + t * lineSegment.Point2Y,
                s * lineSegment.Point1Z + t * lineSegment.Point2Z);
        }

        public static IEnumerable<Float64Vector3D> GetPointsAt(this ILineSegment3D lineSegment, IEnumerable<double> tList)
        {
            return tList.Select(lineSegment.GetPointAt);
        }

        public static Float64Vector3D GetDirection12(this ILineSegment3D lineSegment)
        {
            return Float64Vector3D.Create(lineSegment.Point2X - lineSegment.Point1X,
                lineSegment.Point2Y - lineSegment.Point1Y,
                lineSegment.Point2Z - lineSegment.Point1Z);
        }

        public static Float64Vector3D GetDirection21(this ILineSegment3D lineSegment)
        {
            return Float64Vector3D.Create(lineSegment.Point1X - lineSegment.Point2X,
                lineSegment.Point1Y - lineSegment.Point2Y,
        ...
        public static Triangle3D ToTriangle(this ILineSegment3D lineSegment, Float64Vector3D point3)
        {
            return new Triangle3D(
                lineSegment.Point1X,
                lineSegment.Point1Y,
        ...
        public static LineSegment2D GetLineSegment(this IBeam2D beam, Float64Vector2D tPoint1, Float64Vector2D tPoint2)
        {
        ...
        public static Line2D GetRay(this IBeam2D beam, Float64Vector2D tPoint1, Float64Vector2D tPoint2)
        {
            var point1 = beam.GetPoint(tPoint1.X, tPoint1.Y);
            var point2 = beam.GetPoint(tPoint2.X, tPoint2.Y);
        ...
        public static Triangle2D GetTriangle(this IBeam2D beam, Float64Vector2D tPoint1, Float64Vector2D tPoint2, Float64Vector2D tPoint3)
        {
            var point1 = beam.GetPoint(tPoint1.X, tPoint1.Y);
            var point2 = beam.GetPoint(tPoint2.X, tPoint2.Y);
        ...
        public static Float64Vector3D GetOrigin1(this ILinePair3D linePair)
        {
            return Float64Vector3D.Create(linePair.Origin1X,
                linePair.Origin1Y,
                linePair.Origin1Z);
        }

        public static Float64Vector3D GetOrigin2(this ILinePair3D linePair)
        {
            return Float64Vector3D.Create(linePair.Origin2X,
                linePair.Origin2Y,
                linePair.Origin2Z);
        }

        public static Float64Vector3D GetDirection1(this ILinePair3D linePair)
        {
            return Float64Vector3D.Create(linePair.Direction1X,
                linePair.Direction1Y,
                linePair.Direction1Z);
        }

        public static Float64Vector3D GetDirection2(this ILinePair3D linePair)
        {
            return Float64Vector3D.Create(linePair.Direction2X,
                linePair.Direction2Y,
