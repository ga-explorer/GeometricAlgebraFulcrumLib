...
namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.BasicShapes.Triangles.Mutable
{
    public sealed class MutableTriangle2D : ITriangle2D
    {
        public static MutableTriangle2D Create(IFloat64Vector2D point1, IFloat64Vector2D point2, IFloat64Vector2D point3)
        {
        ...
        public MutableTriangle2D SetPoint1(IFloat64Vector2D point)
        {
            Point1X = point.X;
            Point1Y = point.Y;
        ...
        public MutableTriangle2D SetPoint2(IFloat64Vector2D point)
        {
            Point2X = point.X;
            Point2Y = point.Y;
        ...
        public MutableTriangle2D SetPoint3(IFloat64Vector2D point)
        {
            Point3X = point.X;
            Point3Y = point.Y;
        ...
        public MutableTriangle2D SetTriangle(IFloat64Vector2D point1, IFloat64Vector2D point2, IFloat64Vector2D point3)
        {
            Point1X = point1.X;
            Point1Y = point1.Y;
