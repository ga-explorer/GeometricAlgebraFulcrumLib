...
namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.Differential.Functions.Phasors
{
        ...
        DifferentialCustomFunction
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfCosPhasor Create(double magnitude, double frequency, Float64PlanarAngle phase)
        {
            return new DfCosPhasor(
                magnitude,
                frequency,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private DfCosPhasor(double magnitude, double frequency, Float64PlanarAngle phase)
            : base(false)
        {
            Debug.Assert(
