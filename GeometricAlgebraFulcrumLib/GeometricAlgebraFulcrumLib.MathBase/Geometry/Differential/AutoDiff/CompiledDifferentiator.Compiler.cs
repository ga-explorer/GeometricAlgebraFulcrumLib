using TapeElement = GeometricAlgebraFulcrumLib.MathBase.Geometry.Differential.AutoDiff.Compiled.TapeElement;
using InputEdge = GeometricAlgebraFulcrumLib.MathBase.Geometry.Differential.AutoDiff.Compiled.InputEdge;
using InputEdges = GeometricAlgebraFulcrumLib.MathBase.Geometry.Differential.AutoDiff.Compiled.InputEdges;

namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.Differential.AutoDiff
{
