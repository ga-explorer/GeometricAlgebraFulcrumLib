namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.Differential.AutoDiff.Compiled
{
    internal sealed class TermPower : TapeElement
    {
        ...
        private TapeElement Base
            => Inputs.Element(BaseIdx);

        private TapeElement Exponent
            => Inputs.Element(ExpIdx);
