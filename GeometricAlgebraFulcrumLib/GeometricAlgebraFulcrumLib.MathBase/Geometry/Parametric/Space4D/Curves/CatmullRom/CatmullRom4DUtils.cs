...
namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.Parametric.Space4D.Curves.CatmullRom;
...
public static class CatmullRom4DUtils
{
    ...
    public static Float64Vector4D GetCatmullRomValue(this double t, Quad<double> tQuad, Quad<IFloat64Tuple4D> pQuad)
    {
    ...
    public static Float64Vector4D GetCatmullRomDerivativeValue(this double t, Quad<double> tQuad, Quad<IFloat64Tuple4D> pQuad)
    {
        var (t0, t1, t2, t3) = tQuad;
        var (p0, p1, p2, p3) =
            pQuad.MapItems(p => p.ToTuple4D());
    ...
    public static Float64Vector4D GetCatmullRomDerivative2Value(this double t, Quad<double> tQuad, Quad<IFloat64Tuple4D> pQuad)
    {
        var (t0, t1, t2, t3) = tQuad;
        var (p0, p1, p2, p3) =
            pQuad.MapItems(p => p.ToTuple4D());
