...
namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.Parametric.SpaceND.Curves.CatmullRom;

public static class CatmullRomNDUtils
{
    ...
    public static Float64Vector GetCatmullRomValue(this double t, Quad<double> tQuad, Quad<Float64Vector> pQuad)
    {
    ...
    public static Float64Vector GetCatmullRomDerivativeValue(this double t, Quad<double> tQuad, Quad<Float64Vector> pQuad)
    {
        var (t0, t1, t2, t3) = tQuad;
        var (p0, p1, p2, p3) = pQuad;
    ...
    public static Float64Vector GetCatmullRomDerivative2Value(this double t, Quad<double> tQuad, Quad<Float64Vector> pQuad)
    {
        var (t0, t1, t2, t3) = tQuad;
        var (p0, p1, p2, p3) = pQuad;
