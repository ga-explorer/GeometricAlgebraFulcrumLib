...
namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.Parametric.Space3D.Surfaces.Sampled
{
    public sealed record GrParametricSurfaceTreeSample3D
    {
        ...
        public Float64Vector3D GetNormal()
        {
            var t10 = 1d - InterpolationValue1;
            var t11 = InterpolationValue1;
            ...
            return s00 * LeafNode.Frame00.Normal.ToVector3D() +
                   s01 * LeafNode.Frame01.Normal.ToVector3D() +
                   s10 * LeafNode.Frame10.Normal.ToVector3D() +
                   s11 * LeafNode.Frame11.Normal.ToVector3D();
        }
        ...
        public GrParametricSurfaceLocalFrame3D GetFrame()
        {
            ...
            var normal = 
                s00 * LeafNode.Frame00.Normal.ToVector3D() +
                s01 * LeafNode.Frame01.Normal.ToVector3D() +
                s10 * LeafNode.Frame10.Normal.ToVector3D() +
                s11 * LeafNode.Frame11.Normal.ToVector3D();
