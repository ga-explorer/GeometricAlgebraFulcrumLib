...
namespace GeometricAlgebraFulcrumLib.MathBase.Geometry.Parametric.Space3D.Curves
{
    public static class ParametricCurve3DComposerUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ParametricCircle3D CreateCircle3D(this IFloat64Tuple3D unitNormal, double radius, int rotationCount = 1)
        {
            return new ParametricCircle3D(Float64Vector3D.Zero, unitNormal, radius, rotationCount);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ParametricCircle3D CreateCircle3D(this IFloat64Tuple3D unitNormal, IFloat64Tuple3D center, double radius, int rotationCount = 1)
        {
