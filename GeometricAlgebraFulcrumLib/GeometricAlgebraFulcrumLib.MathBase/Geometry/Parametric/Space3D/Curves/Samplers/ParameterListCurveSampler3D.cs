    ...
    IParametricCurveSampler3D
{
    ...
    public ParameterListCurveSampler3D(IParametricCurve3D curve, ImmutableSortedSet<double> parameterValueSet, bool isPeriodic = false)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ParameterListCurveSampler3D SetCurve(IParametricCurve3D curve, ImmutableSortedSet<double> parameterValueSet, bool isPeriodic)
    {
        IsPeriodic = isPeriodic;
        Curve = curve;
        ParameterValueSet = parameterValueSet;
