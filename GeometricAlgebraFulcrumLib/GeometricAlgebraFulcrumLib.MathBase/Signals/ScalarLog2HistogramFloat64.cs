...
{
    public sealed class ScalarLog2HistogramFloat64
    {
        ...
        public static ScalarLog2HistogramFloat64 Create(IEnumerable<double> dataValueList)
        {
            var histSum = 0d;
            ...
            return new ScalarLog2HistogramFloat64(histogramData);
        }
        ...
        private ScalarLog2HistogramFloat64(ImmutableSortedDictionary<int, double> histogramData)
        {
        ...
        public ScalarLog2HistogramFloat64 Trim(double trimPercentage)
        {
