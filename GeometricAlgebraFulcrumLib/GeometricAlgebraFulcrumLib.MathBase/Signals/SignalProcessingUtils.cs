...
namespace GeometricAlgebraFulcrumLib.MathBase.Signals
{
    ...
    {
        public static ScalarSignalFloat64 GetPeriodicPaddedSignal_NoInterpolator(this ScalarSignalFloat64 signal, int trendSampleCount, int paddingSampleCount = -1)
        {
        ...
        public static ScalarSignalFloat64 GetPeriodicPaddedSignal_CatmullRom(this ScalarSignalFloat64 signal, int trendSampleCount, int paddingSampleCount = -1)
        {
            if (paddingSampleCount < 0)
                paddingSampleCount = signal.Count;
        ...
        public static ScalarSignalFloat64 GetPeriodicPaddedSignal(this ScalarSignalFloat64 signal, int trendSampleCount, int paddingSampleCount = -1, bool useCatmullRomInterpolator = true)
        {
        ...
        public static ScalarSignalSpectrumComplex GetFourierSpectrum(this ScalarSignalFloat64 signal, DfFourierSignalInterpolatorOptions options)
        {
            ...
            var vectorSpectrumFull =
                (ScalarSignalSpectrumComplex)signal
                    .GetFourierSpectrum()
            ...
            var energySpectrumFull =
                (ScalarSignalSpectrumFloat64)signal
                    .GetEnergySpectrum()
                    .RemoveHighFrequencySamples(options.FrequencyThreshold);
            ...
            var vectorSpectrum =
                new ScalarSignalSpectrumComplex(samplingSpecs)
                {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfChebyshevSignalInterpolator CreateChebyshevInterpolator(this ScalarSignalFloat64 signal, DfChebyshevSignalInterpolatorOptions options)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfAkimaSplineInterpolator CreateSmoothedAkimaSplineFunction(this ScalarSignalFloat64 signal, int bezierDegree)
        {
            var reSampledSignal =
        ...
        public static void PlotSignal(this ScalarSignalFloat64 scalarSignal, double tMin, double tMax, string plotFileName)
        {
        ...
        public static void PlotScalarSignal(this ScalarSignalFloat64 scalarSignal, string title, string filePath)
        {
            ...
            var plotWidth = 
                (scalarSignal.Count * 2).Clamp(1920, 7680);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IReadOnlyList<Complex> GetValue(this IReadOnlyList<ScalarSignalSpectrumComplex> vectorSpectrum, IReadOnlyList<SignalSpectrum<Complex>.SignalSpectrumSample> vectorSpectrumSample, double t)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IReadOnlyList<ScalarSignalFloat64> GetRealSignal(this IReadOnlyList<ScalarSignalSpectrumComplex> vectorSpectrum, IReadOnlyList<SignalSpectrum<Complex>.SignalSpectrumSample> vectorSpectrumSample, IEnumerable<double> tValues)
        {
            return vectorSpectrum
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IReadOnlyList<SignalSpectrum<Complex>.SignalSpectrumSample> GetSample(this IReadOnlyList<ScalarSignalSpectrumComplex> vectorSpectrum, int index)
        {
            return vectorSpectrum
        ...
        public static IReadOnlyList<ScalarSignalSpectrumComplex> Add(this IReadOnlyList<ScalarSignalSpectrumComplex> vectorSpectrum, IEnumerable<SignalSpectrum<Complex>.SignalSpectrumSample> vectorSpectrumSample)
        {
            var i = 0;
        ...
        public static Image PlotValue(this DifferentialFunction scalarFunction, ScalarSignalFloat64 scalarSignal, double xMin, double xMax)
        {
            return ((Func<double, double>)scalarFunction.GetValue).Plot(scalarSignal, xMin, xMax);
        }

        public static Image PlotFirstDerivative(this DifferentialFunction scalarFunction, ScalarSignalFloat64 scalarSignal, double xMin, double xMax)
        {
        ...
        public static Image PlotSecondDerivative(this DifferentialFunction scalarFunction, ScalarSignalFloat64 scalarSignal, double xMin, double xMax)
        {
        ...
        public static Image PlotValue(this DifferentialFunction scalarFunction, ScalarSignalFloat64 scalarSignal, double xMin, double xMax, double yMin, double yMax)
        {
        ...
        public static Image PlotFirstDerivative(this DifferentialFunction scalarFunction, ScalarSignalFloat64 scalarSignal, double xMin, double xMax, double yMin, double yMax)
        {
            var func = scalarFunction.GetDerivative1().GetValue;
        ...
        public static Image PlotSecondDerivative(this DifferentialFunction scalarFunction, ScalarSignalFloat64 scalarSignal, double xMin, double xMax, double yMin, double yMax)
        {
            var func = scalarFunction.GetDerivative2().GetValue;
