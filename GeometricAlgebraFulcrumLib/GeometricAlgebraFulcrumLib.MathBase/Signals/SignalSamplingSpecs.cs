...
{
    public sealed record SignalSamplingSpecs
    {
        ...
        public SignalSamplingSpecs(int sampleCount, double samplingRate)
        {
            if (sampleCount < 1)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ScalarSignalFloat64 GetSampledFunctionSignal(Func<double, double> func)
        {
            return 0d
                .GetLinearRange((SampleCount - 1) / SamplingRate, SampleCount)
                .Select(func)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ScalarSignalFloat64 GetSampledFunctionSignal(Func<double, double> func, int sampleCount)
        {
            if (sampleCount < 1)
                throw new ArgumentOutOfRangeException(nameof(sampleCount));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ScalarSignalFloat64 GetSampledFunctionSignal(Func<double, double> func, int firstSampleIndex, int sampleCount)
        {
            if (sampleCount < 1)
                throw new ArgumentOutOfRangeException(nameof(sampleCount));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ScalarSignalFloat64 GetSampledFunctionSignal(DifferentialFunction func)
        {
            return 0d
                .GetLinearRange((SampleCount - 1) / SamplingRate, SampleCount)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ScalarSignalFloat64 GetSampledFunctionSignal(DifferentialFunction func, int sampleCount)
        {
            if (sampleCount < 1)
                throw new ArgumentOutOfRangeException(nameof(sampleCount));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ScalarSignalFloat64 GetSampledFunctionSignal(DifferentialFunction func, int firstSampleIndex, int sampleCount)
        {
            if (sampleCount < 1)
                throw new ArgumentOutOfRangeException(nameof(sampleCount));
