...
namespace GeometricAlgebraFulcrumLib.MathBase.Borders.Space1D.Immutable
{
    public readonly struct BoundingBox1D : IBoundingBox1D
    {
        ...
        public BoundingBox1D(double minValue, double maxValue)
        {
            MinValue = minValue;
            MaxValue = maxValue;
        ...
        public BoundingBox1D(IBoundingBox1D boundingBox)
        {
            MinValue = boundingBox.MinValue;
            MaxValue = boundingBox.MaxValue;
