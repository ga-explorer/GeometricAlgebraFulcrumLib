...
namespace GeometricAlgebraFulcrumLib.MathBase.SignalAlgebra
{
    public class XGaVectorPolynomialInterpolator
    {
        ...
        internal static XGaVectorPolynomialInterpolator Create(XGaVector<ScalarSignalFloat64> scalarSamples)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private XGaVectorPolynomialInterpolator(XGaVector<ScalarSignalFloat64> scalarSamples)
        {
