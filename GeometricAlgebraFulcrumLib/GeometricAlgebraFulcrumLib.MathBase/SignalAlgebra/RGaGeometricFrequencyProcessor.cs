...
public abstract class RGaGeometricFrequencyProcessor
{
    ...
    public RGaProcessor<ScalarSignalFloat64> ScalarSignalProcessor 
    ...
    public RGaVector<ScalarSignalFloat64> VectorSignal { get; protected set;}

    public RGaVector<ScalarSignalFloat64> VectorSignalInterpolated { get; protected set;}

    public IReadOnlyList<RGaVector<ScalarSignalFloat64>> VectorSignalTimeDerivatives { get; protected set; }

    public IReadOnlyList<RGaVector<ScalarSignalFloat64>> VectorSignalArcLengthDerivatives { get; protected set; }
        
    public IReadOnlyList<ScalarSignalFloat64> ArcLengthTimeDerivatives { get; protected set; }

    public IReadOnlyList<RGaVector<ScalarSignalFloat64>> ArcLengthFramesOrthogonal { get; protected set; }

    public IReadOnlyList<RGaVector<ScalarSignalFloat64>> ArcLengthFramesOrthonormal { get; protected set; }

    public IReadOnlyList<RGaVector<ScalarSignalFloat64>> ArcLengthFramesOrthonormalDerivatives { get; protected set; }

    public IReadOnlyList<ScalarSignalFloat64> Curvatures { get; protected set; }

    public IReadOnlyList<RGaBivector<ScalarSignalFloat64>> AngularVelocityBlades { get; protected set; }
    
    public IReadOnlyList<RGaBivector<ScalarSignalFloat64>> AngularVelocityAverageBlades { get; protected set; }
    ...
    protected void ComputeVectorSignalArcLengthDerivatives()
    {
        ...
        var vDs = new RGaVector<ScalarSignalFloat64>[VSpaceDimensions];
    ...
    protected void ComputeArcLengthFrames()
    {
        ...
        var framesOrthogonal = new RGaVector<ScalarSignalFloat64>[VSpaceDimensions];
        var framesOrthonormal = new RGaVector<ScalarSignalFloat64>[VSpaceDimensions];
    ...
    protected void ComputeCurvatures()
    {
        ...
        var avBladeArray = new RGaBivector<ScalarSignalFloat64>[k];
        var avBladeAvgArray = new RGaBivector<ScalarSignalFloat64>[k];
