...
namespace GeometricAlgebraFulcrumLib.MathBase.SignalAlgebra
{
    public abstract class XGaGeometricFrequencyProcessor
    {
        ...
        public XGaProcessor<ScalarSignalFloat64> ScalarSignalProcessor 
        ...
        public XGaVector<ScalarSignalFloat64> VectorSignal { get; protected set;}

        public XGaVector<ScalarSignalFloat64> VectorSignalInterpolated { get; protected set;}

        public IReadOnlyList<XGaVector<ScalarSignalFloat64>> VectorSignalTimeDerivatives { get; protected set; }

        public IReadOnlyList<XGaVector<ScalarSignalFloat64>> VectorSignalArcLengthDerivatives { get; protected set; }
        
        public IReadOnlyList<ScalarSignalFloat64> ArcLengthTimeDerivatives { get; protected set; }

        public IReadOnlyList<XGaVector<ScalarSignalFloat64>> ArcLengthFramesOrthogonal { get; protected set; }

        public IReadOnlyList<XGaVector<ScalarSignalFloat64>> ArcLengthFramesOrthonormal { get; protected set; }

        public IReadOnlyList<XGaVector<ScalarSignalFloat64>> ArcLengthFramesOrthonormalDerivatives { get; protected set; }

        public IReadOnlyList<ScalarSignalFloat64> Curvatures { get; protected set; }

        public IReadOnlyList<XGaBivector<ScalarSignalFloat64>> AngularVelocityBlades { get; protected set; }
    
        public IReadOnlyList<XGaBivector<ScalarSignalFloat64>> AngularVelocityAverageBlades { get; protected set; }

        //public XGaBivector<ScalarSignalFloat64> DarbouxBivectors { get; protected set; }
        ...
        {
            var sDt = new ScalarSignalFloat64[VSpaceDimensions];
        ...
        protected void ComputeVectorSignalArcLengthDerivatives()
        {
            ...
            var vDs = new XGaVector<ScalarSignalFloat64>[VSpaceDimensions];
        ...
        protected void ComputeArcLengthFrames()
        {
            ...
            var framesOrthogonal = new XGaVector<ScalarSignalFloat64>[VSpaceDimensions];
            var framesOrthonormal = new XGaVector<ScalarSignalFloat64>[VSpaceDimensions];
        ...
        protected void ComputeCurvatures()
        {
            ...
            var curvatureArray = new ScalarSignalFloat64[VSpaceDimensions - 1];
            ...
            var avBladeArray = new XGaBivector<ScalarSignalFloat64>[k];
            var avBladeAvgArray = new XGaBivector<ScalarSignalFloat64>[k];
