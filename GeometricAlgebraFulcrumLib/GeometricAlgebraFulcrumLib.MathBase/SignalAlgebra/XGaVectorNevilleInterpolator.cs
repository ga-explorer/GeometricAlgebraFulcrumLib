...
namespace GeometricAlgebraFulcrumLib.MathBase.SignalAlgebra
{
    public class XGaVectorNevilleInterpolator
    {
        ...
        private IEnumerable<NevillePolynomialInterpolation> GetInterpolatorList(XGaVector<ScalarSignalFloat64> samples, int sampleCount, double t)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaFloat64Vector GetVector(XGaVector<ScalarSignalFloat64> samples, int sampleCount, double t)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaFloat64Vector GetVectorDt1(XGaVector<ScalarSignalFloat64> samples, int sampleCount, double t)
        {
            var signalTime = (sampleCount - 1) / SamplingRate;
            if (t < 0 || t > signalTime)
                return SampleProcessor.CreateZeroVector();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaFloat64Vector GetVectorDt2(XGaVector<ScalarSignalFloat64> samples, int sampleCount, double t)
        {
            var signalTime = (sampleCount - 1) / SamplingRate;
            if (t < 0 || t > signalTime)
                return SampleProcessor.CreateZeroVector();
        ...
        public XGaVector<ScalarSignalFloat64> GetVectorsDt1(XGaVector<ScalarSignalFloat64> samples, int sampleCount)
        {
        ...
        public XGaVector<ScalarSignalFloat64> GetVectorsDt2(XGaVector<ScalarSignalFloat64> samples, int sampleCount)
        {
            var processor = samples.Processor;
