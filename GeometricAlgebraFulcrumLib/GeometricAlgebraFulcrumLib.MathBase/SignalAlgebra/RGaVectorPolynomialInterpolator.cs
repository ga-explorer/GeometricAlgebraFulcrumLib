...
public class RGaVectorPolynomialInterpolator
{
    ...
    internal static RGaVectorPolynomialInterpolator Create(RGaVector<ScalarSignalFloat64> scalarSamples)
    {
        return new RGaVectorPolynomialInterpolator(scalarSamples);
    }


    public RGaVector<ScalarSignalFloat64> VectorSamples { get; }

    public RGaProcessor<ScalarSignalFloat64> SignalProcessor 
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private RGaVectorPolynomialInterpolator(RGaVector<ScalarSignalFloat64> scalarSamples)
    {
    ...
    public RGaVector<ScalarSignalFloat64> GetVectors()
    {
    ...
    public RGaVector<ScalarSignalFloat64> GetVectorsDt1()
    {
        var vectorList = Enumerable
            .Range(0, SampleCount)
    ...
    public RGaVector<ScalarSignalFloat64> GetVectorsDt2()
    {
        var vectorList = Enumerable
            .Range(0, SampleCount)
    ...
    public RGaVector<ScalarSignalFloat64> GetVectorsDt(int degree = 1)
    {
        var vectorList = Enumerable
            .Range(0, SampleCount)
