...
namespace GeometricAlgebraFulcrumLib.MathBase.SignalAlgebra
{
    ...
    {
        public static VectorChebyshevInterpolator Create(XGaVector<ScalarSignalFloat64> vectorSignal, SignalSamplingSpecs samplingSpecs, DfChebyshevSignalInterpolatorOptions options)
        {
        ...
        private VectorChebyshevInterpolator(XGaVector<ScalarSignalFloat64> scalarSamples, SignalSamplingSpecs samplingSpecs, IReadOnlyList<DfChebyshevSignalInterpolator[]> interpolatorList)
        {
