...
namespace GeometricAlgebraFulcrumLib.MathBase.SignalAlgebra
{
    ...
    {
        public static VectorDifferentialInterpolator CreateLinearSpline(XGaVector<ScalarSignalFloat64> vectorSignal, SignalSamplingSpecs samplingSpecs, DfLinearSplineSignalInterpolatorOptions options)
        {
        ...
        public static VectorDifferentialInterpolator CreateCatmullRomSpline(XGaVector<ScalarSignalFloat64> vectorSignal, SignalSamplingSpecs samplingSpecs, DfCatmullRomSplineSignalInterpolatorOptions options)
        {
            var n = vectorSignal.VSpaceDimensions;
        ...
        public static VectorDifferentialInterpolator CreateChebyshev(XGaVector<ScalarSignalFloat64> vectorSignal, SignalSamplingSpecs samplingSpecs, DfChebyshevSignalInterpolatorOptions options)
        {
            var n = vectorSignal.VSpaceDimensions;
        ...
        public static VectorDifferentialInterpolator CreateFourier(XGaVector<ScalarSignalFloat64> vectorSignal, SignalSamplingSpecs samplingSpecs, DfFourierSignalInterpolatorOptions options)
        {
            var n = vectorSignal.VSpaceDimensions;
        ...
        public static VectorDifferentialInterpolator Create(XGaVector<ScalarSignalFloat64> vectorSignal, SignalSamplingSpecs samplingSpecs, DfSignalInterpolatorOptions options)
        {
        ...
        public XGaProcessor<ScalarSignalFloat64> SignalProcessor 
        ...
        public XGaVector<ScalarSignalFloat64> VectorSamples { get; }

        public IReadOnlyList<DifferentialFunction[]> InterpolatorList { get; }

    
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private VectorDifferentialInterpolator(XGaVector<ScalarSignalFloat64> scalarSamples, SignalSamplingSpecs samplingSpecs, IReadOnlyList<DifferentialFunction[]> interpolatorList)
        {
        ...
        public XGaVector<ScalarSignalFloat64> GetVectors()
        {
            ...
            var columnVectorArray = new ScalarSignalFloat64[VSpaceDimensions];
        ...
        public XGaVector<ScalarSignalFloat64> GetVectorsDt1()
        {
            var processor = VectorSamples.Processor;
        ...
        public XGaVector<ScalarSignalFloat64> GetVectorsDt2()
        {
            var processor = VectorSamples.Processor;
        ...
        public XGaVector<ScalarSignalFloat64> GetVectorsDt(int degree = 1)
        {
            var processor = VectorSamples.Processor;
