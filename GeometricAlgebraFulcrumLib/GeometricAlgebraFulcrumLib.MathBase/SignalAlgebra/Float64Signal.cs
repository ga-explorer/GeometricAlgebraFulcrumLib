...
namespace GeometricAlgebraFulcrumLib.MathBase.SignalAlgebra
{
        ...
        IReadOnlyList<double>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Signal CreateRandomUniform(double samplingRate, int sampleCount, System.Random randomGenerator)
        {
            var sampleList =
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Signal CreateRandomUniform(double samplingRate, int sampleCount, System.Random randomGenerator, double minValue, double maxValue)
        {
            var sampleList =
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Signal CreateRandomGaussian(double samplingRate, int sampleCount, System.Random randomGenerator)
        {
            var sampleList =
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float64Signal CreateRandomGaussian(double samplingRate, int sampleCount, System.Random randomGenerator, double mu, double sigma)
        {
            var sampleList =
        ...
        private Float64Signal(double samplingRate, IEnumerable<Float64Scalar> sampleList, bool isReadOnly)
        {
            ...
            _sampleList = new List<double>(sampleList.Select(s => s.Value));
            IsReadOnly = isReadOnly;
            SamplingRate = samplingRate;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Signal AddRandomUniform(System.Random randomGenerator)
        {
            return MapSamples(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Signal AddRandomUniform(System.Random randomGenerator, double minValue, double maxValue)
        {
            return MapSamples(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Signal AddRandomGaussian(System.Random randomGenerator)
        {
            return MapSamples(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Signal AddRandomGaussian(System.Random randomGenerator, double mu, double sigma)
        {
            return MapSamples(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Signal Asin()
        {
            return MapSamples(Math.Asin);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Signal Acos()
        {
            return MapSamples(Math.Acos);
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float64Signal Atan()
        {
