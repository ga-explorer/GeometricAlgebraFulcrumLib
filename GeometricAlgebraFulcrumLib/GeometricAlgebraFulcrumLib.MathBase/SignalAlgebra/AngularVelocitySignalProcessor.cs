...
namespace GeometricAlgebraFulcrumLib.MathBase.SignalAlgebra
{
    public abstract class AngularVelocitySignalProcessor
    {
        ...
        public XGaVector<ScalarSignalFloat64> VectorSignal { get; private set;}

        public XGaVector<ScalarSignalFloat64> VectorSignalInterpolated { get; protected set;}

        public Pair<XGaVector<ScalarSignalFloat64>> VectorSignalTimeDerivatives { get; protected set; }

        public Pair<XGaVector<ScalarSignalFloat64>> VectorSignalArcLengthDerivatives { get; protected set; }
        
        public Pair<ScalarSignalFloat64> ArcLengthTimeDerivatives { get; protected set; }

        public Pair<XGaVector<ScalarSignalFloat64>> ArcLengthFramesOrthogonal { get; protected set; }

        public Pair<XGaVector<ScalarSignalFloat64>> ArcLengthFramesOrthonormal { get; protected set; }

        public ScalarSignalFloat64 Curvatures { get; protected set; }

        public XGaBivector<ScalarSignalFloat64> AngularVelocityBlades { get; private set; }
    
        public XGaBivector<ScalarSignalFloat64> AngularVelocityAverageBlades { get; protected set; }
        ...
        private void ComputeVectorSignalArcLengthDerivatives()
        {
            ...
            VectorSignalArcLengthDerivatives = new Pair<XGaVector<ScalarSignalFloat64>>(vDs1, vDs2);
        }
        ...
        private void ComputeArcLengthFrames()
        {
            ...
            ArcLengthFramesOrthogonal = new Pair<XGaVector<ScalarSignalFloat64>>(u1, u2);
            ArcLengthFramesOrthonormal = new Pair<XGaVector<ScalarSignalFloat64>>(e1, e2);
        }
