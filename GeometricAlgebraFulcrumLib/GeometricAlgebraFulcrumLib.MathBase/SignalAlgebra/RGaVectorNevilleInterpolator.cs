...
public class RGaVectorNevilleInterpolator
{
    ...
    private IEnumerable<NevillePolynomialInterpolation> GetInterpolatorList(RGaVector<ScalarSignalFloat64> samples, int sampleCount, double t)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaFloat64Vector GetVector(RGaVector<ScalarSignalFloat64> samples, int sampleCount, double t)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaFloat64Vector GetVectorDt1(RGaVector<ScalarSignalFloat64> samples, int sampleCount, double t)
    {
        var signalTime = (sampleCount - 1) / SamplingRate;
        if (t < 0 || t > signalTime)
            return SampleProcessor.CreateZeroVector();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaFloat64Vector GetVectorDt2(RGaVector<ScalarSignalFloat64> samples, int sampleCount, double t)
    {
        var signalTime = (sampleCount - 1) / SamplingRate;
        if (t < 0 || t > signalTime)
            return SampleProcessor.CreateZeroVector();
    ...
    public RGaVector<ScalarSignalFloat64> GetVectorsDt1(RGaVector<ScalarSignalFloat64> samples, int sampleCount)
    {
    ...
    public RGaVector<ScalarSignalFloat64> GetVectorsDt2(RGaVector<ScalarSignalFloat64> samples, int sampleCount)
    {
        var processor = samples.Processor;
