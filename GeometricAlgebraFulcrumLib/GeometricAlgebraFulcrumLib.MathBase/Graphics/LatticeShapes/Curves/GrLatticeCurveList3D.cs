...
namespace GeometricAlgebraFulcrumLib.MathBase.Graphics.LatticeShapes.Curves
{
        ...
        IReadOnlyList<GrLatticeCurveLocalFrame3D>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GrLatticeCurveList3D MapPoints(Func<Float64Vector3D, Float64Vector3D> mappingFunc)
        {
            foreach (var curve in _gridsList)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GrLatticeCurveList3D XRotatePointsBy(double angle)
        {
            return MapPoints(p => 
                p.XRotateBy(angle)
            );
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GrLatticeCurveList3D YRotatePointsBy(double angle)
        {
            return MapPoints(p => 
                p.YRotateBy(angle)
            );
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GrLatticeCurveList3D ZRotatePointsBy(double angle)
        {
            return MapPoints(p => 
                p.ZRotateBy(angle)
            );
