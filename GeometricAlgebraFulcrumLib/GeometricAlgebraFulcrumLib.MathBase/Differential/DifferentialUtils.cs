...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential
{
    public static class DifferentialUtils
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScalarSignalFloat64 GetSmoothedSignal(this ScalarSignalFloat64 signal, int smoothingFactorsCount)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScalarSignalFloat64 GetSmoothedSignal(this ScalarSignalFloat64 signal, IReadOnlyList<int> smoothingFactors)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScalarSignalFloat64 GetSmoothedSignal(this ScalarSignalFloat64 signal, DfSignalInterpolatorOptions options)
        {
        ...
        public static IEnumerable<Float64Tuple2D> GetBezierSmoothingPoints(this IEnumerable<double> yInputList, IEnumerable<double> xInputList, int bezierDegree, bool assumeUniformX)
        {
