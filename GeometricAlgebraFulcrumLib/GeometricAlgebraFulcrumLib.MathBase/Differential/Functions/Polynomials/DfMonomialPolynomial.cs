...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions.Polynomials
{
        ...
        DfPolynomial
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfMonomialPolynomial Create(Float64SparseTuple scalarCoefficients)
        {
        ...
        {
            return new DfMonomialPolynomial(
                new Float64SparseTuple(scalarCoefficients)
            );
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private DfMonomialPolynomial(Float64SparseTuple scalarCoefficients)
        ...
        public override double GetValue(double t)
        {
            ...
            foreach (var (i, c) in ScalarCoefficients.IndexItemPairs)
        ...
        {
            if (ScalarCoefficients.SparseCount == 0) 
                return this;
