...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions.Polynomials
{
        ...
        DfPolynomial
    {
        ...
        public static Float64SparseTuple GetScalarCoefficients(int degree, Func<double, double> f)
        {
            if (degree < 0)
            ...
            return scalarCoefficients;
        }
    
        public static Float64SparseTuple GetScalarCoefficients(int degree, Func<double, double> f, int sampleCount, double minVarValue, double maxVarValue)
        {
            if (degree < 0)
                throw new ArgumentOutOfRangeException(nameof(degree));
        ...
        public static Float64SparseTuple GetScalarCoefficients(int degree, Func<double, double> f, DfAffinePolynomial unitToVarMap)
        {
            if (degree < 0)
                throw new ArgumentOutOfRangeException(nameof(degree));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfChebyshevPolynomial Create(Float64SparseTuple scalarCoefficients)
        {
            return new DfChebyshevPolynomial(scalarCoefficients);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfChebyshevPolynomial Create(Float64SparseTuple scalarCoefficients, double minVarValue, double maxVarValue)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfChebyshevPolynomial Create(Float64SparseTuple scalarCoefficients, DfAffinePolynomial varToUnitMap, DfAffinePolynomial unitToVarMap)
        {
            return new DfChebyshevPolynomial(
                scalarCoefficients,
                varToUnitMap,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private DfChebyshevPolynomial(Float64SparseTuple scalarCoefficients, DfAffinePolynomial varToUnitMap, DfAffinePolynomial unitToVarMap)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private DfChebyshevPolynomial(Float64SparseTuple scalarCoefficients)
            : base(scalarCoefficients)
        {
            HasVarMap = false;
            VarToUnitMap = DfAffinePolynomial.Identity;
        ...
        {
            return ScalarCoefficients.IndexItemPairs.Select(r => 
        ...
        public DfChebyshevPolynomial GetPolynomialDerivative1()
        {
            ...
            foreach (var (n, c) in ScalarCoefficients.IndexItemPairs)
            {
                for (var k = 0; k <= n - 1; k++)
                {
            ...
            return new DfChebyshevPolynomial(
                scalarCoefficients.InPlaceScale(VarToUnitMap.ScalarFactor),
                VarToUnitMap,
                UnitToVarMap
            );
        }
        ...
        public DfChebyshevPolynomial Add(double p2)
        {
            ...
            var scalarCoefficients = new Float64SparseTuple(ScalarCoefficients);
        ...
        public DfChebyshevPolynomial Add(DfChebyshevPolynomial p2)
        {
            ...
            foreach (var (i, c) in p2.ScalarCoefficients.IndexItemPairs)
        ...
        public DfChebyshevPolynomial Times(DfChebyshevBasis p2)
        {
            ...
            var i2 = p2.Degree;
            foreach (var (i1, c1) in ScalarCoefficients.IndexItemPairs)
            {
                var i = i1 + i2;
        ...
        public DfChebyshevPolynomial Times(DfChebyshevPolynomial p2)
        {
            ...
            foreach (var (i1, c1) in ScalarCoefficients.IndexItemPairs)
            foreach (var (i2, c2) in p2.ScalarCoefficients.IndexItemPairs)
            {
                var i = i1 + i2;
                var j = Math.Abs(i1 - i2);
                var d = 0.5 * c1 * c2;
