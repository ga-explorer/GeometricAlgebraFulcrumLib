...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions.Polynomials
{
        ...
        DfPolynomial
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfBernsteinPolynomial Create(int spaceDegree, Float64SparseTuple scalarCoefficients)
        {
            if (scalarCoefficients.LastIndex > spaceDegree)
                scalarCoefficients.ClearByIndex(i => i > spaceDegree);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private DfBernsteinPolynomial(int spaceDegree, Float64SparseTuple scalarCoefficients) 
        ...
        public override double GetValue(double t)
        {
            ...
            foreach (var (degree, scalar) in ScalarCoefficients.IndexItemPairs)
            {
                value += 
                    scalar *
