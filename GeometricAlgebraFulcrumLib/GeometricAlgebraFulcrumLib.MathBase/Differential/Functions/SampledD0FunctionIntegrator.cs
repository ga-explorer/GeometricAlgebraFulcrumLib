...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions
{
    ...
    {
        public ScalarSignalFloat64 TimeSignal { get; }

        public ScalarSignalFloat64 ValueSignal { get; }
        ...
        public SampledD0FunctionIntegrator(ScalarSignalFloat64 valueSignal, DifferentialFunction derivativeFunction)
        {
