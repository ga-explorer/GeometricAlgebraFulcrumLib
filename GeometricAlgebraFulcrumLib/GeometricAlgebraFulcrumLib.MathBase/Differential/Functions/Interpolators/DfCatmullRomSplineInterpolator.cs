...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions.Interpolators
{
        ...
        DifferentialInterpolatorFunction
    {
        public static DfCatmullRomSplineInterpolator CreateFromSortedX(IReadOnlyList<double> xValues, IReadOnlyList<double> yValues, CatmullRomSplineType splineType = CatmullRomSplineType.Centripetal)
        {
            ...
            var bsSignalPointList = new Float64Tuple2D[xValues.Count];

            for (var i = 0; i < pointCount; i++)
                bsSignalPointList[i] = new Float64Tuple2D(xValues[i], yValues[i]);
        ...
        public static DfCatmullRomSplineInterpolator Create(ScalarSignalFloat64 signal, DfCatmullRomSplineSignalInterpolatorOptions options)
        {
        ...
        public DfCatmullRomSplineInterpolator GetInterpolatorDerivative1()
        {
            ...
            var xValues = 
                Curve.ControlPoints.Select(p => p.X).ToImmutableArray();
