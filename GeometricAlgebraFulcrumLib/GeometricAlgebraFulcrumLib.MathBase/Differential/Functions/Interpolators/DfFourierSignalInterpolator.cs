...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions.Interpolators
{
        ...
        DifferentialSignalInterpolatorFunction
    {
        ...
        public static DfFourierSignalInterpolator Create(ScalarSignalFloat64 signal, DfFourierSignalInterpolatorOptions options)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfFourierSignalInterpolator Create(ScalarSignalFloat64 signal, int sampleIndex1, int sampleIndex2, DfFourierSignalInterpolatorOptions options)
        {
        ...
        public ScalarSignalSpectrumComplex VectorSignalSpectrum { get; }


        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private DfFourierSignalInterpolator(SignalSamplingSpecs samplingSpecs, int sampleIndex1, int sampleIndex2, DfFourierSignalInterpolatorOptions options, ScalarSignalSpectrumComplex signalSpectrum) 
