...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions.Interpolators
{
    ...
    {
        public static DfCatmullRomSplineSignalInterpolator Create(ScalarSignalFloat64 signal, int sampleIndex1, int sampleIndex2, DfCatmullRomSplineSignalInterpolatorOptions options)
        {
        ...
        public static DfCatmullRomSplineSignalInterpolator Create(ScalarSignalFloat64 signal, DfCatmullRomSplineSignalInterpolatorOptions options)
        {
            if (options.BezierDegree is < 2 or > 63)
                throw new ArgumentOutOfRangeException(
                    nameof(options.BezierDegree),
        ...
        private DfCatmullRomSplineSignalInterpolator(SignalSamplingSpecs samplingSpecs, int sampleIndex1, int sampleIndex2, DfCatmullRomSplineSignalInterpolatorOptions options, CatmullRomSpline2D curve)
