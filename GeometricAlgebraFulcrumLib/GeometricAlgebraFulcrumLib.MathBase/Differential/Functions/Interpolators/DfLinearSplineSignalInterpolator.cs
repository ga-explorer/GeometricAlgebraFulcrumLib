...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions.Interpolators
{
        ...
        DifferentialSignalInterpolatorFunction
    {
        ...
        public static DfLinearSplineSignalInterpolator Create(ScalarSignalFloat64 signal, DfLinearSplineSignalInterpolatorOptions options)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfLinearSplineSignalInterpolator Create(ScalarSignalFloat64 signal, int sampleIndex1, int sampleIndex2, DfLinearSplineSignalInterpolatorOptions options)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private DfLinearSplineSignalInterpolator(SignalSamplingSpecs samplingSpecs, int sampleIndex1, int sampleIndex2, DfLinearSplineSignalInterpolatorOptions options, LinearSpline spline) 
