...
namespace GeometricAlgebraFulcrumLib.MathBase.Differential.Functions.Interpolators
{
        ...
        DifferentialSignalInterpolatorFunction
    {
        ...
        public static DfChebyshevSignalInterpolator Create(ScalarSignalFloat64 signal, int sampleIndex1, int sampleIndex2, DfChebyshevSignalInterpolatorOptions options)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DfChebyshevSignalInterpolator Create(ScalarSignalFloat64 signal, DfChebyshevSignalInterpolatorOptions options)
        {
            signal = signal.GetSmoothedSignal(options);
            var samplingSpecs = signal.SamplingSpecs;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private DfChebyshevSignalInterpolator(SignalSamplingSpecs samplingSpecs, int sampleIndex1, int sampleIndex2, DfChebyshevSignalInterpolatorOptions options, DfChebyshevPolynomial polynomial) 
