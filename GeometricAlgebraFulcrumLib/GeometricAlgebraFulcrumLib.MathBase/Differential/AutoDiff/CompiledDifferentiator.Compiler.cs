using TapeElement = GeometricAlgebraFulcrumLib.MathBase.Differential.AutoDiff.Compiled.TapeElement;
using InputEdge = GeometricAlgebraFulcrumLib.MathBase.Differential.AutoDiff.Compiled.InputEdge;
using InputEdges = GeometricAlgebraFulcrumLib.MathBase.Differential.AutoDiff.Compiled.InputEdges;

namespace GeometricAlgebraFulcrumLib.MathBase.Differential.AutoDiff
{
