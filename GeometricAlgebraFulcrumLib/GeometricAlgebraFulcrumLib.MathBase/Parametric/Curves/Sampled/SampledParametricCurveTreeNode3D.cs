...
{
    public abstract class SampledParametricCurveTreeNode3D :
        IReadOnlyCollection<SampledParametricCurveTreeNode3D>
    {
        public SampledParametricCurve3D ParentTree { get; }

        public SampledParametricCurveTreeBranch3D ParentBranch { get; }

        public IEnumerable<SampledParametricCurveTreeBranch3D> ParentBranches
        {
            get
            {
        ...
        public bool IsLeaf
            => this is SampledParametricCurveTreeLeaf3D;

        public bool IsBranch
            => this is SampledParametricCurveTreeBranch3D;
        ...
        public SampledParametricCurveTreeCorner3D Corner0 { get; }

        public SampledParametricCurveTreeCorner3D Corner1 { get; }
        ...
        protected SampledParametricCurveTreeNode3D(SampledParametricCurve3D parentTree)
        {
            ...
            var position0 = new ParametricTreeCornerPosition3D(0, 0);
            var position1 = new ParametricTreeCornerPosition3D(0, 1);
        ...
        protected SampledParametricCurveTreeNode3D(SampledParametricCurveTreeBranch3D parentBranch, bool isRightChild)
        {
            ...
            var position0 = new ParametricTreeCornerPosition3D(Level, CellIndex);
            var position1 = new ParametricTreeCornerPosition3D(Level, CellIndex + 1);
        ...
        public bool HasNearEdgeFrames(SampledParametricCurveTreeOptions3D options)
        {
        ...
        public abstract IEnumerator<SampledParametricCurveTreeNode3D> GetEnumerator();
