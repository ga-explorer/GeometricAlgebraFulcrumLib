...
{
    public sealed record ParametricTreeCornerPosition3D :
        IComparable<ParametricTreeCornerPosition3D>
    {
        ...
        public ParametricTreeCornerPosition3D(int level, int segmentCount)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int CompareTo(ParametricTreeCornerPosition3D other)
        {
            if (other is null)
