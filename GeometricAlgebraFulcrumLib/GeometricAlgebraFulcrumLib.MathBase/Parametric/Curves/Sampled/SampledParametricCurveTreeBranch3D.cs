...
{
    public sealed class SampledParametricCurveTreeBranch3D :
        SampledParametricCurveTreeNode3D
    {
        public override int Count => 2;

        public SampledParametricCurveTreeNode3D Child0 { get; private set; }

        public SampledParametricCurveTreeNode3D Child1 { get; private set; }
        ...
        internal SampledParametricCurveTreeBranch3D(SampledParametricCurve3D parentTree)
            : base(parentTree)
        {
        }

        internal SampledParametricCurveTreeBranch3D(SampledParametricCurveTreeBranch3D parentBranch, bool isRightChild)
            : base(parentBranch, isRightChild)
        {
        }


        private SampledParametricCurveTreeBranch3D CreateBranchChildren(SampledParametricCurveTreeOptions3D options)
        {
            Child0 = new SampledParametricCurveTreeBranch3D(this, false).GenerateTree(options);
            Child1 = new SampledParametricCurveTreeBranch3D(this, true).GenerateTree(options);
        ...
        internal SampledParametricCurveTreeNode3D GenerateTree(SampledParametricCurveTreeOptions3D options)
        {
            ...
            return ParentTree.AddLeafNode(
                new SampledParametricCurveTreeLeaf3D(ParentBranch, IsRightChild)
            );
        }

        internal SampledParametricCurveTreeNode3D GetChildContaining(double parameterValue)
        {
        ...
        internal SampledParametricCurveTreeNode3D GetChildContainingLength(double length)
        {
