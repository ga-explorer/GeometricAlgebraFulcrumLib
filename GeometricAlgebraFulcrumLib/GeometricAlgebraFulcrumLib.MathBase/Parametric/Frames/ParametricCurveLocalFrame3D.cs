...
namespace GeometricAlgebraFulcrumLib.MathBase.Parametric.Frames
{
        ...
        IParametricCurveLocalFrame3D
    {
        ...
        public static ParametricCurveLocalFrame3D Create(double parameterValue, IFloat64Tuple3D point, IFloat64Tuple3D normal1, IFloat64Tuple3D normal2, IFloat64Tuple3D tangent)
        {
            return new ParametricCurveLocalFrame3D(
                parameterValue,
                point.ToTuple3D(),
        ...
        private ParametricCurveLocalFrame3D(double parameterValue, IFloat64Tuple3D point, IFloat64Tuple3D normal1, IFloat64Tuple3D normal2, IFloat64Tuple3D tangent)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ParametricCurveLocalFrame3D GetRotatedFrameUsingQuaternion(IFloat64Tuple4D quaternion)
        {
            return new ParametricCurveLocalFrame3D(
                ParameterValue,
                Point,
