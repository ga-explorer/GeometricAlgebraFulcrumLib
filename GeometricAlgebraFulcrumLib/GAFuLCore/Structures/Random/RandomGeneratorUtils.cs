...
public static class RandomGeneratorUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T GetMappedNumber<T>(this System.Random randomGenerator, System.Func<double, T> mappingFunc)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<T> GetMappedNumbers<T>(this System.Random randomGenerator, int count, System.Func<double, T> mappingFunc)
    {
        while (count > 0)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T GetMappedInteger<T>(this System.Random randomGenerator, System.Func<int, T> mappingFunc)
    {
        return mappingFunc(randomGenerator.GetInteger());
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T GetMappedInteger<T>(this System.Random randomGenerator, int maxValue, System.Func<int, T> mappingFunc)
    {
        return mappingFunc(randomGenerator.GetInteger(maxValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T GetMappedInteger<T>(this System.Random randomGenerator, int minValue, int maxValue, System.Func<int, T> mappingFunc)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<T> GetMappedIntegers<T>(this System.Random randomGenerator, int count, System.Func<int, T> mappingFunc)
    {
        while (count > 0)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<T> GetMappedIntegers<T>(this System.Random randomGenerator, int count, int maxValue, System.Func<int, T> mappingFunc)
    {
        while (count > 0)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IEnumerable<T> GetMappedIntegers<T>(this System.Random randomGenerator, int count, int minValue, int maxValue, System.Func<int, T> mappingFunc)
    {
        while (count > 0)
        {
    ...
    public static System.Tuple<double[], double[]> CreateDataArrays(this Histogram hist)
    {
    ...
    {
        return new System.Random(HashCombine(Environment.TickCount, ThreadLocalRandom.Current.Next()));
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static System.Random CreateJavaRandom()
    {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static System.Random CreateJavaRandom(long seed)
    {
