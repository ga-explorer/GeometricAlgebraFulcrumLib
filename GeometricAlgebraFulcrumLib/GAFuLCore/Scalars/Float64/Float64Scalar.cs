    ...
    IFloat64Scalar
{
    ...
    public static Float64Scalar E { get; } 
        = new Float64Scalar(Math.E);
    
    public static Float64Scalar Pi { get; } 
        = new Float64Scalar(Math.PI);
    
    public static Float64Scalar TwoPi { get; } 
        = new Float64Scalar(2d * Math.PI);
    ...
    public static bool IsFinite(Float64Scalar value)
    {
        return !double.IsNaN(value.ScalarValue) && 
               !double.IsInfinity(value.ScalarValue);
    }
    ...
    {
        if (double.TryParse(s, NumberStyles.Any, provider, out var resultValue))
        {
            result = new Float64Scalar(resultValue);
            return true;
        }
    ...
    {
        return new Float64Scalar(Math.Pow(x.ScalarValue, y.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Abs(Float64Scalar value)
    {
        return new Float64Scalar(Math.Abs(value.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Log(Float64Scalar x)
    {
        return new Float64Scalar(Math.Log(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Log(Float64Scalar x, Float64Scalar newBase)
    {
        return new Float64Scalar(Math.Log(x.ScalarValue, newBase.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Log10(Float64Scalar x)
    {
        return new Float64Scalar(Math.Log10(x.ScalarValue));
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Log2(Float64Scalar value)
    {
        return new Float64Scalar(Math.Log(value.ScalarValue, 2));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Exp(Float64Scalar x)
    {
        return new Float64Scalar(Math.Exp(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Cosh(Float64Scalar x)
    {
        return new Float64Scalar(Math.Cosh(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Sinh(Float64Scalar x)
    {
        return new Float64Scalar(Math.Sinh(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Tanh(Float64Scalar x)
    {
        return new Float64Scalar(Math.Tanh(x.ScalarValue));
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Exp10(Float64Scalar x)
    {
        return new Float64Scalar(Math.Pow(10, x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Exp2(Float64Scalar x)
    {
        return new Float64Scalar(Math.Pow(2, x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Round(Float64Scalar x, int digits, MidpointRounding mode)
    {
        return new Float64Scalar(Math.Round(x.ScalarValue, digits, mode));
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Cbrt(Float64Scalar x)
    {
        return new Float64Scalar(Math.Pow(x.ScalarValue, 1d/3));
    }
    ...
    public static Float64Scalar Hypot(Float64Scalar x, Float64Scalar y)
    {
        return new Float64Scalar(
            Math.Sqrt(
                x.ScalarValue.Square() + y.ScalarValue.Square()
            )
        );
    }
    ...
    {
        return new Float64Scalar(Math.Pow(x.ScalarValue, 1d / n));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Sqrt(Float64Scalar x)
    {
        return new Float64Scalar(Math.Sqrt(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Acos(Float64Scalar x)
    {
        return new Float64Scalar(Math.Acos(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar AcosPi(Float64Scalar x)
    {
        return new Float64Scalar(Math.Acos(x.ScalarValue) / Math.PI);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Asin(Float64Scalar x)
    {
        return new Float64Scalar(Math.Asin(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar AsinPi(Float64Scalar x)
    {
        return new Float64Scalar(Math.Asin(x.ScalarValue) / Math.PI);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Atan(Float64Scalar x)
    {
        return new Float64Scalar(Math.Atan(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar AtanPi(Float64Scalar x)
    {
        return new Float64Scalar(Math.Atan(x.ScalarValue) / Math.PI);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Cos(Float64Scalar x)
    {
        return new Float64Scalar(Math.Cos(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar CosPi(Float64Scalar x)
    {
        return new Float64Scalar(Math.Cos(x.ScalarValue * Math.PI));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Sin(Float64Scalar x)
    {
        return new Float64Scalar(Math.Sin(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (Float64Scalar Sin, Float64Scalar Cos) SinCos(Float64Scalar x)
    {
        return (new Float64Scalar(Math.Sin(x.ScalarValue)), new Float64Scalar(Math.Cos(x.ScalarValue)));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static (Float64Scalar SinPi, Float64Scalar CosPi) SinCosPi(Float64Scalar x)
    {
        return (new Float64Scalar(Math.Sin(x.ScalarValue * Math.PI)), new Float64Scalar(Math.Cos(x.ScalarValue * Math.PI)));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar SinPi(Float64Scalar x)
    {
        return new Float64Scalar(Math.Sin(x.ScalarValue * Math.PI));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Tan(Float64Scalar x)
    {
        return new Float64Scalar(Math.Tan(x.ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar TanPi(Float64Scalar x)
    {
        return new Float64Scalar(Math.Tan(x.ScalarValue * Math.PI));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Scalar Atan2(Float64Scalar y, Float64Scalar x)
    {
        return new Float64Scalar(Math.Atan2(y.ScalarValue, x.ScalarValue));
    }
    ...
    {
        return !double.IsNaN(ScalarValue) && !double.IsInfinity(ScalarValue);
    }
    ...
    {
        return new Float64Scalar(Math.Pow(ScalarValue, 2));
    }
    ...
    {
        return new Float64Scalar(Math.Pow(10, ScalarValue));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar Exp2()
    {
        return new Float64Scalar(Math.Pow(2, ScalarValue));
    }
    ...
    {
        return new Float64Scalar(Math.Pow(ScalarValue, 1d/3));
    }
    ...
    {
        return new Float64Scalar(
            Math.Sqrt(ScalarValue * ScalarValue + y * y)
        );
    }
    ...
    {
        return new Float64Scalar(Math.Pow(ScalarValue, 1d / n));
    }
    ...
    public Pair<Float64Scalar> SinCos()
    {
        return new Pair<Float64Scalar>(
            new Float64Scalar(Math.Sin(ScalarValue)), 
            new Float64Scalar(Math.Cos(ScalarValue))
        );
    }
    ...
    {
        return new Float64Scalar(Math.Cos(ScalarValue * Math.PI));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar SinPi()
    {
        return new Float64Scalar(Math.Sin(ScalarValue * Math.PI));
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar TanPi()
    {
        return new Float64Scalar(Math.Tan(ScalarValue * Math.PI));
    }
    ...
    {
        return new Pair<Float64Scalar>(
            new Float64Scalar(Math.Sin(ScalarValue * Math.PI)), 
            new Float64Scalar(Math.Cos(ScalarValue * Math.PI))
        );
    }
    ...
    public Float64Scalar CosWave(double value1, double value2, int cycleCount = 1)
    {
        ...
        return new Float64Scalar(
            value1 + 0.5d * (1d - Math.Cos((2 * Math.PI) * t)) * (value2 - value1)
        );
    }
