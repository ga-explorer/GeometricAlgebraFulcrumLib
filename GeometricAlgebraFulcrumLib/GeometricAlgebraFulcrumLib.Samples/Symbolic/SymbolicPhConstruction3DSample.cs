...
namespace GeometricAlgebraFulcrumLib.Samples.Symbolic
{
    public static class SymbolicPhConstruction3DSample
    {
        ...
        //    //var a0 = 
        //    //    GeometricProcessor.CreateMultivector(scaledRotor0.Multivector);
        ...
        //    //var a1 = 
        //    //    GeometricProcessor.CreateMultivector(scaledRotor1.Multivector);
        ...
        public static void Example2()
        {
            ...
            var theta1 = Expr.INT_ZERO;
            var theta2 = Expr.INT_ZERO;

            //var p = GeometricProcessor.CreateVector(
            //    "Subscript[p, 1]", 
            //    "Subscript[p, 2]", 
            //    "Subscript[p, 3]"
            //);

            //var d = GeometricProcessor.CreateVector(
            //    "Subscript[d, 1]", 
            //    "Subscript[d, 2]", 
            //    "Subscript[d, 3]"
            //);
