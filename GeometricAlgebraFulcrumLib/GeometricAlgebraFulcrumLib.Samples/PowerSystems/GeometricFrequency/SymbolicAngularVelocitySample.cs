...
public static class SymbolicAngularVelocitySample
{
    ...
    public static void Example1()
    {
        ...
        var wt = w * t;
        var theta = $"2 * Pi / {VSpaceDimension}".CreateScalar(ScalarProcessor);
        ...
        var v1Scalars =
            Enumerable
                ...
                .ToArray();
        v1Scalars[VSpaceDimension - 1] /= 2;

        var v1 =
            v1Scalars.Select(s => s.ScalarValue).CreateVector(GeometricProcessor);
