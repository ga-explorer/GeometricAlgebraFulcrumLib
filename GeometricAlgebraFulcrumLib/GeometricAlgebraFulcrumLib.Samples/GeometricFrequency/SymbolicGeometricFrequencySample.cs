...
public static class SymbolicGeometricFrequencySample
{
    ...
    public static void Example1()
    {
        ...
        var sDt2 = sDt1.Differentiate(t).TrigReduce();
        ...
        var (u1, u2) = 
            GeometricProcessor.ApplyGramSchmidtByProjections(vDs1, vDs2, false);
    ...
    public static void Example3()
    {
        ...
        var sDt1 = vDt1NormSquared.Sqrt();
        var sDt2 = sDt1.Differentiate(t).TrigReduce();
        var sDt3 = sDt2.Differentiate(t).TrigReduce();
        ...
        var omega2MeanNorm = 
            omega2Mean.NormSquared().TrigReduce().Sqrt();
    ...
    public static void Example4()
    {
        ...
        var assumeExpr = 
            $@"And[t >= 0, t <= 1, \[Omega] > 0, V > 0, Element[t | \[Omega] | V, Reals], Element[a, Vectors[{VSpaceDimension}, Reals]]]".ToExpr();
        ...
        var a = 
            Enumerable
                ...
                .Select(k => $"V * Cos[2 * Pi * {k} / {VSpaceDimension}]".ToExpr())
                .CreateVector(GeometricProcessor);

        var b = 
            Enumerable
                .Range(0, (int) VSpaceDimension)
                .Select(k => $"V * Sin[2 * Pi * {k} / {VSpaceDimension}]".ToExpr())
                .CreateVector(GeometricProcessor);
    ...
    public static void Example5()
    {
        ...
        var a = 
            Enumerable
                .Range(0, (int) VSpaceDimension)
                .Select(k => $"Subscript[V,{k + 1}] * Cos[2 * Pi * {k} / {VSpaceDimension}]".ToExpr())
                .CreateVector(GeometricProcessor);

        var b = 
            Enumerable
                .Range(0, (int) VSpaceDimension)
                .Select(k => $"Subscript[V,{k + 1}] * Sin[2 * Pi * {k} / {VSpaceDimension}]".ToExpr())
                .CreateVector(GeometricProcessor);
    ...
    public static void Example6()
    {
        ...
        for (var i = 0; i < HarmonicsCount; i++)
        {
            ...
            aVectors[i] = 
                Enumerable
                    .Range(0, (int) VSpaceDimension)
                    .Select(k => $"Subscript[V,{k + 1}{j}] * Cos[2 * Pi * {k} / {VSpaceDimension}]".ToExpr())
                    .CreateVector(GeometricProcessor);

            bVectors[i] =
                Enumerable
                    .Range(0, (int) VSpaceDimension)
                    .Select(k => $"Subscript[V,{k + 1}{j}] * Sin[2 * Pi * {k} / {VSpaceDimension}]".ToExpr())
                    .CreateVector(GeometricProcessor);
    ...
    public static void Example7()
    {
        ...
        var assumeExpr = 
            $@"And[t >= 0, t <= 1, \[Omega] > 0, Element[t | \[Omega], Reals], Element[a | b, Vectors[{VSpaceDimension}, Reals]]]".ToExpr();
        ...
        var vDs1 = vDt1 / sDt1;
        var vDs2 = vDs1.Differentiate(t) / sDt1;
    ...
    public static void Example8()
    {
        ...
        var assumeExpr = 
            $@"And[t >= 0, t <= 1, \[Omega] > 0, Element[t | \[Omega], Reals], Element[a | b | c, Vectors[{VSpaceDimension}, Reals]]]".ToExpr();
        ...
        var vDs1 = vDt1 / sDt1;
        var vDs2 = vDs1.Differentiate(t) / sDt1;
        var vDs3 = vDs2.Differentiate(t) / sDt1;
    ...
    public static void Example9()
    {
        ...
        var assumeExpr = 
            $@"And[t >= 0, t <= 1, \[Omega] > 0, Element[t | \[Omega], Reals], Element[a1 | a2 | a3 | b1 | b2 | b3, Vectors[{VSpaceDimension}, Reals]]]".ToExpr();
