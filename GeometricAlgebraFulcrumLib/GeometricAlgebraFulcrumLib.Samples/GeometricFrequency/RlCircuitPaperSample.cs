...
namespace GeometricAlgebraFulcrumLib.Samples.GeometricFrequency
{
    public static class RlCircuitPaperSample
    {
        ...
        public static void Example1()
        {
            ...
            PlotCurve(uDt2, "u''", "uDt2");

            PlotCurve(iDt1, "i'", "iDt1");
            PlotCurve(iDt2, "i''", "iDt2");
            PlotCurve(iDt3, "i'''", "iDt3");
        ...
        public static void Example2()
        {
            ...
            PlotCurve(uData[0].ScalarValue, "u", "uData");
            PlotCurve(iData[0].ScalarValue, "i", "iData");
            PlotCurve(wData[0].ScalarValue, "w", "wData");

            PlotCurve(u.ScalarValue, "u", "u");
            PlotCurve(uDt1.ScalarValue, "u'", "uDt1");
            PlotCurve(uDt2.ScalarValue, "u''", "uDt2");
            PlotCurve(uDt3.ScalarValue, "u'''", "uDt3");
            PlotCurve(uDt4.ScalarValue, "u''''", "uDt4");

            PlotCurve(i.ScalarValue, "i", "i");
            PlotCurve(iDt1.ScalarValue, "i'", "iDt1");
            PlotCurve(iDt2.ScalarValue, "i''", "iDt2");
            PlotCurve(iDt3.ScalarValue, "i'''", "iDt3");
            PlotCurve(iDt4.ScalarValue, "i''''", "iDt4");
            
            PlotCurve(w.ScalarValue, "w", "w");
            PlotCurve(wDt1.ScalarValue, "w'", "wDt1");
            PlotCurve(wDt2.ScalarValue, "w''", "wDt2");
            PlotCurve(wDt3.ScalarValue, "w'''", "wDt3");
            PlotCurve(wDt4.ScalarValue, "w''''", "wDt4");

            PlotCurve(d.ScalarValue, "d", "d");
            PlotCurve(k1.ScalarValue, "k1", "k1");
            PlotCurve(r1.ScalarValue, "r1", "r1");
            PlotCurve(l1.ScalarValue, "l1", "l1");
            ...
            PlotCurve(r.ScalarValue, "R", "R");
            PlotCurve(l.ScalarValue, "L", "L");

            PlotCurve(k.ScalarValue, "K", "K");
            PlotCurve(j.ScalarValue, "J", "J");
            PlotCurve(b.ScalarValue, "b", "b");
        }
