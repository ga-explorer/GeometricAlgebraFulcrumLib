...
public static class CGa5DIntersectionSamples
{
    ...
    {
        var point1 = Float64Vector3D.Create(-1.2, 1.4, 0.25);
        var point2 = Float64Vector3D.Create(1.3, -2.4, -3.25);
        ...
        yield return Ga.DefineFlatLine(
            point1,
            Float64Vector3D.Create(-1.1, 1.4, -2.1)
        );
            
        yield return Ga.DefineFlatLine(
            point2,
            Float64Vector3D.Create(2.1, -1.1, 1.1)
        );

        yield return Ga.DefineFlatPlane(
            point1,
            Float64Bivector3D.Create(-1.1, 1.4, -2.1)
        );
            
        yield return Ga.DefineFlatPlane(
            point2,
            Float64Bivector3D.Create(2.1, -1.1, 1.1)
        );
