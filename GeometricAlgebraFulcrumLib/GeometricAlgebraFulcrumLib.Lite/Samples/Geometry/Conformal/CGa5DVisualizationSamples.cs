...
public static class CGa5DVisualizationSamples
{
    ...
    public static void StaticFlatsExample()
    {
        ...
        var flatLine = CGa.EncodeOpnsFlatLine(
            ...
            Float64Vector3D.Create(1, 1, 1).GetNormal()
        );

        var flatPlane = CGa.EncodeOpnsFlatPlane(
            3,
            Float64Vector3D.Create(1, 1, 1).Negative()
        );
    ...
    public static void StaticRoundsExample()
    {
        ...
        var roundPointPair = 
            CGa.EncodeOpnsRoundPointPair(
                ...
                Float64Vector3D.Create(-4, 4, -4).GetNormal()
            );
    ...
    public static void ParametricLineExample1()
    {
        ...
        var latexOffset = Float64Vector3D.CreateSymmetricVector(0.25);
    ...
    public static void ParametricPlaneExample1()
    {
        ...
        // Draw LaTeX expressions
        var latexOffset = Float64Vector3D.CreateSymmetricVector(0.75);

        CGa.Visualizer
            .DrawLaTeX("point1", point1Curve.GetOffsetCurve(latexOffset))
            .DrawLaTeX("point2", point2Curve.GetOffsetCurve(latexOffset))
            .DrawLaTeX("point3", point3Curve.Point.Add(latexOffset));
    ...
    public static void ParametricPlaneExample2()
    {
        ...
        // Draw LaTeX expressions
        var latexOffset = Float64Vector3D.CreateSymmetricVector(0.5);
    ...
    public static void ParametricSphereExample1()
    {
        ...
        // Draw LaTeX expressions
        var latexOffset = Float64Vector3D.CreateSymmetricVector(1);
        ...
        CGa.Visualizer
            .DrawLaTeX(
                ...
                positionCurve1.GetOffsetCurve(
                    Float64Vector3D.CreateSymmetricVector(2.5)
                )
            ).DrawLaTeX(
                "element2",
                positionCurve2.GetOffsetCurve(
                    Float64Vector3D.CreateSymmetricVector(2)
                )
            ).DrawLaTeX(
                "intersectionElement",
    ...
    public static void ParametricCircleInterpolationExample()
    {
        ...
        var roundCircle1 =
            CGa.DefineRoundCircle(
                4,
                Float64Vector3D.Create(5, 5, 0),
                Float64Vector3D.Create(2, 1, 1)
            );

        var roundCircle2 =
            CGa.DefineRoundCircle(
                -9,
                Float64Vector3D.Create(-5, -5, 2),
