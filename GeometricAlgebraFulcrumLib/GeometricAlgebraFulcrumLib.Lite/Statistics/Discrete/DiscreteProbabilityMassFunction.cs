...
namespace GeometricAlgebraFulcrumLib.Lite.Statistics.Discrete
{
        ...
        DiscreteProbabilityFunction
    {
        ...
        public static DiscreteProbabilityMassFunction CreateFromHistogram(System.Random randomGenerator, double domainFirstValue, double domainLastValue, int domainSampleCount, int samplesCount = 10000000)
        {
            ...
            for (var i = 0; i < domainSampleCount; i++)
            {
                ...
                var p = (double)count / histogram.DataCount;
