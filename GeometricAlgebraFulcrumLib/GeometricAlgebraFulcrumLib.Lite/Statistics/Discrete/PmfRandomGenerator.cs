namespace GeometricAlgebraFulcrumLib.Lite.Statistics.Discrete;

public class PmfRandomGenerator :
    System.Random
{
    public static PmfRandomGenerator Create(System.Random uniformRandomGenerator, IReadOnlyList<double> inverseCdfArray)
    {
    ...
    public System.Random UniformRandomGenerator { get; }

    public IReadOnlyList<double> InverseCdfArray { get; }


    private PmfRandomGenerator(System.Random uniformRandomGenerator, IReadOnlyList<double> inverseCdfArray)
    {
