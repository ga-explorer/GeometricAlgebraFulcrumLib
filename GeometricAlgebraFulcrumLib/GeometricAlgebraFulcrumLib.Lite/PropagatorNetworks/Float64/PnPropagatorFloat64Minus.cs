    ...
    PnPropagatorFloat64
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private PnPropagatorFloat64Minus(PnCellFloat64 inputCell1, PnCellFloat64 inputCell2, PnCellFloat64 outputCell)
        : base(outputCell)
    {
