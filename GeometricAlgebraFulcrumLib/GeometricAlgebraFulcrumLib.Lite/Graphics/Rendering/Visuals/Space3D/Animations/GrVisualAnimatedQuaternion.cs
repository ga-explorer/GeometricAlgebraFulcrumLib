    ...
    IParametricQuaternion
{
    ...
    public static GrVisualAnimatedQuaternion operator +(GrVisualAnimatedQuaternion p1, Float64Quaternion p2)
    {
    ...
    public static GrVisualAnimatedQuaternion operator +(Float64Quaternion p1, GrVisualAnimatedQuaternion p2)
    {
        var baseCurve = ComputedParametricQuaternion.Create(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Quaternion GetQuaternion(double time)
    {
    ...
    public Float64Quaternion GetDerivative1Quaternion(double time)
    {
        if (!FrameTimeRange.Contains(time))
            throw new ArgumentOutOfRangeException();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<KeyValuePair<int, Float64Quaternion>> GetKeyFrameIndexPositionPairs()
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<KeyValuePair<int, double>> GetKeyFrameIndexValuePairs(Func<Float64Quaternion, double> positionToValueMap)
    {
        return FrameIndexTimePairs.Select(
            indexTimePair =>
            {
