...
public class GrKonvaJsLayerComposer
{
    ...
    public GrKonvaJsLayerComposer AddPoint(string name, IPair<double> point, double radius)
    {
        return AddPoint(
            name, 
            point.Item1,
    ...
    public GrKonvaJsLayerComposer AddPoints(string name, IEnumerable<IPair<double>> pointList, double radius)
    {
        var i = 0;
    ...
    public GrKonvaJsLayerComposer AddLine(string name, IReadOnlyList<IPair<double>> pointArray, bool closed)
    {
    ...
    public GrKonvaJsLayerComposer AddLine(string name, IReadOnlyList<IPair<double>> pointArray, bool closed, double tension)
    {
        var line = new GrKonvaJsLine(name);
    ...
    public GrKonvaJsLayerComposer AddBezierLine(string name, IReadOnlyList<IPair<double>> pointArray)
    {
        var line = new GrKonvaJsLine(name);
    ...
    public GrKonvaJsLayerComposer AddBezierLine(string name, params IPair<double>[] pointArray)
    {
        return AddBezierLine(
            name, 
            (IReadOnlyList<IPair<double>>) pointArray
        );
    }

    public GrKonvaJsLayerComposer AddBezierLine(string name, IReadOnlyList<IPair<double>> pointArray, bool closed)
    {
        var line = new GrKonvaJsLine(name);
    ...
    public GrKonvaJsLayerComposer AddClosedBezierLine(string name, params IPair<double>[] pointArray)
    {
        return AddBezierLine(
            name, 
            pointArray, 
    ...
    public GrKonvaJsLayerComposer AddLine(string name, IPair<double> point1, IPair<double> point2)
    {
        var line = new GrKonvaJsLine(name);
