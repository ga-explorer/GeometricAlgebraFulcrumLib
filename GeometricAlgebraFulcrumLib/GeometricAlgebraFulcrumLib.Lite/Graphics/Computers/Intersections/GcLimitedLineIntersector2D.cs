...
using GeometricAlgebraFulcrumLib.Lite.Graphics.Accelerators.BIH.Space2D;
using GeometricAlgebraFulcrumLib.Lite.Graphics.Accelerators.BIH.Space2D.Traversal;
...
namespace GeometricAlgebraFulcrumLib.Lite.Graphics.Computers.Intersections
{
    public class GcLimitedLineIntersector2D
    {
        ...
        public GcLimitedLineIntersector2D SetLineAsLineSegment(IFloat64Vector2D point1, IFloat64Vector2D point2)
        {
            Line = new Line2D(
                point1.X,
                point1.Y,
