    ...
    IReadOnlyList<LinFloat64VectorToVectorRotation4D>
{
    ...
    public static LinFloat64VectorToVectorRotationSequence4D CreateRandom(System.Random random, int dimensions, int count)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            var v = random.GetFloat64Tuple4D();
    ...
    public static LinFloat64VectorToVectorRotationSequence4D CreateRandomOrthogonal(System.Random random, int dimensions, int count)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            var u = vectorList[2 * i].ToTuple4D();
            var v = vectorList[2 * i + 1].ToTuple4D();
            var angle = random.GetAngle();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public LinFloat64VectorToVectorRotationSequence4D AppendMap(Float64Vector4D sourceVector, Float64Vector4D targetVector)
    {
        _mapList.Add(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public LinFloat64VectorToVectorRotationSequence4D AppendMap(Float64Vector4D sourceVector, Float64Vector4D targetVector, Float64PlanarAngle angle)
    {
        _mapList.Add(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public LinFloat64VectorToVectorRotationSequence4D PrependMap(Float64Vector4D sourceVector, Float64Vector4D targetVector)
    {
        _mapList.Insert(
            0, 
            LinFloat64VectorToVectorRotation4D.Create(sourceVector, targetVector)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public LinFloat64VectorToVectorRotationSequence4D InsertMap(int index, Float64Vector4D sourceVector, Float64Vector4D targetVector)
    {
        _mapList.Insert(
            index, 
            LinFloat64VectorToVectorRotation4D.Create(sourceVector, targetVector)
    ...
    public override Float64Vector4D MapBasisVector(int basisIndex)
    {
        ...
        foreach (var rotation in _mapList)
        {
            ...
            var r = composer.ESp(t);
            var s = composer.ESp(u);
            var rsPlus = r + s;
            var rsMinus = r - s;
