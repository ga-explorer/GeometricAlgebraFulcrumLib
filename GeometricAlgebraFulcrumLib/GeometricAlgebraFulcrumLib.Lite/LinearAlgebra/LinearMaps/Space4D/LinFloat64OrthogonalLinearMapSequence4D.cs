...
using GeometricAlgebraFulcrumLib.Lite.LinearAlgebra.SubSpaces.Space4D;
...
namespace GeometricAlgebraFulcrumLib.Lite.LinearAlgebra.LinearMaps.Space4D
{
        ...
        ILinFloat64UnilinearMap4D
    {
        ...
        public static LinFloat64OrthogonalLinearMapSequence4D CreateRandom(System.Random random, int count)
        {
            var matrix = 
        ...
        public static LinFloat64OrthogonalLinearMapSequence4D CreateRandomOrthogonal(System.Random random, int count)
        {
        ...
        {
            var vector = 
                Float64Vector4D.BasisVectors[basisIndex];
