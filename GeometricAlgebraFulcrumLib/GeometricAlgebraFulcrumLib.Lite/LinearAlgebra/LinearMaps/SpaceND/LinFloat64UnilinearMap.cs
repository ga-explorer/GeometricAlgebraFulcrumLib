    ...
    IReadOnlyDictionary<IndexPair, double>
{
    ...
    private readonly IReadOnlyDictionary<int, Float64Vector> _indexVectorDictionary;
    ...
    public Float64Vector this[int key]
        => _indexVectorDictionary.TryGetValue(key, out var mv)
            ? mv : Float64Vector.ZeroVector;
    ...
    public IEnumerable<KeyValuePair<int, Float64Vector>> IndexVectorPairs
        => _indexVectorDictionary;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal LinFloat64UnilinearMap(IReadOnlyDictionary<int, Float64Vector> indexVectorDictionary)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetVector(int index, out Float64Vector vector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetColumnVector(int index2, out Float64Vector? vector)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Vector MapBasisVector(int index)
    {
    ...
    public LinFloat64UnilinearMap Map(LinFloat64UnilinearMap map2)
    {
        var indexVectorDictionary =
            map2
                ...
                .Select(p =>
                    new KeyValuePair<int, Float64Vector>(p.Key, MapVector(p.Value))
                )
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<KeyValuePair<int, Float64Vector>> GetMappedBasisVectors()
    {
    ...
    public IEnumerable<KeyValuePair<int, Float64Vector>> GetMappedBasisVectors(int vSpaceDimensions)
    {
        return _indexVectorDictionary
            ...
            .Select(p =>
                new KeyValuePair<int, Float64Vector>(p.Key, p.Value)
            );
    }
