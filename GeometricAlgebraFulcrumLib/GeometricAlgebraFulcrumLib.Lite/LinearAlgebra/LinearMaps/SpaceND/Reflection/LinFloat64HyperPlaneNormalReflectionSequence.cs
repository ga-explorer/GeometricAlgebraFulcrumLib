    ...
    IReadOnlyList<LinFloat64HyperPlaneNormalReflection>
{
    ...
    public static LinFloat64HyperPlaneNormalReflectionSequence CreateRandom(System.Random random, int dimensions, int count)
    {
    ...
    public static LinFloat64HyperPlaneNormalReflectionSequence CreateRandomOrthogonal(System.Random random, int dimensions, int count)
    {
        if (count > dimensions)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public LinFloat64HyperPlaneNormalReflectionSequence AppendMap(Float64Vector reflectionNormal)
    {
        _mapList.Add(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public LinFloat64HyperPlaneNormalReflectionSequence PrependMap(Float64Vector reflectionNormal)
    {
        _mapList.Insert(
            0,
            LinFloat64HyperPlaneNormalReflection.Create(reflectionNormal)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public LinFloat64HyperPlaneNormalReflectionSequence InsertMap(int index, Float64Vector reflectionNormal)
    {
        _mapList.Insert(
            index,
            LinFloat64HyperPlaneNormalReflection.Create(reflectionNormal)
