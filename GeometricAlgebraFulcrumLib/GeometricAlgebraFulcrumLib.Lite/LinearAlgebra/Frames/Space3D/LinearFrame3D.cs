...
public class LinearFrame3D
{
    ...
    public Float64Vector3D UDirection
        => Float64Vector3D.Create(UDirectionX, UDirectionY, UDirectionZ);

    public Float64Vector3D VDirection
        => Float64Vector3D.Create(VDirectionX, VDirectionY, VDirectionZ);

    public Float64Vector3D WDirection
        => Float64Vector3D.Create(WDirectionX, WDirectionY, WDirectionZ);
