...
{
    public static XGaFloat64GramSchmidtFrame Create(Float64Vector3D v1, Float64Vector3D v2, Float64Vector3D v3)
    {
    ...
    public static XGaFloat64GramSchmidtFrame Create(params Float64Vector[] vArray)
    {
        var n = Math.Max(
            vArray.Length,
