...
namespace GeometricAlgebraFulcrumLib.Lite.GeometricAlgebra.Extended.Float64.LinearMaps.Rotors
{
    public static class XGaFloat64RotorComposerUtils
    {
        ...
        /// <returns></returns>
        public static XGaFloat64PureRotor CreateParametricPureRotor3D(this XGaFloat64Vector sourceVector, XGaFloat64Vector targetVector, double angleTheta)
        {
            var metric = sourceVector.Processor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static XGaFloat64ScaledPureRotor CreateScaledParametricPureRotor3D(this XGaFloat64Vector sourceVector, XGaFloat64Vector targetVector, double angleTheta, double scalingFactor)
        {
            return sourceVector
        ...
        public static XGaFloat64ScaledPureRotor CreateScaledPureRotorFromAxis(this XGaFloat64Vector targetVector, LinSignedBasisVector sourceAxis, bool assumeUnitVector = false)
        {
            ...
            var ek = metric.CreateTermVector(k);
        ...
        /// <returns></returns>
        public static XGaFloat64PureRotor CreatePureRotor(this XGaFloat64Bivector rotationBlade, double rotationAngle)
        {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static XGaFloat64PureRotor CreateGivensRotor(this XGaFloat64Processor processor, int i, int j, double rotationAngle)
        {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static XGaFloat64ScaledPureRotor CreateScaledGivensRotor(this XGaFloat64Processor processor, int i, int j, double rotationAngle, double scalingFactor)
        {
            Debug.Assert(i >= 0 && j != i);
        ...
        public static XGaFloat64Rotor CreateRotorToFrame(this XGaFloat64BasisVectorFrame sourceFrame, XGaFloat64BasisVectorFrame targetFrame)
        {
            ...
            var rotorMultivector =
                mvFrame2
                    ...
                    .Aggregate(
                        (XGaFloat64Multivector) metric.CreateZeroMultivector(),
                        (mv1, mv2) => mv1.Add(mv2)
                    );
