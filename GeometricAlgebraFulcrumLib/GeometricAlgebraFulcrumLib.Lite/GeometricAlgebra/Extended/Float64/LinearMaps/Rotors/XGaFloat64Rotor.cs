...
namespace GeometricAlgebraFulcrumLib.Lite.GeometricAlgebra.Extended.Float64.LinearMaps.Rotors
{
        ...
        : XGaFloat64RotorBase
    {
        ...
        /// <returns></returns>
        public static XGaFloat64Rotor CreateEuclideanPureRotor(double rotationAngle, XGaFloat64KVector rotationBlade)
        {
        ...
        /// <param name="rotationAngle"></param>
        /// <returns></returns>
        public static XGaFloat64Rotor CreateGivensRotor(XGaFloat64Processor processor, int i, int j, double rotationAngle)
        {
