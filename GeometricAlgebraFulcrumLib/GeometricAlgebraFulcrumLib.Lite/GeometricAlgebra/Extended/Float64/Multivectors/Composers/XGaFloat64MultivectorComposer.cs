...
namespace GeometricAlgebraFulcrumLib.Lite.GeometricAlgebra.Extended.Float64.Multivectors.Composers
{
        ...
        IXGaFloat64Element
    {
        ...
        {
            return MapScalars((id, scalar) =>
                Metric.ConjugateSign(id) * scalar
            );
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaFloat64Scalar ENormSquared()
        {
            var scalarList =
                _idScalarDictionary
                    .Values
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaFloat64Scalar ENorm()
        {
            return ENormSquared().Sqrt();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XGaFloat64Scalar NormSquared()
        {
            var scalarList =
                _idScalarDictionary
                    .Select(p =>
