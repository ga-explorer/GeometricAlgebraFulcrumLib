...
public static class XGaFloat64BivectorComposerUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Bivector CreateTermBivector(this XGaFloat64Processor processor, int index1, int index2)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Bivector CreateTermBivector(this XGaFloat64Processor processor, int index1, int index2, double scalar)
    {
        if (index1 < 0 || index1 >= index2)
            throw new InvalidOperationException();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Bivector CreateTermBivector(this XGaFloat64Processor processor, IPair<int> indexPair)
    {
        return new XGaFloat64Bivector(
            processor,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Bivector CreateTermBivector(this XGaFloat64Processor processor, IPair<int> indexPair, double scalar)
    {
        if (scalar.IsZero())
            return new XGaFloat64Bivector(processor);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Bivector CreateTermBivector(this XGaFloat64Processor processor, KeyValuePair<Int32Pair, double> indexScalarPair)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Bivector CreateTermBivector(this XGaFloat64Processor processor, KeyValuePair<IIndexSet, double> indexScalarPair)
    {
        return processor.CreateTermBivector(indexScalarPair.Key, indexScalarPair.Value);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Bivector CreateTermBivector(this XGaFloat64Processor processor, IIndexSet basisBlade)
    {
        return new XGaFloat64Bivector(
            processor,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Bivector CreateTermBivector(this XGaFloat64Processor processor, IIndexSet basisBlade, double scalar)
    {
        if (scalar.IsZero())
            return new XGaFloat64Bivector(processor);
