...
public static class XGaFloat64KVectorComposerUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64HigherKVector CreateTermHigherKVector(this XGaFloat64Processor processor, IIndexSet id)
    {
        var grade = id.Count;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64HigherKVector CreateTermHigherKVector(this XGaFloat64Processor processor, IIndexSet id, double scalar)
    {
        var grade = id.Count;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64HigherKVector CreateTermHigherKVector(this XGaFloat64Processor processor, KeyValuePair<IIndexSet, double> term)
    {
        var (id, scalar) = term;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64KVector CreateTermKVector(this XGaFloat64Processor processor, KeyValuePair<IIndexSet, double> term)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64KVector CreateTermKVector(this XGaFloat64Processor processor, IIndexSet basisBlade)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64KVector CreateTermKVector(this XGaFloat64Processor processor, IIndexSet basisBlade, double scalar)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64KVector CreateTermKVector(this XGaFloat64Processor processor, ulong basisBlade)
    {
        return processor.CreateTermKVector(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64KVector CreateTermKVector(this XGaFloat64Processor processor, ulong basisBlade, double scalar)
    {
