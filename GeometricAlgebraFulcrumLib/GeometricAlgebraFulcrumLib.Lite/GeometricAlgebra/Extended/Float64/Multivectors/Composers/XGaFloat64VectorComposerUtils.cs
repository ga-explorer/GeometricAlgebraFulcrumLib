...
public static class XGaFloat64VectorComposerUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, int index)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, int index, double scalar)
    {
        if (scalar.IsZero())
            return new XGaFloat64Vector(processor);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, KeyValuePair<int, double> indexScalarPair)
    {
        return processor.CreateTermVector(indexScalarPair.Key, indexScalarPair.Value);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, ulong basisVector)
    {
        var basisScalarDictionary =
            new SingleItemDictionary<IIndexSet, double>(basisVector.BitPatternToIndexSet(), 1d);

        return new XGaFloat64Vector(processor, basisScalarDictionary);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, ulong basisVector, double scalar)
    {
        if (scalar.IsZero())
            return new XGaFloat64Vector(processor);

        var basisScalarDictionary =
            new SingleItemDictionary<IIndexSet, double>(basisVector.BitPatternToIndexSet(), scalar);

        return new XGaFloat64Vector(processor, basisScalarDictionary);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, IIndexSet basisVector)
    {
        var basisScalarDictionary =
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, IIndexSet basisVector, double scalar)
    {
        if (scalar.IsZero())
            return new XGaFloat64Vector(processor);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, KeyValuePair<ulong, double> indexScalarPair)
    {
        return processor.CreateTermVector(indexScalarPair.Key, indexScalarPair.Value);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XGaFloat64Vector CreateTermVector(this XGaFloat64Processor processor, KeyValuePair<IIndexSet, double> indexScalarPair)
    {
        return processor.CreateTermVector(indexScalarPair.Key, indexScalarPair.Value);
    }
