...
namespace GeometricAlgebraFulcrumLib.Lite.GeometricAlgebra.Restricted.Float64.Frames
{
    public class RGaFloat64GramSchmidtFrame
    {
        public static RGaFloat64GramSchmidtFrame Create(Float64Vector3D v1, Float64Vector3D v2, Float64Vector3D v3)
        {
            ...
            {
                RGaFloat64Processor.Euclidean.CreateVector(e1),
                RGaFloat64Processor.Euclidean.CreateVector(e2),
                RGaFloat64Processor.Euclidean.CreateVector(e3)
            };
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RGaFloat64GramSchmidtFrame CleanNorms(double epsilon = 1e-12)
        {
