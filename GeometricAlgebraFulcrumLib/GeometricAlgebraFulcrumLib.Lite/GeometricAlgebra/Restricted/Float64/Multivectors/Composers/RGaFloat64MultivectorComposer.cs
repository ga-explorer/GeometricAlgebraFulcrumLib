    ...
    IRGaElement
{
    ...
    {
        return MapScalars((id, scalar) =>
            Processor.ConjugateSign(id) * scalar
        );
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaFloat64Scalar ENormSquared()
    {
        var scalarList =
            _idScalarDictionary
                .Values
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaFloat64Scalar ENorm()
    {
        return ENormSquared().Sqrt();
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaFloat64Scalar NormSquared()
    {
        var scalarList =
            _idScalarDictionary
                .Select(p =>
