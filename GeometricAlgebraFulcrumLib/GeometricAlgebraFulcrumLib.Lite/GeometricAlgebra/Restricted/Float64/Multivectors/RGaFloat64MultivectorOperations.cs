...
namespace GeometricAlgebraFulcrumLib.Lite.GeometricAlgebra.Restricted.Float64.Multivectors
{
    public abstract partial class RGaFloat64Multivector
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual RGaFloat64Scalar ENormSquared()
        {
            if (IsZero)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual RGaFloat64Scalar NormSquared()
        {
            if (IsZero)
                return Processor.CreateZeroScalar();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual RGaFloat64Scalar ENorm()
        {
            return ENormSquared().Sqrt();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual RGaFloat64Scalar Norm()
        {
            return NormSquared().SqrtOfAbs();
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual RGaFloat64Scalar ESpSquared()
        {
            if (IsZero)
                return Processor.CreateZeroScalar();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual RGaFloat64Scalar SpSquared()
        {
            if (IsZero)
                return Processor.CreateZeroScalar();
