...
namespace GeometricAlgebraFulcrumLib.Lite.GeometricAlgebra.Restricted.Float64.Multivectors
{
    public static class RGaFloat64KVectorUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RGaFloat64KVector Op(this IEnumerable<RGaFloat64Vector> mvList)
        {
            return mvList.Skip(1).Aggregate(
                (RGaFloat64KVector)mvList.First(),
        ...
        {
            var blade = (RGaFloat64KVector) processor.CreateOneScalar();
