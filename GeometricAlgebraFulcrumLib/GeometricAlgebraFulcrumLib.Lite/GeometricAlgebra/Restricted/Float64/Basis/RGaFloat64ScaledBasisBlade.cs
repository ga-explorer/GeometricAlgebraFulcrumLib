    ...
    : IRGaFloat64Element
{
    ...
    public RGaFloat64ScaledBasisBlade(RGaFloat64Processor processor, IRGaSignedBasisBlade basisBlade, Float64Scalar scalar)
    {
        Processor = processor;
        Id = basisBlade.Id;
        Scalar = scalar.Value * basisBlade.Sign;
    }
    ...
    public Float64Scalar Signature()
    {
        return IsZero 
            ? 0d 
            : Metric.Signature(Id) * Scalar.Value.Square();
    }
    ...
    {
        return BasisBlade.ReverseSign() * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar GradeInvolutionScalar()
    {
        return BasisBlade.GradeInvolutionSign() * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar CliffordConjugateScalar()
    {
        return BasisBlade.CliffordConjugateSign() * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EConjugateScalar()
    {
        return BasisBlade.EConjugateSign() * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ConjugateScalar()
    {
        return BasisBlade.ConjugateSign() * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar TimesScalar(IntegerSign sign)
    {
        return Scalar.Value * sign;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EGpScalar(ulong basisBlade)
    {
        return BasisBlade.EGpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EGpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.EGpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar GpScalar(ulong basisBlade)
    {
        return BasisBlade.GpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar GpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.GpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar OpScalar(ulong basisBlade)
    {
        return BasisBlade.OpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar OpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.OpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ESpScalar(ulong basisBlade)
    {
        return BasisBlade.ESpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ESpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.ESpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar SpScalar(ulong basisBlade)
    {
        return BasisBlade.SpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar SpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.SpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ELcpScalar(ulong basisBlade)
    {
        return BasisBlade.ELcpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ELcpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.ELcpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar LcpScalar(ulong basisBlade)
    {
        return BasisBlade.LcpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar LcpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.LcpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ERcpScalar(ulong basisBlade)
    {
        return BasisBlade.ERcpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ERcpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.ERcpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar RcpScalar(ulong basisBlade)
    {
        return BasisBlade.RcpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar RcpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.RcpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EFdpScalar(ulong basisBlade)
    {
        return BasisBlade.EFdpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EFdpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.EFdpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar FdpScalar(ulong basisBlade)
    {
        return BasisBlade.FdpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar FdpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.FdpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EHipScalar(ulong basisBlade)
    {
        return BasisBlade.EHipSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EHipScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.EHipSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar HipScalar(ulong basisBlade)
    {
        return BasisBlade.HipSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar HipScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.HipSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EAcpScalar(ulong basisBlade)
    {
        return BasisBlade.EAcpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar EAcpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.EAcpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar AcpScalar(ulong basisBlade)
    {
        return BasisBlade.AcpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar AcpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.AcpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ECpScalar(ulong basisBlade)
    {
        return BasisBlade.ECpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar ECpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.ECpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar CpScalar(ulong basisBlade)
    {
        return BasisBlade.CpSign(basisBlade) * Scalar.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Float64Scalar CpScalar(RGaFloat64ScaledBasisBlade basisBlade)
    {
        return BasisBlade.CpSign(basisBlade.BasisBlade) * Scalar.Value * basisBlade.Scalar.Value;
    }
