...
public sealed class TrstMap3D : ITransform3D
{
    ...
    public static TrstMap3D CreateFromXSectionToLineSectionMap(double section1StartX, double section1EndX, Float64Vector3D section2Start, Float64Vector3D section2End)
    {
    ...
    public Float64Vector3D XSectionStart => Float64Vector3D.Create(0, 0, 0);

    public Float64Vector3D XSectionEnd => Float64Vector3D.Create(XSectionLength, 0, 0);

    public Float64Vector3D FinalSectionStart { get; set; }

    public Float64Vector3D FinalSectionEnd { get; set; }


    public Float64Vector3D MapPoint(Float64Vector3D point)
    {
        ...
        return Float64Vector3D.Create(x * _scaleFactor + _translate2X,
