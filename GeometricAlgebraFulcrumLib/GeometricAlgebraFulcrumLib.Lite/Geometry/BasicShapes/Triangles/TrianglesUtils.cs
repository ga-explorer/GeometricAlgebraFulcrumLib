...
namespace GeometricAlgebraFulcrumLib.Lite.Geometry.BasicShapes.Triangles;
...
public static class TrianglesUtils
{
    ...
    public static IEnumerable<Float64Vector2D> GetEndPoints(this IEnumerable<ITriangle2D> trianglesList)
    {
    ...
    public static Float64Vector2D GetInnerPointAt(this ITriangle2D triangle, double d1, double d2, double d3)
    {
        var dInv = 1 / (d1 + d2 + d3);
        var w1 = d1 * dInv;
        var w2 = d2 * dInv;
    ...
    public static Float64Vector2D GetPointAt(this ITriangle2D triangle, double w1, double w2)
    {
        var w3 = 1.0d - (w1 + w2);
    ...
    public static Triangle2D GetTriangleAt(this ITriangle2D triangle, Float64Vector2D w1, Float64Vector2D w2, Float64Vector2D w3)
    {
    ...
    public static Float64Vector3D GetPoint1(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point1X, triangle.Point1Y, triangle.Point1Z);
    }

    public static Float64Vector3D GetPoint2(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point2X, triangle.Point2Y, triangle.Point2Z);
    }

    public static Float64Vector3D GetPoint3(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point3X, triangle.Point3Y, triangle.Point3Z);
    }

    public static Float64Vector3D[] GetEndPoints(this ITriangle3D lineSegment)
    {
        return new[]
        {
            ...
            Float64Vector3D.Create(lineSegment.Point2X,
                lineSegment.Point2Y,
                lineSegment.Point2Z),
            Float64Vector3D.Create(lineSegment.Point3X,
                lineSegment.Point3Y,
                lineSegment.Point3Z)
        };
    }

    public static IEnumerable<Float64Vector3D> GetEndPoints(this IEnumerable<ITriangle3D> trianglesList)
    {
        return trianglesList.SelectMany(t => t.GetEndPoints());
    }

    public static Float64Vector3D GetDirection12(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point2X - triangle.Point1X,
            triangle.Point2Y - triangle.Point1Y,
            triangle.Point2Z - triangle.Point1Z);
    }

    public static Float64Vector3D GetDirection21(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point1X - triangle.Point2X,
            triangle.Point1Y - triangle.Point2Y,
            triangle.Point1Z - triangle.Point2Z);
    }

    public static Float64Vector3D GetDirection23(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point3X - triangle.Point2X,
            triangle.Point3Y - triangle.Point2Y,
            triangle.Point3Z - triangle.Point2Z);
    }

    public static Float64Vector3D GetDirection32(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point2X - triangle.Point3X,
            triangle.Point2Y - triangle.Point3Y,
            triangle.Point2Z - triangle.Point3Z);
    }

    public static Float64Vector3D GetDirection31(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point1X - triangle.Point3X,
            triangle.Point1Y - triangle.Point3Y,
            triangle.Point1Z - triangle.Point3Z);
    }

    public static Float64Vector3D GetDirection13(this ITriangle3D triangle)
    {
        return Float64Vector3D.Create(triangle.Point3X - triangle.Point1X,
            triangle.Point3Y - triangle.Point1Y,
    ...
    public static Float64Vector3D GetNormal(this ITriangle3D triangle)
    {
        return triangle
            .GetDirection12()
            .VectorCross(
    ...
    public static Float64Vector3D GetUnitNormal(this ITriangle3D triangle)
    {
        return triangle
            .GetDirection12()
            .VectorUnitCross(
    ...
    public static Float64Vector3D GetPointAt(this ITriangle3D triangle, double d1, double d2, double d3)
    {
        var d = 1 / (d1 + d2 + d3);
        var w1 = d1 * d;
        var w2 = d2 * d;
        ...
        return Float64Vector3D.Create(w1 * triangle.Point1X + w2 * triangle.Point2X + w3 * triangle.Point3X,
            w1 * triangle.Point1Y + w2 * triangle.Point2Y + w3 * triangle.Point3Y,
            w1 * triangle.Point1Z + w2 * triangle.Point2Z + w3 * triangle.Point3Z);
    }

    public static Float64Vector3D GetPointAt(this ITriangle3D triangle, double w1, double w2)
    {
        var w3 = 1.0d - (w1 + w2);
    ...
    public static IEnumerable<Float64Vector3D> GetPointsAt(this ITriangle3D triangle, IEnumerable<Float64Vector3D> parametersList)
    {
        return parametersList.Select(p => triangle.GetPointAt(p.X, p.Y));
    }

    public static Triangle3D GetTriangleAt(this ITriangle3D triangle, Float64Vector3D w1, Float64Vector3D w2, Float64Vector3D w3)
    {
        var point1 = triangle.GetPointAt(w1.X, w1.Y);
        var point2 = triangle.GetPointAt(w2.X, w2.Y);
        var point3 = triangle.GetPointAt(w3.X, w3.Y);
