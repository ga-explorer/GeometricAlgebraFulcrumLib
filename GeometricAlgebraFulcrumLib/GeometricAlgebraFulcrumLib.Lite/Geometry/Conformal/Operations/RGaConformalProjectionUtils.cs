...
public static class RGaConformalProjectionUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector2D ProjectPositionOnFlat2D(this RGaConformalElement element, RGaConformalFlat flat)
    {
        return element
            .PositionToOpnsFlatPoint()
            .ProjectOpnsOn(flat.EncodeOpnsBlade())
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Float64Vector3D ProjectPositionOnFlat3D(this RGaConformalElement element, RGaConformalFlat flat)
    {
        return element
            .PositionToOpnsFlatPoint()
            .ProjectOpnsOn(flat.EncodeOpnsBlade())
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IParametricCurve2D ProjectPositionOnFlat2D(this RGaConformalElement element, RGaConformalParametricElement flat)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IParametricCurve2D ProjectPositionOnFlat2D(this RGaConformalParametricElement element, RGaConformalFlat flat)
    {
        return ComputedParametricCurve2D.Create(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IParametricCurve2D ProjectPositionOnFlat2D(this RGaConformalParametricElement element, RGaConformalParametricElement flat)
    {
        return ComputedParametricCurve2D.Create(
