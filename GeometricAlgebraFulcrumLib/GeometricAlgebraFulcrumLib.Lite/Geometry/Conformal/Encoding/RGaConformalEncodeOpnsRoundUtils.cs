...
public static class RGaConformalEncodeOpnsRoundUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundPoint(this RGaConformalSpace conformalSpace, Float64Vector2D egaPoint)
    {
        return conformalSpace.EncodeIpnsRoundPoint(egaPoint).CGaUnDual();
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundPoint(this RGaConformalSpace conformalSpace, Float64Vector3D egaPoint)
    {
        return conformalSpace.EncodeIpnsRoundPoint(egaPoint).CGaUnDual();
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundPoint(this RGaConformalSpace conformalSpace, Float64Vector egaPoint)
    {
        return conformalSpace.EncodeIpnsRoundPoint(egaPoint).CGaUnDual();
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundPointPair(this RGaConformalSpace conformalSpace, Float64Vector2D egaPoint1, Float64Vector2D egaPoint2)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundCircle(this RGaConformalSpace conformalSpace, Float64Vector2D egaPoint1, Float64Vector2D egaPoint2, Float64Vector2D egaPoint3)
    {
        Debug.Assert(conformalSpace.Is4D);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundSphere(this RGaConformalSpace conformalSpace, Float64Vector2D egaPoint1, Float64Vector2D egaPoint2, Float64Vector2D egaPoint3, Float64Vector2D egaPoint4)
    {
        Debug.Assert(conformalSpace.Is4D);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundPointPair(this RGaConformalSpace conformalSpace, Float64Vector3D egaPoint1, Float64Vector3D egaPoint2)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundCircle(this RGaConformalSpace conformalSpace, Float64Vector3D egaPoint1, Float64Vector3D egaPoint2, Float64Vector3D egaPoint3)
    {
        Debug.Assert(conformalSpace.Is5D);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RGaConformalBlade EncodeOpnsRoundSphere(this RGaConformalSpace conformalSpace, Float64Vector3D egaPoint1, Float64Vector3D egaPoint2, Float64Vector3D egaPoint3, Float64Vector3D egaPoint4)
    {
        Debug.Assert(conformalSpace.Is5D);
