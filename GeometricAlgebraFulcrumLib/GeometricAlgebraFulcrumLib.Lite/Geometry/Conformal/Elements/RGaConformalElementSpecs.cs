    ...
    IEquatable<RGaConformalElementSpecs>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalParametricElement CreateParametricElement(Float64ScalarRange parameterRange, Func<double, RGaConformalBlade> getBladeFunc, IFloat64Vector2D egaProbePoint)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalParametricElement CreateParametricElement(Float64ScalarRange parameterRange, Func<double, RGaConformalBlade> getBladeFunc, IFloat64Vector3D egaProbePoint)
    {
        var egaProbePointBlade = 
            egaProbePoint.EncodeEGaVectorBlade(ConformalSpace);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalParametricElement CreateParametricElement(Float64ScalarRange parameterRange, Func<double, RGaConformalBlade> getBladeFunc, Float64Vector egaProbePoint)
    {
        var egaProbePointBlade = 
            egaProbePoint.EncodeEGaVectorBlade(ConformalSpace);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaConformalParametricElement CreateParametricElement(Float64ScalarRange parameterRange, Func<double, RGaConformalBlade> getBladeFunc, IParametricCurve2D egaProbePointCurve)
    {
        return RGaConformalParametricElement.Create(
            ConformalSpace,
            parameterRange,
