...
namespace GeometricAlgebraFulcrumLib.Lite.Geometry.Differential.Functions.Polynomials
{
        ...
        DfPolynomialBasis
    {
        ...
        public DfMonomialPolynomial GetPolynomialDerivative1()
        {
            ...
            var scalarCoefficients = Float64VectorComposer.Create(Degree - 1, Degree);
        ...
        public DfMonomialPolynomial GetPolynomialDerivativeN(int order)
        {
            ...
            var scalarCoefficients = Float64VectorComposer.Create(degree, scalar);
        ...
        {
            var scalarCoefficients = Float64VectorComposer.Create(Degree, 1d);
