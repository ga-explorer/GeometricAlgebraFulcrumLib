    ...
    IReadOnlyList<ParametricCurveLocalFrame2D>
{
    ...
    public IParametricCurve2D Curve { get; }
    ...
    public AdaptiveCurve2D(IParametricCurve2D surface, Float64ScalarRange parameterValueRange)
    {
        Curve = surface;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public AdaptiveCurve2D(IParametricCurve2D surface, double minParameterValue, double maxParameterValue)
    {
        Debug.Assert(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public AdaptiveCurve2D(IParametricCurve2D surface)
    {
        Curve = surface;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<Float64Vector2D> GetPoints(double parameterValue)
    {
        return GetPoints(ParameterValueMin, parameterValue);
    }

    public IEnumerable<Float64Vector2D> GetPoints(double parameterValue1, double parameterValue2)
    {
