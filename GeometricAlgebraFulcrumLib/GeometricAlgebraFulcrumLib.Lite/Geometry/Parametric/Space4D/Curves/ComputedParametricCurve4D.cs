...
namespace GeometricAlgebraFulcrumLib.Lite.Geometry.Parametric.Space4D.Curves
{
        ...
        IParametricCurve4D
    {
        ...
        public static ComputedParametricCurve4D Create(Func<double, Float64Vector4D> getPointFunc)
        {
            return new ComputedParametricCurve4D(getPointFunc);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComputedParametricCurve4D Create(Func<double, Float64Vector4D> getPointFunc, Func<double, Float64Vector4D> getTangentFunc)
        {
        ...
        public Func<double, Float64Vector4D> GetPointFunc { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private ComputedParametricCurve4D(Func<double, Float64Vector4D> getPointFunc)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private ComputedParametricCurve4D(Func<double, Float64Vector4D> getPointFunc, Func<double, Float64Vector4D> getTangentFunc)
        {
            GetPointFunc = getPointFunc;
