...
namespace GeometricAlgebraFulcrumLib.Lite.Geometry.Parametric.Space3D.Curves.Bezier
{
        ...
        IParametricC2Curve3D
    {
        ...
        public Float64Vector3D Point4 { get; }
        
        public Float64ScalarRange ParameterRange 
            => Float64ScalarRange.Infinite;


        public BezierCurve3Degree3D(IFloat64Vector3D point1, IFloat64Vector3D point2, IFloat64Vector3D point3, IFloat64Vector3D point4)
        {
            Point1 = point1.ToVector3D();
            Point2 = point2.ToVector3D();
            Point3 = point3.ToVector3D();
            Point4 = point4.ToVector3D();
        ...
        public Float64Vector3D GetPoint(double parameterValue)
        {
            ...
            return Float64Vector3D.Create(p1 * Point1.X + p2 * Point2.X + p3 * Point3.X + p4 * Point4.X,
        ...
        public Float64Vector3D GetDerivative1Point(double parameterValue)
        {
            ...
            return Float64Vector3D.Create(p1 * (Point2.X - Point1.X) + p2 * (Point3.X - Point2.X) + p3 * (Point4.X - Point3.X),
