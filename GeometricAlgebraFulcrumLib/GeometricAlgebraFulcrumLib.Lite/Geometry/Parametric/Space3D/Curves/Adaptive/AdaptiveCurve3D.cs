    ...
    IReadOnlyList<ParametricCurveLocalFrame3D>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<Float64Vector3D> GetPoints(double parameterValue)
    {
        return GetPoints(ParameterRange.MinValue, parameterValue);
    }

    public IEnumerable<Float64Vector3D> GetPoints(double parameterValue1, double parameterValue2)
    {
