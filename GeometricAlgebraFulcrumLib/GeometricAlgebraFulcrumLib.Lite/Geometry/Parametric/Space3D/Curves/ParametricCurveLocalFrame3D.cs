...
namespace GeometricAlgebraFulcrumLib.Lite.Geometry.Parametric.Space3D.Curves
{
        ...
        IParametricCurveLocalFrame3D
    {
        ...
        public static ParametricCurveLocalFrame3D Create(double parameterValue, IFloat64Vector3D point, IFloat64Vector3D tangent, IPair<IFloat64Vector3D> normalPair)
        {
            return new ParametricCurveLocalFrame3D(
                parameterValue,
                point.ToVector3D(),
                tangent.ToVector3D(),
                normalPair.Item1.ToVector3D(),
                normalPair.Item2.ToVector3D()
            );
        }
