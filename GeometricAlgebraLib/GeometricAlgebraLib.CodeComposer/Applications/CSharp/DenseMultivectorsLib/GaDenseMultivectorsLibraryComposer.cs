...
{
    public sealed class GaDenseMultivectorsLibraryComposer :
        GaCodeLibraryComposerBase
    {
        public static string GenerateCode(int vSpaceDimensions)
        {
            var codeLibraryComposer = new GaDenseMultivectorsLibraryComposer(vSpaceDimensions);
        ...
        public GaDenseMultivectorsLibraryComposer(int vSpaceDimensions) : 
            base(GaClcLanguageServer.CSharp4(new GaClcMathematicaExprToCSharpConverter()))
        {
...
"
        ...
        private string GetMultivectorBinaryOperationCode(Func<IGaMultivectorStorage<ISymbolicExpressionAtomic>, IGaMultivectorStorage<ISymbolicExpressionAtomic>, IGaMultivectorStorage<ISymbolicExpressionAtomic>> binaryOperationFunc, Func<ulong, string> namingFunc1, Func<ulong, string> namingFunc2, Func<ulong, string> namingFunc3)
        {
            ...
            mv1.SetExternalNamesById(namingFunc1);
            mv2.SetExternalNamesById(namingFunc2);
            mv3.SetExternalNamesById(namingFunc3);
        ...
        {
            return new GaDenseMultivectorsLibraryComposer(VSpaceDimensions);
        }
    }
}