using GeometricAlgebraLib.Algebra.Outermorphisms.Computed;
...
namespace GeometricAlgebraLib.CodeComposer.Applications.CSharp.DenseKVectorsLib.Outermorphism
{
