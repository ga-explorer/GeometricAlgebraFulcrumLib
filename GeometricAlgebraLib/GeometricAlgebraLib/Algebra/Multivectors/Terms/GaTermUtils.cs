...
namespace GeometricAlgebraLib.Algebra.Multivectors.Terms
{
    public static class GaTermUtils
    {
        ...
        public static IEnumerable<GaTerm<T>> IndexScalarToTermUniform<T>(this IEnumerable<KeyValuePair<ulong, T>> pairsList, int grade)
        {
            return pairsList.Select(pair => GaTerm<T>.CreateUniform(grade, pair.Key, pair.Value));
        }

        public static IEnumerable<GaTerm<T>> IndexScalarToTermGraded<T>(this IEnumerable<KeyValuePair<ulong, T>> pairsList, int grade)
        {
            return pairsList.Select(pair => GaTerm<T>.CreateGraded(grade, pair.Key, pair.Value));
        }

        public static IEnumerable<GaTerm<T>> IndexScalarToTermFull<T>(this IEnumerable<KeyValuePair<ulong, T>> pairsList, int grade)
        {
        ...
        public static IEnumerable<GaTerm<T>> IndexScalarToTermUniform<T>(this IEnumerable<Tuple<ulong, T>> pairsList, int grade)
        {
            return pairsList.Select(tuple => GaTerm<T>.CreateUniform(grade, tuple.Item1, tuple.Item2));
        }

        public static IEnumerable<GaTerm<T>> IndexScalarToTermGraded<T>(this IEnumerable<Tuple<ulong, T>> pairsList, int grade)
        {
            return pairsList.Select(tuple => GaTerm<T>.CreateGraded(grade, tuple.Item1, tuple.Item2));
        }

        public static IEnumerable<GaTerm<T>> IndexScalarToTermFull<T>(this IEnumerable<Tuple<ulong, T>> pairsList, int grade)
        {
        ...
        public static IEnumerable<GaTerm<T>> GradeIndexScalarToTermUniform<T>(this IEnumerable<Tuple<int, ulong, T>> tuplesList)
        {
            return tuplesList.Select(tuple => GaTerm<T>.CreateUniform(tuple.Item1, tuple.Item2, tuple.Item3));
        }

        public static IEnumerable<GaTerm<T>> GradeIndexScalarToTermGraded<T>(this IEnumerable<Tuple<int, ulong, T>> tuplesList)
        {
            return tuplesList.Select(tuple => GaTerm<T>.CreateGraded(tuple.Item1, tuple.Item2, tuple.Item3));
        }

        public static IEnumerable<GaTerm<T>> GradeIndexScalarToTermFull<T>(this IEnumerable<Tuple<int, ulong, T>> tuplesList)
        {
