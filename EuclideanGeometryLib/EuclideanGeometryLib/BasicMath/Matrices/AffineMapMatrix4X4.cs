...
{
    public sealed class AffineMapMatrix4X4 : 
        IAffineMap3D
    {
        public static AffineMapMatrix4X4 CreateZeroMatrix()
        {
            return new AffineMapMatrix4X4();
        }

        public static AffineMapMatrix4X4 CreateIdentityMatrix()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
                {
                    [0] = 1.0d,
        ...
        public static AffineMapMatrix4X4 CreateTranslationMatrix(double dx, double dy, double dz)
        {
        ...
        public static AffineMapMatrix4X4 CreateScalingMatrix(double sx, double sy, double sz)
        {
        ...
        public static AffineMapMatrix4X4 CreateScalingMatrix(double s)
        {
        ...
        public static AffineMapMatrix4X4 CreateXyReflectionMatrix()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
        ...
        public static AffineMapMatrix4X4 CreateYzReflectionMatrix()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
        ...
        public static AffineMapMatrix4X4 CreateZxReflectionMatrix()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
        ...
        public static AffineMapMatrix4X4 CreateXReflectionMatrix()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
        ...
        public static AffineMapMatrix4X4 CreateYReflectionMatrix()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
        ...
        public static AffineMapMatrix4X4 CreateZReflectionMatrix()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
        ...
        public static AffineMapMatrix4X4 CreateOriginReflectionMatrix()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
        ...
        public static AffineMapMatrix4X4 CreateXRotationMatrix(double radianAngle)
        {
        ...
        public static AffineMapMatrix4X4 CreateYRotationMatrix(double radianAngle)
        {
            Debug.Assert(!double.IsNaN(radianAngle));
        ...
        public static AffineMapMatrix4X4 CreateZRotationMatrix(double radianAngle)
        {
            Debug.Assert(!double.IsNaN(radianAngle));
        ...
        public static AffineMapMatrix4X4 CreateRotationMatrix(Tuple3D unitAxis, double radianAngle)
        {
        ...
        public static AffineMapMatrix4X4 operator -(AffineMapMatrix4X4 m1)
        {
        ...
        public static AffineMapMatrix4X4 operator +(AffineMapMatrix4X4 m1, AffineMapMatrix4X4 m2)
        {
        ...
        public static AffineMapMatrix4X4 operator *(AffineMapMatrix4X4 m1, double s)
        {
        ...
        public static AffineMapMatrix4X4 operator *(double s, AffineMapMatrix4X4 m1)
        {
            Debug.Assert(!m1.HasNaNComponents && !double.IsNaN(s));
        ...
        public AffineMapMatrix3X3 UpperLeftBlock3X3
        {
            get
            {
        ...
        public AffineMapMatrix4X4()
        {

        }

        public AffineMapMatrix4X4(AffineMapMatrix4X4 m1)
        {
        ...
        public AffineMapMatrix4X4(Matrix4x4 m1)
        {
            _items[0] = m1.M11;
            _items[1] = m1.M21;
            _items[2] = m1.M31;
        ...
        public AffineMapMatrix4X4 ResetToIdentity()
        {
            _items[0] = 1;
            _items[1] = 0;
            _items[2] = 0;
        ...
        public AffineMapMatrix4X4 ResetTo(AffineMapMatrix4X4 m1)
        {
            _items[0] = m1._items[0];
            _items[1] = m1._items[1];
            _items[2] = m1._items[2];
        ...
        public AffineMapMatrix4X4 SetColumn(int columnIndex, Tuple4D columnVector)
        {
            var j = columnIndex << 2;
        ...
        public AffineMapMatrix4X4 SelfSwapRows(int j1, int j2)
        {
        ...
        public AffineMapMatrix4X4 SelfSwapColumns(int i1, int i2)
        {
        ...
        public AffineMapMatrix4X4 SelfTranspose()
        {
            var s = _items[1];
            _items[1] = _items[4];
            _items[4] = s;
        ...
        public AffineMapMatrix4X4 Transpose()
        {
            var m = new AffineMapMatrix4X4
            {
                _items =
        ...
        public AffineMapMatrix4X4 Inverse()
        {
            var indxc = new int[4];
            var indxr = new int[4];
            var ipiv = new[] { 0, 0, 0, 0 };
            var minv = new AffineMapMatrix4X4(this);
        ...
        public AffineMapMatrix4X4 InverseTranspose()
        {
        ...
        {
            return new AffineMapMatrix4X4(this);
        }
