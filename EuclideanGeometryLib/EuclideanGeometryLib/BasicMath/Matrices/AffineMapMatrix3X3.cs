...
{
    public sealed class AffineMapMatrix3X3 : 
        IAffineMap2D
    {
        public static AffineMapMatrix3X3 CreateIdentityMatrix()
        {
            var m = new AffineMapMatrix3X3
            {
                _items =
                {
                    [0] = 1.0d,
        ...
        public static AffineMapMatrix3X3 CreateTranslationMatrix(double dx, double dy)
        {
            var m = new AffineMapMatrix3X3
            {
                _items =
        ...
        public static AffineMapMatrix3X3 CreateScalingMatrix(double sx, double sy)
        {
            var m = new AffineMapMatrix3X3
            {
                _items =
        ...
        public static AffineMapMatrix3X3 CreateScalingMatrix(double s)
        {
            var m = new AffineMapMatrix3X3
            {
                _items =
        ...
        public static AffineMapMatrix3X3 CreateXReflectionMatrix()
        {
            var m = new AffineMapMatrix3X3
            {
                _items =
        ...
        public static AffineMapMatrix3X3 CreateYReflectionMatrix()
        {
            var m = new AffineMapMatrix3X3
            {
                _items =
        ...
        public static AffineMapMatrix3X3 CreateOriginReflectionMatrix()
        {
            var m = new AffineMapMatrix3X3
            {
                _items =
        ...
        public static AffineMapMatrix3X3 CreateRotationMatrix(double radianAngle)
        {
            var m = new AffineMapMatrix3X3();
        ...
        public static AffineMapMatrix3X3 operator -(AffineMapMatrix3X3 m1)
        {
        ...
        public static AffineMapMatrix3X3 operator +(AffineMapMatrix3X3 m1, AffineMapMatrix3X3 m2)
        {
        ...
        public static AffineMapMatrix3X3 operator *(AffineMapMatrix3X3 m1, double s)
        {
        ...
        public static AffineMapMatrix3X3 operator *(double s, AffineMapMatrix3X3 m1)
        {
            Debug.Assert(!m1.HasNaNComponent && !double.IsNaN(s));
        ...
        public AffineMapMatrix3X3()
        {

        }

        public AffineMapMatrix3X3(AffineMapMatrix3X3 m1)
        {
        ...
        public AffineMapMatrix3X3 NearestOrthogonalMatrix()
        {
            var r1 = new AffineMapMatrix3X3(this);
            var r2 = r1;
        ...
        public AffineMapMatrix3X3 Inverse()
        {
            var indxc = new int[3];
            var indxr = new int[3];
            var ipiv = new[] { 0, 0, 0 };
            var minv = new AffineMapMatrix3X3(this);
        ...
        public AffineMapMatrix3X3 SelfTranspose()
        {
            var s = _items[1];
            _items[1] = _items[3];
            _items[3] = s;
        ...
        public AffineMapMatrix3X3 Transpose()
        {
            var m = new AffineMapMatrix3X3
            {
                _items =
        ...
        public AffineMapMatrix3X3 InverseTranspose()
        {
        ...
        {
            return new AffineMapMatrix3X3(this);
        }
